  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        nl: `${SITE_URL}/nl/categories`,
        it: `${SITE_URL}/it/categories`,
...
const COPY: Record<string, {
  ...
  fr: {
    ...
    howItems: [
      'Choisissez une catégorie adaptée à votre animal et vos préférences',
    ...
    faqs: [
      { q: 'Tous les hôtels acceptent-ils vraiment les animaux ?', a: 'Oui. Tous les hôtels référencés sur HotelsWithPets.com ont une politique pet-friendly explicite, vérifiée sur Booking.com. Nous n\'incluons pas les hôtels qui acceptent les animaux "sous réserve" ou "sous conditions non précisées".' },
      { q: 'Quelle est la différence entre "Chiens acceptés" et "Sans supplément animaux" ?', a: 'Les hôtels "Chiens acceptés" accueillent les chiens, mais certains facturent un supplément par nuit. La catégorie "Sans supplément animaux" regroupe uniquement les hôtels où votre chien séjourne sans frais supplémentaires.' },
      { q: 'Les limites de poids sont-elles vérifiées ?', a: 'Nous affichons les informations disponibles sur Booking.com. Pour les animaux de grande taille (plus de 20 kg), nous recommandons toujours de confirmer directement avec l\'hôtel avant de réserver.' },
      { q: 'Le supplément animaux est-il inclus dans le prix affiché ?', a: 'Non. Le supplément animaux est généralement réglé à l\'arrivée. Le prix affiché correspond au tarif de base de la chambre tel que communiqué par Booking.com.' },
    ],
  },
  en: {
  ...
  es: {
    intro: 'Todos nuestros hoteles tienen una política de mascotas verificada, pero cada viaje es distinto. Filtra por categoría para encontrar exactamente lo que necesitas: perro grande, gato, estancia de lujo, acceso a playa o sin suplemento por mascota.',
    whyTitle: '¿Por qué filtrar por categoría?',
    whyText: '"Se admiten mascotas" no lo dice todo. Algunos hoteles solo aceptan perros pequeños; otros cobran una tarifa nocturna elevada. Nuestras categorías van más allá: agrupan los hoteles por criterios concretos y verificados directamente en la fuente.',
    howTitle: 'Cómo usar los filtros',
    howItems: [
      'Elige la categoría que mejor se adapte a tu mascota y tus preferencias',
    ...
    faqs: [
      { q: '¿Todos los hoteles listados aceptan realmente mascotas?', a: 'Sí. Todos los hoteles de HotelsWithPets.com tienen una política pet-friendly explícita y verificada en Booking.com. Excluimos los que solo aceptan animales "bajo condiciones no especificadas".' },
      { q: '¿Cuál es la diferencia entre "Admite perros" y "Sin suplemento por mascota"?', a: 'Todos los hoteles "Admite perros" aceptan perros, pero algunos cobran una tarifa adicional por noche. "Sin suplemento por mascota" incluye únicamente los hoteles donde tu perro se aloja sin ningún coste extra.' },
      { q: '¿Se verifican los límites de peso?', a: 'Mostramos la información disponible en Booking.com. Para perros grandes (más de 20 kg), recomendamos confirmar directamente con el hotel antes de reservar.' },
      { q: '¿El precio mostrado incluye el suplemento por mascota?', a: 'No. El suplemento por mascota se suele abonar en el momento del check-in. El precio mostrado corresponde a la tarifa base de la habitación según Booking.com.' },
    ],
  },
}
