...
const REGIONS: Region[] = [
  {
    id: 'foret-noire',
    emoji: '🌲',
    title: { en: 'Black Forest', fr: 'Forêt-Noire', es: 'Selva Negra', pt: 'Floresta Negra', de: 'Schwarzwald' },
    cities: [
      {
        slug: 'freiburg-im-breisgau',
        name: 'Freiburg im Breisgau',
        region: { en: 'Black Forest', fr: 'Forêt-Noire', es: 'Selva Negra', pt: 'Floresta Negra', de: 'Schwarzwald' },
        julyTemp: 24,
        tag: { en: 'Sunniest city in Germany · forest trails · 24°C', fr: 'Ville la plus ensoleillée d\'Allemagne · forêt · 24°C', es: 'Ciudad más soleada de Alemania · bosque · 24°C', pt: 'Cidade mais soalheira da Alemanha · floresta · 24°C', de: 'Sonnigste Stadt Deutschlands · Waldwege · 24°C' },
        why: {
      ...
      },
      {
        ...
        region: { en: 'Black Forest', fr: 'Forêt-Noire', es: 'Selva Negra', pt: 'Floresta Negra', de: 'Schwarzwald' },
        julyTemp: 23,
        tag: { en: 'Belle Époque spa · Lichtentaler Allee · 23°C', fr: 'Spa Belle Époque · Lichtentaler Allee · 23°C', es: 'Balneario Belle Époque · Lichtentaler Allee · 23°C', pt: 'Spa Belle Époque · Lichtentaler Allee · 23°C', de: 'Belle-Époque-Kurort · Lichtentaler Allee · 23°C' },
        why: {
  ...
  },
  {
    id: 'baviere-alpine',
    emoji: '⛰️',
    title: { en: 'Bavarian Alps', fr: 'Alpes bavaroises', es: 'Alpes bávaros', pt: 'Alpes bávaros', de: 'Bayerische Alpen' },
    cities: [
      {
        slug: 'garmisch-partenkirchen',
        name: 'Garmisch-Partenkirchen',
        region: { en: 'Bavarian Alps', fr: 'Alpes bavaroises', es: 'Alpes bávaros', pt: 'Alpes bávaros', de: 'Bayerische Alpen' },
        julyTemp: 22,
        tag: { en: 'Zugspitze base · Loisach river · 22°C', fr: 'Pied de la Zugspitze · Loisach · 22°C', es: 'Base de la Zugspitze · Loisach · 22°C', pt: 'Base da Zugspitze · Loisach · 22°C', de: 'Fuß der Zugspitze · Loisach · 22°C' },
        why: {
  ...
  },
  {
    id: 'lac-de-constance',
    emoji: '🌊',
    title: { en: 'Lake Constance', fr: 'Lac de Constance', es: 'Lago Constanza', pt: 'Lago Constança', de: 'Bodensee' },
    cities: [
      {
        slug: 'lindau',
        name: 'Lindau im Bodensee',
        region: { en: 'Lake Constance', fr: 'Lac de Constance', es: 'Lago Constanza', pt: 'Lago Constança', de: 'Bodensee' },
        julyTemp: 22,
        tag: { en: 'Island old town · Alpine panorama · 22°C', fr: 'Vieille ville insulaire · panorama alpin · 22°C', es: 'Ciudad vieja insular · panorama alpino · 22°C', pt: 'Cidade velha insular · panorama alpino · 22°C', de: 'Inselaltstadt · Alpenpanorama · 22°C' },
        why: {
  ...
  },
  {
    id: 'cote-baltique',
    emoji: '🌊',
    title: { en: 'Baltic coast (Rügen)', fr: 'Côte baltique (Rügen)', es: 'Costa báltica (Rügen)', pt: 'Costa báltica (Rügen)', de: 'Ostseeküste (Rügen)' },
    cities: [
      {
        slug: 'rugen',
        name: 'Rügen',
        region: { en: 'Baltic coast', fr: 'Côte baltique', es: 'Costa báltica', pt: 'Costa báltica', de: 'Ostseeküste' },
        julyTemp: 21,
        tag: { en: 'Chalk cliffs · Baltic sea · dog beaches year-round', fr: 'Falaises de craie · mer Baltique · plages dog-friendly toute l\'année', es: 'Acantilados de tiza · mar Báltico · playas dog-friendly todo el año', pt: 'Falésias de giz · mar Báltico · praias dog-friendly o ano todo', de: 'Kreidefelsen · Ostsee · Hundestrände ganzjährig' },
        why: {
  ...
  },
  {
    ...
    emoji: '🏰',
    title: { en: 'Romantic Rhine & Neckar', fr: 'Rhin et Neckar romantiques', es: 'Rin y Neckar románticos', pt: 'Reno e Neckar românticos', de: 'Romantischer Rhein & Neckar' },
    cities: [
      {
        slug: 'heidelberg',
        name: 'Heidelberg',
        region: { en: 'Romantic Rhine & Neckar', fr: 'Rhin et Neckar romantiques', es: 'Rin y Neckar románticos', pt: 'Reno e Neckar românticos', de: 'Romantischer Rhein & Neckar' },
        julyTemp: 24,
        tag: { en: 'Neckar river · Germany\'s oldest university · 24°C', fr: 'Neckar · plus vieille université d\'Allemagne · 24°C', es: 'Neckar · universidad más antigua de Alemania · 24°C', pt: 'Neckar · universidade mais antiga da Alemanha · 24°C', de: 'Neckar · Deutschlands älteste Universität · 24°C' },
        why: {
        ...
        hotels: [
          {
            ...
            stars: 4,
            note: { en: 'Neckar riverside hotel, terrace with castle views, dogs up to 25 kg accepted.', fr: 'Hôtel en bord du Neckar, terrasse avec vue sur le château, chiens jusqu\'à 25 kg acceptés.', es: 'Hotel a orillas del Neckar, terraza con vistas al castillo, perros hasta 25 kg aceptados.', pt: 'Hotel à beira do Neckar, terraço com vistas para o castelo, cães até 25 kg aceites.', de: 'Hotel direkt am Neckar, Terrasse mit Schlossblick, Hunde bis 25 kg erlaubt.' },
          },
          {
...
const T = {
  ...
  hotelsLabel: { en: 'Our hotel picks', fr: 'Nos hôtels recommandés', es: 'Nuestros hoteles recomendados', pt: 'Os nossos hotéis recomendados', de: 'Unsere Hotelauswahl' },
  ...
  faq: {
    q1: { en: 'Which German cities stay cool in summer?', fr: 'Quelles villes allemandes restent fraîches en été ?', es: '¿Qué ciudades alemanas permanecen frescas en verano?', pt: 'Que cidades alemãs se mantêm frescas no verão?', de: 'Welche deutschen Städte bleiben im Sommer kühl?' },
    a1: {
    ...
    q2: { en: 'Are dogs allowed on German trains?', fr: 'Les chiens sont-ils autorisés dans les trains allemands ?', es: '¿Se permiten perros en los trenes alemanes?', pt: 'São permitidos cães nos comboios alemães?', de: 'Sind Hunde in deutschen Zügen erlaubt?' },
    a2: {
    ...
    q4: { en: 'Are dogs allowed on German beaches?', fr: 'Les chiens sont-ils autorisés sur les plages allemandes ?', es: '¿Se permiten perros en las playas alemanas?', pt: 'São permitidos cães nas praias alemãs?', de: 'Sind Hunde an deutschen Stränden erlaubt?' },
    a4: {
    ...
    q5: { en: 'What is the dog tax (Hundesteuer) in Germany?', fr: 'Qu\'est-ce que la taxe sur les chiens (Hundesteuer) en Allemagne ?', es: '¿Qué es el impuesto sobre perros (Hundesteuer) en Alemania?', pt: 'O que é o imposto sobre cães (Hundesteuer) na Alemanha?', de: 'Was ist die Hundesteuer in Deutschland?' },
    a5: {
      ...
      <section className="bg-gradient-to-br from-slate-900 via-gray-800 to-emerald-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-green-200 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-5">
            🇩🇪 {locale === 'fr' ? 'Forêt-Noire · Bavière · Baltique' : locale === 'es' ? 'Selva Negra · Baviera · Báltico' : locale === 'pt' ? 'Floresta Negra · Baviera · Báltico' : locale === 'de' ? 'Schwarzwald · Bayern · Ostsee' : 'Black Forest · Bavaria · Baltic'}
          </div>
