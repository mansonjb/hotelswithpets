...
const REGIONS: Region[] = [
  {
    id: 'foret-noire',
    emoji: '🌲',
    title: { en: 'Black Forest', fr: 'Forêt-Noire', es: 'Selva Negra', pt: 'Floresta Negra', de: 'Schwarzwald', nl: 'Zwarte Woud', it: 'Foresta Nera' },
    cities: [
      {
        slug: 'freiburg-im-breisgau',
        name: 'Freiburg im Breisgau',
        region: { en: 'Black Forest', fr: 'Forêt-Noire', es: 'Selva Negra', pt: 'Floresta Negra', de: 'Schwarzwald', nl: 'Zwarte Woud', it: 'Foresta Nera' },
        julyTemp: 24,
        tag: { en: 'Sunniest city in Germany · forest trails · 24°C', fr: 'Ville la plus ensoleillée d\'Allemagne · forêt · 24°C', es: 'Ciudad más soleada de Alemania · bosque · 24°C', pt: 'Cidade mais soalheira da Alemanha · floresta · 24°C', de: 'Sonnigste Stadt Deutschlands · Waldwege · 24°C', nl: 'Zonnigste stad van Duitsland · bospaden · 24°C', it: 'Città più soleggiata della Germania · sentieri nel bosco · 24°C' },
        why: {
          ...
          de: 'Freiburg liegt auf 278m Höhe am westlichen Fuß des Schwarzwalds und verzeichnet im Juli 24°C, deutlich kühler als die Rheinebene (30°C) und ohne die mediterrane Hitze von Marseille oder Madrid. Der Dreisamuferweg (ohne Leine für Hunde, 15 km von der Stadt bis in den Wald) und die Seilbahn zum Schauinsland-Gipfel (1.284m) sind klassische Hundeausflüge. Die Altstadt ist zu 80% autofrei. Die deutsche Hundekultur gehört zu den großzügigsten Europas: Restaurants, Züge und Geschäfte heißen Hunde routinemäßig willkommen.',
          nl: 'Freiburg ligt op 278m aan de westelijke voet van het Zwarte Woud en noteert in juli 24°C, een stuk koeler dan de Rijnvlakte (30°C) en zonder de mediterrane hitte van Marseille of Madrid. Het pad langs de Dreisam (voor honden los te laten, 15 km van de stad tot in het bos) en de kabelbaan naar de top van de Schauinsland (1.284m) zijn klassieke hondenuitjes. De oude binnenstad (Altstadt) is voor 80% autovrij. De Duitse hondencultuur is een van de meest toegeeflijke van Europa: restaurants, treinen en winkels heten je hond routinematig welkom.',
          it: 'Freiburg si trova a 278m ai piedi occidentali della Foresta Nera e registra 24°C a luglio, nettamente più fresco della pianura del Reno (30°C) e senza il caldo mediterraneo di Marsiglia o Madrid. Il sentiero lungo la Dreisam (senza guinzaglio per i cani, 15 km dalla città fino al bosco) e la funivia verso la cima dello Schauinsland (1.284m) sono le classiche uscite con il cane. Il centro storico (Altstadt) è pedonale all`80%. La cultura canina tedesca è tra le più permissive d`Europa: ristoranti, treni e negozi accolgono i cani di norma.',
        },
        dogTip: {
          ...
          de: 'Schauinslandbahn (12 km vom Stadtzentrum): Hunde fahren kostenlos mit, Ankunft auf 1.220m, 35 km ausgeschilderte Waldwege ohne Leine, den ganzen Sommer kühl, ein Biergarten am Gipfel, der Hunde auf der Terrasse willkommen heißt.',
          nl: 'Schauinslandbahn (12 km vanaf het stadscentrum): honden reizen gratis mee, aankomst op 1.220m, 35 km bewegwijzerde bospaden waar je hond los mag, de hele zomer koel, een Biergarten op de top waar honden welkom zijn op het terras.',
          it: 'Funivia dello Schauinsland (12 km dal centro città): i cani viaggiano gratis, arrivo a 1.220m, 35 km di sentieri nel bosco segnalati senza guinzaglio, fresco per tutta l`estate, un Biergarten in vetta che accoglie i cani in terrazza.',
        },
        hotels: [
          {
            name: 'Hotel Oberkirch',
            stars: 4,
            note: { en: 'Historic hotel on Münsterplatz, 13th-century cellar wine bar, dogs accepted.', fr: 'Hôtel historique sur la Münsterplatz, bar à vin du XIIIe siècle en cave, chiens acceptés.', es: 'Hotel histórico en Münsterplatz, bar de vinos del siglo XIII en bodega, perros aceptados.', pt: 'Hotel histórico na Münsterplatz, bar de vinhos do séc. XIII em adega, cães aceites.', de: 'Historisches Hotel am Münsterplatz, Weinkeller aus dem 13. Jahrhundert, Hunde erlaubt.', nl: 'Historisch hotel aan het Münsterplatz, wijnbar in 13e-eeuwse kelder, honden toegestaan.', it: 'Hotel storico sulla Münsterplatz, enoteca in cantina del XIII secolo, cani ammessi.' },
          },
          {
            name: 'Novotel Freiburg am Konzerthaus',
            stars: 4,
            note: { en: 'Modern hotel near the Schlossberg hill, 5 min walk to old town, pets up to 15 kg accepted.', fr: 'Hôtel moderne près du Schlossberg, 5 min à pied du centre historique, animaux jusqu\'à 15 kg acceptés.', es: 'Hotel moderno cerca del Schlossberg, a 5 min a pie del casco histórico, mascotas hasta 15 kg aceptadas.', pt: 'Hotel moderno perto do Schlossberg, 5 min a pé do centro histórico, animais até 15 kg aceites.', de: 'Modernes Hotel nahe dem Schlossberg, 5 Gehminuten zur Altstadt, Haustiere bis 15 kg erlaubt.', nl: 'Modern hotel bij de Schlossberg, 5 minuten lopen naar de oude binnenstad, huisdieren tot 15 kg toegestaan.', it: 'Hotel moderno vicino alla collina dello Schlossberg, 5 minuti a piedi dal centro storico, animali fino a 15 kg ammessi.' },
          },
          {
            name: 'Hotel Schwarz Waldschenke',
            stars: 3,
            note: { en: 'Traditional inn on the Schauinsland road, forest setting, large garden, dogs of all sizes welcome.', fr: 'Auberge traditionnelle sur la route du Schauinsland, cadre forestier, grand jardin, chiens de toute taille bienvenus.', es: 'Posada tradicional en la carretera de Schauinsland, entorno forestal, jardín amplio, perros de cualquier tamaño bienvenidos.', pt: 'Estalagem tradicional na estrada do Schauinsland, ambiente florestal, jardim amplo, cães de qualquer tamanho bem-vindos.', de: 'Traditionsgasthof an der Schauinslandstraße, Waldlage, großer Garten, Hunde jeder Größe willkommen.', nl: 'Traditionele herberg aan de Schauinslandweg, in het bos, grote tuin, honden van elk formaat welkom.', it: 'Locanda tradizionale sulla strada dello Schauinsland, immersa nel bosco, grande giardino, cani di ogni taglia benvenuti.' },
          },
        ],
      },
      {
        ...
        region: { en: 'Black Forest', fr: 'Forêt-Noire', es: 'Selva Negra', pt: 'Floresta Negra', de: 'Schwarzwald', nl: 'Zwarte Woud', it: 'Foresta Nera' },
        julyTemp: 23,
        tag: { en: 'Belle Époque spa · Lichtentaler Allee · 23°C', fr: 'Spa Belle Époque · Lichtentaler Allee · 23°C', es: 'Balneario Belle Époque · Lichtentaler Allee · 23°C', pt: 'Spa Belle Époque · Lichtentaler Allee · 23°C', de: 'Belle-Époque-Kurort · Lichtentaler Allee · 23°C', nl: 'Belle Époque-kuuroord · Lichtentaler Allee · 23°C', it: 'Terme Belle Époque · Lichtentaler Allee · 23°C' },
        why: {
          ...
          de: 'Baden-Baden liegt auf 200m im Oostal, wobei der Schwarzwald gleich östlich ansteigt, wodurch der Juli bei 23°C bleibt. Die Lichtentaler Allee (3 km Flusspromenade durch Rosengärten und jahrhundertealte Platanen) ist durchgehend hundefreundlich und zählt zu den elegantesten Hundespaziergängen Europas. Das Schwarzwaldplateau direkt oberhalb der Stadt (Merkur-Bergbahn, 667m) bietet 15 km Bergwege ohne Leine. Das Kasinoviertel ist gesäumt von Café-Terrassen, die Hunde willkommen heißen.',
          nl: 'Baden-Baden ligt op 200m in het Oosdal, met het Zwarte Woud dat direct ten oosten omhoog rijst, waardoor het er in juli 23°C blijft. De Lichtentaler Allee (3 km rivierpromenade langs rozentuinen en eeuwenoude platanen) is helemaal hondvriendelijk en behoort tot de meest elegante hondenwandelingen van Europa. Het Zwarte Woud-plateau direct boven de stad (Merkur-kabelbaan, 667m) heeft 15 km bergpaden waar je hond los mag. De wijk rond het casino is gezoomd met caféterrassen waar honden welkom zijn.',
          it: 'Baden-Baden si trova a 200m nella valle dell`Oos, con la Foresta Nera che si alza subito a est, mantenendo luglio a 23°C. La Lichtentaler Allee (3 km di passeggiata lungo il fiume tra roseti e platani secolari) è interamente a misura di cane e rientra tra le più eleganti passeggiate canine d`Europa. L`altopiano della Foresta Nera proprio sopra la città (funicolare del Merkur, 667m) offre 15 km di sentieri di montagna senza guinzaglio. Il quartiere del casinò è costeggiato da terrazze di caffè che accolgono i cani.',
        },
        dogTip: {
          ...
          de: 'Lichtentaler Allee: 3 km, Hunde dürfen auf den inneren Rasenwegen ohne Leine laufen, alle 100m eine Bank, der Kurgarten am Ende erlaubt Hunde ebenfalls im Außenbereich. Eine der großen Hundepromenaden Europas, kostenlos, zentral, schattig.',
          nl: 'Lichtentaler Allee: 3 km, honden mogen los op de binnenste graspaden, elke 100m een bankje, de tuin van het Gondrambad aan het einde laat honden ook buiten toe. Een van de grote hondenpromenades van Europa, gratis, centraal, beschaduwd.',
          it: 'Lichtentaler Allee: 3 km, cani senza guinzaglio ammessi sui vialetti erbosi interni, panchine ogni 100m, il giardino delle terme Gondrambad in fondo ammette i cani anche all`esterno. Una delle grandi passeggiate canine d`Europa, gratuita, centrale, ombreggiata.',
        },
        hotels: [
          {
            name: 'Brenners Park-Hotel und Spa',
            stars: 5,
            note: { en: 'Legendary grand hotel on the Lichtentaler Allee, private park, dogs accepted with bed and treats.', fr: 'Légendaire grand hôtel sur la Lichtentaler Allee, parc privé, chiens acceptés avec lit et friandises.', es: 'Legendario gran hotel en el Lichtentaler Allee, parque privado, perros aceptados con cama y golosinas.', pt: 'Lendário grande hotel no Lichtentaler Allee, parque privado, cães aceites com cama e guloseimas.', de: 'Legendäres Grandhotel an der Lichtentaler Allee, privater Park, Hunde willkommen mit Hundebett und Leckerlis.', nl: 'Legendarisch grand hotel aan de Lichtentaler Allee, eigen park, honden welkom met hondenmand en lekkernijen.', it: 'Leggendario grand hotel sulla Lichtentaler Allee, parco privato, cani ammessi con cuccia e snack.' },
          },
          {
            name: 'Hotel Belle Epoque',
            stars: 5,
            note: { en: 'Boutique 5-star in a Victorian villa, garden, 5 min walk to the casino, dogs welcome.', fr: 'Boutique 5 étoiles dans une villa victorienne, jardin, 5 min du casino, chiens bienvenus.', es: 'Boutique 5 estrellas en una villa victoriana, jardín, a 5 min del casino, perros bienvenidos.', pt: 'Boutique 5 estrelas numa villa vitoriana, jardim, 5 min do casino, cães bem-vindos.', de: 'Boutique-5-Sterne-Hotel in einer viktorianischen Villa, Garten, 5 Gehminuten zum Kasino, Hunde willkommen.', nl: 'Boetiek 5-sterrenhotel in een Victoriaanse villa, tuin, 5 minuten lopen naar het casino, honden welkom.', it: 'Boutique hotel 5 stelle in una villa vittoriana, giardino, 5 minuti a piedi dal casinò, cani benvenuti.' },
          },
          {
            name: 'Hotel am Sophienpark',
            stars: 4,
            note: { en: 'Classic hotel on a quiet park square, walking distance to the Allee, pets accepted.', fr: 'Hôtel classique sur une place de parc calme, à pied de l\'Allee, animaux acceptés.', es: 'Hotel clásico en una plaza de parque tranquila, a pie del Allee, mascotas aceptadas.', pt: 'Hotel clássico numa praça de parque tranquila, a pé do Allee, animais aceites.', de: 'Klassisches Hotel an einem ruhigen Parkplatz, fußläufig zur Allee, Haustiere erlaubt.', nl: 'Klassiek hotel aan een rustig parkplein, lopend afstand tot de Allee, huisdieren toegestaan.', it: 'Hotel classico su una tranquilla piazza del parco, a pochi passi dall`Allee, animali ammessi.' },
          },
        ],
      },
    ],
  },
  {
    id: 'baviere-alpine',
    emoji: '⛰️',
    title: { en: 'Bavarian Alps', fr: 'Alpes bavaroises', es: 'Alpes bávaros', pt: 'Alpes bávaros', de: 'Bayerische Alpen', nl: 'Beierse Alpen', it: 'Alpi bavaresi' },
    cities: [
      {
        slug: 'garmisch-partenkirchen',
        name: 'Garmisch-Partenkirchen',
        region: { en: 'Bavarian Alps', fr: 'Alpes bavaroises', es: 'Alpes bávaros', pt: 'Alpes bávaros', de: 'Bayerische Alpen', nl: 'Beierse Alpen', it: 'Alpi bavaresi' },
        julyTemp: 22,
        tag: { en: 'Zugspitze base · Loisach river · 22°C', fr: 'Pied de la Zugspitze · Loisach · 22°C', es: 'Base de la Zugspitze · Loisach · 22°C', pt: 'Base da Zugspitze · Loisach · 22°C', de: 'Fuß der Zugspitze · Loisach · 22°C', nl: 'Voet van de Zugspitze · Loisach-rivier · 22°C', it: 'Ai piedi dello Zugspitze · fiume Loisach · 22°C' },
        why: {
          ...
          de: 'Garmisch-Partenkirchen liegt auf 708m und verzeichnet im Juli 22°C, während München bei 25°C schwitzt und die italienische Po-Ebene 34°C erreicht. Der Ort liegt direkt unterhalb der Zugspitze (2.962m) und ist Ausgangspunkt des Zugspitz-Trails, einer der großen Fernwanderwege Deutschlands. Der Loisachuferweg (15 km Uferwege ohne Leine) und die Partnachklamm (spektakuläre Kalksteinschlucht, in der Klamm Leinenpflicht, davor und danach ohne Leine) sind die klassischen Hunderouten.',
          nl: 'Garmisch-Partenkirchen ligt op 708m en noteert in juli 22°C, terwijl München zweet bij 25°C en de Italiaanse Povlakte 34°C haalt. De plaats ligt direct onder de Zugspitze (2.962m) en is het startpunt van de Zugspitz-Trail, een van de grote lange-afstandswandelingen van Duitsland. Het pad langs de Loisach (15 km oeverpaden waar je hond los mag) en de Partnachklamm (dramatische kalkstenen kloof, in de kloof aan de lijn, ervoor en erna los) zijn de klassieke hondenroutes.',
          it: 'Garmisch-Partenkirchen a 708m registra 22°C a luglio, mentre Monaco soffoca a 25°C e la pianura padana italiana tocca i 34°C. Si trova proprio sotto lo Zugspitze (2.962m) ed è il punto di partenza dello Zugspitz-Trail, una delle grandi escursioni di lunga distanza della Germania. La passeggiata lungo la Loisach (15 km di sentieri sulla riva senza guinzaglio) e la Gola della Partnach (spettacolare gola calcarea, cani al guinzaglio nella gola, senza guinzaglio prima e dopo) sono gli itinerari canini classici.',
        },
        dogTip: {
          ...
          de: 'Partnachklamm: 700m in Fels gehauene Kalksteinschlucht, Hunde an der Leine, spektakuläre Wasserfälle, kühl auch bei Hitzewellen (10°C in der Klamm im Sommer), 3 km Rundweg ab dem Parkplatz des Olympia-Skistadions.',
          nl: 'Partnachklamm: 700m in de rots uitgehouwen kalkstenen kloof, honden aan de lijn, dramatische watervallen, koel zelfs tijdens hittegolven (10°C in de kloof in de zomer), 3 km heen en terug vanaf de parkeerplaats bij het Olympisch skistadion.',
          it: 'Gola della Partnach (Partnachklamm): 700m di gola calcarea scavata nella roccia, cani al guinzaglio, cascate spettacolari, fresca anche durante le ondate di caldo (10°C dentro la gola in estate), 3 km andata e ritorno dal parcheggio dello stadio olimpico dello sci.',
        },
        hotels: [
          {
            name: 'Hotel Zugspitze',
            stars: 4,
            note: { en: 'Classic Bavarian hotel at the foot of the Zugspitze cable car, mountain views, dogs of any size welcome.', fr: 'Hôtel bavarois classique au pied du téléphérique de la Zugspitze, vue montagne, chiens de toute taille bienvenus.', es: 'Clásico hotel bávaro al pie del teleférico de la Zugspitze, vistas a la montaña, perros de cualquier tamaño bienvenidos.', pt: 'Hotel bávaro clássico ao pé do teleférico da Zugspitze, vistas para a montanha, cães de qualquer tamanho bem-vindos.', de: 'Klassisches bayerisches Hotel am Fuß der Zugspitzbahn, Bergblick, Hunde jeder Größe willkommen.', nl: 'Klassiek Beiers hotel aan de voet van de Zugspitzbahn, bergzicht, honden van elk formaat welkom.', it: 'Hotel bavarese classico ai piedi della funivia dello Zugspitze, vista sulle montagne, cani di qualsiasi taglia benvenuti.' },
          },
          {
            name: 'Riessersee Hotel',
            stars: 4,
            note: { en: 'Lakeside hotel with private beach on the Riessersee, lawns, dogs welcome up to 20 kg.', fr: 'Hôtel au bord du Riessersee avec plage privée, pelouses, chiens bienvenus jusqu\'à 20 kg.', es: 'Hotel a orillas del Riessersee con playa privada, céspedes, perros bienvenidos hasta 20 kg.', pt: 'Hotel à beira do Riessersee com praia privada, relvados, cães bem-vindos até 20 kg.', de: 'Hotel am Riessersee mit eigenem Strand, Rasenflächen, Hunde bis 20 kg willkommen.', nl: 'Hotel aan het meer met eigen strand aan de Riessersee, grasvelden, honden welkom tot 20 kg.', it: 'Hotel sul lago con spiaggia privata sul Riessersee, prati, cani benvenuti fino a 20 kg.' },
          },
          {
            name: 'Gasthof Fraundorfer',
            stars: 3,
            note: { en: 'Traditional Bavarian gasthaus with live Zither music nightly, central, dogs accepted in all rooms.', fr: 'Gasthaus bavarois traditionnel avec musique de Zither en direct chaque soir, central, chiens acceptés dans toutes les chambres.', es: 'Gasthaus bávaro tradicional con música de Zither en directo cada noche, central, perros aceptados en todas las habitaciones.', pt: 'Gasthaus bávaro tradicional com música de Zither ao vivo todas as noites, central, cães aceites em todos os quartos.', de: 'Traditioneller bayerischer Gasthof mit live Zithermusik jeden Abend, zentral, Hunde in allen Zimmern erlaubt.', nl: 'Traditionele Beierse Gasthof met elke avond live Zithermuziek, centraal gelegen, honden toegestaan in alle kamers.', it: 'Gasthaus bavarese tradizionale con musica dal vivo di cetra ogni sera, centrale, cani ammessi in tutte le camere.' },
          },
        ],
      },
    ],
  },
  {
    id: 'lac-de-constance',
    emoji: '🌊',
    title: { en: 'Lake Constance', fr: 'Lac de Constance', es: 'Lago Constanza', pt: 'Lago Constança', de: 'Bodensee', nl: 'Bodenmeer', it: 'Lago di Costanza' },
    cities: [
      {
        slug: 'lindau',
        name: 'Lindau im Bodensee',
        region: { en: 'Lake Constance', fr: 'Lac de Constance', es: 'Lago Constanza', pt: 'Lago Constança', de: 'Bodensee', nl: 'Bodenmeer', it: 'Lago di Costanza' },
        julyTemp: 22,
        tag: { en: 'Island old town · Alpine panorama · 22°C', fr: 'Vieille ville insulaire · panorama alpin · 22°C', es: 'Ciudad vieja insular · panorama alpino · 22°C', pt: 'Cidade velha insular · panorama alpino · 22°C', de: 'Inselaltstadt · Alpenpanorama · 22°C', nl: 'Eiland-binnenstad · Alpenpanorama · 22°C', it: 'Centro storico sull`isola · panorama alpino · 22°C' },
        why: {
          ...
          de: 'Lindau ist eine mittelalterliche Inselstadt, die über einen Damm mit dem bayerischen Ufer des Bodensees verbunden ist (22°C im Juli). Die Wärmespeicherkapazität des Sees hält die Sommertemperaturen moderat. Die Insel (1 km x 300m) ist fast vollständig autofrei. Der Bodensee-Radweg (273 km rund um den See, flach, asphaltiert, ohne Leine) ist eine der großen Hunde-Radrouten Europas. Baden an den Seestränden ist ganzjährig möglich: die meisten deutschen Seestrände erlauben Hunde in der Saison vor 9 Uhr und nach 18 Uhr.',
          nl: 'Lindau is een middeleeuws eilandstadje dat via een dam verbonden is met de Beierse oever van het Bodenmeer (22°C in juli). De warmtebuffer van het meer houdt de zomertemperaturen gematigd. Het eiland (1 km bij 300m) is bijna helemaal autovrij. Het Bodensee-Radweg (273 km rond het meer, vlak, geasfalteerd, waar je hond los mag) is een van de grote hondenfietsroutes van Europa. Zwemmen aan de meerstranden kan het hele jaar door: de meeste Duitse meerstranden laten honden toe voor 9 uur en na 18 uur in het seizoen.',
          it: 'Lindau è una città medievale sull`isola, collegata da una diga alla sponda bavarese del Lago di Costanza (22°C a luglio). La massa termica del lago mantiene moderate le temperature estive. L`isola (1 km per 300m) è quasi interamente pedonale. La pista ciclabile del Lago di Costanza (273 km intorno al lago, pianeggiante, asfaltata, senza guinzaglio) è uno dei grandi itinerari ciclabili per cani d`Europa. Fare il bagno alle spiagge del lago è possibile tutto l`anno: la maggior parte delle spiagge lacustri tedesche ammette i cani prima delle 9 e dopo le 18 in stagione.',
        },
        dogTip: {
          ...
          de: 'Bodensee-Radweg: flach, 273 km rund um den gesamten See durch 3 Länder (Deutschland, Österreich, Schweiz), Hunde auf den meisten Abschnitten ohne Leine, in Lindau gibt es Leihräder mit Vorderkorb für Hunde. Die komplette Runde dauert 5-7 Tage.',
          nl: 'Bodensee-Radweg (fietspad rond het Bodenmeer): vlak, 273 km rond het hele meer door 3 landen (Duitsland, Oostenrijk, Zwitserland), honden mogen los op de meeste stukken, in Lindau zijn huurfietsen beschikbaar met voormand voor honden. De volledige route duurt 5 tot 7 dagen.',
          it: 'Bodensee-Radweg (pista ciclabile del Lago di Costanza): pianeggiante, 273 km intorno all`intero lago attraversando 3 paesi (Germania, Austria, Svizzera), cani senza guinzaglio sulla maggior parte dei tratti, a Lindau sono disponibili bici a noleggio con cestino anteriore per il cane. Il giro completo richiede 5-7 giorni.',
        },
        hotels: [
          {
            name: 'Bayerischer Hof Lindau',
            stars: 4,
            note: { en: 'Traditional grand hotel on the harbour promenade, lake views, dogs accepted.', fr: 'Grand hôtel traditionnel sur la promenade du port, vue sur le lac, chiens acceptés.', es: 'Gran hotel tradicional en el paseo del puerto, vistas al lago, perros aceptados.', pt: 'Grande hotel tradicional no passeio do porto, vistas para o lago, cães aceites.', de: 'Traditionelles Grandhotel an der Hafenpromenade, Seeblick, Hunde erlaubt.', nl: 'Traditioneel grand hotel aan de havenpromenade, uitzicht op het meer, honden toegestaan.', it: 'Grand hotel tradizionale sulla passeggiata del porto, vista sul lago, cani ammessi.' },
          },
          {
            name: 'Hotel Villino',
            stars: 4,
            note: { en: 'Elegant Mediterranean-style hotel with garden terrace on the lake, small pets welcome.', fr: 'Élégant hôtel de style méditerranéen avec terrasse-jardin sur le lac, petits animaux bienvenus.', es: 'Elegante hotel de estilo mediterráneo con terraza-jardín junto al lago, mascotas pequeñas bienvenidas.', pt: 'Elegante hotel de estilo mediterrânico com terraço-jardim junto ao lago, animais pequenos bem-vindos.', de: 'Elegantes Hotel im mediterranen Stil mit Gartenterrasse am See, kleine Haustiere willkommen.', nl: 'Elegant hotel in mediterrane stijl met tuinterras aan het meer, kleine huisdieren welkom.', it: 'Elegante hotel in stile mediterraneo con terrazza-giardino sul lago, piccoli animali benvenuti.' },
          },
          {
            name: 'Hotel Helvetia',
            stars: 4,
            note: { en: 'Lakefront hotel on the island with its own dock, dogs of all sizes accepted.', fr: 'Hôtel en bord de lac sur l\'île avec son propre ponton, chiens de toute taille acceptés.', es: 'Hotel frente al lago en la isla con su propio embarcadero, perros de cualquier tamaño aceptados.', pt: 'Hotel à beira do lago na ilha com o seu próprio cais, cães de qualquer tamanho aceites.', de: 'Hotel direkt am See auf der Insel mit eigenem Steg, Hunde jeder Größe erlaubt.', nl: 'Hotel aan het meer op het eiland met eigen aanlegsteiger, honden van elk formaat toegestaan.', it: 'Hotel fronte lago sull`isola con pontile privato, cani di ogni taglia ammessi.' },
          },
        ],
      },
    ],
  },
  {
    id: 'cote-baltique',
    emoji: '🌊',
    title: { en: 'Baltic coast (Rügen)', fr: 'Côte baltique (Rügen)', es: 'Costa báltica (Rügen)', pt: 'Costa báltica (Rügen)', de: 'Ostseeküste (Rügen)', nl: 'Oostzeekust (Rügen)', it: 'Costa baltica (Rügen)' },
    cities: [
      {
        slug: 'rugen',
        name: 'Rügen',
        region: { en: 'Baltic coast', fr: 'Côte baltique', es: 'Costa báltica', pt: 'Costa báltica', de: 'Ostseeküste', nl: 'Oostzeekust', it: 'Costa baltica' },
        julyTemp: 21,
        tag: { en: 'Chalk cliffs · Baltic sea · dog beaches year-round', fr: 'Falaises de craie · mer Baltique · plages dog-friendly toute l\'année', es: 'Acantilados de tiza · mar Báltico · playas dog-friendly todo el año', pt: 'Falésias de giz · mar Báltico · praias dog-friendly o ano todo', de: 'Kreidefelsen · Ostsee · Hundestrände ganzjährig', nl: 'Kalkrotsen · Oostzee · het hele jaar hondenstranden', it: 'Scogliere di gesso · Mar Baltico · spiagge per cani tutto l`anno' },
        why: {
          ...
          de: 'Rügen ist die größte Insel Deutschlands (926 km²) und eines der hundefreundlichsten Reiseziele Europas. Die Ostseeküste bleibt im Juli bei 21°C, 4°C kühler als Berlin. 90% der Strände Rügens erlauben Hunde ganzjährig ohne saisonales Verbot. Die Kreidefelsen des Nationalparks Jasmund sind UNESCO-Welterbe mit 15 km Klippenwegen ohne Leine. Die Kurpromenaden von Binz, Sellin und Göhren sind alle hundefreundlich. Die Rügensche Bäderbahn (Rasender Roland, historische Dampflok von 1895) nimmt Hunde kostenlos mit.',
          nl: 'Rügen is het grootste eiland van Duitsland (926 km²) en een van de meest hondvriendelijke bestemmingen van Europa. De Oostzeekust blijft in juli op 21°C, 4°C koeler dan Berlijn. 90% van de stranden van Rügen laat honden het hele jaar toe, zonder seizoensverbod. De kalkrotsen van het Nationaal Park Jasmund zijn UNESCO-werelderfgoed met 15 km klifpaden waar je hond los mag. De kuurpromenades van Binz, Sellin en Göhren zijn allemaal hondvriendelijk. De Rügense Bäderbahn (Rasender Roland, historische stoomtrein uit 1895) neemt honden gratis mee.',
          it: 'Rügen è l`isola più grande della Germania (926 km²) e una delle mete più a misura di cane d`Europa. La costa baltica resta a 21°C a luglio, 4°C in meno di Berlino. Il 90% delle spiagge di Rügen ammette i cani tutto l`anno senza divieto stagionale. Le scogliere di gesso del Parco Nazionale di Jasmund sono un sito UNESCO con 15 km di sentieri in cima alla scogliera senza guinzaglio. Le passeggiate termali di Binz, Sellin e Göhren sono tutte a misura di cane. Il trenino di Rügen (Rasender Roland, treno a vapore d`epoca del 1895) accoglie i cani gratis.',
        },
        dogTip: {
          ...
          de: 'Strand von Prora (Binz): 4 km Ostseestrand, an dem Hunde ganzjährig erlaubt sind, in ausgewiesenen Bereichen ohne Leine, gesäumt von einem Wald aus Waldkiefern (Schatten im Sommer), die Ostsee erreicht im Juli 20°C, Hunde schwimmen frei.',
          nl: 'Strand van Prora (Binz): 4 km Oostzeestrand waar honden het hele jaar zijn toegestaan, los in de aangewezen zones, omzoomd door een bos grove dennen (schaduw in de zomer), de Oostzee bereikt in juli 20°C, honden zwemmen vrij.',
          it: 'Spiaggia di Prora (Binz): 4 km di spiaggia baltica dove i cani sono ammessi tutto l`anno, senza guinzaglio nelle zone designate, alle spalle un bosco di pini silvestri (ombra in estate), la temperatura del Mar Baltico arriva a 20°C a luglio, i cani nuotano liberamente.',
        },
        hotels: [
          {
            name: 'Grand Hotel Binz',
            stars: 4,
            note: { en: 'Historic grand hotel in Binz spa resort, seafront, dogs of any size accepted.', fr: 'Grand hôtel historique dans la station thermale de Binz, en bord de mer, chiens de toute taille acceptés.', es: 'Gran hotel histórico en el balneario de Binz, frente al mar, perros de cualquier tamaño aceptados.', pt: 'Grande hotel histórico no resort termal de Binz, frente ao mar, cães de qualquer tamanho aceites.', de: 'Historisches Grandhotel im Kurort Binz, direkt am Meer, Hunde jeder Größe erlaubt.', nl: 'Historisch grand hotel in kuuroord Binz, aan zee, honden van elk formaat toegestaan.', it: 'Grand hotel storico nella località termale di Binz, fronte mare, cani di qualsiasi taglia ammessi.' },
          },
          {
            name: 'Hotel Arkona Strandhotel',
            stars: 4,
            note: { en: 'Direct beach access in Binz, modern rooms, dogs welcome with dedicated pet amenities.', fr: 'Accès direct à la plage à Binz, chambres modernes, chiens bienvenus avec équipements dédiés.', es: 'Acceso directo a la playa en Binz, habitaciones modernas, perros bienvenidos con amenities dedicados.', pt: 'Acesso direto à praia em Binz, quartos modernos, cães bem-vindos com amenities dedicados.', de: 'Direkter Strandzugang in Binz, moderne Zimmer, Hunde willkommen mit eigener Haustierausstattung.', nl: 'Direct aan het strand in Binz, moderne kamers, honden welkom met speciale huisdiervoorzieningen.', it: 'Accesso diretto alla spiaggia a Binz, camere moderne, cani benvenuti con dotazioni dedicate.' },
          },
          {
            name: 'Naturresort Prora',
            stars: 3,
            note: { en: 'Converted historical building in Prora, forest and beach, dogs of all sizes accepted free.', fr: 'Bâtiment historique converti à Prora, forêt et plage, chiens de toute taille acceptés gratuitement.', es: 'Edificio histórico convertido en Prora, bosque y playa, perros de cualquier tamaño aceptados gratis.', pt: 'Edifício histórico convertido em Prora, floresta e praia, cães de qualquer tamanho aceites gratuitamente.', de: 'Umgebautes historisches Gebäude in Prora, Wald und Strand, Hunde jeder Größe kostenlos erlaubt.', nl: 'Verbouwd historisch gebouw in Prora, bos en strand, honden van elk formaat gratis toegestaan.', it: 'Edificio storico ristrutturato a Prora, bosco e spiaggia, cani di ogni taglia ammessi gratis.' },
          },
        ],
      },
    ],
  },
  {
    ...
    emoji: '🏰',
    title: { en: 'Romantic Rhine & Neckar', fr: 'Rhin et Neckar romantiques', es: 'Rin y Neckar románticos', pt: 'Reno e Neckar românticos', de: 'Romantischer Rhein & Neckar', nl: 'Romantische Rijn & Neckar', it: 'Reno e Neckar romantici' },
    cities: [
      {
        slug: 'heidelberg',
        name: 'Heidelberg',
        region: { en: 'Romantic Rhine & Neckar', fr: 'Rhin et Neckar romantiques', es: 'Rin y Neckar románticos', pt: 'Reno e Neckar românticos', de: 'Romantischer Rhein & Neckar', nl: 'Romantische Rijn & Neckar', it: 'Reno e Neckar romantici' },
        julyTemp: 24,
        tag: { en: 'Neckar river · Germany\'s oldest university · 24°C', fr: 'Neckar · plus vieille université d\'Allemagne · 24°C', es: 'Neckar · universidad más antigua de Alemania · 24°C', pt: 'Neckar · universidade mais antiga da Alemanha · 24°C', de: 'Neckar · Deutschlands älteste Universität · 24°C', nl: 'Neckar · oudste universiteit van Duitsland · 24°C', it: 'Fiume Neckar · università più antica di Germania · 24°C' },
        why: {
          ...
          de: 'Heidelberg liegt auf 114m im Neckartal und verzeichnet im Juli 24°C, gemildert durch das Mikroklima des Tals und den bewaldeten Heiligenberg-Höhenzug (440m), der die Hitze aus dem Süden abschirmt. Der Philosophenweg (2 km Hangweg ohne Leine oberhalb der Stadt mit Blick auf Schloss und Fluss) ist der berühmteste Hundespaziergang in Baden-Württemberg. Das Neckarufer (8 km Wege ohne Leine von der Alten Brücke bis Ziegelhausen) ist flach und schattig. Die älteste Universitätsstadt Deutschlands hat eine lebendige Café-Kultur im Freien, die Hunde willkommen heißt.',
          nl: 'Heidelberg ligt op 114m in het Neckardal en noteert in juli 24°C, getemperd door het microklimaat van het dal en de beboste Heiligenberg-heuvelrug (440m) die de hitte uit het zuiden tegenhoudt. Het Philosophenweg (2 km hellingpad zonder lijn boven de stad met uitzicht op kasteel en rivier) is de beroemdste hondenwandeling van Baden-Württemberg. De Neckaroever (8 km paden waar je hond los mag, van de oude brug tot Ziegelhausen) is vlak en beschaduwd. De oudste universiteitsstad van Duitsland heeft een levendige terrascultuur die honden welkom heet.',
          it: 'Heidelberg a 114m nella valle del Neckar registra 24°C a luglio, mitigata dal microclima della valle e dalla dorsale boscosa dello Heiligenberg (440m) che blocca il caldo da sud. Il Philosophenweg (Sentiero dei Filosofi, 2 km di percorso senza guinzaglio sulla collina sopra la città con vista sul castello e sul fiume) è la passeggiata canina più famosa del Baden-Württemberg. La riva del Neckar (8 km di sentieri senza guinzaglio dal ponte vecchio a Ziegelhausen) è pianeggiante e ombreggiata. La città universitaria più antica di Germania ha una vivace cultura dei caffè all`aperto che accoglie i cani.',
        },
        dogTip: {
          ...
          de: 'Philosophenweg: 2 km Hangweg ohne Leine oberhalb der Altstadt, Schlossruine direkt gegenüber sichtbar, im Frühling blühende Wiesen, alle 300m eine Bank, kühl unter Buchen auch im Juli, Zugang über die Schlangenweg-Treppen von der Alten Brücke.',
          nl: 'Philosophenweg: 2 km hellingpad zonder lijn boven de oude binnenstad, kasteelruïne direct zichtbaar aan de overkant, in het voorjaar bloeiende weides, elke 300m een bankje, koel onder de beuken zelfs in juli, toegang via de trappen van de Schlangenweg vanaf de oude brug.',
          it: 'Philosophenweg (Sentiero dei Filosofi): 2 km di sentiero collinare senza guinzaglio sopra il centro storico, rovine del castello visibili proprio di fronte, prati fioriti in primavera, panchine ogni 300m, fresco sotto i faggi anche a luglio, accesso tramite la scalinata dello Schlangenweg dal ponte vecchio.',
        },
        hotels: [
          {
            name: 'Heidelberg Marriott Hotel',
            stars: 4,
            note: { en: 'Neckar riverside hotel, terrace with castle views, dogs up to 25 kg accepted.', fr: 'Hôtel en bord du Neckar, terrasse avec vue sur le château, chiens jusqu\'à 25 kg acceptés.', es: 'Hotel a orillas del Neckar, terraza con vistas al castillo, perros hasta 25 kg aceptados.', pt: 'Hotel à beira do Neckar, terraço com vistas para o castelo, cães até 25 kg aceites.', de: 'Hotel direkt am Neckar, Terrasse mit Schlossblick, Hunde bis 25 kg erlaubt.', nl: 'Hotel aan de Neckar, terras met kasteeluitzicht, honden tot 25 kg toegestaan.', it: 'Hotel sulle rive del Neckar, terrazza con vista sul castello, cani fino a 25 kg ammessi.' },
          },
          {
            name: 'Hotel Zum Ritter St. Georg',
            stars: 4,
            note: { en: 'Renaissance building in the old town, the most historic hotel in Heidelberg, dogs accepted.', fr: 'Bâtiment Renaissance dans la vieille ville, l\'hôtel le plus historique de Heidelberg, chiens acceptés.', es: 'Edificio renacentista en el casco histórico, el hotel más histórico de Heidelberg, perros aceptados.', pt: 'Edifício renascentista na cidade velha, o hotel mais histórico de Heidelberg, cães aceites.', de: 'Renaissancegebäude in der Altstadt, das historischste Hotel Heidelbergs, Hunde erlaubt.', nl: 'Renaissancegebouw in de oude binnenstad, het meest historische hotel van Heidelberg, honden toegestaan.', it: 'Edificio rinascimentale nel centro storico, l`hotel più storico di Heidelberg, cani ammessi.' },
          },
          {
            name: 'NH Heidelberg',
            stars: 4,
            note: { en: 'Modern hotel on the Bismarckplatz, 5 min walk to the Neckar, pets up to 20 kg welcome.', fr: 'Hôtel moderne sur la Bismarckplatz, 5 min à pied du Neckar, animaux jusqu\'à 20 kg bienvenus.', es: 'Hotel moderno en Bismarckplatz, a 5 min a pie del Neckar, mascotas hasta 20 kg bienvenidas.', pt: 'Hotel moderno na Bismarckplatz, 5 min a pé do Neckar, animais até 20 kg bem-vindos.', de: 'Modernes Hotel am Bismarckplatz, 5 Gehminuten zum Neckar, Haustiere bis 20 kg willkommen.', nl: 'Modern hotel aan het Bismarckplatz, 5 minuten lopen naar de Neckar, huisdieren tot 20 kg welkom.', it: 'Hotel moderno sulla Bismarckplatz, 5 minuti a piedi dal Neckar, animali fino a 20 kg benvenuti.' },
          },
        ],
      },
    ],
...
const T = {
  title: {
    ...
    de: 'Die besten Städte, um mit Ihrem Hund der Hitze in Deutschland zu entkommen (2026)',
    nl: 'De beste steden om met je hond de hitte in Duitsland te ontvluchten (2026)',
    it: 'Le migliori città per sfuggire al caldo in Germania con il tuo cane (2026)',
  },
  metaTitle: {
    ...
    de: 'Kühles Deutschland mit Hund: 6 Städte unter 25°C im Juli (2026)',
    nl: 'Koel Duitsland met je hond: 6 steden onder 25°C in juli (2026)',
    it: 'Germania fresca con il tuo cane: 6 città sotto i 25°C a luglio (2026)',
  },
  metaDesc: {
    ...
    de: 'Während München 25°C und die Rheinebene 30°C erreichen, bleiben Schwarzwald, Bayerische Alpen und Ostseeküste unter 24°C. Freiburg, Baden-Baden, Garmisch, Lindau, Rügen, Heidelberg: 6 hundefreundliche Städte.',
    nl: 'Terwijl München 25°C haalt en de Rijnvlakte 30°C, blijven het Zwarte Woud, de Beierse Alpen en de Oostzeekust onder 24°C. Freiburg, Baden-Baden, Garmisch, Lindau, Rügen, Heidelberg: 6 hondvriendelijke steden.',
    it: 'Mentre Monaco tocca i 25°C e la pianura del Reno i 30°C, la Foresta Nera, le Alpi bavaresi e la costa baltica restano sotto i 24°C. Freiburg, Baden-Baden, Garmisch, Lindau, Rügen, Heidelberg: 6 città a misura di cane.',
  },
  intro: {
    ...
    de: 'Deutschland reicht von der Ostsee (19°C im Juli) bis zur Rheinebene (30°C). Der Sweet Spot sind Schwarzwald, Bayerische Alpen und Bodensee, alle unter 24°C und mit einigen der großzügigsten Hundegesetze Europas. Hunde reisen in den meisten Regionalzügen kostenlos, dürfen die meisten Restaurants besuchen und die meisten Stadtparks ohne Leine nutzen.',
    nl: 'Duitsland loopt van de Oostzee (19°C in juli) tot de Rijnvlakte (30°C). Het ideale gebied is het Zwarte Woud, de Beierse Alpen en het Bodenmeer, allemaal onder 24°C en met enkele van de meest toegeeflijke hondenregels van Europa. Honden reizen gratis mee in de meeste regionale treinen, mogen de meeste restaurants in en mogen in de meeste stadsparken los lopen.',
    it: 'La Germania va dal Baltico (19°C a luglio) alla pianura del Reno (30°C). Il punto giusto è la Foresta Nera, le Alpi bavaresi e il Lago di Costanza, tutti sotto i 24°C e con alcune delle norme sui cani più permissive d`Europa. I cani viaggiano gratis sulla maggior parte dei treni regionali, entrano nella maggior parte dei ristoranti e usano senza guinzaglio la maggior parte dei parchi urbani.',
  },
  ...
  seeHotels: { en: 'All pet-friendly hotels', fr: 'Tous les hôtels pet-friendly', es: 'Todos los hoteles pet-friendly', pt: 'Todos os hotéis pet-friendly', de: 'Alle haustierfreundlichen Hotels', nl: 'Alle hondvriendelijke hotels', it: 'Tutti gli hotel pet-friendly' },
  hotelsLabel: { en: 'Our hotel picks', fr: 'Nos hôtels recommandés', es: 'Nuestros hoteles recomendados', pt: 'Os nossos hotéis recomendados', de: 'Unsere Hotelauswahl', nl: 'Onze hotelkeuzes', it: 'I nostri hotel consigliati' },
  ...
  breadGuides: { en: 'Guides', fr: 'Guides', es: 'Guías', pt: 'Guias', de: 'Guides', nl: 'Guides', it: 'Guide' },
  faq: {
    q1: { en: 'Which German cities stay cool in summer?', fr: 'Quelles villes allemandes restent fraîches en été ?', es: '¿Qué ciudades alemanas permanecen frescas en verano?', pt: 'Que cidades alemãs se mantêm frescas no verão?', de: 'Welche deutschen Städte bleiben im Sommer kühl?', nl: 'Welke Duitse steden blijven koel in de zomer?', it: 'Quali città tedesche restano fresche in estate?' },
    a1: {
      ...
      de: 'Die kühlsten deutschen Städte im Juli: Ostseeküste (Rügen 19°C, Usedom 20°C), Schwarzwald (Baden-Baden 23°C, Freiburg 24°C), Bayerische Alpen (Berchtesgaden 20°C, Garmisch-Partenkirchen 22°C), Bodensee (Lindau 22°C). München liegt im Schnitt bei 25°C (warm), die Rheinebene bei 28-30°C. Berlin (24°C) und Hamburg (22°C) sind gemäßigt. Für die zuverlässigsten kühlen Temperaturen in Kombination mit großartigen Wanderwegen sind die Bayerischen Alpen und der Schwarzwald die erste Wahl.',
      nl: 'De koelste Duitse steden in juli: Oostzeekust (Rügen 19°C, Usedom 20°C), Zwarte Woud (Baden-Baden 23°C, Freiburg 24°C), Beierse Alpen (Berchtesgaden 20°C, Garmisch-Partenkirchen 22°C), Bodenmeer (Lindau 22°C). München zit gemiddeld op 25°C (warm), de Rijnvlakte op 28-30°C. Berlijn (24°C) en Hamburg (22°C) zijn gematigd. Voor de meest betrouwbare koele temperaturen gecombineerd met prachtige wandelpaden zijn de Beierse Alpen en het Zwarte Woud de beste keuzes.',
      it: 'Le città tedesche più fresche a luglio: costa baltica (Rügen 19°C, Usedom 20°C), Foresta Nera (Baden-Baden 23°C, Freiburg 24°C), Alpi bavaresi (Berchtesgaden 20°C, Garmisch-Partenkirchen 22°C), Lago di Costanza (Lindau 22°C). Monaco ha una media di 25°C (caldo), la pianura del Reno 28-30°C. Berlino (24°C) e Amburgo (22°C) sono moderate. Per le temperature fresche più affidabili unite a sentieri splendidi, le Alpi bavaresi e la Foresta Nera sono le scelte migliori.',
    },
    q2: { en: 'Are dogs allowed on German trains?', fr: 'Les chiens sont-ils autorisés dans les trains allemands ?', es: '¿Se permiten perros en los trenes alemanes?', pt: 'São permitidos cães nos comboios alemães?', de: 'Sind Hunde in deutschen Zügen erlaubt?', nl: 'Mogen honden mee in Duitse treinen?', it: 'I cani sono ammessi sui treni tedeschi?' },
    a2: {
      ...
      de: 'Regeln der Deutschen Bahn (DB): Hunde in Transportboxen unter 55x45x25 cm reisen kostenlos. Größere Hunde benötigen ein Kinder-Ticket zum halben Preis, müssen an der Leine geführt werden, und in ICE- und IC-Fernzügen ist ein Maulkorb Pflicht. Regionalzüge (RE, RB): Hunde an der Leine ohne Maulkorb erlaubt. S-Bahn und U-Bahn: Hunde in Transportboxen kostenlos, größere Hunde zum ermäßigten Tarif mit Leinen- und Maulkorbpflicht in Berlin und München. Das Bayern-Ticket deckt Hunde kostenlos in Regionalzügen in ganz Bayern ab. Das Schwarzwald-Ticket deckt Hunde kostenlos im Schwarzwald-Netz ab. Rügen: Der Rasende Roland nimmt Hunde in allen Wagen kostenlos mit.',
      nl: 'Regels van de Deutsche Bahn (DB): honden in een reismand onder 55x45x25 cm reizen gratis. Grotere honden hebben een kinderkaartje tegen halve prijs nodig, moeten aan de lijn en in de langeafstands-ICE- en IC-treinen is een muilkorf verplicht. Regionale treinen (RE, RB): honden toegestaan aan de lijn zonder muilkorf. S-Bahn en U-Bahn: honden in een reismand gratis, grotere honden tegen gereduceerd tarief met lijn- en muilkorfplicht in Berlijn en München. Het Bayern-Ticket dekt honden gratis in regionale treinen door heel Beieren. Het Schwarzwald-Ticket dekt honden gratis in het netwerk van het Zwarte Woud. Rügen: de Rasender Roland-stoomtrein neemt honden gratis mee in alle wagons.',
      it: 'Regole Deutsche Bahn (DB): i cani in trasportino sotto i 55x45x25 cm viaggiano gratis. I cani più grandi richiedono un biglietto bambino a metà prezzo, devono stare al guinzaglio ed è obbligatoria la museruola sui treni a lunga percorrenza ICE e IC. Treni regionali (RE, RB): cani ammessi al guinzaglio senza museruola. S-Bahn e U-Bahn: cani in trasportino gratis, cani più grandi a tariffa ridotta con guinzaglio e museruola obbligatori a Berlino e Monaco. Il Bayern-Ticket (abbonamento giornaliero per la Baviera) copre i cani gratis sui treni regionali di tutta la Baviera. Lo Schwarzwald-Ticket copre i cani gratis nella rete della Foresta Nera. Rügen: il trenino a vapore Rasender Roland accoglie i cani gratis in tutte le carrozze.',
    },
    q3: { en: 'Are dogs allowed in German restaurants and beer gardens?', fr: 'Les chiens sont-ils autorisés dans les restaurants et brasseries allemands ?', es: '¿Se permiten perros en los restaurantes y cervecerías alemanes?', pt: 'São permitidos cães nos restaurantes e cervejarias alemães?', de: 'Sind Hunde in deutschen Restaurants und Biergärten erlaubt?', nl: 'Zijn honden welkom in Duitse restaurants en biertuinen?', it: 'I cani sono ammessi nei ristoranti e nei Biergarten tedeschi?' },
    a3: {
      ...
      de: 'Deutschland hat eine der hundefreundlichsten Kulturen Europas. Biergärten: Hunde sind fast überall willkommen, auch in den großen (Englischer Garten in München, Tivoli in Berlin). Traditionelle Gasthäuser und Wirtschaften: Hunde sind in der großen Mehrheit auch im Innenbereich willkommen. Die Rechtslage: Das deutsche Gaststättenrecht überlässt dies dem Ermessen des Inhabers, und die Ablehnung von Hunden ist außerhalb von Fast-Food-Ketten die Ausnahme, nicht die Regel. Terrassen: so gut wie nie irgendeine Einschränkung. Die Frage `Darf mein Hund mit rein?` wird fast immer mit `Ja, natürlich` beantwortet.',
      nl: 'Duitsland heeft een van de meest hondvriendelijke culturen van Europa. Biergärten: honden zijn vrijwel overal welkom, ook in de grote (Englischer Garten in München, Tivoli in Berlijn). Traditionele Gasthäuser en Wirtschaften: honden zijn in de overgrote meerderheid ook binnen welkom. De juridische situatie: de Duitse horecawet laat dit over aan het eigen oordeel van de eigenaar, en het weigeren van honden is de uitzondering, niet de norm, buiten fastfoodketens om. Terrassen: vrijwel nooit enige beperking. De vraag `Darf mein Hund mit rein?` (mag mijn hond mee naar binnen?) wordt bijna altijd beantwoord met `Ja natürlich.`',
      it: 'La Germania ha una delle culture più permissive d`Europa nei confronti dei cani. Biergarten: cani praticamente sempre benvenuti, compresi i più grandi (Englischer Garten a Monaco, Tivoli a Berlino). Ristoranti tradizionali (Gasthäuser, Wirtschaften): cani benvenuti all`interno nella stragrande maggioranza. La situazione legale: la legge tedesca sulla ristorazione lascia la decisione al proprietario, e rifiutare i cani è l`eccezione, non la norma, al di fuori delle catene di fast food. Terrazze (Biergarten, terrazze dei caffè): quasi mai alcuna restrizione. La domanda `Darf mein Hund mit rein?` (posso portare dentro il mio cane?) riceve quasi sempre come risposta `Ja natürlich.`',
    },
    q4: { en: 'Are dogs allowed on German beaches?', fr: 'Les chiens sont-ils autorisés sur les plages allemandes ?', es: '¿Se permiten perros en las playas alemanas?', pt: 'São permitidos cães nas praias alemãs?', de: 'Sind Hunde an deutschen Stränden erlaubt?', nl: 'Mogen honden mee naar Duitse stranden?', it: 'I cani sono ammessi sulle spiagge tedesche?' },
    a4: {
      ...
      de: 'Die Regeln für deutsche Strände unterscheiden sich je nach Bundesland und Gemeinde. Ostseeküste (Mecklenburg-Vorpommern): Rügen und Usedom haben die großzügigsten Regeln Deutschlands. 90% der Strände erlauben Hunde ganzjährig, mit eigenen Hundestränden in den großen Badeorten. Nur an den Hauptbadestränden stark frequentierter Orte sind Hunde im Juli/August verboten, die angrenzenden Strände bleiben aber offen. Nordseeküste (Schleswig-Holstein): ähnliche Regeln. Bodensee: die meisten Strände erlauben Hunde im Sommer vor 9 Uhr und nach 18 Uhr. Bayerische Seen: unterschiedlich, viele erlauben Hunde in ausgewiesenen Bereichen. Achten Sie immer auf Schilder mit der Aufschrift `Hundestrand`.',
      nl: 'De regels voor Duitse stranden verschillen per deelstaat en gemeente. Oostzeekust (Mecklenburg-Vorpommern): Rügen en Usedom hebben de meest toegeeflijke regels van Duitsland. 90% van de stranden laat honden het hele jaar toe, met specifieke hondenstranden (Hundestrand) bij grote badplaatsen. Honden zijn alleen verboden op de hoofdzwemstranden (Badestrand) van drukke badplaatsen in juli-augustus, maar de aangrenzende stranden blijven open. Noordzeekust (Sleeswijk-Holstein): vergelijkbare regels. Bodenmeer: de meeste stranden laten honden toe voor 9 uur en na 18 uur in de zomer. Beierse meren: wisselend, veel laten honden toe in aangewezen zones. Kijk altijd uit naar borden met `Hundestrand`.',
      it: 'Le regole delle spiagge tedesche variano per Land e comune. Costa baltica (Meclemburgo-Pomerania Anteriore): Rügen e Usedom hanno le regole più permissive di Germania. Il 90% delle spiagge ammette i cani tutto l`anno, con spiagge dedicate ai cani (Hundestrand) nelle principali località. I cani sono vietati solo nei tratti balneabili principali (Badestrand) delle località affollate a luglio-agosto, ma le spiagge adiacenti restano aperte. Costa del Mare del Nord (Schleswig-Holstein): regole simili. Lago di Costanza: la maggior parte delle spiagge ammette i cani prima delle 9 e dopo le 18 in estate. Laghi bavaresi: variabile, molti ammettono i cani in zone dedicate. Controlla sempre i cartelli `Hundestrand` sulla spiaggia.',
    },
    q5: { en: 'What is the dog tax (Hundesteuer) in Germany?', fr: 'Qu\'est-ce que la taxe sur les chiens (Hundesteuer) en Allemagne ?', es: '¿Qué es el impuesto sobre perros (Hundesteuer) en Alemania?', pt: 'O que é o imposto sobre cães (Hundesteuer) na Alemanha?', de: 'Was ist die Hundesteuer in Deutschland?', nl: 'Wat is de hondenbelasting (Hundesteuer) in Duitsland?', it: 'Cos`è la tassa sui cani (Hundesteuer) in Germania?' },
    a5: {
      ...
      de: 'Die Hundesteuer ist eine kommunale Steuer, die von gemeldeten Hundehaltern in Deutschland jährlich gezahlt wird. Als Tourist müssen Sie diese NICHT zahlen. Hundehalter, die Deutschland aus dem Ausland besuchen, müssen ihren Hund für Aufenthalte von wenigen Monaten weder anmelden noch die Steuer zahlen. Die Hundesteuer gilt nur für Einwohner. Ihr Hund muss jedoch gechippt sein und einen gültigen EU-Heimtierausweis (oder ein gleichwertiges Nicht-EU-Dokument) mit aktueller Tollwutimpfung besitzen. Manche Bundesländer verlangen von ihren eigenen Einwohnern eine Hundehaftpflichtversicherung, nicht aber von ausländischen Besuchern.',
      nl: 'De Hundesteuer is een gemeentelijke hondenbelasting die jaarlijks wordt betaald door geregistreerde hondenbezitters in Duitsland. Als toerist ben je dit NIET verplicht te betalen. Hondenbezitters die Duitsland vanuit het buitenland bezoeken, hoeven hun hond niet te registreren of de belasting te betalen voor verblijven van een paar maanden. De Hundesteuer geldt alleen voor inwoners. Wel geldt: jouw hond moet gechipt zijn en een geldig EU-dierenpaspoort (of gelijkwaardig niet-EU-document) hebben met een actuele rabiësvaccinatie. Sommige Duitse deelstaten verplichten hun eigen inwoners een aansprakelijkheidsverzekering voor honden (Hundehaftpflichtversicherung), maar niet buitenlandse bezoekers.',
      it: 'La Hundesteuer è una tassa comunale sui cani pagata ogni anno dai proprietari di cani registrati in Germania. Da turista NON sei tenuto a pagarla. I proprietari di cani in visita in Germania dall`estero non devono registrare il proprio cane né pagare la tassa per soggiorni di pochi mesi. La Hundesteuer si applica solo ai residenti. Tuttavia: il tuo cane deve avere il microchip e un passaporto UE per animali valido (o equivalente extra-UE) con vaccinazione antirabbica aggiornata. Alcuni Land tedeschi richiedono un`assicurazione di responsabilità civile per cani (Hundehaftpflichtversicherung) ai propri residenti, ma non ai visitatori stranieri.',
    },
  },
}
      ...
      <section className="bg-gradient-to-br from-slate-900 via-gray-800 to-emerald-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-green-200 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-5">
            🇩🇪 {locale === 'fr' ? 'Forêt-Noire · Bavière · Baltique' : locale === 'es' ? 'Selva Negra · Baviera · Báltico' : locale === 'pt' ? 'Floresta Negra · Baviera · Báltico' : locale === 'de' ? 'Schwarzwald · Bayern · Ostsee' : locale === 'nl' ? 'Zwarte Woud · Beieren · Oostzee' : locale === 'it' ? 'Foresta Nera · Baviera · Baltico' : 'Black Forest · Bavaria · Baltic'}
          </div>
