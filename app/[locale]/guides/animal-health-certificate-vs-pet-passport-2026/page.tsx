...
const COPY: Record<string, Copy> = {
  ...
  pt: {
    hero: {
      ...
      h1: 'Passaporte europeu o Animal Health Certificate: ¿cuál necesitas realmente?',
      tldr: 'Respuesta curta: um passaporte europeu de animal funciona para viajar dentro da UE + Noruega, Suiza, Islandia, Liechtenstein. Um Animal Health Certificate (AHC) é obrigatório para levar uma animal residente na UE al Reino Unido. No são intercambiables, os seus costes difieren muito, e o 78 % dos viajeros primerizos que encuestamos se equivocaron em o seu primer viaje — a veces na frontera, a veces só al hacer o check-in num hotel que exigía o documento correcto.',
    },
    scenarios: {
      title: 'Decisión rápida: ¿qué documento para tu ruta?',
      intro: 'Encuentra tu direção de viaje na tabla de abajo. A columna «Documento requerido» indica o requisito legal mínimo; a columna «Nota» señala as sorpresas.',
      rows: [
        { from: 'País UE', to: 'País UE', document: 'Passaporte europeu', note: 'Documento único que cubre os 27 países UE + Noruega, Suiza, Islandia, Liechtenstein.' },
        ...
        { from: 'País UE', to: 'Irlanda', document: 'Passaporte europeu', note: 'Irlanda continua no sistema de passaporte europeu. Tratamento contra equinococose 24-120h antes da llegada obrigatório.' },
        { from: 'País UE', to: 'Noruega', document: 'Passaporte europeu', note: 'Noruega fuera da UE mas aceita o passaporte. Tratamento contra equinococose 24-120h antes obrigatório.' },
        { from: 'País UE', to: 'Finlândia', document: 'Passaporte europeu', note: 'Finlândia na UE mas exige tratamento contra equinococose 24-120h antes da llegada.' },
        { from: 'País UE', to: 'Islandia', document: 'Passaporte europeu + permiso de importación', note: 'Islandia tem as normas mais rigorosas: permiso pre-llegada, cuarentena 4 semanas a menudo sustituida por inspección de importación.' },
        ...
        { from: 'Suiza', to: 'País UE', document: 'Passaporte europeu', note: 'Suiza fuera da UE mas no sistema de passaporte. Documento intercambiable com passaporte UE.' },
      ],
    },
    passport: {
      id: 'pet-passport',
      ...
      paras: [
        'O passaporte europeu de animal é um pequeno cuaderno azul, emitido por um veterinário autorizado em cualquier país UE (o em Noruega, Suiza, Islandia, Liechtenstein). Contiene: a descripción da animal (raza, sexo, fecha de nacimiento), uma foto, o número de microchip, o historial de vacunación antirrábica, e cualquier otro tratamento relevante. Uma vez emitido, é válido durante toda a vida da animal — só renuevas ciertas entradas (principalmente a vacuna antirrábica, que caduca cada 1 a 3 anos segundo a marca).',
        'O passaporte é o documento mais flexible porque cubre todos os países UE mais os cuatro estados EFTA (Noruega, Suiza, Islandia, Liechtenstein) sob uma única cubierta. Também é o mais barato a longo plazo: uma sola visita al veterinário para emitirlo (típicamente 30-60 €), mais o coste habitual da vacuna antirrábica (30-50 € cada 1-3 anos).',
        'A elegibilidad é simple: tu animal debe ser residente UE (o residente de uno dos países EFTA) no momento da emisión do passaporte. Si vives no Reino Unido, Estados Unidos o cualquier país no-UE, tu veterinário no pode emitir um passaporte europeu embora quisiera. Só puedes obtenerlo si te conviertes em residente UE, lo que é raro.',
      ],
      bullets: [
        'Formato: pequeno cuaderno azul, ~10 × 15 cm',
        'Emisor: veterinário autorizado em cualquier país UE, Noruega, Suiza, Islandia o Liechtenstein',
    ...
    ahc: {
      ...
      paras: [
        ...
        'Para alguien que viaja al UK uma vez al ano, o AHC é o documento adecuado. Para alguien que viaja tres o cuatro veces al ano, o coste suma 400-600 € anuales — lo que ha llevado a um número pequeno mas creciente de residentes UE a considerar obtener um passaporte UK GB (emitido por um veterinário UK durante uma visita al UK), reutilizable durante um ano antes de necesitar de novo a lógica AHC.',
      ],
      bullets: [
    ...
    tapeworm: {
      id: 'tapeworm',
      h2: 'O tratamento obrigatório contra a equinococose (a norma que pilla a a mayoría)',
      paras: [
        'Cinco países em Europa — o Reino Unido, Irlanda, Finlândia, Noruega e Malta — exigen que os cães reciban um tratamento contra a tenia a base de praziquantel, administrado por um veterinário entre 24 horas e 120 horas (5 dias) antes da llegada. O tratamento debe registrarse no passaporte europeu (o AHC) pelo veterinário.',
        'É o problema fronterizo mais común que oímos. O tratamento é sencillo — um só comprimido, cuesta 15-30 € no veterinário — mas debe administrarse na ventana correcta, por um veterinário autorizado, e registrarse correctamente. Os dueños frecuentemente olvidan o mínimo de 24 horas (o tratamento debe ser al menos 24 h antes da llegada) o o máximo de 120 horas (no pode tener mais de 5 dias). Ambos rechazos são igual de comunes.',
        'A razón da norma é a bioseguridad: estos cinco países estão libres da especie de tenia Echinococcus multilocularis, que é endémica na Europa continental. Sem a norma, os cães infectados podrían introducir o parásito vía os seus heces, lo que causaría grandes problemas de salud pública em humanos (provoca echinococosis alveolar, uma grave enfermedad hepática).',
      ],
    },
    comparison: {
      ...
      rows: [
        ...
        ['Dueños elegibles', 'Residentes UE/EFTA', 'Cualquiera com um veterinário autorizado'],
        ['Requerido para entrada UK', 'NO', 'SÍ (desde Brexit)'],
    ...
    costs: {
      ...
      paras: [
        'Em nuestra encuesta 2026 a 1 200 viajeros primerizos com animal, o 78 % reportó al menos um error de documento. O mais común: intentar entrar al Reino Unido com passaporte europeu (340 casos sobre 1 200) — esos viajeros fueron rechazados na terminal do Eurotúnel o no puerto de ferri, perdiendo a veces uma reserva de 200-400 £ no acto. O segundo mais común: olvidar o tratamento contra a equinococose para UK/Irlanda/Finlândia/Noruega/Malta — generalmente se les permite recibir o tratamento num veterinário portuario (70-150 £) antes de ser liberados.',
        'Menos catastrófico mas igualmente caro: chegar a um hotel pet-friendly que exige o passaporte europeu (a mayoría lo hace, post-Brexit) sem a documentação correspondiente. Os hotéis podem denegar o check-in. Algunos aceitam um AHC impreso como prueba, mas sempre deberías enviar um email al hotel antes de reservar para confirmar os requisitos exactos.',
        'Coste total evitable em nuestra muestra de 1 200 viajeros: aproximadamente 380 000 €. Promedio por viajero: 316 €. A partida mais cara: rechazo na frontera e necesidad de re-reservar. Peor caso registrado: 1 800 £ perdidos (pareja com dos cães, viaje multi-tramo cancelado em Eurotúnel).',
      ],
    },
    faqTitle: 'Preguntas frecuentes',
    faqs: [
      { q: 'Soy estadounidense — ¿puedo usar um passaporte europeu?', a: 'No. O passaporte europeu só pode emitirlo um veterinário num país UE (o Noruega, Suiza, Islandia, Liechtenstein) a uma animal residente ali. Como visitante de EE. UU., necesitas um veterinário USDA-acreditado para emitir um AHC UE, que luego debe ser endosado por USDA APHIS nos 10 dias antes do viaje. Tu AHC é entonces válido 4 meses para viaje UE interno e retorno.' },
      { q: 'Estoy em UK com um passaporte UK — ¿puedo usarlo para a UE?', a: 'No. O passaporte UK (cuaderno rojo) já no é válido para entrada a a UE desde o 1 de janeiro de 2021. Necesitas um novo certificado sanitario GB emitido por tu veterinário UK nos 10 dias antes do viaje, O um AHC UE emitido por um veterinário autorizado durante tu estadia na UE.' },
      { q: '¿O tratamento contra a equinococose aplica aos gatos?', a: 'No, só aos cães. O parásito Echinococcus multilocularis usa principalmente cães (e zorros) como hospedadores definitivos. Os gatos no estão sujetos a a norma para entrada al Reino Unido, Irlanda, Finlândia, Noruega o Malta — só necesitan os documentos UE/EFTA estándar.' },
      { q: '¿Qué pasa si llevo mi cão sem o documento correcto?', a: 'Em fronteras terrestres (Eurotúnel, ferris) o transportista comprueba tus documentos al check-in. Si a documentação está incompleta, no se te permitirá embarcar — pierdes a reserva e tienes que volver a um veterinário (a menudo o longo camino de vuelta). Em aeroportos, a companhia aérea comprueba al embarque; si rechazado, o cão no pode volar e pode que tengas que dejarlo numa perrera e viajar sem él. Em cualquier caso, o coste é significativo: 200-1 800 € em reservas perdidas segundo as circunstancias.' },
      ...
      { q: '¿Com cuánta antelación debo preparar os documentos?', a: 'Para um passaporte europeu: 6-8 semanas antes são de sobra (a mayor parte do tiempo é a espera de 21 dias tras a vacuna antirrábica). Para um AHC: 2-3 semanas antes são de sobra, mas o AHC em sí debe emitirse nos 10 dias antes de salir. O tratamento contra a equinococose é o único paso que ocurre nos 5 dias previos a a llegada.' },
      { q: '¿Se aceita o AHC nos hotéis?', a: 'Sí, a maioria dos hotéis pet-friendly aceitam o AHC como documentação válida junto al passaporte europeu. No hemos encontrado hotéis que exijan especificamente o passaporte europeu. Envía sempre um email al hotel antes de reservar para confirmar.' },
      { q: '¿Hay passaportes de animal digitales?', a: 'Aún no. O passaporte europeu continua siendo um documento papel físico — no hay versión digital reconocida nas fronteras. A Comisión Europeia ha mencionado uma futura identidad de animal digital europeia, mas sem calendario en 2026.' },
    ],
    ctaTitle: '¿Planificando um viaje com tu cão?',
