...
const REGIONS: Region[] = [
  {
    id: 'salzburg',
    emoji: '🎼',
    title: { en: 'Salzburg & surroundings', fr: 'Salzbourg et environs', es: 'Salzburgo y alrededores', pt: 'Salzburgo e arredores', de: 'Salzburg und Umgebung', nl: 'Salzburg en omgeving', it: 'Salisburgo e dintorni' },
    cities: [
      {
        slug: 'salzburg',
        name: 'Salzburg',
        region: { en: 'Salzburg', fr: 'Salzbourg', es: 'Salzburgo', pt: 'Salzburgo', de: 'Salzburg', nl: 'Salzburg', it: 'Salisburgo' },
        julyTemp: 24,
        tag: { en: 'Mozart · Salzach river · Alpine parks · 24°C', fr: 'Mozart · Salzach · parcs alpins · 24°C', es: 'Mozart · río Salzach · parques alpinos · 24°C', pt: 'Mozart · rio Salzach · parques alpinos · 24°C', de: 'Mozart · Salzach · Alpenparks · 24 °C', nl: 'Mozart · Salzach · Alpenparken · 24 °C', it: 'Mozart · Salzach · parchi alpini · 24 °C' },
        why: {
          ...
          it: `Salisburgo sorge a 424 m sulla Salzach, tra le Alpi di Berchtesgaden e l'avanterra alpina, così luglio resta a 24 °C mentre Vienna arriva a 27 °C e Budapest a 30 °C. L'altopiano del Mönchsberg (500 m, funicolare dal centro) ha 5 km di sentieri nel bosco senza guinzaglio e le mura della fortezza. La riva della Salzach (20 km di sentieri senza guinzaglio, pianeggianti, ombreggiati da salici) è la grande passeggiata per cani della città. Il tuo cane può entrare nel Mirabellgarten al guinzaglio e nel parco dello Schloss Hellbrunn (268 m, 5 km a sud) senza guinzaglio.`,
        },
        dogTip: {
  ...
  },
  {
    id: 'salzkammergut',
    emoji: '🏔️',
    title: { en: 'Salzkammergut lake district', fr: 'Salzkammergut (lacs alpins)', es: 'Salzkammergut (lagos alpinos)', pt: 'Salzkammergut (lagos alpinos)', de: 'Salzkammergut (Alpenseen)', nl: 'Salzkammergut (Alpenmeren)', it: 'Salzkammergut (laghi alpini)' },
    cities: [
      {
        slug: 'bad-ischl',
        name: 'Bad Ischl',
        region: { en: 'Salzkammergut', fr: 'Salzkammergut', es: 'Salzkammergut', pt: 'Salzkammergut', de: 'Salzkammergut', nl: 'Salzkammergut', it: 'Salzkammergut' },
        julyTemp: 22,
        tag: { en: 'Emperor Franz Joseph · Traun river · 22°C', fr: 'Empereur François-Joseph · Traun · 22°C', es: 'Emperador Francisco José · río Traun · 22°C', pt: 'Imperador Francisco José · rio Traun · 22°C', de: 'Kaiser Franz Joseph · Traun · 22 °C', nl: 'Keizer Frans Jozef · Traun · 22 °C', it: 'Imperatore Francesco Giuseppe · Traun · 22 °C' },
        why: {
          ...
          it: `Bad Ischl, a 469 m, fu per 60 anni la residenza estiva dell'imperatore Francesco Giuseppe e sorge nel cuore del Salzkammergut, alla confluenza della Traun e dell'Ischl. Luglio si attesta in media sui 22 °C grazie alle montagne circostanti. Il parco della Kaiservilla (cane al guinzaglio, tenuta accessibile) e il sentiero lungo la riva della Traun (10 km senza guinzaglio) sono gli itinerari classici. Hallstatt (20 km a sud, patrimonio UNESCO) è una bella gita di un giorno: il tuo cane può esplorare la riva del lago e il sentiero della valle dell'Echerntal senza guinzaglio.`,
        },
        dogTip: {
  ...
  },
  {
    id: 'tyrol',
    emoji: '⛰️',
    title: { en: 'Tyrol', fr: 'Tyrol', es: 'Tirol', pt: 'Tirol', de: 'Tirol', nl: 'Tirol', it: 'Tirolo' },
    cities: [
      {
        slug: 'innsbruck',
        name: 'Innsbruck',
        region: { en: 'Tyrol', fr: 'Tyrol', es: 'Tirol', pt: 'Tirol', de: 'Tirol', nl: 'Tirol', it: 'Tirolo' },
        julyTemp: 24,
        tag: { en: 'Inn valley · Nordkette 2,334m · 24°C', fr: 'Vallée de l\'Inn · Nordkette 2 334m · 24°C', es: 'Valle del Inn · Nordkette 2.334m · 24°C', pt: 'Vale do Inn · Nordkette 2.334m · 24°C', de: 'Inntal · Nordkette 2.334 m · 24 °C', nl: 'Inndal · Nordkette 2.334 m · 24 °C', it: `Valle dell'Inn · Nordkette 2.334 m · 24 °C` },
        why: {
          ...
          it: `Innsbruck, a 574 m, sorge nella valle dell'Inn circondata su ogni lato da vette di 2.000-3.000 m che incanalano l'aria alpina fresca verso la città, mantenendo luglio a 24 °C. La Nordkettenbahn porta il tuo cane (gratis) dal centro città a 2.334 m in meno di 30 minuti. La passeggiata lungo l'Inn (15 km di sentieri senza guinzaglio a est e a ovest) è pianeggiante e ombreggiata. Il centro storico (Altstadt) è pedonale. La città più alpina d'Austria, con il miglior accesso alla montagna di qualsiasi centro cittadino europeo.`,
        },
        dogTip: {
      ...
      },
      {
        ...
        region: { en: 'Tyrol', fr: 'Tyrol', es: 'Tirol', pt: 'Tirol', de: 'Tirol', nl: 'Tirol', it: 'Tirolo' },
        julyTemp: 21,
        tag: { en: 'Zillertal Alps · cable cars · 21°C', fr: 'Alpes du Zillertal · télécabines · 21°C', es: 'Alpes del Zillertal · telecabinas · 21°C', pt: 'Alpes do Zillertal · telecabines · 21°C', de: 'Zillertaler Alpen · Seilbahnen · 21 °C', nl: 'Zillertaler Alpen · kabelbanen · 21 °C', it: 'Alpi dello Zillertal · funivie · 21 °C' },
        why: {
          ...
          it: `Mayrhofen, a 627 m, è la base di valle delle Alpi dello Zillertal e registra 21 °C a luglio. La Ahornbahn (cani gratis, fino a 2.000 m) porta i visitatori su un ampio altopiano alpino con 30 km di sentieri estivi senza guinzaglio. La pista ciclabile dello Zillertal (52 km, pianeggiante, senza guinzaglio) collega Jenbach a Mayrhofen tra prati e terreni agricoli. Il paese stesso è completamente pedonale nel centro. Il sentiero della cascata verso l'Hintersee (30 min., senza guinzaglio) è la classica passeggiata locale.`,
        },
        dogTip: {
  ...
  },
  {
    id: 'carinthie',
    emoji: '🏖️',
    title: { en: 'Carinthia (lake district)', fr: 'Carinthie (lacs alpins)', es: 'Carintia (lagos alpinos)', pt: 'Caríntia (lagos alpinos)', de: 'Kärnten (Seenregion)', nl: 'Karinthië (merengebied)', it: 'Carinzia (regione dei laghi)' },
    cities: [
      {
        slug: 'velden-am-worthersee',
        name: 'Velden am Wörthersee',
        region: { en: 'Carinthia', fr: 'Carinthie', es: 'Carintia', pt: 'Caríntia', de: 'Kärnten', nl: 'Karinthië', it: 'Carinzia' },
        julyTemp: 24,
        tag: { en: 'Wörthersee · warmest Alpine lake · 24°C', fr: 'Wörthersee · lac alpin le plus chaud · 24°C', es: 'Wörthersee · lago alpino más cálido · 24°C', pt: 'Wörthersee · lago alpino mais quente · 24°C', de: 'Wörthersee · wärmster Alpensee · 24 °C', nl: 'Wörthersee · warmste Alpenmeer · 24 °C', it: 'Wörthersee · lago alpino più caldo · 24 °C' },
        why: {
          ...
          it: 'Velden am Wörthersee è la glamour resort lacustre dell\'Austria a 440 m, con il Wörthersee che raggiunge i 26 °C per fare il bagno a luglio mentre la temperatura dell\'aria resta a 24 °C. La passeggiata lungo la riva (18 km attorno al lago, interamente senza guinzaglio) è la più lunga passeggiata per cani lungo un lago in Austria. Le Karawanken circostanti (2.000 m) e la Villacher Alpe (funivia a 2.166 m, 20 km a sud) offrono sentieri alpini senza guinzaglio raggiungibili nello stesso giorno. I cani sono benvenuti sul traghetto passeggeri del lago.',
        },
        dogTip: {
  ...
  },
  {
    id: 'vorarlberg',
    emoji: '🌄',
    title: { en: 'Vorarlberg & Bregenz', fr: 'Vorarlberg et Bregenz', es: 'Vorarlberg y Bregenz', pt: 'Vorarlberg e Bregenz', de: 'Vorarlberg und Bregenz', nl: 'Vorarlberg en Bregenz', it: 'Vorarlberg e Bregenz' },
    cities: [
      {
        slug: 'bregenz',
        name: 'Bregenz',
        region: { en: 'Vorarlberg', fr: 'Vorarlberg', es: 'Vorarlberg', pt: 'Vorarlberg', de: 'Vorarlberg', nl: 'Vorarlberg', it: 'Vorarlberg' },
        julyTemp: 23,
        tag: { en: 'Lake Constance · Pfänder 1,064m · 23°C', fr: 'Lac de Constance · Pfänder 1 064m · 23°C', es: 'Lago Constanza · Pfänder 1.064m · 23°C', pt: 'Lago Constança · Pfänder 1.064m · 23°C', de: 'Bodensee · Pfänder 1.064 m · 23 °C', nl: 'Bodenmeer · Pfänder 1.064 m · 23 °C', it: 'Lago di Costanza · Pfänder 1.064 m · 23 °C' },
        why: {
          ...
          it: 'Bregenz è la città più occidentale dell\'Austria, sul Lago di Costanza a 398 m, con il Pfänder (1.064 m) che si erge subito dietro. Luglio si attesta in media sui 23 °C grazie al lago. La Pfänderbahn (cani gratis) raggiunge i 1.022 m in 7 minuti, con 15 km di sentieri alpini senza guinzaglio e uno dei migliori parchi faunistici d\'Austria (cervi, cinghiali, marmotte). La pista ciclabile del Lago di Costanza (273 km attorno al lago, attraverso Germania, Austria e Svizzera) inizia a Bregenz. I cani sono benvenuti sui traghetti del lago.',
        },
        dogTip: {
...
const T = {
  title: {
    ...
    it: 'Le migliori città per sfuggire al caldo in Austria con il tuo cane (2026)',
  },
  metaTitle: {
    ...
    it: 'Austria fresca con il tuo cane: 6 città alpine sotto i 25 °C a luglio (2026)',
  },
  metaDesc: {
    ...
    it: 'Salisburgo, Bad Ischl, Innsbruck, Mayrhofen, Velden e Bregenz: 6 città austriache sotto i 25 °C a luglio con sentieri alpini senza guinzaglio, rive di laghi a misura di cane e funivie che portano il tuo cane gratis.',
  },
  intro: {
    ...
    it: `L'Austria è uno dei paesi più a misura di cane in Europa: il tuo cane può salire su tutti i treni e i tram, entrare nella maggior parte dei ristoranti e viene accolto calorosamente dalla cultura dei caffè. Le Alpi mantengono ogni grande città sotto i 25 °C a luglio. Sei città in cinque regioni, dal centro barocco di Salisburgo allo Zillertal a 600 m.`,
  },
  julyTemp: { en: 'July avg high', fr: 'Max moy. juillet', es: 'Máx. prom. julio', pt: 'Máx. méd. julho', de: 'Juli Ø Höchstwert', nl: 'Juli gem. max.', it: 'Media max. luglio' },
  ...
  hotelsLabel: { en: 'Our hotel picks', fr: 'Nos hôtels recommandés', es: 'Nuestros hoteles recomendados', pt: 'Os nossos hotéis recomendados', de: 'Unsere Hotelempfehlungen', nl: 'Onze hotelkeuzes', it: 'I nostri hotel selezionati' },
  ...
  faq: {
    ...
    a1: {
      ...
      it: 'Tutte le principali città austriache sono più fresche dell\'Europa meridionale, ma all\'interno dell\'Austria i luoghi più freschi sono le cittadine di fondovalle in quota (Mayrhofen 21 °C, Bad Ischl 22 °C, Bregenz 23 °C) rispetto a Vienna (27 °C) e Graz (26 °C). Tirolo e Vorarlberg sono costantemente le province più fresche. La regione dei laghi della Carinzia (Velden 24 °C) è più calda, ma beneficia delle brezze del lago. I resort di montagna sopra i 1.000 m sono 6-8 °C più freschi delle valli.',
    },
    q2: { en: 'Are dogs allowed on Austrian trains and public transport?', fr: 'Les chiens sont-ils autorisés dans les trains et transports en commun autrichiens ?', es: '¿Se permiten perros en los trenes y transporte público austriacos?', pt: 'São permitidos cães nos comboios e transportes públicos austríacos?', de: 'Sind Hunde in österreichischen Zügen und öffentlichen Verkehrsmitteln erlaubt?', nl: 'Mag je hond mee in Oostenrijkse treinen en het openbaar vervoer?', it: 'Il tuo cane può salire sui treni e sui mezzi pubblici austriaci?' },
    a2: {
      ...
      it: 'Regole delle ÖBB (Ferrovie Federali Austriache): i cani in un trasportino sotto i 60x40x40 cm viaggiano gratis. I cani a partire da 60x40x40 cm necessitano di un biglietto bambino a metà prezzo, devono stare al guinzaglio, museruola obbligatoria sui treni a lunga percorrenza (Railjet, Nightjet). Treni regionali (R, REX): cane al guinzaglio senza museruola. Tram e autobus: cani in trasportino gratis, cani più grandi a metà prezzo con guinzaglio e museruola. Le funivie del Vorarlberg (Pfänderbahn, Lünersee ecc.): cani gratis. La Zillertalbahn: cani gratis. Metropolitana di Vienna: cani in trasportino gratis, cani più grandi a metà prezzo con museruola.',
    },
    q3: { en: 'Are dogs welcome in Austrian restaurants and cafés?', fr: 'Les chiens sont-ils bienvenus dans les restaurants et cafés autrichiens ?', es: '¿Son bienvenidos los perros en los restaurantes y cafés austriacos?', pt: 'Os cães são bem-vindos nos restaurantes e cafés austríacos?', de: 'Sind Hunde in österreichischen Restaurants und Cafés willkommen?', nl: 'Is je hond welkom in Oostenrijkse restaurants en cafés?', it: 'Il tuo cane è benvenuto nei ristoranti e nei caffè austriaci?' },
    a3: {
      ...
      it: 'L\'Austria è tra i paesi più accoglienti d\'Europa per i cani quando si esce a mangiare. Caffè viennesi (Kaffeehäuser): il tuo cane è benvenuto quasi ovunque all\'interno, una tradizione secolare. Gasthäuser e rifugi alpini: cani benvenuti all\'interno con il consenso del proprietario, raramente rifiutati. Giardini della birra (Biergärten): cani accettati praticamente ovunque. Ristoranti: la legge austriaca sull\'igiene alimentare (LMH 2006) lascia la decisione al proprietario, i rifiuti sono rari tranne che nella ristorazione raffinata e nei grandi ristoranti d\'albergo. Terrazze: nessuna restrizione.',
    },
    q4: { en: 'Are dogs allowed in Austrian National Parks?', fr: 'Les chiens sont-ils autorisés dans les parcs nationaux autrichiens ?', es: '¿Se permiten perros en los parques nacionales austriacos?', pt: 'São permitidos cães nos parques nacionais austríacos?', de: 'Sind Hunde in österreichischen Nationalparks erlaubt?', nl: 'Mag je hond mee in Oostenrijkse nationale parken?', it: 'Il tuo cane può entrare nei parchi nazionali austriaci?' },
    a4: {
      ...
      it: 'L\'Austria ha 6 parchi nazionali. Hohe Tauern (il più grande, tra Tirolo, Salisburgo e Carinzia): cani ammessi sui sentieri segnalati al guinzaglio, senza guinzaglio nelle zone esterne. Gesäuse (Stiria): cane al guinzaglio su tutti i sentieri segnalati. Kalkalpen (Alta Austria): cane al guinzaglio. Donau-Auen (Bassa Austria): cane al guinzaglio sui sentieri segnalati. Thayatal e Neusiedler See: cane al guinzaglio. In pratica, le zone cuscinetto esterne (Vorzone) di ogni parco consentono i cani senza guinzaglio. I punti di accesso ai parchi tramite funivia (come la Grossglockner Hochalpenstrasse) accettano i cani.',
    },
    q5: { en: 'Do Austrian cable cars accept dogs?', fr: 'Les téléphériques autrichiens acceptent-ils les chiens ?', es: '¿Los teleféricos austriacos aceptan perros?', pt: 'Os teleféricos austríacos aceitam cães?', de: 'Nehmen österreichische Seilbahnen Hunde mit?', nl: 'Mogen honden mee in Oostenrijkse kabelbanen?', it: 'Le funivie austriache accettano i cani?' },
    a5: {
      ...
      it: 'La maggior parte delle funivie austriache (Seilbahnen) accetta i cani, e molte lo fanno gratis. La regola standard è: i cani in un trasportino viaggiano a tariffa bambino o gratis; i cani più grandi di un trasportino viaggiano a tariffa bambino e devono stare al guinzaglio. Confermate gratis: Nordkettenbahn (Innsbruck), Pfänderbahn (Bregenz), Ahornbahn (Mayrhofen), funicolare del Mönchsberg (Salisburgo). Confermate con guinzaglio a tariffa bambino: Hahnenkammbahn (Kitzbühel), Patscherkofelbahn (Innsbruck). Controlla sempre il sito web del gestore, perché le regole cambiano stagionalmente. Sulle seggiovie destinate agli sciatori durante la stagione sciistica, i cani non vengono mai accettati.',
    },
  },
}
      ...
      <section className="bg-gradient-to-br from-red-900 via-red-800 to-slate-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-red-200 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-5">
            🇦🇹 {locale === 'fr' ? 'Salzbourg · Tyrol · Carinthie · Vorarlberg' : locale === 'es' ? 'Salzburgo · Tirol · Carintia · Vorarlberg' : locale === 'pt' ? 'Salzburgo · Tirol · Caríntia · Vorarlberg' : locale === 'de' ? 'Salzburg · Tirol · Kärnten · Vorarlberg' : locale === 'nl' ? 'Salzburg · Tirol · Karinthië · Vorarlberg' : locale === 'it' ? 'Salisburgo · Tirolo · Carinzia · Vorarlberg' : 'Salzburg · Tyrol · Carinthia · Vorarlberg'}
          </div>
