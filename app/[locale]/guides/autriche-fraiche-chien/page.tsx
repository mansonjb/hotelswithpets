...
const REGIONS: Region[] = [
  {
    id: 'salzburg',
    emoji: '🎼',
    title: { en: 'Salzburg & surroundings', fr: 'Salzbourg et environs', es: 'Salzburgo y alrededores', pt: 'Salzburgo e arredores', de: 'Salzburg und Umgebung' },
    cities: [
      {
        slug: 'salzburg',
        name: 'Salzburg',
        region: { en: 'Salzburg', fr: 'Salzbourg', es: 'Salzburgo', pt: 'Salzburgo', de: 'Salzburg' },
        julyTemp: 24,
        tag: { en: 'Mozart · Salzach river · Alpine parks · 24°C', fr: 'Mozart · Salzach · parcs alpins · 24°C', es: 'Mozart · río Salzach · parques alpinos · 24°C', pt: 'Mozart · rio Salzach · parques alpinos · 24°C', de: 'Mozart · Salzach · Alpenparks · 24 °C' },
        why: {
  ...
  },
  {
    id: 'salzkammergut',
    emoji: '🏔️',
    title: { en: 'Salzkammergut lake district', fr: 'Salzkammergut (lacs alpins)', es: 'Salzkammergut (lagos alpinos)', pt: 'Salzkammergut (lagos alpinos)', de: 'Salzkammergut (Alpenseen)' },
    cities: [
      {
        slug: 'bad-ischl',
        name: 'Bad Ischl',
        region: { en: 'Salzkammergut', fr: 'Salzkammergut', es: 'Salzkammergut', pt: 'Salzkammergut', de: 'Salzkammergut' },
        julyTemp: 22,
        tag: { en: 'Emperor Franz Joseph · Traun river · 22°C', fr: 'Empereur François-Joseph · Traun · 22°C', es: 'Emperador Francisco José · río Traun · 22°C', pt: 'Imperador Francisco José · rio Traun · 22°C', de: 'Kaiser Franz Joseph · Traun · 22 °C' },
        why: {
  ...
  },
  {
    id: 'tyrol',
    emoji: '⛰️',
    title: { en: 'Tyrol', fr: 'Tyrol', es: 'Tirol', pt: 'Tirol', de: 'Tirol' },
    cities: [
      {
        slug: 'innsbruck',
        name: 'Innsbruck',
        region: { en: 'Tyrol', fr: 'Tyrol', es: 'Tirol', pt: 'Tirol', de: 'Tirol' },
        julyTemp: 24,
        tag: { en: 'Inn valley · Nordkette 2,334m · 24°C', fr: 'Vallée de l\'Inn · Nordkette 2 334m · 24°C', es: 'Valle del Inn · Nordkette 2.334m · 24°C', pt: 'Vale do Inn · Nordkette 2.334m · 24°C', de: 'Inntal · Nordkette 2.334 m · 24 °C' },
        why: {
      ...
      },
      {
        ...
        region: { en: 'Tyrol', fr: 'Tyrol', es: 'Tirol', pt: 'Tirol', de: 'Tirol' },
        julyTemp: 21,
        tag: { en: 'Zillertal Alps · cable cars · 21°C', fr: 'Alpes du Zillertal · télécabines · 21°C', es: 'Alpes del Zillertal · telecabinas · 21°C', pt: 'Alpes do Zillertal · telecabines · 21°C', de: 'Zillertaler Alpen · Seilbahnen · 21 °C' },
        why: {
  ...
  },
  {
    id: 'carinthie',
    emoji: '🏖️',
    title: { en: 'Carinthia (lake district)', fr: 'Carinthie (lacs alpins)', es: 'Carintia (lagos alpinos)', pt: 'Caríntia (lagos alpinos)', de: 'Kärnten (Seenregion)' },
    cities: [
      {
        slug: 'velden-am-worthersee',
        name: 'Velden am Wörthersee',
        region: { en: 'Carinthia', fr: 'Carinthie', es: 'Carintia', pt: 'Caríntia', de: 'Kärnten' },
        julyTemp: 24,
        tag: { en: 'Wörthersee · warmest Alpine lake · 24°C', fr: 'Wörthersee · lac alpin le plus chaud · 24°C', es: 'Wörthersee · lago alpino más cálido · 24°C', pt: 'Wörthersee · lago alpino mais quente · 24°C', de: 'Wörthersee · wärmster Alpensee · 24 °C' },
        why: {
  ...
  },
  {
    id: 'vorarlberg',
    emoji: '🌄',
    title: { en: 'Vorarlberg & Bregenz', fr: 'Vorarlberg et Bregenz', es: 'Vorarlberg y Bregenz', pt: 'Vorarlberg e Bregenz', de: 'Vorarlberg und Bregenz' },
    cities: [
      {
        slug: 'bregenz',
        name: 'Bregenz',
        region: { en: 'Vorarlberg', fr: 'Vorarlberg', es: 'Vorarlberg', pt: 'Vorarlberg', de: 'Vorarlberg' },
        julyTemp: 23,
        tag: { en: 'Lake Constance · Pfänder 1,064m · 23°C', fr: 'Lac de Constance · Pfänder 1 064m · 23°C', es: 'Lago Constanza · Pfänder 1.064m · 23°C', pt: 'Lago Constança · Pfänder 1.064m · 23°C', de: 'Bodensee · Pfänder 1.064 m · 23 °C' },
        why: {
...
const T = {
  ...
  julyTemp: { en: 'July avg high', fr: 'Max moy. juillet', es: 'Máx. prom. julio', pt: 'Máx. méd. julho', de: 'Juli Ø Höchstwert' },
  ...
  faq: {
    q1: { en: 'Which Austrian cities stay cool in summer?', fr: 'Quelles villes autrichiennes restent fraîches en été ?', es: '¿Qué ciudades austriacas permanecen frescas en verano?', pt: 'Que cidades austríacas se mantêm frescas no verão?', de: 'Welche österreichischen Städte bleiben im Sommer kühl?' },
    a1: {
    ...
    q4: { en: 'Are dogs allowed in Austrian National Parks?', fr: 'Les chiens sont-ils autorisés dans les parcs nationaux autrichiens ?', es: '¿Se permiten perros en los parques nacionales austriacos?', pt: 'São permitidos cães nos parques nacionais austríacos?', de: 'Sind Hunde in österreichischen Nationalparks erlaubt?' },
    a4: {
    ...
    q5: { en: 'Do Austrian cable cars accept dogs?', fr: 'Les téléphériques autrichiens acceptent-ils les chiens ?', es: '¿Los teleféricos austriacos aceptan perros?', pt: 'Os teleféricos austríacos aceitam cães?', de: 'Nehmen österreichische Seilbahnen Hunde mit?' },
    a5: {
      ...
      <section className="bg-gradient-to-br from-red-900 via-red-800 to-slate-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-red-200 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-5">
            🇦🇹 {locale === 'fr' ? 'Salzbourg · Tyrol · Carinthie · Vorarlberg' : locale === 'es' ? 'Salzburgo · Tirol · Carintia · Vorarlberg' : locale === 'pt' ? 'Salzburgo · Tirol · Caríntia · Vorarlberg' : locale === 'de' ? 'Salzburg · Tirol · Kärnten · Vorarlberg' : 'Salzburg · Tyrol · Carinthia · Vorarlberg'}
          </div>
