...
export async function generateMetadata({
  ...
  const descriptions: Record<string, string> = {
    ...
    it: `Otto destinazioni della costa baltica dove i cani sono benvenuti in spiaggia per tutta l'estate: Sopot, Kolobrzeg, Swinoujscie, Rugen, Usedom, Warnemunde, Palanga, Parnu. Più fresca del Mediterraneo, zone canine ufficiali, hotel pet-friendly verificati.`,
  }
  return {
...
const PICKS: Pick[] = [
  {
    ...
    whyIt: `Sopot è la città termale più elegante della Riviera Baltica, con il molo di legno più lungo d'Europa (512 m, cani ammessi fuori dagli orari di balneazione). Il lungomare pedonale Monte Cassino è costeggiato da ristoranti e terrazze di caffè che accettano universalmente i cani al guinzaglio. La Lesna Opera (anfiteatro dell'opera nel bosco) ospita concerti all'aperto in una conca boschiva naturale, dove i cani aspettano sul pendio erboso durante gli spettacoli. Agosto è alta stagione ma la città la gestisce con eleganza: a differenza di Cannes o Marbella, Sopot ha spazio vero. La zona di spiaggia canina designata si trova all'estremità nord, oltre l'hotel Neptun.`,
  ...
  },
  {
    ...
    whyIt: `Kolobrzeg è una delle località termali baltiche più popolari della Polonia, con 18 km di spiaggia di sabbia bianca fine, un faro storico e una cultura di passeggiate con il cane ben radicata tutto l'anno. La spiaggia canina all'estremità ovest della lunga spiaggia è ufficialmente segnalata e non ha alcuna restrizione stagionale. La cultura termale della città (bagni di salamoia, parchi per inalazioni) è una tradizione polacca: i cani ovviamente non fanno i bagni, ma i parchi del lungomare intorno ai padiglioni termali sono tutti accessibili ai cani. I prezzi medi degli hotel sono il 40% inferiori a quelli di Sopot per una qualità equivalente.`,
    ...
    hotelIt: `Hotel Arkas - hotel termale 4 stelle con accesso alla spiaggia, cani ammessi con supplemento modesto. Accesso diretto alla spiaggia sabbiosa e alla zona canina segnalata all'estremità ovest.`,
  },
  {
    slug: 'swinoujscie',
    name: 'Swinoujscie',
    ...
    whyIt: `Swinoujscie si trova sull'isola di Uznam (parzialmente tedesca: la città è a cavallo del confine), ha la spiaggia di sabbia ininterrotta più lunga della costa baltica polacca (12 km) e una vera zona canina indicata sulla mappa ufficiale della città. Il lato tedesco dell'isola (Usedom) inizia subito dall'altra parte del fiume con un traghetto gratuito, raddoppiando l'area da esplorare. La località è più tranquilla di Sopot ma ha un affascinante lungomare Belle Epoque.`,
  ...
  },
  {
    ...
    whyIt: `Rugen è l'isola più grande della Germania e una delle coste più belle del Nord Europa: le bianche scogliere di gesso (Kreidefelsen) del Parco Nazionale di Jasmund, l'elegante località di Binz con il suo lungomare, e il molo di Sellin che ammette cani al guinzaglio tutto l'anno. Il castello di caccia di Granitz, raggiungibile a piedi nel bosco, è a misura di cane. La cultura tedesca delle spiagge per cani è formale ma chiara: cerca i cartelli Hundestrand (spiaggia per cani). Binz, Sellin e Baabe hanno tutte spiagge canine ufficialmente delimitate.`,
    ...
    hotelIt: `Rugen Hotel und Bungalows Binz - 4 stelle, direttamente sul lungomare, cani ammessi con supplemento moderato. Opzione bungalow per famiglie con cani che necessitano di più spazio.`,
  },
  {
    slug: 'usedom',
    name: 'Usedom',
    ...
    whyIt: `Usedom è l'isola tedesca con più ore di sole (1906 ore/anno) e tre eleganti località imperiali: Heringsdorf, Ahlbeck e Bansin. Ognuna ha uno Hundestrand ufficiale che funziona tutto l'anno, senza i divieti da giugno a settembre presenti su molte spiagge tedesche. La Strandpromenade di 13 km che collega tutte e tre le località è piatta, pavimentata ed espressamente aperta ai cani. Il molo di Ahlbeck è il più antico ancora in funzione in Germania (1898) e ammette cani al guinzaglio.`,
  ...
  },
  {
    ...
    whyIt: `Warnemunde è il quartiere balneare di Rostock, raggiungibile in S-Bahn dal centro di Rostock in 22 minuti. Ha una vera spiaggia canina a est del faro che funziona tutto l'anno, un lungomare pianeggiante adatto a qualsiasi razza, e uno storico centro di villaggio di pescatori (il canale Alter Strom) dove le terrazze dei ristoranti tollerano i cani al guinzaglio. La colonia di artisti di Ahrenshoop sulla penisola di Fischland-Darss, 40 km a ovest, è una delle zone costiere più belle e incontaminate della Germania, con sentieri nel bosco che ammettono i cani.`,
    ...
    hotelIt: `Hotel Hubner - 3 stelle di fronte al faro, cani ammessi con supplemento modesto. Esci dalla porta e la spiaggia canina è a 5 minuti verso est.`,
  },
  {
    slug: 'palanga',
    name: 'Palanga',
    ...
    whyIt: `Palanga è la principale località balneare della Lituania e ha una scena estiva sorprendentemente cosmopolita per una città così piccola (13.000 abitanti che salgono a 80.000 in agosto). La spiaggia canina ufficiale all'estremità sud ha una segnaletica chiara e funziona senza interruzioni stagionali. Il Parco Botanico (parco del Museo dell'Ambra di Palanga) è un giardino paesaggistico di 100 ettari aperto ai cani al guinzaglio, uno dei parchi più belli della costa baltica. La città si gira interamente a piedi in 30 minuti e la cultura dei ristoranti con terrazza è tollerante verso i cani.`,
  ...
  },
  {
    ...
    whyIt: `Parnu è la capitale estiva dell'Estonia e ha l'acqua più calda della costa estone: ancora fresca in stile baltico a 18-20°C ad agosto, ma la spiaggia di sabbia e il ritmo da città termale ne fanno la località più vivibile della costa baltica. Il parco prato di Rannaniidu ha un'area ufficiale senza guinzaglio, la zona canina della spiaggia nel tratto sud è segnalata, e tutta la cultura delle terrazze di Parnu (caffè e ristoranti) è esplicitamente tollerante verso i cani. I cani si siedono di routine ai tavoli all'aperto senza problemi. Le temperature di agosto restano sotto i 21°C grazie alla brezza baltica.`,
...
const COPY = {
  ...
  de: {
    eyebrow: 'OSTSEE-RIVIERA 2026 · HUNDEFREUNDLICHE KUESTE',
    title: `Hundefreundliche Ostseekueste 2026: 8 Strandziele von Polen bis Estland`,
    intro: `Die Ostseekueste ist Europas am schnellsten wachsendes Sommerreiseziel: kuehler als das Mittelmeer, mit einer hundefreundlichen Strandkultur, die man in Frankreich, Spanien oder Italien vergeblich sucht. Von den eleganten Seebruecken-Badeorten Polens bis zu den Kurstaedten Estlands werden Hunde an der Ostseekueste nicht nur geduldet: Sie finden offizielle Hundestrand-Zonen, ganzjaehrigen Zugang und eine lokale Kultur, die sich um das Leben im Freien mit Tieren dreht. Die Augusttemperaturen bleiben bei 20-22°C, das Wasser bei 18-22°C, und die Meeresbrise macht diese Kueste im Sommer zur sichersten Europas fuer jede Hunderasse.`,
    pickHeading: '8 Strandziele an der Ostsee, an denen Hunde den ganzen Sommer willkommen sind',
    whyHere: 'Warum hier',
    hotelLabel: 'Wo uebernachten',
    seeDestCta: 'Kompletter Stadtguide →',
    hotelCta: 'Verfuegbarkeit ansehen →',
    augustLabel: 'Aug. Durchschnittshoechstwert',
    practicalHeading: 'Praktische Infos zur Ostseekueste fuer Hundehalter',
    practical: [
      { h: 'Hundestrandregeln Ostsee vs. Mittelmeer', p: `Deutschland betreibt ein formelles Hundestrand-System: offizielle Hundestraende sind mit klaren Schildern gekennzeichnet, in den meisten Badeorten ganzjaehrig geoeffnet, ohne Verbot von Juni bis September. Polen hat auf den offiziellen Stadtplaenen ausgewiesene Hundezonen (Sopot, Kolobrzeg, Swinoujscie, Gdynia), die dauerhaft bestehen. Litauen (Palanga) und Estland (Parnu) verfuegen beide ueber offiziell markierte Zonen mit Zugang den ganzen August ueber. Lettland bietet totale Freiheit: kein saisonales Strandverbot an der gesamten Kueste. Zum Vergleich: Frankreich (totales Verbot an bewachten Straenden von Juni bis September), Spanien (Verbot von Juni bis September an den meisten Costa-Straenden) und Italien (Verbot an den meisten Adria- und Tyrrhenischen Straenden den ganzen Sommer). Die Ostsee ist Europas Hauptstadt der Hundestraende.` },
      { h: 'Ostseewasser fuer Hunde: ist es unbedenklich?', p: `Die Ostsee ist das am wenigsten salzige grosse Meer der Welt (8-12 Promille gegenueber 38 Promille im Mittelmeer). Hunde koennen frei schwimmen, ohne die Fellschaeden oder Augenreizungen, die mittelmeerisches Salz verursacht, aber das Wasser ist immer noch salzig genug, dass Trinken schaedlich ist. Bringen Sie nach dem Schwimmen immer Suesswasser fuer Ihren Hund mit. Der niedrige Salzgehalt bedeutet auch, dass es an der polnischen und deutschen Kueste im August kein Quallenproblem gibt. Die Wassertemperatur bleibt im August an allen 8 Zielen bei 18-22°C, fuer die meisten Rassen nie unangenehm kalt.` },
      { h: 'Anreise an die Ostseekueste mit Bahn und Faehre', p: `Berlin nach Ruegen: 3 Std. mit Direktzug (IC) bis Binz oder Bergen auf Ruegen. Warschau nach Sopot/Danzig: 3,5 Std. mit Intercity-Express (Hunde in Box oder an der Leine, geringe Gebuehr). Vilnius nach Palanga: 3 Std. mit dem Bus (kein Direktzug). Riga nach Parnu: 2 Std. mit dem Bus (kein Direktzug, haeufige Busverbindungen). Mit der Faehre: Rostock nach Helsinki (Tallink, 28 Std., Hunde gegen Kabinenaufpreis oder im Zwinger), Travemuende nach Helsinki (Finnlines, 28 Std.), Travemuende nach Tallinn (Tallink). Hunde sind auf allen Ostsee-Faehren gegen geringen Aufpreis zugelassen. Von Westeuropa aus ist die Kuestenstrasse E28 von Stettin durch alle polnischen Badeorte bis hinauf nach Litauen einer der grossen Hunde-Roadtrips Europas.` },
      { h: 'Ostsee vs. Mittelmeer fuer brachyzephale Hunde', p: `Die Ostseekueste ist im Sommer Europas sicherste Kueste fuer kurznasige Rassen (Bulldoggen, Moepse, Boxer, Boston Terrier) und fuer aeltere Hunde. Die Augustlufttemperatur bleibt an allen 8 Zielen bei 20-22°C: keine Gehwegwaerme ueber 30°C, kein Asphaltrisiko, kein Feuchtigkeitsanstieg. Das Wasser bei 18-22°C wirkt erfrischend statt kalt, und der niedrige Salzgehalt ist schonender fuer Haut und Fell. Zum Vergleich das Mittelmeer im August: Luft bei 30-38°C, Asphalt bei 50-60°C, Salzkonzentration, die Augen und Haut nach jedem Schwimmen reizt. Die Ostsee ist fuer hitzeempfindliche Hunde kein Kompromiss: Sie ist aktiv das richtige Reiseziel.` },
    ],
    faqHeading: 'Haeufig gestellte Fragen',
    faqs: [
      { q: 'Ist die Ostsee fuer Hunde zum Schwimmen unbedenklich?', a: `Ja. Der niedrige Salzgehalt (8-12 Promille) ist deutlich schonender als beim Mittelmeer oder Atlantik. Spuelen Sie das Fell nach dem Schwimmen mit Suesswasser ab, vor allem um Sand und Oberflaechenrueckstaende zu entfernen. An der polnischen und deutschen Ostseekueste gibt es im Sommer kein Quallenproblem. Das Wasser bleibt im August bei 18-22°C, erfrischend, aber fuer die meisten Rassen nicht kalt. Kurzhaarige Hunde (Windhunde, Weimaraner) koennen frei ein- und aussteigen, ohne auszukuehlen. Bringen Sie immer Suesswasser zum Trinken mit: Die Ostsee ist immer noch salzig genug, um bei grossen verschluckten Mengen Dehydrierung auszuloesen.` },
      { q: 'Welcher polnische Badeort ist am besten fuer Hunde?', a: `Sopot fuer Atmosphaere und Eleganz: Europas laengste Seebruecke, der Boulevard Monte Cassino, die besten Restaurants, aber teuer in der Hochsaison im August. Kolobrzeg fuer den laengsten Strand und die am besten organisierte Hundezone: 18 km Strand, offiziell markierte westliche Hundezone, 40 % guenstiger als Sopot, und die Kurpark-Promenaden sind alle fuer Hunde zugaenglich. Swinoujscie fuer die wenigsten Menschenmassen und das deutsch-polnische Doppelerlebnis: Die deutsche Insel Usedom ist eine kostenlose Faehrfahrt entfernt und bietet damit Zugang zu Hundestraenden zweier Laender von einer Basis aus. Fuer Familien, die aus Deutschland oder Skandinavien anreisen, ist Swinoujscie der logischste Einstiegspunkt.` },
      { q: 'Kann ich mit einem Hund die gesamte Ostseekueste entlangfahren?', a: `Ja. Die Kuestenstrasse E28 fuehrt von Swinoujscie ueber Kolobrzeg nach Danzig (Sopot), verlaeuft dann weiter noerdlich durch Gdynia und ueber die Grenze nach Litauen in Richtung Palanga, und von dort weiter durch Lettland nach Estland in Richtung Parnu und Tallinn. Eine komplette Fahrt von Swinoujscie nach Tallinn umfasst etwa 1.200 km und dauert 10-12 Stunden ohne Unterbrechung. Aufgeteilt auf 3-4 Tage mit Uebernachtungen an den Zielen dieses Guides ist es einer der besten Hunde-Roadtrips Europas: Jeder Badeort auf der Route hat einen Hundestrand, eine ausgewiesene Freilaufzone, oder beides.` },
      { q: 'Was ist der beste Monat fuer die Ostsee mit Hund?', a: `August. Das Wasser ist am waermsten (18-22°C an allen 8 Zielen), die Lufttemperatur liegt bei 20-22°C, die Ostseebrisen halten die Kuestenfeuchtigkeit niedrig, und die Hundestrand-Saison ist ueberall in vollem Gange. Juli ist ebenfalls hervorragend (etwas kuehleres Wasser bei 16-20°C, etwas weniger Andrang). September ist ruhig und oft nur halb so teuer wie der August, mit Lufttemperaturen, die auf 15-18°C sinken: hervorragend fuer Hunde, aber etwas kuehl fuer Halter, die schwimmen moechten. Ab Oktober beginnt die Nebensaison: Die meisten Hundestraende bleiben offiziell geoeffnet, aber die Badeorte gehen in den Winterschlaf.` },
    ],
    relatedHeading: 'Siehe auch',
  },
  nl: {
    eyebrow: 'OOSTZEE-RIVIERA 2026 · HONDVRIENDELIJKE KUST',
    title: `Hondvriendelijke Oostzeekust 2026: 8 strandbestemmingen van Polen tot Estland`,
    intro: `De Oostzeekust is Europa's snelst groeiende zomerbestemming: koeler dan de Middellandse Zee, met een hondvriendelijke strandcultuur die je in Frankrijk, Spanje of Italië nergens vindt. Van de elegante pierbadplaatsen van Polen tot de kuursteden van Estland worden honden aan de Oostzee niet zomaar getolereerd: ze hebben officieel aangewezen zones, toegang het hele jaar door, en een lokale cultuur die om het buitenleven met dieren draait. De augustustemperaturen blijven op 20-22°C, het water op 18-22°C, en de zeebries maakt dit de veiligste Europese kust voor elk ras in de zomer.`,
    pickHeading: '8 strandbestemmingen aan de Oostzee waar honden de hele zomer welkom zijn',
    whyHere: 'Waarom hier',
    hotelLabel: 'Waar je kunt overnachten',
    seeDestCta: 'Volledige stadsgids →',
    hotelCta: 'Bekijk beschikbaarheid →',
    augustLabel: 'Gem. max aug',
    practicalHeading: 'Praktische info Oostzeekust voor hondenbaasjes',
    practical: [
      { h: 'Hondenstrandregels Oostzee vs Middellandse Zee', p: `Duitsland hanteert een formeel Hundestrand-systeem: officiële hondenstranden zijn duidelijk aangegeven, het hele jaar open in de meeste badplaatsen, zonder verbod van juni tot september. Polen heeft aangewezen hondenzones op officiële stadskaarten (Sopot, Kolobrzeg, Swinoujscie, Gdynia) die permanent zijn. Litouwen (Palanga) en Estland (Parnu) hebben allebei officieel gemarkeerde zones met toegang de hele maand augustus. Letland biedt totale vrijheid: nergens aan de kust geldt een seizoensverbod op het strand. Vergelijk dat met Frankrijk (totaal verbod op bewaakte stranden van juni tot september), Spanje (verbod van juni tot september op de meeste Costa-stranden) en Italië (verbod op de meeste Adriatische en Tyrreense stranden de hele zomer). De Oostzee is de hondenstrandhoofdstad van Europa.` },
      { h: 'Oostzeewater voor honden: is het veilig?', p: `De Oostzee is de minst zoute grote zee ter wereld (8-12 promille tegenover 38 promille in de Middellandse Zee). Honden kunnen vrij zwemmen zonder de vachtschade of oogirritatie die Middellandse-Zeezout veroorzaakt, maar het water is nog wel zout genoeg om schadelijk te zijn bij het drinken ervan. Neem na het zwemmen altijd zoet water mee voor je hond. De lage zoutgehalte betekent ook geen kwallenprobleem langs de Poolse en Duitse kust in augustus. De watertemperatuur blijft in augustus op alle 8 bestemmingen 18-22°C, nooit onaangenaam koud voor de meeste rassen.` },
      { h: 'Naar de Oostzeekust met trein en veerboot', p: `Berlijn naar Rugen: 3 uur met directe trein (IC) naar Binz of Bergen auf Rugen. Warschau naar Sopot/Gdansk: 3,5 uur met Intercity-expres (honden in bench of aan de lijn, lage toeslag). Vilnius naar Palanga: 3 uur met de bus (geen directe trein). Riga naar Parnu: 2 uur met de bus (geen directe trein, frequente busverbindingen). Per veerboot: Rostock naar Helsinki (Tallink, 28 uur, honden tegen hutopslag of in kennel), Travemünde naar Helsinki (Finnlines, 28 uur), Travemünde naar Tallinn (Tallink). Honden worden op alle Oostzeeveerboten toegelaten tegen een lage toeslag. Vanuit West-Europa is de kustweg E28 vanaf Szczecin door alle Poolse badplaatsen en verder tot Litouwen een van Europa's grootste hondenroadtrips.` },
      { h: 'Oostzee vs Middellandse Zee voor brachycefale honden', p: `De Oostzeekust is 's zomers de veiligste Europese kust voor platneuzige rassen (bulldogs, mopshonden, boxers, Boston terriers) en voor oudere honden. De luchttemperatuur blijft in augustus op alle 8 bestemmingen 20-22°C: geen straatwarmte boven 30°C, geen asfaltrisico, geen vochtigheidspiek. Water op 18-22°C is verfrissend in plaats van koud, en de lage zoutgehalte is milder voor huid en vacht. Vergelijk dat met de Middellandse Zee in augustus: lucht op 30-38°C, asfalt op 50-60°C, zoutconcentratie die na elke zwembeurt ogen en huid irriteert. De Oostzee is geen compromis voor hittegevoelige honden: het is actief de juiste bestemming.` },
    ],
    faqHeading: 'Veelgestelde vragen',
    faqs: [
      { q: 'Is de Oostzee veilig om mee te zwemmen voor honden?', a: `Ja. Het lage zoutgehalte (8-12 promille) is veel milder dan de Middellandse Zee of de Atlantische Oceaan. Spoel de vacht na het zwemmen af met zoet water, vooral om zand en oppervlakteresten te verwijderen. Geen kwallenprobleem langs de Poolse en Duitse Oostzeekust in de zomer. Het water blijft in augustus op 18-22°C, verfrissend maar niet koud voor de meeste rassen. Honden met korte vacht (windhonden, Weimaraners) kunnen vrij in en uit het water zonder af te koelen. Neem altijd zoet drinkwater mee: de Oostzee is nog wel zout genoeg om uitdroging te veroorzaken als je hond aanzienlijke hoeveelheden binnenkrijgt.` },
      { q: 'Welke Poolse badplaats is het beste voor honden?', a: `Sopot voor sfeer en elegantie: Europa's langste pier, de boulevard Monte Cassino, de beste restaurants, maar duur in het drukke augustus. Kolobrzeg voor het langste strand en de best georganiseerde hondenzone: 18 km strand, officieel gemarkeerde westelijke hondenzone, 40% goedkoper dan Sopot, en de kuurpromenadeparken zijn allemaal toegankelijk voor honden. Swinoujscie voor de minste drukte en de dubbele Duits-Poolse ervaring: het Duitse eiland Usedom ligt een gratis veerpont verderop, waardoor je vanaf één uitvalsbasis toegang hebt tot hondenstranden van twee landen. Voor gezinnen die vanuit Duitsland of Scandinavië komen rijden, is Swinoujscie het meest logische instappunt.` },
      { q: 'Kan ik met een hond de hele Oostzeekust doorrijden?', a: `Ja. De kustweg E28 loopt van Swinoujscie via Kolobrzeg naar Gdansk (Sopot), gaat dan verder noordwaarts door Gdynia en over de grens naar Litouwen richting Palanga, en vandaar verder door Letland en naar Estland richting Parnu en Tallinn. Een volledige rit van Swinoujscie naar Tallinn beslaat ongeveer 1.200 km en duurt 10-12 uur zonder stop. Verdeeld over 3-4 dagen met overnachtingen bij de bestemmingen uit deze gids is het een van Europa's beste hondenroadtrips: elke badplaats onderweg heeft een hondenstrand, een gemarkeerde loslopen-zone, of allebei.` },
      { q: 'Wat is de beste maand voor de Oostzee met een hond?', a: `Augustus. Het water is het warmst (18-22°C op alle 8 bestemmingen), de luchttemperatuur is 20-22°C, de Oostzeebriezen houden de kustvochtigheid laag, en het hondenstrandseizoen is overal in volle gang. Juli is ook uitstekend (iets koeler water op 16-20°C, iets minder druk). September is rustig en vaak half zo duur als augustus, met een luchttemperatuur die daalt naar 15-18°C: uitstekend voor honden maar wat fris voor baasjes die willen zwemmen. Vanaf oktober is het laagseizoen: de meeste hondenstranden blijven officieel open, maar de badplaatsen gaan in winterslaap.` },
    ],
  ...
  it: {
    ...
    intro: `La costa baltica è la destinazione estiva a più rapida crescita d'Europa: più fresca del Mediterraneo, con una cultura di spiaggia pet-friendly impossibile da trovare in Francia, Spagna o Italia. Dalle eleganti località con molo della Polonia alle città termali dell'Estonia, i cani non sono solo tollerati sulle spiagge baltiche: hanno zone ufficiali designate, accesso tutto l'anno e una cultura locale costruita attorno alla vita all'aperto con gli animali. Le temperature di agosto restano sui 20-22°C, l'acqua sui 18-22°C, e la brezza marina rende questa la costa europea più sicura per qualsiasi razza in estate.`,
    ...
    practical: [
      { h: 'Regole spiagge canine Baltico vs Mediterraneo', p: `La Germania gestisce un sistema formale di Hundestrand: le spiagge canine ufficiali sono segnalate con cartelli chiari, aperte tutto l'anno nella maggior parte delle località, senza divieto da giugno a settembre. La Polonia ha zone canine designate sulle mappe ufficiali delle città (Sopot, Kolobrzeg, Swinoujscie, Gdynia) che sono permanenti. Lituania (Palanga) ed Estonia (Parnu) hanno entrambe zone segnalate ufficiali con accesso per tutto agosto. La Lettonia offre libertà totale: nessun divieto stagionale sulle spiagge in nessun punto della costa. Confronta questo con la Francia (divieto totale sulle spiagge sorvegliate da giugno a settembre), la Spagna (divieto da giugno a settembre sulla maggior parte delle spiagge della Costa) e l'Italia (divieto sulla maggior parte delle spiagge adriatiche e tirreniche per tutta l'estate). Il Baltico è la capitale europea delle spiagge canine.` },
      { h: 'Acqua baltica per i cani: è sicura?', p: `Il Baltico è il mare maggiore meno salato del mondo (8-12 per mille contro 38 per mille del Mediterraneo). I cani possono nuotare liberamente senza i danni al pelo o l'irritazione oculare che il sale mediterraneo provoca, ma l'acqua rimane abbastanza salina da rendere dannoso berla. Porta sempre acqua dolce per il tuo cane dopo il bagno. La bassa salinità significa anche nessun problema di meduse lungo la costa polacca e tedesca in agosto. La temperatura dell'acqua resta sui 18-22°C ad agosto in tutte e 8 le destinazioni, mai scomodamente fredda per la maggior parte delle razze.` },
      { h: 'Come arrivare sulla costa baltica in treno e traghetto', p: `Berlino-Rugen: 3h in treno diretto (IC) fino a Binz o Bergen auf Rugen. Varsavia-Sopot/Danzica: 3h30 in Intercity express (cani in trasportino o al guinzaglio, supplemento modesto). Vilnius-Palanga: 3h in autobus (nessun treno diretto). Riga-Parnu: 2h in autobus (nessun treno diretto, autobus frequenti). In traghetto: Rostock-Helsinki (Tallink, 28h, cani con supplemento cabina o in canile), Travemunde-Helsinki (Finnlines, 28h), Travemunde-Tallinn (Tallink). I cani sono ammessi su tutti i traghetti baltici con un modesto supplemento. Dall'Europa occidentale, la strada costiera E28 da Stettino attraverso tutte le località polacche fino in Lituania è uno dei grandi viaggi su strada con il cane d'Europa.` },
      { h: 'Baltico vs Mediterraneo per cani brachicefali', p: `La costa baltica è la costa europea più sicura in estate per le razze dal muso schiacciato (bulldog, carlini, boxer, Boston terrier) e per i cani anziani. La temperatura dell'aria ad agosto in tutte e 8 le destinazioni resta sui 20-22°C: niente calore dell'asfalto oltre i 30°C, nessun rischio asfalto, nessun picco di umidità. L'acqua a 18-22°C è rinfrescante anziché fredda, e la bassa salinità è più delicata su pelle e pelo. Confronta con il Mediterraneo ad agosto: aria a 30-38°C, asfalto a 50-60°C, concentrazione di sale che irrita occhi e pelle dopo ogni bagno. Il Baltico non è un compromesso per i cani sensibili al caldo: è attivamente la destinazione giusta.` },
    ],
    faqHeading: 'Domande frequenti',
    faqs: [
      { q: 'Il Mar Baltico è sicuro per far nuotare i cani?', a: `Sì. La bassa salinità (8-12 per mille) è molto più delicata del Mediterraneo o dell'Atlantico. Risciacqua il pelo con acqua dolce dopo il bagno, principalmente per rimuovere sabbia e residui superficiali. Nessun problema di meduse lungo la costa baltica polacca e tedesca in estate. L'acqua resta sui 18-22°C ad agosto, rinfrescante ma non fredda per la maggior parte delle razze. I cani a pelo corto (levrieri, Weimaraner) possono entrare e uscire liberamente senza raffreddarsi. Porta sempre acqua dolce da bere: il Baltico rimane comunque abbastanza salato da causare disidratazione se il tuo cane ne ingerisce quantità significative.` },
      { q: 'Quale località polacca è migliore per i cani?', a: `Sopot per atmosfera ed eleganza: il molo più lungo d'Europa, il lungomare Monte Cassino, i ristoranti migliori, ma costosa nel picco di agosto. Kolobrzeg per la spiaggia più lunga e la zona canina meglio organizzata: 18 km di spiaggia, zona canina ovest ufficialmente segnalata, 40% più economica di Sopot, e i parchi del lungomare termale sono tutti accessibili ai cani. Swinoujscie per la minore folla e la doppia esperienza tedesco-polacca: l'isola tedesca di Usedom è a un traghetto gratuito di distanza, dandoti accesso alle spiagge canine di due paesi da un'unica base. Per le famiglie che arrivano in auto dalla Germania o dalla Scandinavia, Swinoujscie è il punto di ingresso più logico.` },
      { q: 'Posso percorrere tutta la costa baltica in auto con un cane?', a: `Sì. La strada costiera E28 va da Swinoujscie attraverso Kolobrzeg fino a Danzica (Sopot), poi continua a nord attraverso Gdynia e oltrepassa il confine verso la Lituania in direzione Palanga, e da lì risale attraverso la Lettonia fino in Estonia verso Parnu e Tallinn. Un percorso completo da Swinoujscie a Tallinn copre circa 1.200 km e richiede 10-12 ore senza fermate. Diviso in 3-4 giorni con soste notturne nelle destinazioni di questa guida, è uno dei migliori viaggi su strada con il cane d'Europa: ogni località sul percorso ha una spiaggia canina, una zona ufficiale senza guinzaglio, o entrambe.` },
      { q: 'Qual è il mese migliore per il Baltico con un cane?', a: `Agosto. L'acqua è la più calda (18-22°C in tutte e 8 le destinazioni), la temperatura dell'aria è di 20-22°C, le brezze baltiche mantengono bassa l'umidità costiera, e la stagione delle spiagge canine è in pieno svolgimento ovunque. Anche luglio è eccellente (acqua leggermente più fresca a 16-20°C, un po' meno affollato). Settembre è tranquillo e spesso costa la metà di agosto, con temperatura dell'aria che scende a 15-18°C: ottimo per i cani ma un po' fresco per i proprietari che vogliono nuotare. Da ottobre in poi è bassa stagione: la maggior parte delle spiagge canine restano ufficialmente aperte, ma le località balneari entrano in letargo.` },
    ],
            ...
            <article key={p.slug} className="bg-white rounded-2xl border border-stone-200 overflow-hidden">
              ...
              <header className="px-5 sm:px-7 py-4 bg-gradient-to-r from-cyan-50 to-teal-50 border-b border-stone-200 flex flex-wrap items-baseline gap-x-4 gap-y-1">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-stone-900">
                  <Link href={`/${locale}${p.destPath}`} className="hover:text-cyan-700">{getLocalizedCityName(p.slug, p.name, locale)}</Link>
                </h3>
