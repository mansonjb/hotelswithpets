...
const PICKS: Pick[] = [
  ...
  },
  {
    ...
    whyIt: `Kolobrzeg e una delle località termali baltiche più popolari della Polonia, con 18 km di spiaggia di sabbia bianca fine, un faro storico e una cultura di passeggiate con il cane ben radicata tutto l'anno. La spiaggia canina all'estremità ovest della lunga spiaggia e ufficialmente segnalata e non ha alcuna restrizione stagionale. La cultura termale della città (bagni di salamoia, parchi per inalazioni) e una tradizione polacca: i cani ovviamente non fanno i bagni, ma i parchi del lungomare intorno ai padiglioni termali sono tutti accessibili ai cani. I prezzi medi degli hotel sono il 40% inferiori a quelli di Sopot per una qualità equivalente.`,
  ...
  },
  {
    ...
    whyIt: `Usedom e l'isola tedesca con più ore di sole (1906 ore/anno) e tre eleganti località imperiali: Heringsdorf, Ahlbeck e Bansin. Ognuna ha uno Hundestrand ufficiale che funziona tutto l'anno, senza i divieti da giugno a settembre presenti su molte spiagge tedesche. La Strandpromenade di 13 km che collega tutte e tre le località e piatta, pavimentata ed espressamente aperta ai cani. Il molo di Ahlbeck e il più antico ancora in funzione in Germania (1898) e ammette cani al guinzaglio.`,
  ...
  },
  {
    ...
    whyIt: `Warnemunde e il quartiere balneare di Rostock, raggiungibile in S-Bahn dal centro di Rostock in 22 minuti. Ha una vera spiaggia canina a est del faro che funziona tutto l'anno, un lungomare pianeggiante adatto a qualsiasi razza, e uno storico centro di villaggio di pescatori (il canale Alter Strom) dove le terrazze dei ristoranti tollerano i cani al guinzaglio. La colonia di artisti di Ahrenshoop sulla penisola di Fischland-Darss, 40 km a ovest, e una delle zone costiere più belle e incontaminate della Germania, con sentieri nel bosco che ammettono i cani.`,
  ...
  },
  {
    ...
    whyIt: `Palanga e la principale località balneare della Lituania e ha una scena estiva sorprendentemente cosmopolita per una città così piccola (13.000 abitanti che salgono a 80.000 in agosto). La spiaggia canina ufficiale all'estremità sud ha una segnaletica chiara e funziona senza interruzioni stagionali. Il Parco Botanico (parco del Museo dell'Ambra di Palanga) e un giardino paesaggistico di 100 ettari aperto ai cani al guinzaglio, uno dei parchi più belli della costa baltica. La città si gira interamente a piedi in 30 minuti e la cultura dei ristoranti con terrazza e tollerante verso i cani.`,
