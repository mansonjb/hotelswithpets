...
const PICKS: Pick[] = [
  {
    ...
    whyIt: `La brezza baltica mantiene Tallinn sotto i 22C anche ad agosto, rendendola la capitale piu fresca del continente europeo in estate. La spiaggia di Pirita ha una zona canina dedicata dove il tuo cane puo correre libero sulla sabbia. Il Parco Kadriorg si estende su 70 ettari e accoglie i cani al guinzaglio tutto l'anno, con ampi sentieri ombreggiati ideali per una passeggiata a meta giornata. I tram accolgono i cani al guinzaglio gratuitamente in tutta la citta. I prezzi sono circa la meta di quello che paghi in Scandinavia per lo stesso livello di hotel.`,
    ...
    hotelIt: `Hotel Telegraaf Autograph Collection e un 5 stelle nello storico ex edificio del telegrafo della citta vecchia, con un cortile spa dove rilassarti dopo una passeggiata. I cani fino a 10 kg sono benvenuti con un supplemento modesto, e la posizione centrale ti mette a 15 minuti a piedi dal Parco Kadriorg e dalle mura della citta vecchia.`,
  },
  {
    slug: 'riga',
    name: 'Riga',
    ...
    whyIt: `Riga e la capitale liberty d'Europa, con un patrimonio architettonico che rende ogni passeggiata nel centro un museo a cielo aperto. La localita balneare di Jurmala e a 30 minuti in treno suburbano e ad agosto ha una sezione di spiaggia canina dedicata. Il parco boschivo Mezaparks ai margini della citta offre zone libere dal guinzaglio in una pineta che resta fresca tutta l'estate. La cultura dei biergarten a Riga e molto tollerante verso i cani, quindi il tuo cane ti accompagna alla maggior parte dei tavoli all'aperto. La passeggiata lungo la Daugava e un lungofiume piatto e ampio, perfetto per una corsa mattutina.`,
    ...
    hotelIt: `Grand Hotel Kempinski Riga e un 5 stelle sulle rive del fiume Daugava, con vista diretta sulla citta vecchia dall'altra parte dell'acqua. Gli animali sono benvenuti con un supplemento modesto, e la posizione lungo il fiume ti da accesso immediato alla passeggiata pianeggiante per passeggiate mattutine o serali. La posizione centrale dell'hotel mette anche il quartiere liberty a 10 minuti a piedi.`,
  },
  {
    slug: 'vilnius',
    name: 'Vilnius',
    ...
    whyIt: `Vilnius e il gioiello barocco degli stati baltici, con un centro storico patrimonio UNESCO fatto di chiese, cortili e vicoli acciottolati. Il Giardino dei Bernardini adiacente al centro storico e aperto ai cani al guinzaglio e offre una fuga verde ombreggiata nel cuore della citta. La passeggiata lungo il fiume Neris si estende per 6 km pianeggianti dal centro verso l'esterno, ideale per una passeggiata al mattino presto o a tarda sera quando le strade in pietra hanno smaltito il calore. Il Parco Vingis ai margini occidentali della citta ha aree recintate dedicate ai cani liberi. I dehors dei ristoranti in tutta la citta sono universalmente tolleranti verso i cani, secondo la tradizione lituana.`,
    ...
    hotelIt: `Stikliai Hotel e un boutique 5 stelle nel cuore del centro storico, in una delle strade acciottolate piu tranquille del quartiere barocco. Gli animali sono accettati su richiesta, e l'hotel ha un cortile giardino dove il tuo cane puo riposare all'ombra tra una passeggiata e l'altra. La posizione e letteralmente dentro la zona UNESCO, a pochi minuti dal Giardino dei Bernardini.`,
  },
  {
    slug: 'bruges',
    name: 'Bruges',
    ...
    whyIt: `Bruges resta sotto i 23C ad agosto ed e una delle citta medievali piu percorribili a piedi d'Europa, con alzaie lungo i canali che offrono una rete completa di percorsi pianeggianti, senza biglietto d'ingresso e aperti ai cani ovunque. Il Parco Minnewater (il Lago dell'Amore) e uno spazio verde pianeggiante dove i cani al guinzaglio sono benvenuti accanto all'acqua. Le gite in barca sui canali non ammettono cani, ma le alzaie lungo ogni canale sono un'alternativa gratuita e forse piu intima, al tuo ritmo. Il centro storico e abbastanza compatto da poter essere percorso interamente a piedi, senza mai aver bisogno dei mezzi pubblici.`,
    ...
    hotelIt: `Hotel Heritage e una boutique 4 stelle in una casa sul canale nel centro storico, senza supplemento per gli animali. L'edificio risale al XIX secolo, le camere sono tranquille e ben arredate, e la posizione sulla Niklaasstraat ti mette a 5 minuti sia dalla Piazza del Mercato che dall'alzaia del Minnewaterpark. La colazione e inclusa, il che ne fa una delle migliori opzioni pet-friendly di Bruges per rapporto qualita-prezzo.`,
  },
  {
    slug: 'ghent',
    name: 'Ghent',
    ...
    whyIt: `Gand e la citta universitaria del Belgio, decisamente piu rilassata di Bruges, con una cultura locale che tratta i cani come una parte normale della vita quotidiana. Il Citadelpark e uno spazio verde di 12 ettari con una zona libera dal guinzaglio, a poche fermate di tram dal centro. I dehors sul lungomare a Graslei e Korenlei lungo il porto interno sono fiancheggiati da terrazze di bar e ristoranti che accettano tutti i cani ai tavoli all'aperto. La passeggiata esterna attorno al castello di Gravensteen segue il canale ed e sempre pet-friendly. Gand ha anche un mercato coperto (Vrijdagmarkt) dove i cani al guinzaglio sono tollerati alla maggior parte delle bancarelle.`,
    ...
    hotelIt: `Pillows Grand Boutique Hotel Reylof e un 4 stelle in una villa patrizia restaurata vicino al Citadelpark, uno degli hotel piu curati nel design di Gand. I cani sono benvenuti in hotel, e la posizione vicino al parco significa che la tua passeggiata mattutina inizia dal cancello del giardino. La strada tranquilla ti risparmia il rumore turistico del centro di Bruges.`,
  },
  {
    slug: 'ljubljana',
    name: 'Ljubljana',
    ...
    whyIt: `Lubiana e una delle poche capitali dell'Europa centrale con un centro storico completamente pedonale, il che rende passeggiare con un cane qui subito piu piacevole che in qualsiasi citta paragonabile. Il Parco Tivoli ha un prato libero dal guinzaglio a 10 minuti a piedi dal centro storico, e la passeggiata sulla collina del castello accetta cani al guinzaglio con vista panoramica sulla citta. La Riserva Naturale di Barje ai margini meridionali della citta e una palude pianeggiante con una rete di 25 km di passerelle in legno: un paradiso per cani senza traffico e con tanta ombra tra i salici. Le temperature di agosto raggiungono al massimo 24C, gestibili per la maggior parte dei cani con passeggiate al mattino presto e alla sera.`,
  ...
  },
  {
    ...
    whyIt: `Wroclaw e la citta dai cento ponti, costruita su dodici isole collegate da oltre 100 ponti sul fiume Oder. I cani al guinzaglio sono benvenuti su tutti i ponti pubblici e sui percorsi lungofiume, rendendo ogni passeggiata un'esplorazione delle vie d'acqua. Il Parco Szczytnicki ai margini orientali della citta ha una zona libera dal guinzaglio all'interno del vasto parco. I dehors delle birrerie artigianali in tutta la citta sono universalmente pet-friendly, un tratto distintivo della cultura all'aperto di Wroclaw. Il quartiere Psie Pole a nord, il cui nome significa letteralmente "Campo dei Cani" in polacco, conferma il legame storico della citta con i cani.`,
  ...
  },
  {
    ...
    whyIt: `L'anello verde del Planty a Cracovia e una passeggiata circolare pianeggiante di 4 km attorno all'intero perimetro del centro storico, interamente su sentieri verdi con cani al guinzaglio benvenuti: probabilmente la migliore passeggiata urbana per cani dell'Europa centrale. Le spiagge sulla Vistola a est del quartiere di Kazimierz si aprono ai cani da agosto in poi, quando la stagione balneare inizia a concludersi. La Foresta di Wolski, 10 km a ovest del centro, ha aree psie biegowisko designate (zone libere dal guinzaglio) in un vero ambiente boschivo. I dehors della piazza del mercato della citta accettano cani alla maggior parte dei tavoli all'aperto.`,
    ...
    hotelIt: `Hotel Stary e un boutique 5 stelle nel centro storico, ricavato da una restaurata casa signorile del XV secolo su Piazza Szczepanski. Gli animali sono benvenuti in hotel. La posizione e eccezionalmente centrale: esci direttamente sul Planty, e la Piazza del Mercato Principale e a 2 minuti a piedi. La piscina sul tetto con vista sul centro storico e un tratto distintivo per i pomeriggi caldi di agosto.`,
  },
]
...
const COPY = {
  ...
  it: {
    ...
    title: `Dove andare con il tuo cane ad agosto: 8 citta europee fresche sotto i 25C`,
    intro: `Agosto e il mese peggiore in Europa per viaggiare con un cane sensibile al caldo. L'intero bacino del Mediterraneo supera i 30C, l'asfalto a Roma, Barcellona e Atene raggiunge i 55C a mezzogiorno, e le razze brachicefale (bulldog, carlini, bulldog francesi, boxer) possono entrare in colpo di calore nel giro di pochi minuti. La risposta non e annullare il viaggio estivo: e spostarsi verso nord. Queste otto citta negli stati baltici, in Belgio e nell'Europa centrale restano affidabilmente sotto i 25C ad agosto, hanno una cultura canina consolidata con parchi liberi dal guinzaglio e spiagge per cani, e offrono hotel che prendono sul serio gli animali.`,
    pickHeading: 'Le otto scelte di agosto (dalla piu fresca)',
    whyHere: 'Perche qui',
    ...
    practical: [
      { h: `Perche agosto e il mese peggiore per i cani nel sud Europa`, p: `A luglio, le temperature nel sud Europa sono alte ma spesso raggiungono il picco nel primo pomeriggio e scendono un po' la sera. Agosto ribalta questo schema: il suolo, le strade e gli edifici hanno accumulato sei settimane di calore e lo rilasciano durante la notte, il che significa che le minime notturne restano sopra i 25C in molte citta mediterranee. Per un cane che non puo sudare (solo ansimare, inefficace sopra i 28C), agosto a Roma, Atene o Siviglia e davvero pericoloso. Le razze dal muso schiacciato, i cani anziani e quelli in sovrappeso non riescono a regolarsi adeguatamente: scegli una citta piu a nord o viaggia in quota.` },
      { h: `Il vantaggio baltico`, p: `Tallinn, Riga e Vilnius condividono un vantaggio specifico ad agosto: il Mar Baltico funziona da regolatore di temperatura, mantenendo le temperature costiere e vicine alla costa 5-8C sotto la media dell'entroterra dell'Europa centrale. Queste citta hanno anche la migliore combinazione di cultura canina e convenienza in Europa: parchi liberi dal guinzaglio, spiagge per cani, cani gratis sui mezzi pubblici, e supplementi animali negli hotel spesso tra i piu bassi dell'UE. Confronto budget: una notte in un hotel 4 stelle a Tallinn costa in media 80-120 euro, contro 180-250 euro per una qualita equivalente a Stoccolma o 130-200 euro a Helsinki.` },
      { h: `Cani nei parchi dell'Europa centrale: il psie biegowisko`, p: `Cracovia e Wroclaw hanno entrambe un'istituzione specificamente polacca: il psie biegowisko, ovvero una zona canina dedicata all'interno di un parco pubblico. Sono aree recintate libere dal guinzaglio, spesso con punti d'acqua, segnalate sulle mappe dei parchi cittadini e rispettate dagli altri frequentatori. L'equivalente in Belgio e l'hondenlosloopweide (prato libero dal guinzaglio), presente nel Citadelpark di Gand e in spazi verdi simili. Se il tuo cane ha bisogno di tempo libero dal guinzaglio ad agosto, queste sono le tue opzioni garantite in citta che altrimenti richiedono il guinzaglio negli spazi pubblici.` },
      { h: `Prenotare l'hotel ad agosto: tempistiche e cosa chiedere`, p: `Agosto e il picco del turismo europeo. Nelle capitali baltiche, la domanda estiva fa si che i buoni hotel pet-friendly esauriscano la disponibilita gia a giugno per le settimane di punta di agosto (1-10 agosto e 20-31 agosto sono le piu affollate). Prenota presto, e al momento della prenotazione conferma due cose direttamente con l'hotel: il limite di peso del cane (molte strutture dell'Europa centrale fissano il limite a 10 kg o 15 kg), e se la politica sugli animali si estende agli spazi comuni come la terrazza del bar o la sala colazione. A Bruges e Gand, le Feste di Gand (meta agosto) riempiono la citta: prenota con almeno 8 settimane di anticipo.` },
    ],
    faqHeading: 'Domande frequenti',
    faqs: [
      { q: `Agosto e piu economico di luglio nel nord Europa?`, a: `Nelle capitali baltiche, agosto e in realta leggermente piu caro di luglio perche il turismo internazionale raggiunge il picco nelle prime due settimane del mese. I prezzi scendono in modo netto dopo il 20 agosto, quando le vacanze scolastiche finiscono nella maggior parte del nord Europa. Se hai flessibilita, il periodo dal 21 agosto al 5 settembre offre la migliore combinazione di temperature fresche e prezzi piu bassi. In Belgio (Bruges, Gand), agosto e alta stagione per tutto il mese, senza sconti significativi fino a meta settembre.` },
      { q: `Il mio cane puo andare su una spiaggia baltica ad agosto?`, a: `Si, con alcune condizioni. La spiaggia di Pirita a Tallinn ha una zona canina dedicata accessibile tutto l'anno. La localita balneare di Jurmala vicino a Riga ha una sezione specifica per cani in estate. In Estonia e Lettonia, i cani sono generalmente ammessi sulle spiagge al di fuori delle zone di balneazione designate. Le spiagge lituane (Palanga, Nida) applicano regole stagionali piu rigide dal 1 giugno al 30 settembre sui tratti principali. Controlla sempre le regole locali vigenti al punto di accesso, perche possono cambiare di anno in anno. Porta una ciotola d'acqua: la sabbia delle spiagge baltiche si scalda piu di quanto suggerisca la temperatura dell'aria.` },
      { q: `Bruges e gestibile con un cane ad agosto senza le barche sui canali?`, a: `Completamente. Le alzaie lungo ogni canale di Bruges formano una rete di passeggiate completa e gratuita, e per molti versi sono migliori delle barche turistiche: vai al tuo ritmo, hai l'ombra degli alberi lungo l'alzaia, e il tuo cane e con te. Il Parco Minnewater (30 minuti a piedi dal centro) e il cortile del Begijnhof (cani al guinzaglio tollerati fuori dall'edificio della chiesa) aggiungono altri due spazi tranquilli. L'unico svantaggio e la folla turistica di agosto nel centro: pianifica le tue passeggiate principali prima delle 9 o dopo le 19.` },
      { q: `E i Balcani ad agosto? Solo la Slovenia va bene?`, a: `La Slovenia e l'eccezione nei Balcani perche Lubiana si trova a 295 metri di altitudine e beneficia di flussi d'aria alpini che limitano le temperature di agosto a 24C. La costa croata (Dubrovnik, Split, Hvar) tocca i 30-34C ad agosto ed e davvero inadatta ai cani sensibili al caldo. Montenegro e Albania sono ancora piu caldi. La Bosnia in quota (Sarajevo 26-28C) e al limite. Serbia (Belgrado 32C ad agosto) e Bulgaria (Sofia 29C) sono troppo calde. Se vuoi l'Adriatico ad agosto con un cane, le opzioni migliori sono la costa slovena (Pirano, Portoroz) a 26-27C, oppure le isole croate settentrionali prima del 20 del mese.` },
    ],
