...
const PICKS: Pick[] = [
  ...
  },
  {
    ...
    whyIt: `Riga e la capitale liberty d'Europa, con un patrimonio architettonico che rende ogni passeggiata nel centro un museo a cielo aperto. La località balneare di Jurmala e a 30 minuti in treno suburbano e ad agosto ha una sezione di spiaggia canina dedicata. Il parco boschivo Mezaparks ai margini della città offre zone libere dal guinzaglio in una pineta che resta fresca tutta l'estate. La cultura dei biergarten a Riga e molto tollerante verso i cani, quindi il tuo cane ti accompagna alla maggior parte dei tavoli all'aperto. La passeggiata lungo la Daugava e un lungofiume piatto e ampio, perfetto per una corsa mattutina.`,
  ...
  },
  {
    ...
    whyIt: `Bruges resta sotto i 23C ad agosto ed e una delle città medievali più percorribili a piedi d'Europa, con alzaie lungo i canali che offrono una rete completa di percorsi pianeggianti, senza biglietto d'ingresso e aperti ai cani ovunque. Il Parco Minnewater (il Lago dell'Amore) e uno spazio verde pianeggiante dove i cani al guinzaglio sono benvenuti accanto all'acqua. Le gite in barca sui canali non ammettono cani, ma le alzaie lungo ogni canale sono un'alternativa gratuita e forse più intima, al tuo ritmo. Il centro storico e abbastanza compatto da poter essere percorso interamente a piedi, senza mai aver bisogno dei mezzi pubblici.`,
    ...
    hotelIt: `Hotel Heritage e una boutique 4 stelle in una casa sul canale nel centro storico, senza supplemento per gli animali. L'edificio risale al XIX secolo, le camere sono tranquille e ben arredate, e la posizione sulla Niklaasstraat ti mette a 5 minuti sia dalla Piazza del Mercato che dall'alzaia del Minnewaterpark. La colazione e inclusa, il che ne fa una delle migliori opzioni pet-friendly di Bruges per rapporto qualità-prezzo.`,
  },
  {
    slug: 'ghent',
    name: 'Ghent',
    ...
    hotelIt: `Pillows Grand Boutique Hotel Reylof e un 4 stelle in una villa patrizia restaurata vicino al Citadelpark, uno degli hotel più curati nel design di Gand. I cani sono benvenuti in hotel, e la posizione vicino al parco significa che la tua passeggiata mattutina inizia dal cancello del giardino. La strada tranquilla ti risparmia il rumore turistico del centro di Bruges.`,
  },
  {
    slug: 'ljubljana',
    name: 'Ljubljana',
...
const COPY = {
  ...
  it: {
    ...
    practical: [
      { h: `Perché agosto e il mese peggiore per i cani nel sud Europa`, p: `A luglio, le temperature nel sud Europa sono alte ma spesso raggiungono il picco nel primo pomeriggio e scendono un po' la sera. Agosto ribalta questo schema: il suolo, le strade e gli edifici hanno accumulato sei settimane di calore e lo rilasciano durante la notte, il che significa che le minime notturne restano sopra i 25C in molte città mediterranee. Per un cane che non può sudare (solo ansimare, inefficace sopra i 28C), agosto a Roma, Atene o Siviglia e davvero pericoloso. Le razze dal muso schiacciato, i cani anziani e quelli in sovrappeso non riescono a regolarsi adeguatamente: scegli una città più a nord o viaggia in quota.` },
    ...
    faqs: [
      ...
      { q: `E i Balcani ad agosto? Solo la Slovenia va bene?`, a: `La Slovenia e l'eccezione nei Balcani perché Lubiana si trova a 295 metri di altitudine e beneficia di flussi d'aria alpini che limitano le temperature di agosto a 24C. La costa croata (Dubrovnik, Split, Hvar) tocca i 30-34C ad agosto ed e davvero inadatta ai cani sensibili al caldo. Montenegro e Albania sono ancora più caldi. La Bosnia in quota (Sarajevo 26-28C) e al limite. Serbia (Belgrado 32C ad agosto) e Bulgaria (Sofia 29C) sono troppo calde. Se vuoi l'Adriatico ad agosto con un cane, le opzioni migliori sono la costa slovena (Pirano, Portoroz) a 26-27C, oppure le isole croate settentrionali prima del 20 del mese.` },
    ],
