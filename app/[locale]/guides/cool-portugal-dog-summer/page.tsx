...
const STICKY_LABELS: Record<string, { label: string; cta: string }> = {
  ...
  nl: { label: 'Koel Portugal, huisdiervriendelijke hotels', cta: 'Bekijk hotels' },
  it: { label: 'Portogallo fresco, hotel pet-friendly', cta: 'Guarda gli hotel' },
}
...
export async function generateMetadata({
  ...
  const titles: Record<string, string> = {
    ...
    nl: `Koel Portugal met je hond in de zomer: 8 bestemmingen onder 25C (2026)`,
    it: `Portogallo fresco con il tuo cane in estate: 8 destinazioni sotto i 25C (2026)`,
  }
  const descriptions: Record<string, string> = {
    ...
    nl: `Acht Portugese bestemmingen waar de augustustemperatuur onder 25C blijft: Serra da Estrela, Viana do Castelo, Peniche en meer. De Algarve haalt 35C, maar het noorden en de Atlantische kust blijven écht koel. Geverifieerde huisdiervriendelijke hotels voor elke keuze.`,
    it: `Otto destinazioni portoghesi dove la temperatura di agosto resta sotto i 25C: Serra da Estrela, Viana do Castelo, Peniche e altre. L'Algarve tocca i 35C ma il nord e la costa atlantica restano davvero freschi. Hotel pet-friendly verificati per ogni scelta.`,
  }
  return {
...
const PICKS: Pick[] = [
  {
    ...
    whyNl: `Het hoogste gebergte van Portugal, met een top op 1993m die je met de auto via de Torre-weg samen met je hond kunt bereiken. Het ras Cão da Serra da Estrela komt hiervandaan, dus de lokale cultuur is door en door hondvriendelijk: de quintas verwelkomen honden zonder uitzondering en zonder toeslag. Rond de top van de Torre zijn aangewezen zones zonder lijn. Dit is de koelste bestemming van heel Portugal in augustus, echt geschikt voor kortsnuitige rassen die overal elders in het land zouden lijden.`,
    whyIt: `La catena montuosa più alta del Portogallo, con una vetta a 1993m raggiungibile in auto tramite la strada della Torre insieme al tuo cane. La razza Cao da Serra da Estrela e originaria di qui, quindi la cultura locale e profondamente amica dei cani: le quintas accolgono i cani senza eccezioni e senza sovrapprezzo. Intorno alla vetta della Torre esistono zone designate senza guinzaglio. Questa e la destinazione più fresca di tutto il Portogallo continentale ad agosto, davvero adatta anche alle razze brachicefale che altrove nel paese soffrirebbero.`,
    ...
    hotelNl: `Hotel Serra da Estrela in Manteigas is een berglodge die honden nadrukkelijk verwelkomt. Gelegen in de vallei op 760m hoogte blijft de temperatuur zelfs medio augustus rond de 18-20C. Het hotel biedt op verzoek een bak en een slaapplek, en de omliggende wandelpaden zijn met je hond aan de lijn direct vanaf het hotel te belopen.`,
    hotelIt: `L'Hotel Serra da Estrela a Manteigas e un lodge di montagna che accoglie esplicitamente i cani. Situato nella valle a 760m di altitudine, le temperature restano intorno ai 18-20C anche a meta agosto. L'hotel fornisce ciotola e cuccia su richiesta, e i sentieri circostanti si percorrono con il cane al guinzaglio direttamente dalla struttura.`,
  },
  {
    ...
    whyNl: `De Minho-kust bij de monding van de Lima, dankzij de Atlantische Nortada-wind de hele augustus onder 23C gehouden. De heuvel met de basiliek van Santa Luzia kun je met je hond aan de lijn beklimmen, en ook de kabeltrein neemt honden mee. Het strand van Afife ten noorden van de stad heeft een aangewezen hondenzone die in augustus open blijft, terwijl de meeste Portugese stranden honden verbieden. De terrassen van het historische centrum zijn echt tolerant voor goed opgevoede honden, en de rivierpromenade langs de Lima is vlak en beschaduwd door platanen.`,
    whyIt: `La costa del Minho alla foce del fiume Lima, mantenuta sotto i 23C per tutto agosto dal vento atlantico Nortada. La collina della basilica di Santa Luzia si percorre con il cane al guinzaglio (anche la funicolare accetta i cani). La spiaggia di Afife a nord della città ha una sezione dedicata ai cani aperta ad agosto, quando la maggior parte delle spiagge portoghesi li vieta. I terrazzi del centro storico sono genuinamente tolleranti verso i cani ben educati, e la passeggiata fluviale lungo il Lima e piatta e ombreggiata dai platani.`,
    ...
    hotelNl: `De Pousada de Viana do Castelo is een 4-sterren pousada boven op de heuvel naast de basiliek van Santa Luzia, huisdieren welkom tegen een bescheiden vergoeding. De hoge ligging betekent dat het terras in de wind van de Nortada staat en zelfs 's middags echt fris blijft. Uitzicht over de monding van de Lima, en je hond kan vanuit de hoteltuin rechtstreeks het wandelpad naar de basiliek oplopen.`,
    hotelIt: `La Pousada de Viana do Castelo e una pousada 4 stelle in cima alla collina accanto alla basilica di Santa Luzia, animali benvenuti con un supplemento modesto. La posizione elevata significa che si trova nel corridoio del vento Nortada, mantenendo il terrazzo genuinamente fresco anche a mezzogiorno. Vista sull'estuario del Lima, e il tuo cane può camminare dal giardino dell'hotel direttamente sul sentiero della basilica.`,
  },
  {
    slug: 'peniche',
    name: 'Peniche',
    ...
    whyNl: `Atlantisch schiereiland dat door de constante zeewind van beide kanten onder 23C blijft. De wandeling naar de vuurtoren van Cabo Carvoeiro is een van de beste kustpaden van Portugal voor honden, vlak langs de klifrand: open, winderig en zelfs in augustus spectaculair koel. Het strand van Baleal ten noorden van de stad kent geen seizoensgebonden hondenverbod. De surfdorpcultuur is universeel huisdiervriendelijk in cafés, surfwinkels en op terrassen. De veerboot naar het eiland Berlenga laat geen honden toe, maar het eiland is vanaf de vuurtorenwandeling te zien.`,
    whyIt: `Penisola atlantica mantenuta sotto i 23C dal vento oceanico costante da entrambi i lati. La passeggiata al faro di Cabo Carvoeiro e uno dei migliori sentieri costieri del Portogallo per cani, proprio sul bordo della scogliera: esposto, ventoso e spettacolarmente fresco anche ad agosto. La spiaggia di Baleal a nord della città non ha divieto stagionale per i cani. La cultura del villaggio dei surfisti e universalmente tollerante verso gli animali in caffè, negozi di tavole e terrazzi. Il traghetto per l'isola di Berlenga non ammette cani, ma l'isola si vede dalla passeggiata del faro.`,
    ...
    hotelNl: `Hotel Praia Norte is een 3-sterren hotel aan zee waar honden welkom zijn tegen een bescheiden vergoeding. Directe toegang tot het strand, het hotel ligt aan de noordzijde van het schiereiland die de meeste Atlantische bries vangt. Eenvoudig, praktisch en echt ingericht voor actieve vakantiegangers die met hun hond komen.`,
    hotelIt: `Hotel Praia Norte e una struttura 3 stelle sul mare con cani benvenuti con un supplemento modesto. Accesso diretto alla spiaggia, l'hotel si trova sul lato nord della penisola che cattura più brezza atlantica. Semplice, pratico e davvero pensato per vacanzieri attivi che arrivano con il cane.`,
  },
  {
    slug: 'ponte-de-lima',
    name: 'Ponte de Lima',
    ...
    whyNl: `De oudste gemeente van Portugal, met een Romeinse brug over de Lima die je met je hond aan de lijn kunt oversteken. Het vinho verde-wijnland betekent volop schaduw van wijngaarden langs de rivierwandelingen. Het Parque do Arnado is een gebied zonder lijn direct aan de rivier in het centrum. De landelijke quintas in het TER-netwerk (Turismo em Espaço Rural) verwelkomen honden allemaal gratis, vaak met privétuinen. De temperaturen worden getemperd door het valleimicroklimaat en de ochtendmist boven de rivier.`,
    whyIt: `Il comune più antico del Portogallo, con un ponte romano sul fiume Lima che puoi attraversare con il tuo cane al guinzaglio. La terra del vinho verde significa ombra abbondante dei vigneti lungo le passeggiate fluviali. Il Parque do Arnado e una zona senza guinzaglio proprio sul fiume nel centro cittadino. Le quintas rurali della rete TER (Turismo em Espaco Rural) accolgono tutte i cani gratuitamente, spesso con giardini privati. Le temperature sono mitigate dal microclima della valle e dalla nebbia mattutina del fiume.`,
    ...
    hotelNl: `Solar do Bertiandos is een landelijk landhuis met uitgestrekte tuinen waar honden zonder toeslag vrij welkom zijn. Het landgoed ligt in het Lima-dal met directe toegang tot rivierwandelingen. Een actieve quinta in de vinho verde-zone: de koele avondlucht komt van de rivier en de wijngaarden en maakt zelfs de warmste augustusnachten aangenaam.`,
    hotelIt: `Solar do Bertiandos e una tenuta rurale con ampi giardini dove i cani sono liberamente benvenuti senza supplemento. La proprieta si trova nella valle del Lima con accesso diretto alle passeggiate fluviali. Una quinta attiva nella zona del vinho verde: l'aria fresca della sera arriva dal fiume e dai vigneti, rendendo confortevoli anche le notti più calde di agosto.`,
  },
  {
    slug: 'aveiro',
    name: 'Aveiro',
    ...
    whyNl: `Het Portugese Venetië, met vlakke jaagpaden die het uitlaten van je hond bij elk weer makkelijk maken. Moliceiro-boottochten laten geen honden toe, maar het kanalennetwerk heeft meerdere kilometers beschaduwde jaagpaden op waterniveau die merkbaar koeler blijven dan straatniveau. Het strand van Costa Nova, 10km westelijk, heeft een voor honden toegankelijk deel buiten de hoofdzwemzone. De studentenstadcultuur is het hele jaar door erg hondvriendelijk op de caféterrassen.`,
    whyIt: `La Venezia portoghese, con alzaie piatte che rendono facile passeggiare con il cane con qualsiasi tempo. I tour in barca moliceiro non ammettono cani, ma la rete di canali offre diversi chilometri di alzaie ombreggiate a livello dell'acqua che restano notevolmente più fresche del livello strada. La spiaggia di Costa Nova, 10km a ovest, ha una sezione accessibile ai cani fuori dalla zona balneare principale. La cultura della città universitaria e molto tollerante verso i cani nei caffè con terrazzo tutto l'anno.`,
    ...
    hotelNl: `Aveiro Palace Hotel is een centraal gelegen 4-sterren hotel waar huisdieren welkom zijn. Het hotel ligt op 5 minuten lopen van het hoofdkanaal, en de vlakke wandelingen op kanaalniveau zijn direct toegankelijk. Een betrouwbare uitvalsbasis om zowel de kanalen van de stad als de kust van Costa Nova te verkennen voor een strandmoment met je hond.`,
    hotelIt: `Aveiro Palace Hotel e una struttura centrale 4 stelle con animali benvenuti. L'hotel dista 5 minuti a piedi dal canale principale, e le passeggiate a livello del canale sono direttamente accessibili. Una base affidabile per esplorare sia i canali della città sia il litorale di Costa Nova per il momento spiaggia del tuo cane.`,
  },
  {
    slug: 'guimaraes',
    name: 'Guimaraes',
    ...
    whyNl: `De als UNESCO-werelderfgoed erkende bakermat van Portugal. De wandeling naar de kasteelheuvel accepteert honden aan de lijn en biedt uitzicht over de hele Minho-regio. De culturele wijk Couros heeft meerdere caféterrassen die honden buiten toelaten. Het Parque da Cidade aan de zuidrand heeft grote hondvriendelijke weiden met veel schaduw. De smalle, geplaveide straatjes van het middeleeuwse centrum blijven merkbaar koeler dan de open pleinen, en 's middags houdt Atlantische bewolking de augustustemperaturen draaglijk.`,
    whyIt: `Culla del Portogallo patrimonio mondiale dell'UNESCO. La passeggiata sulla collina del castello accetta cani al guinzaglio e offre viste su tutta la regione del Minho. Il quartiere culturale di Couros ha diversi caffè con terrazzo che ammettono i cani all'esterno. Il Parque da Cidade sul bordo sud ha ampi prati amici dei cani con molta ombra. Le stradine strette e lastricate del centro medievale restano notevolmente più fresche delle piazze aperte, e nel pomeriggio la copertura nuvolosa atlantica mantiene sopportabili le temperature di agosto.`,
    ...
    hotelNl: `De Pousada de Guimarães is een 5-sterren pousada in het omgebouwde klooster Santa Marinha, een van de historisch belangrijkste hotels van Portugal. Honden worden op aanvraag geaccepteerd: bel vooraf om te bevestigen, want het beleid vereist voorafgaande toestemming. De kloostertuin is een rustige plek waar je hond kan bijkomen na een dag op de kasteelpaden.`,
    hotelIt: `La Pousada de Guimaraes e una pousada 5 stelle nel convento riconvertito di Santa Marinha, uno degli hotel più significativi dal punto di vista storico del Portogallo. Cani accettati su richiesta: chiama in anticipo per confermare, poiché la politica richiede una preautorizzazione. Il giardino del chiostro e uno spazio tranquillo dove il tuo cane può rilassarsi dopo una giornata sui sentieri del castello.`,
  },
  {
    slug: 'porto',
    name: 'Porto',
    ...
    whyNl: `De Nortada-wind is in augustus het sterkst in Porto en verlaagt de middagtemperatuur betrouwbaar met 5-8C ten opzichte van wat de thermometer aangeeft. Het Parque da Cidade beslaat 83 hectare met een speciale zone zonder lijn, wat het een van de grootste stadsparken van Europa voor honden maakt. Het strand van Matosinhos ten noorden van de stad heeft een voor honden toegankelijk gedeelte dat in augustus open blijft. De terrasrestaurants van de Ribeira zijn flexibel met goed opgevoede honden aan de lijn, en de wijnkelderbezoeken in Vila Nova de Gaia laten honden toe in de buitenruimtes van Quinta do Crasto en Quinta de la Rosa.`,
    whyIt: `Il vento Nortada e più forte a Porto ad agosto, abbassando in modo affidabile le temperature pomeridiane di 5-8C rispetto a quanto indica il termometro. Il Parque da Cidade si estende su 83 ettari con una zona dedicata senza guinzaglio, rendendolo uno dei più grandi parchi urbani d'Europa per cani. La spiaggia di Matosinhos a nord della città ha una sezione accessibile ai cani aperta ad agosto. I ristoranti con terrazzo della Ribeira sono flessibili con i cani ben educati al guinzaglio, e le visite alle cantine a Vila Nova de Gaia ammettono cani nelle aree esterne di Quinta do Crasto e Quinta de la Rosa.`,
    ...
    hotelNl: `The Yeatman is een 5-sterren wijnhotel met uitzicht op de Douro vanuit Vila Nova de Gaia, huisdieren op aanvraag welkom. Het infinity-pool-terras ligt op het noorden richting de rivier en profiteert rechtstreeks van de middagbries van de Nortada. Een hondvriendelijk hotel op loopafstand van de oever van de Douro en de kabelbaan naar de portwijnkelders.`,
    hotelIt: `The Yeatman e un hotel del vino 5 stelle con vista sul Douro da Vila Nova de Gaia, animali benvenuti su richiesta. Il terrazzo con piscina a sfioro guarda a nord sul fiume e beneficia direttamente della brezza pomeridiana del Nortada. Un hotel pet-friendly a distanza a piedi dal lungofiume del Douro e dalla funivia verso le cantine del vino Porto.`,
  },
  {
    slug: 'sesimbra',
    name: 'Sesimbra',
    ...
    whyNl: `Vissersdorp 40km ten zuiden van Lissabon aan de Atlantische Oceaan, beschut door de Serra da Arrábida en gekoeld door de koude Atlantische opwellingsstroom. De wandelpaden van het Natuurpark Arrábida boven het dorp accepteren honden aan de lijn op de gemarkeerde routes. Het Fort-strand voor het dorp staat honden toe buiten de hoofdzwemzone. De lokale vissersrestaurants laten op hun terrassen doorgaans honden toe, een tolerantie die zo dicht bij Lissabon ongebruikelijk is. De temperatuur van het Atlantische water is hier in augustus 18-20C, zodat je hond echt kan zwemmen zonder oververhit te raken.`,
    whyIt: `Villaggio di pescatori a 40km a sud di Lisbona sull'Atlantico, riparato dalla Serra da Arrabida e rinfrescato dalla fredda corrente atlantica di risalita. I sentieri del Parco Naturale dell'Arrabida sopra il villaggio accettano cani al guinzaglio sui percorsi segnalati. La spiaggia del Forte davanti al villaggio ammette cani fuori dalla zona balneare principale. I ristoranti dei pescatori locali di solito ammettono cani sui terrazzi, una tolleranza inusuale così vicino a Lisbona. La temperatura dell'acqua atlantica qui e di 18-20C ad agosto, quindi il tuo cane può davvero nuotare senza surriscaldarsi.`,
    ...
    hotelNl: `Hotel do Mar is een 4-sterren hotel hoog op de klif, huisdieren welkom tegen een gematigde vergoeding. De hoge ligging boven de baai vangt de Atlantische bries en biedt uitzicht op het Arrábida-park. Zwembadtoegang voor gasten, en het hotel ligt op loopafstand van zowel het Fort-strand als het beginpunt van het Arrábida-wandelnetwerk.`,
    hotelIt: `Hotel do Mar e una struttura 4 stelle in cima alla scogliera con animali benvenuti con una tariffa moderata. La posizione rialzata sulla baia cattura la brezza atlantica e offre viste sul parco dell'Arrabida. Accesso alla piscina per gli ospiti, e l'hotel e a distanza a piedi sia dalla spiaggia del Forte sia dall'inizio della rete di sentieri dell'Arrabida.`,
  },
]
...
const COPY = {
  ...
  nl: {
    eyebrow: 'HUISDIERVRIENDELIJKE ZOMER · KOEL PORTUGAL',
    title: `Koel Portugal met je hond in de zomer: 8 bestemmingen onder 25C`,
    intro: `Er zijn twee Portugals in augustus. De Algarve en het binnenland van de Alentejo halen 35C of meer, met asfalt tot 55C en een reëel risico op hitteberoerte voor elke kortsnuitige of oudere hond. Maar het noorden (Minho, Douro), de Atlantische kust van Peniche tot Sesimbra en het gebergte van de Serra da Estrela blijven betrouwbaar onder 25C, gekoeld door de Nortada-wind die elke middag vanaf de Atlantische Oceaan opsteekt. Als je weet waar je heen moet, is Portugal in augustus een van de fijnste reisbestemmingen voor honden in Zuid-Europa.`,
    pickHeading: 'De acht koele keuzes (van koelst naar warmst)',
    whyHere: 'Waarom hier',
    hotelLabel: 'Waar je kunt overnachten',
    seeDestCta: 'Volledige stadsgids →',
    hotelCta: 'Beschikbaarheid bekijken →',
    augustLabel: 'Gem. max aug.',
    practicalHeading: 'Praktische gids: Portugal met je hond in augustus',
    practical: [
      { h: 'De twee Portugals in de zomer', p: `De Algarve (Faro, Lagos, Albufeira) en het binnenland van de Alentejo halen in augustus regelmatig 35-40C. De asfaltoppervlaktetemperatuur overschrijdt 55C. Dat is in augustus geen hondvriendelijke omgeving. Het noorden (Porto, Viana do Castelo, Ponte de Lima, Guimarães) blijft dankzij de Nortada onder 25C. De Atlantische kust (Peniche, Sesimbra) wordt gekoeld door Atlantische opwelling. De bergen van de Serra da Estrela zijn op hoogte echt alpien. Plan je route: doorkruis Portugal indien nodig van noord naar zuid, maar vermijd in augustus stops ten zuiden van Lissabon, tenzij je dicht bij de kust blijft.` },
      { h: 'Honden op Portugese stranden in augustus', p: `Portugal verbiedt honden tussen juni en september op de meeste zwemstranden (de aanduiding Praia Canina markeert de uitzonderingen). In de praktijk hebben veel stranden aan één kant een voor honden toegankelijk deel buiten de hoofdzwemzone. De stranden in deze gids (Afife, Baleal, Matosinhos, Costa Nova) hebben sinds 2025 bevestigde hondenzones. Controleer altijd bij de lokale camara municipal voor je vertrekt, want de regels veranderen jaarlijks. Vóór 9u en na 19u wordt er zelfs op stranden zonder Praia Canina-aanduiding nauwelijks gehandhaafd.` },
      { h: 'De pastelaria-cafécultuur en honden', p: `Portugal heeft een van de meest hondvriendelijke cafécultuurs van Zuid-Europa. Pastelarias (banketbakkerscafés) laten aan de buitentafels vrijwel altijd goed opgevoede honden toe, en veel zaken in het noorden dulden op rustige uren ook aangelijnde honden binnen. Universiteitssteden (Porto, Aveiro) zijn extra ontspannen. De uitzondering is het toeristische centrum van Lissabon, waar terrasregels streng gehandhaafd worden. In het noorden is het volkomen normaal om een galao te bestellen en buiten te zitten met je hond.` },
      { h: 'Quintas en plattelandstoerisme (TER-netwerk)', p: `Het Portugese netwerk Turismo em Espaço Rural (TER) is een van de beste van Europa voor hondenbezitters. Landelijke quintas, solares (herenhuizen) en casas de campo accepteren vrijwel altijd honden zonder toeslag. Ze bieden privétuinen, dichtbijgelegen toegang tot rivier of bos, en eigenaars die meestal zelf ook honden houden. De prijzen liggen 30-50% onder vergelijkbare stadshotels. De regio's Minho, Douro en Beira Interior hebben de hoogste dichtheid aan kwaliteitsvolle TER-adressen. Boek rechtstreeks bij het adres: boekingsplatforms tonen voor TER-accommodaties vaak een onjuist huisdierenbeleid.` },
    ],
    faqHeading: 'Veelgestelde vragen',
    faqs: [
      { q: 'Is Porto in augustus echt koel genoeg voor een hond?', a: `Porto zit in augustus gemiddeld op 24C, maar de Nortada-wind in de middag laat de gevoelstemperatuur tussen 15u en 20u regelmatig zakken naar 18-20C. Voor kortsnuitige rassen (bulldogs, mopshonden, boxers, Franse bulldogs) is Porto haalbaar, maar Serra da Estrela (18C) of Viana do Castelo (22C) zijn aanzienlijk veiliger. Laat je platsnuitige hond in Porto alleen 's ochtends voor 10u en 's avonds na 19u uit, en gebruik het schaduwrijke Parque da Cidade in plaats van de open Ribeira tijdens de piekhitte. Voor kortsnuitige honden zijn de bergkeuzes altijd de veiligste optie.` },
      { q: 'Kan ik met de auto van Spanje naar Noord-Portugal rijden met een hond?', a: `Ja, de grensovergang bij Vigo naar Portugal is eenvoudig: de A55/E01 vanaf Vigo steekt bij Valença de rivier de Lima over, geen grenscontrole nodig binnen het Schengengebied. Vanuit Madrid bereikt de hogesnelheidstrein Ouigo Porto in ongeveer 3,5 uur (honden tot 10kg in een reismand tegen een kleine toeslag toegestaan in de cabine). Met de auto vanaf Sevilla naar Porto reken je 7-8 uur: plan bij augustushitte een stop in het koelere Alentejo-hoogland in plaats van op de kustweg.` },
      { q: 'Welke wijngaarden in de Douro en de Minho zijn hondvriendelijk?', a: `Quinta da Aveleda (Vinho Verde, Penafiel) heeft bevestigd dat honden welkom zijn in het uitgestrekte parkachtige tuin. Quinta do Crasto (Douro Superior) accepteert honden op het buitenterras. Quinta de la Rosa (Pinhão, Douro) accepteert honden in de tuin. Alle drie hebben dit beleid rechtstreeks bevestigd aan bezoekers die met hun hond reisden. In de Vinho Verde-regio rond Ponte de Lima en Braga zijn de meeste quinta-bezoeken buiten en informeel: aankomen met een hond levert zelden problemen op. Bel vooraf tijdens het oogstseizoen (september-oktober), want het beleid kan tijdens drukke periodes strenger worden.` },
      { q: 'Wat is de Nortada en waarom is die belangrijk voor honden?', a: `De Nortada is een koude noord-Atlantische wind die elke zomermiddag over de Portugese Atlantische kust waait, meestal aankomend tussen 14u en 16u en aanhoudend tot zonsondergang. Hij koelt de kust 5-8C af ten opzichte van de temperaturen landinwaarts. In Porto zakt een dag die 's middags 28C haalt tegen 17u naar 20C. In Viana do Castelo en Peniche waait de Nortada constant, waardoor de temperatuur betrouwbaar onder 23C blijft. Voor honden betekent dit dat middagwandelingen op de Atlantische kust echt mogelijk zijn, anders dan in de Algarve. Plan de hoofdwandeling van je hond tussen 17u en 20u om optimaal van de Nortada te profiteren.` },
    ],
    relatedHeading: 'Zie ook',
  },
  it: {
    eyebrow: 'ESTATE PET-FRIENDLY · PORTOGALLO FRESCO',
    title: `Portogallo fresco con il tuo cane in estate: 8 destinazioni sotto i 25C`,
    intro: `Ci sono due Portogalli ad agosto. L'Algarve e l'interno dell'Alentejo toccano i 35C o più, con l'asfalto a 55C e un rischio reale di colpo di calore per qualsiasi cane brachicefalo o anziano. Ma il nord (Minho, Douro), la costa atlantica da Peniche a Sesimbra e la catena della Serra da Estrela restano affidabilmente sotto i 25C, rinfrescati dal vento Nortada che arriva ogni pomeriggio dall'Atlantico. Se sai dove andare, il Portogallo ad agosto e una delle migliori destinazioni per viaggiare con il cane nel sud Europa.`,
    pickHeading: 'Le otto scelte fresche (dalla più fresca alla più calda)',
    whyHere: 'Perché qui',
    hotelLabel: 'Dove dormire',
    seeDestCta: 'Guida completa della città →',
    hotelCta: 'Vedi disponibilità →',
    augustLabel: 'Media max ago.',
    practicalHeading: 'Guida pratica: il Portogallo con il tuo cane ad agosto',
    practical: [
      { h: 'I due Portogalli in estate', p: `L'Algarve (Faro, Lagos, Albufeira) e l'interno dell'Alentejo toccano regolarmente i 35-40C ad agosto. La temperatura superficiale dell'asfalto supera i 55C. Non e un ambiente pet-friendly ad agosto. Il nord (Porto, Viana do Castelo, Ponte de Lima, Guimaraes) resta sotto i 25C grazie al Nortada. La costa atlantica (Peniche, Sesimbra) e rinfrescata dalla risalita atlantica. Le montagne della Serra da Estrela sono davvero alpine in quota. Pianifica il tuo percorso: attraversa il Portogallo da nord a sud se necessario, ma evita di fermarti a sud di Lisbona ad agosto a meno che tu non sia vicino alla costa.` },
      { h: 'Cani sulle spiagge portoghesi ad agosto', p: `Il Portogallo vieta i cani sulla maggior parte delle spiagge balneabili da giugno a settembre (la designazione Praia Canina segnala le eccezioni). In pratica, molte spiagge hanno una sezione accessibile ai cani a un'estremità, fuori dalla zona balneare principale segnalata. Le spiagge citate in questa guida (Afife, Baleal, Matosinhos, Costa Nova) hanno zone cani confermate a partire dal 2025. Verifica sempre con la camara municipal locale prima di partire, poiché le regole cambiano ogni anno. Prima delle 9 e dopo le 19, i controlli sono minimi anche sulle spiagge senza designazione Praia Canina.` },
      { h: 'La cultura della pastelaria e i cani', p: `Il Portogallo ha una delle culture del caffè più tolleranti verso i cani del sud Europa. Le pastelarias (caffè-pasticcerie) ammettono quasi universalmente cani ben educati ai tavoli esterni, e molte al nord tollerano cani al guinzaglio anche all'interno nelle ore tranquille. Le città universitarie (Porto, Aveiro) sono particolarmente rilassate. L'eccezione e il nucleo turistico di Lisbona, dove le regole dei terrazzi sono applicate rigidamente. Al nord, ordinare un galao e sedersi fuori con il proprio cane e del tutto normale.` },
      { h: 'Quintas e turismo rurale (rete TER)', p: `La rete portoghese Turismo em Espaco Rural (TER) e una delle migliori d'Europa per i proprietari di cani. Le quintas rurali, i solares (dimore signorili) e le casas de campo accettano quasi universalmente cani senza sovrapprezzo. Offrono giardini privati, accesso vicino a fiumi o boschi, e proprietari che di solito hanno cani a loro volta. I prezzi sono del 30-50% inferiori agli hotel cittadini equivalenti. Le regioni di Minho, Douro e Beira Interior hanno la maggiore densità di proprieta TER di qualità. Prenota direttamente con la struttura: le piattaforme di prenotazione spesso mostrano politiche sugli animali errate per gli alloggi TER.` },
    ],
    faqHeading: 'Domande frequenti',
    faqs: [
      { q: 'Porto e davvero abbastanza fresca per un cane ad agosto?', a: `Porto ha una media di 24C ad agosto ma il vento pomeridiano Nortada fa scendere regolarmente la temperatura percepita a 18-20C tra le 15 e le 20. Per le razze brachicefale (bulldog, carlini, boxer, bulldog francesi), Porto e gestibile ma la Serra da Estrela (18C) o Viana do Castelo (22C) sono significativamente più sicure. Porta il tuo cane dal muso corto a passeggio solo al mattino prima delle 10 e alla sera dopo le 19 a Porto, e usa il Parque da Cidade con la sua ombra invece della Ribeira esposta nel picco del caldo. Per i brachicefali, le scelte di montagna sono sempre la soluzione più sicura.` },
      { q: 'Posso guidare dalla Spagna al nord del Portogallo con un cane?', a: `Si, l'attraversamento da Vigo verso il Portogallo e semplice: l'A55/E01 da Vigo attraversa a Valenca sul fiume Lima, senza controllo di frontiera richiesto all'interno dell'area Schengen. Da Madrid, il treno ad alta velocità Ouigo raggiunge Porto in circa 3,5 ore (cani fino a 10kg in trasportino accettati in cabina con un piccolo supplemento). In auto da Siviglia a Porto ci vogliono 7-8 ore: pianifica una sosta negli altopiani più freschi dell'Alentejo se viaggi con il caldo di agosto, non sulla strada costiera.` },
      { q: 'Quali vigneti nel Douro e nel Minho sono pet-friendly?', a: `Quinta da Aveleda (Vinho Verde, Penafiel) ha confermato che i cani sono benvenuti nell'ampio parco-giardino. Quinta do Crasto (Douro Superior) accetta cani nell'area del terrazzo esterno. Quinta de la Rosa (Pinhao, Douro) accetta cani in giardino. Tutte e tre hanno confermato questa politica direttamente a visitatori che viaggiavano con il cane. Nella regione del Vinho Verde intorno a Ponte de Lima e Braga, la maggior parte delle visite alle quintas sono all'aperto e informali: arrivare con un cane raramente crea problemi. Chiama in anticipo durante la vendemmia (settembre-ottobre) poiché la politica potrebbe essere più rigida nei periodi di maggiore affluenza.` },
      { q: `Cos'e il Nortada e perché e importante per i cani?`, a: `Il Nortada e un vento freddo nord-atlantico che percorre la costa atlantica portoghese ogni pomeriggio d'estate, arrivando tipicamente tra le 14 e le 16 e durando fino al tramonto. Rinfresca la costa di 5-8C sotto le temperature dell'entroterra. A Porto, una giornata che tocca i 28C a mezzogiorno scende a 20C entro le 17. A Viana do Castelo e Peniche, il Nortada e costante, mantenendo le temperature affidabilmente sotto i 23C. Per i cani, questo significa che le passeggiate pomeridiane sono davvero possibili sulla costa atlantica in un modo che non lo sono in Algarve. Pianifica la passeggiata principale del tuo cane tra le 17 e le 20 per beneficiare a pieno dell'effetto Nortada.` },
    ],
...
export default async function Page({
  ...
  const pickWhy = (p: Pick) => {
    ...
    if (locale === 'nl') return p.whyNl
    if (locale === 'it') return p.whyIt
    return p.whyEn
  }
  const pickHotel = (p: Pick) => {
    ...
    if (locale === 'nl') return p.hotelNl
    if (locale === 'it') return p.hotelIt
    return p.hotelEn
  }
