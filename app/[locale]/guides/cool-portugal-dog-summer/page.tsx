...
const PICKS: Pick[] = [
  {
    ...
    whyIt: `La catena montuosa più alta del Portogallo, con una vetta a 1993m raggiungibile in auto tramite la strada della Torre insieme al tuo cane. La razza Cão da Serra da Estrela è originaria di qui, quindi la cultura locale è profondamente amica dei cani: le quintas accolgono i cani senza eccezioni e senza sovrapprezzo. Intorno alla vetta della Torre esistono zone designate senza guinzaglio. Questa è la destinazione più fresca di tutto il Portogallo continentale ad agosto, davvero adatta anche alle razze brachicefale che altrove nel paese soffrirebbero.`,
    ...
    hotelIt: `L'Hotel Serra da Estrela a Manteigas è un lodge di montagna che accoglie esplicitamente i cani. Situato nella valle a 760m di altitudine, le temperature restano intorno ai 18-20C anche a metà agosto. L'hotel fornisce ciotola e cuccia su richiesta, e i sentieri circostanti si percorrono con il cane al guinzaglio direttamente dalla struttura.`,
  },
  {
  ...
  },
  {
    ...
    whyIt: `Penisola atlantica mantenuta sotto i 23C dal vento oceanico costante da entrambi i lati. La passeggiata al faro di Cabo Carvoeiro è uno dei migliori sentieri costieri del Portogallo per cani, proprio sul bordo della scogliera: esposto, ventoso e spettacolarmente fresco anche ad agosto. La spiaggia di Baleal a nord della città non ha divieto stagionale per i cani. La cultura del villaggio dei surfisti è universalmente tollerante verso gli animali in caffè, negozi di tavole e terrazzi. Il traghetto per l'isola di Berlenga non ammette cani, ma l'isola si vede dalla passeggiata del faro.`,
    ...
    hotelIt: `Hotel Praia Norte è una struttura 3 stelle sul mare con cani benvenuti con un supplemento modesto. Accesso diretto alla spiaggia, l'hotel si trova sul lato nord della penisola che cattura più brezza atlantica. Semplice, pratico e davvero pensato per vacanzieri attivi che arrivano con il cane.`,
  },
  {
    slug: 'ponte-de-lima',
    name: 'Ponte de Lima',
    ...
    whyIt: `Il comune più antico del Portogallo, con un ponte romano sul fiume Lima che puoi attraversare con il tuo cane al guinzaglio. La terra del vinho verde significa ombra abbondante dei vigneti lungo le passeggiate fluviali. Il Parque do Arnado è una zona senza guinzaglio proprio sul fiume nel centro cittadino. Le quintas rurali della rete TER (Turismo em Espaço Rural) accolgono tutte i cani gratuitamente, spesso con giardini privati. Le temperature sono mitigate dal microclima della valle e dalla nebbia mattutina del fiume.`,
    ...
    hotelIt: `Solar do Bertiandos è una tenuta rurale con ampi giardini dove i cani sono liberamente benvenuti senza supplemento. La proprietà si trova nella valle del Lima con accesso diretto alle passeggiate fluviali. Una quinta attiva nella zona del vinho verde: l'aria fresca della sera arriva dal fiume e dai vigneti, rendendo confortevoli anche le notti più calde di agosto.`,
  },
  {
    slug: 'aveiro',
    name: 'Aveiro',
    ...
    hotelIt: `Aveiro Palace Hotel è una struttura centrale 4 stelle con animali benvenuti. L'hotel dista 5 minuti a piedi dal canale principale, e le passeggiate a livello del canale sono direttamente accessibili. Una base affidabile per esplorare sia i canali della città sia il litorale di Costa Nova per il momento spiaggia del tuo cane.`,
  },
  {
    slug: 'guimaraes',
    name: 'Guimaraes',
    ...
    hotelIt: `La Pousada de Guimarães è una pousada 5 stelle nel convento riconvertito di Santa Marinha, uno degli hotel più significativi dal punto di vista storico del Portogallo. Cani accettati su richiesta: chiama in anticipo per confermare, poiché la politica richiede una preautorizzazione. Il giardino del chiostro è uno spazio tranquillo dove il tuo cane può rilassarsi dopo una giornata sui sentieri del castello.`,
  },
  {
    slug: 'porto',
    name: 'Porto',
  ...
  },
  {
    ...
    whyIt: `Villaggio di pescatori a 40km a sud di Lisbona sull'Atlantico, riparato dalla Serra da Arrábida e rinfrescato dalla fredda corrente atlantica di risalita. I sentieri del Parco Naturale dell'Arrábida sopra il villaggio accettano cani al guinzaglio sui percorsi segnalati. La spiaggia del Forte davanti al villaggio ammette cani fuori dalla zona balneare principale. I ristoranti dei pescatori locali di solito ammettono cani sui terrazzi, una tolleranza inusuale così vicino a Lisbona. La temperatura dell'acqua atlantica qui è di 18-20C ad agosto, quindi il tuo cane può davvero nuotare senza surriscaldarsi.`,
    ...
    hotelIt: `Hotel do Mar è una struttura 4 stelle in cima alla scogliera con animali benvenuti con una tariffa moderata. La posizione rialzata sulla baia cattura la brezza atlantica e offre viste sul parco dell'Arrábida. Accesso alla piscina per gli ospiti, e l'hotel è a distanza a piedi sia dalla spiaggia del Forte sia dall'inizio della rete di sentieri dell'Arrábida.`,
  },
]
...
const COPY = {
  ...
  it: {
    ...
    practical: [
      { h: 'I due Portogalli in estate', p: `L'Algarve (Faro, Lagos, Albufeira) e l'interno dell'Alentejo toccano regolarmente i 35-40C ad agosto. La temperatura superficiale dell'asfalto supera i 55C. Non è un ambiente pet-friendly ad agosto. Il nord (Porto, Viana do Castelo, Ponte de Lima, Guimarães) resta sotto i 25C grazie al Nortada. La costa atlantica (Peniche, Sesimbra) è rinfrescata dalla risalita atlantica. Le montagne della Serra da Estrela sono davvero alpine in quota. Pianifica il tuo percorso: attraversa il Portogallo da nord a sud se necessario, ma evita di fermarti a sud di Lisbona ad agosto a meno che tu non sia vicino alla costa.` },
      ...
      { h: 'La cultura della pastelaria e i cani', p: `Il Portogallo ha una delle culture del caffè più tolleranti verso i cani del sud Europa. Le pastelarias (caffè-pasticcerie) ammettono quasi universalmente cani ben educati ai tavoli esterni, e molte al nord tollerano cani al guinzaglio anche all'interno nelle ore tranquille. Le città universitarie (Porto, Aveiro) sono particolarmente rilassate. L'eccezione è il nucleo turistico di Lisbona, dove le regole dei terrazzi sono applicate rigidamente. Al nord, ordinare un galao e sedersi fuori con il proprio cane è del tutto normale.` },
      { h: 'Quintas e turismo rurale (rete TER)', p: `La rete portoghese Turismo em Espaço Rural (TER) è una delle migliori d'Europa per i proprietari di cani. Le quintas rurali, i solares (dimore signorili) e le casas de campo accettano quasi universalmente cani senza sovrapprezzo. Offrono giardini privati, accesso vicino a fiumi o boschi, e proprietari che di solito hanno cani a loro volta. I prezzi sono del 30-50% inferiori agli hotel cittadini equivalenti. Le regioni di Minho, Douro e Beira Interior hanno la maggiore densità di proprietà TER di qualità. Prenota direttamente con la struttura: le piattaforme di prenotazione spesso mostrano politiche sugli animali errate per gli alloggi TER.` },
    ],
    faqHeading: 'Domande frequenti',
    faqs: [
      { q: 'Porto è davvero abbastanza fresca per un cane ad agosto?', a: `Porto ha una media di 24C ad agosto ma il vento pomeridiano Nortada fa scendere regolarmente la temperatura percepita a 18-20C tra le 15 e le 20. Per le razze brachicefale (bulldog, carlini, boxer, bulldog francesi), Porto è gestibile ma la Serra da Estrela (18C) o Viana do Castelo (22C) sono significativamente più sicure. Porta il tuo cane dal muso corto a passeggio solo al mattino prima delle 10 e alla sera dopo le 19 a Porto, e usa il Parque da Cidade con la sua ombra invece della Ribeira esposta nel picco del caldo. Per i brachicefali, le scelte di montagna sono sempre la soluzione più sicura.` },
      { q: 'Posso guidare dalla Spagna al nord del Portogallo con un cane?', a: `Sì, l'attraversamento da Vigo verso il Portogallo è semplice: l'A55/E01 da Vigo attraversa a Valença sul fiume Lima, senza controllo di frontiera richiesto all'interno dell'area Schengen. Da Madrid, il treno ad alta velocità Ouigo raggiunge Porto in circa 3,5 ore (cani fino a 10kg in trasportino accettati in cabina con un piccolo supplemento). In auto da Siviglia a Porto ci vogliono 7-8 ore: pianifica una sosta negli altopiani più freschi dell'Alentejo se viaggi con il caldo di agosto, non sulla strada costiera.` },
      { q: 'Quali vigneti nel Douro e nel Minho sono pet-friendly?', a: `Quinta da Aveleda (Vinho Verde, Penafiel) ha confermato che i cani sono benvenuti nell'ampio parco-giardino. Quinta do Crasto (Douro Superior) accetta cani nell'area del terrazzo esterno. Quinta de la Rosa (Pinhão, Douro) accetta cani in giardino. Tutte e tre hanno confermato questa politica direttamente a visitatori che viaggiavano con il cane. Nella regione del Vinho Verde intorno a Ponte de Lima e Braga, la maggior parte delle visite alle quintas sono all'aperto e informali: arrivare con un cane raramente crea problemi. Chiama in anticipo durante la vendemmia (settembre-ottobre) poiché la politica potrebbe essere più rigida nei periodi di maggiore affluenza.` },
      { q: `Cos'è il Nortada e perché è importante per i cani?`, a: `Il Nortada è un vento freddo nord-atlantico che percorre la costa atlantica portoghese ogni pomeriggio d'estate, arrivando tipicamente tra le 14 e le 16 e durando fino al tramonto. Rinfresca la costa di 5-8C sotto le temperature dell'entroterra. A Porto, una giornata che tocca i 28C a mezzogiorno scende a 20C entro le 17. A Viana do Castelo e Peniche, il Nortada è costante, mantenendo le temperature affidabilmente sotto i 23C. Per i cani, questo significa che le passeggiate pomeridiane sono davvero possibili sulla costa atlantica in un modo che non lo sono in Algarve. Pianifica la passeggiata principale del tuo cane tra le 17 e le 20 per beneficiare a pieno dell'effetto Nortada.` },
    ],
