...
const PICKS: Pick[] = [
  {
    ...
    whyIt: `La catena montuosa piu alta del Portogallo, con una vetta a 1993m raggiungibile in auto tramite la strada della Torre insieme al tuo cane. La razza Cao da Serra da Estrela e originaria di qui, quindi la cultura locale e profondamente amica dei cani: le quintas accolgono i cani senza eccezioni e senza sovrapprezzo. Intorno alla vetta della Torre esistono zone designate senza guinzaglio. Questa e la destinazione piu fresca di tutto il Portogallo continentale ad agosto, davvero adatta anche alle razze brachicefale che altrove nel paese soffrirebbero.`,
  ...
  },
  {
    ...
    hotelIt: `Hotel Praia Norte e una struttura 3 stelle sul mare con cani benvenuti con un supplemento modesto. Accesso diretto alla spiaggia, l'hotel si trova sul lato nord della penisola che cattura piu brezza atlantica. Semplice, pratico e davvero pensato per vacanzieri attivi che arrivano con il cane.`,
  },
  {
    slug: 'ponte-de-lima',
    name: 'Ponte de Lima',
    ...
    whyIt: `Il comune piu antico del Portogallo, con un ponte romano sul fiume Lima che puoi attraversare con il tuo cane al guinzaglio. La terra del vinho verde significa ombra abbondante dei vigneti lungo le passeggiate fluviali. Il Parque do Arnado e una zona senza guinzaglio proprio sul fiume nel centro cittadino. Le quintas rurali della rete TER (Turismo em Espaco Rural) accolgono tutte i cani gratuitamente, spesso con giardini privati. Le temperature sono mitigate dal microclima della valle e dalla nebbia mattutina del fiume.`,
    ...
    hotelIt: `Solar do Bertiandos e una tenuta rurale con ampi giardini dove i cani sono liberamente benvenuti senza supplemento. La proprieta si trova nella valle del Lima con accesso diretto alle passeggiate fluviali. Una quinta attiva nella zona del vinho verde: l'aria fresca della sera arriva dal fiume e dai vigneti, rendendo confortevoli anche le notti piu calde di agosto.`,
  },
  {
    slug: 'aveiro',
    name: 'Aveiro',
    ...
    whyIt: `La Venezia portoghese, con alzaie piatte che rendono facile passeggiare con il cane con qualsiasi tempo. I tour in barca moliceiro non ammettono cani, ma la rete di canali offre diversi chilometri di alzaie ombreggiate a livello dell'acqua che restano notevolmente piu fresche del livello strada. La spiaggia di Costa Nova, 10km a ovest, ha una sezione accessibile ai cani fuori dalla zona balneare principale. La cultura della citta universitaria e molto tollerante verso i cani nei caffe con terrazzo tutto l'anno.`,
  ...
  },
  {
    ...
    whyIt: `Culla del Portogallo patrimonio mondiale dell'UNESCO. La passeggiata sulla collina del castello accetta cani al guinzaglio e offre viste su tutta la regione del Minho. Il quartiere culturale di Couros ha diversi caffe con terrazzo che ammettono i cani all'esterno. Il Parque da Cidade sul bordo sud ha ampi prati amici dei cani con molta ombra. Le stradine strette e lastricate del centro medievale restano notevolmente piu fresche delle piazze aperte, e nel pomeriggio la copertura nuvolosa atlantica mantiene sopportabili le temperature di agosto.`,
    ...
    hotelIt: `La Pousada de Guimaraes e una pousada 5 stelle nel convento riconvertito di Santa Marinha, uno degli hotel piu significativi dal punto di vista storico del Portogallo. Cani accettati su richiesta: chiama in anticipo per confermare, poiche la politica richiede una preautorizzazione. Il giardino del chiostro e uno spazio tranquillo dove il tuo cane puo rilassarsi dopo una giornata sui sentieri del castello.`,
  },
  {
    slug: 'porto',
    name: 'Porto',
    ...
    whyIt: `Il vento Nortada e piu forte a Porto ad agosto, abbassando in modo affidabile le temperature pomeridiane di 5-8C rispetto a quanto indica il termometro. Il Parque da Cidade si estende su 83 ettari con una zona dedicata senza guinzaglio, rendendolo uno dei piu grandi parchi urbani d'Europa per cani. La spiaggia di Matosinhos a nord della citta ha una sezione accessibile ai cani aperta ad agosto. I ristoranti con terrazzo della Ribeira sono flessibili con i cani ben educati al guinzaglio, e le visite alle cantine a Vila Nova de Gaia ammettono cani nelle aree esterne di Quinta do Crasto e Quinta de la Rosa.`,
...
const COPY = {
  ...
  it: {
    ...
    practical: [
      ...
      { h: 'Cani sulle spiagge portoghesi ad agosto', p: `Il Portogallo vieta i cani sulla maggior parte delle spiagge balneabili da giugno a settembre (la designazione Praia Canina segnala le eccezioni). In pratica, molte spiagge hanno una sezione accessibile ai cani a un'estremita, fuori dalla zona balneare principale segnalata. Le spiagge citate in questa guida (Afife, Baleal, Matosinhos, Costa Nova) hanno zone cani confermate a partire dal 2025. Verifica sempre con la camara municipal locale prima di partire, poiche le regole cambiano ogni anno. Prima delle 9 e dopo le 19, i controlli sono minimi anche sulle spiagge senza designazione Praia Canina.` },
      { h: 'La cultura della pastelaria e i cani', p: `Il Portogallo ha una delle culture del caffe piu tolleranti verso i cani del sud Europa. Le pastelarias (caffe-pasticcerie) ammettono quasi universalmente cani ben educati ai tavoli esterni, e molte al nord tollerano cani al guinzaglio anche all'interno nelle ore tranquille. Le citta universitarie (Porto, Aveiro) sono particolarmente rilassate. L'eccezione e il nucleo turistico di Lisbona, dove le regole dei terrazzi sono applicate rigidamente. Al nord, ordinare un galao e sedersi fuori con il proprio cane e del tutto normale.` },
      { h: 'Quintas e turismo rurale (rete TER)', p: `La rete portoghese Turismo em Espaco Rural (TER) e una delle migliori d'Europa per i proprietari di cani. Le quintas rurali, i solares (dimore signorili) e le casas de campo accettano quasi universalmente cani senza sovrapprezzo. Offrono giardini privati, accesso vicino a fiumi o boschi, e proprietari che di solito hanno cani a loro volta. I prezzi sono del 30-50% inferiori agli hotel cittadini equivalenti. Le regioni di Minho, Douro e Beira Interior hanno la maggiore densita di proprieta TER di qualita. Prenota direttamente con la struttura: le piattaforme di prenotazione spesso mostrano politiche sugli animali errate per gli alloggi TER.` },
    ],
    faqHeading: 'Domande frequenti',
    faqs: [
      { q: 'Porto e davvero abbastanza fresca per un cane ad agosto?', a: `Porto ha una media di 24C ad agosto ma il vento pomeridiano Nortada fa scendere regolarmente la temperatura percepita a 18-20C tra le 15 e le 20. Per le razze brachicefale (bulldog, carlini, boxer, bulldog francesi), Porto e gestibile ma la Serra da Estrela (18C) o Viana do Castelo (22C) sono significativamente piu sicure. Porta il tuo cane dal muso corto a passeggio solo al mattino prima delle 10 e alla sera dopo le 19 a Porto, e usa il Parque da Cidade con la sua ombra invece della Ribeira esposta nel picco del caldo. Per i brachicefali, le scelte di montagna sono sempre la soluzione piu sicura.` },
      { q: 'Posso guidare dalla Spagna al nord del Portogallo con un cane?', a: `Si, l'attraversamento da Vigo verso il Portogallo e semplice: l'A55/E01 da Vigo attraversa a Valenca sul fiume Lima, senza controllo di frontiera richiesto all'interno dell'area Schengen. Da Madrid, il treno ad alta velocita Ouigo raggiunge Porto in circa 3,5 ore (cani fino a 10kg in trasportino accettati in cabina con un piccolo supplemento). In auto da Siviglia a Porto ci vogliono 7-8 ore: pianifica una sosta negli altopiani piu freschi dell'Alentejo se viaggi con il caldo di agosto, non sulla strada costiera.` },
      { q: 'Quali vigneti nel Douro e nel Minho sono pet-friendly?', a: `Quinta da Aveleda (Vinho Verde, Penafiel) ha confermato che i cani sono benvenuti nell'ampio parco-giardino. Quinta do Crasto (Douro Superior) accetta cani nell'area del terrazzo esterno. Quinta de la Rosa (Pinhao, Douro) accetta cani in giardino. Tutte e tre hanno confermato questa politica direttamente a visitatori che viaggiavano con il cane. Nella regione del Vinho Verde intorno a Ponte de Lima e Braga, la maggior parte delle visite alle quintas sono all'aperto e informali: arrivare con un cane raramente crea problemi. Chiama in anticipo durante la vendemmia (settembre-ottobre) poiche la politica potrebbe essere piu rigida nei periodi di maggiore affluenza.` },
      { q: `Cos'e il Nortada e perche e importante per i cani?`, a: `Il Nortada e un vento freddo nord-atlantico che percorre la costa atlantica portoghese ogni pomeriggio d'estate, arrivando tipicamente tra le 14 e le 16 e durando fino al tramonto. Rinfresca la costa di 5-8C sotto le temperature dell'entroterra. A Porto, una giornata che tocca i 28C a mezzogiorno scende a 20C entro le 17. A Viana do Castelo e Peniche, il Nortada e costante, mantenendo le temperature affidabilmente sotto i 23C. Per i cani, questo significa che le passeggiate pomeridiane sono davvero possibili sulla costa atlantica in un modo che non lo sono in Algarve. Pianifica la passeggiata principale del tuo cane tra le 17 e le 20 per beneficiare a pieno dell'effetto Nortada.` },
    ],
