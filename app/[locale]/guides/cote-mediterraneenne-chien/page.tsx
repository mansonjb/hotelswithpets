...
const COPY: Record<string, RouteCopy> = {
  ...
  pt: {
    hero: { tagline: 'Costa Mediterrânea · 10 Dias · Com TU Cão', title: 'Um viaje de comboio pela costa mediterrânea com tu cão', subtitle: 'Niza, Génova, Florencia, Roma — cuatro cidades icónicas na Riviera francesa e italiana, conectadas por comboios directos. Hotéis que admitem animais, praias caninas e o mapa Booking.com em vivo para cada parada.' },
    why: { title: 'Porquê este itinerário mediterrâneo funciona com cão', bullets: [
      'Comboios Thello / Trenitalia directos em todo o recorrido — tu cão viaja a tu lado, no em bodega.',
      'As cuatro cidades têm praias caninas oficiales o zonas de banho para cães a menos de 30 minutos.',
    ...
    cities: {
      nice: { days: 'Dias 1–3', intro: "Empieza na Riviera francesa. Niza é uma das as grandes cidades francesas mais pet-friendly: o elétrico T1 admite cães grátis, os 7 km da Promenade des Anglais se recorren com trela, e tres praias caninas oficiales (Carras, Magnan, Lenval) funcionam o ano inteiro. As callejuelas empedradas do centro histórico e o mercado do Cours Saleya admitem cães com trela. Aviso: as praias de guijarros de Niza são duras para as almohadillas — botines recomendados.", highlight: 'Imprescindible com tu cão: amanecer na Promenade des Anglais', highlightDesc: 'Recorre os 7 km enteros desde o extremo do aeroporto até o Quai des États-Unis a a hora dorada, luego café em cualquier esplanada do Vieux-Nice. A mayoría admite cães com trela e trae bol de água sem pedirlo.' },
      genoa: { days: 'Dias 4–5', intro: "Tres horas em Thello pela costa ligur. Génova é a cidade italiana pet-friendly mais infravalorada: o centro histórico medieval mais GRANDE de Europa (carruggi), a Spianata Castelletto com vistas panorámicas, e comboios directos a pueblos com praia canina como Bogliasco e Camogli. O centro histórico de ruelas estreitos é peatonal por defecto — perfeito com cão.", highlight: 'Imprescindible com tu cão: excursión a Cinque Terre', highlightDesc: 'Trenitalia desde Génova-Brignole chega a Monterosso en 1h20 — cães com trela a mitad de preço. Os cinco pueblos têm passeios costeros (fuera de temporada; veto de praia 15 maio–30 setembro).' },
      florence: { days: 'Dias 6–8', intro: "Frecciarossa directo desde Génova-Piazza-Principe (3h, bilhete canino ~20 €). Florencia é lo bastante pequena para recorrerla entera a pé com cão, e a cultura café italiana te deja comer em cualquier sitio — mesmo restaurantes com estrella admitem cães com trela em esplanada. O parque das Cascine (160 ha junto al Arno) tem zonas sem trela; os Jardins de Boboli admitem cães com trela com a entrada normal. Evita os Uffizi e a Accademia (sem animales).", highlight: 'Imprescindible com tu cão: Piazzale Michelangelo al atardecer', highlightDesc: 'Sube desde o Ponte alle Grazie (a ruta pet-friendly por Costa San Giorgio dura 25 min) para a vista postal do Duomo. A esplanada se mantiene fresca até tarde e os cães corren pelos céspedes sob a balaustrada.' },
      rome: { days: 'Dias 9–10', intro: "Frecciarossa desde Florencia en 1h30 (o tramo mais rápido). Roma é enorme e dura em pleno verão, mas primavera e outono são espectaculares: a Villa Borghese (80 ha) e a Appia Antica (3.500 ha de vías romanas) admitem cães com trela. A maioria de trattorie e cafés admitem cães em mesas exteriores. O metro exige trela e bozal; o elétrico é mais fácil com cães ansiosos.", highlight: 'Imprescindible com tu cão: a Appia Antica um domingo', highlightDesc: 'Os domingos, os primeros 5 km da antiga vía romana são peatonales. Alquila uma bici eléctrica pet-friendly em Bar Caffè dell\'Appia e haz 10 km de pinos piñoneros, ruinas e ovejas pastando. Aos cães les encanta.' },
    },
    ...
    practicalBullets: [
      'Passaporte europeu com vacunación antirrábica vigente (21+ dias, menos de 12 meses para a dosis anual).',
      'Microchip ISO 11784/11785 — obrigatório e debe coincidir com o número do passaporte.',
      'NO se exige tratamento contra a equinococose (só Reino Unido / Irlanda / Finlândia / Noruega / Malta).',
    ...
    faqTitle: 'Preguntas frecuentes',
    faqs: [
      { q: '¿Pode mi cão banhar-se na praia?', a: 'Em Italia, a maioria de praias proíbem cães do 15 maio ao 10 setembro salvo Spiagge Cani oficiales. Niza tem 3 praias caninas o ano inteiro. A costa ligur em torno a Génova tem varias. Florencia e Roma são interiores — ver info práctica para as opções mais cercanas.' },
      { q: '¿Cuánto cuesta o viaje?', a: 'Presupuesta 1.000–2.200 € segundo categoría de hotel. Os bilhetes de comboio suman ~350–550 € para 2 adultos + 1 cão si se reservan com 4-6 semanas. O cargo por animal va de 0 a 50 € por parada.' },
      { q: '¿Cuál é a MELHOR época?', a: 'Maio, junho, setembro e principios de outubro são ideales: 18–26 °C, sem problemas de prohibición de praia fuera de temporada alta, e hotéis disponibles. Julho-agosto são duros com cão (calor + restricciones de praia).' },
      { q: '¿É pet-friendly o metro?', a: 'Florencia no tem metro. O elétrico T1 de Niza é o mais pet-friendly. Os metros de Génova e Roma exigen trela + bozal para cães medianos/grandes. Lleva um bozal flexible.' },
      { q: '¿Puedo añadir Nápoles o a Costa Amalfitana?', a: 'Sí — Frecciarossa Roma → Nápoles en 1h10, admite cães. Os buses SITA da Costa Amalfitana admitem cães com trela. A maioria de pueblos costeros têm restricciones estivales.' },
    ],
  },
}
