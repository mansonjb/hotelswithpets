...
const STICKY_LABELS: Record<string, { label: string; cta: string }> = {
  ...
  it: { label: 'Alternative pet-friendly meno affollate', cta: 'Vedi gli hotel' },
}
...
export async function generateMetadata({
  ...
  const titles: Record<string, string> = {
    ...
    it: `Alternative pet-friendly alle citta europee piu affollate: 8 mete piu tranquille (2026)`,
  }
  const descriptions: Record<string, string> = {
    ...
    it: `Proteste a Barcellona, varchi turistici a Venezia, tetti massimi a Santorini: il movimento anti-overtourism del 2026 e reale. I proprietari di cani hanno un vantaggio nascosto: le citta piu tranquille sono quasi sempre piu pet-friendly. Otto alternative verificate con hotel pet-friendly.`,
  }
  return {
...
const PICKS: Pick[] = [
  {
    ...
    whyIt: `Girona e a 1h a nord di Barcellona in treno (12 EUR), ha la stessa cultura catalana e la stessa atmosfera del quartiere gotico ma riceve 10 volte meno turisti. Il vecchio quartiere ebraico (Call) si gira in un pomeriggio con un cane al guinzaglio, le rive dell'Onyar sono piatte e accessibili ai cani tutto l'anno, e le colline circostanti delle Gavarres iniziano a 15 minuti dal centro con sentieri segnalati a guinzaglio obbligatorio. La citta e stata location per Il Trono di Spade, il che attira visitatori curiosi ma niente a che vedere con i 30 milioni di turisti annui di Barcellona.`,
    ...
    hotelIt: `Hotel Llegendes de Girona Catedral - boutique 4 stelle dentro le mura medievali, cani fino a 15 kg accettati (supplemento modesto), cortile in pietra.`,
  },
  {
    slug: 'treviso',
    name: 'Treviso',
    ...
    whyIt: `Treviso e a 30 minuti di treno da Venezia (4,50 EUR) e viene spesso descritta come "Venezia senza la folla e senza l'odore". Ha le stesse facciate medievali affrescate, canali, pescheria e cultura dell'aperitivo, ma riceve solo una frazione dei 30 milioni di visitatori annui di Venezia. La passeggiata lungo il Sile nel centro e completamente piatta e accoglie i cani al guinzaglio, Piazza dei Signori tollera i cani all'ora dell'aperitivo, e le Colline del Prosecco (UNESCO) iniziano a 20 minuti a nord con sentieri che ammettono cani al guinzaglio.`,
    ...
    hotelIt: `Hotel Continental Treviso - 4 stelle centrale, vista sul fiume, animali accettati (supplemento modesto).`,
  },
  {
    slug: 'olomouc',
    name: 'Olomouc',
    ...
    whyIt: `Olomouc e la seconda citta storica piu grande della Cechia e ha una Colonna della Santissima Trinita patrimonio UNESCO e 6 fontane barocche che rivaleggiano con il centro storico di Praga, ma senza praticamente nessuna folla di turisti. Il parco Bezrucovy sady e uno spazio verde piatto di 10 ettari che accoglie i cani al guinzaglio, i tram accettano i cani al guinzaglio gratis, e la popolazione universitaria della citta significa terrazze animate universalmente pet-friendly. Il prezzo medio degli hotel e il 60% di Praga per una qualita equivalente.`,
    ...
    hotelIt: `Hotel Trinity - boutique 4 stelle di fronte alla Colonna della Santissima Trinita, cani benvenuti (supplemento modesto).`,
  },
  {
    slug: 'sifnos',
    name: 'Sifnos',
    ...
    whyIt: `Sifnos e un'isola delle Cicladi a 3 ore di traghetto da Atene (Pireo) che ha la stessa architettura a cubi bianchi e le stesse viste sull'Egeo di Santorini ma riceve una minima frazione dei suoi 3 milioni di visitatori annui. L'isola e famosa per la sua cucina (patria del grande chef greco Nikolaos Tselementes), ha sentieri pianeggianti tra i villaggi, e la maggior parte delle taverne ammette un cane al guinzaglio a un tavolo all'aperto. I cani possono imbarcarsi sui traghetti Blue Star e Seajets in un trasportino (sotto i 6 kg in cabina, i cani piu grandi sul ponte).`,
    ...
    hotelIt: `Petali Village Hotel ad Apollonia - hotel di paese tradizionale, cani accettati in alcune camere su richiesta.`,
  },
  {
    slug: 'sibiu',
    name: 'Sibiu',
    ...
    whyIt: `Sibiu e la piu bella citta sassone della Transilvania ed ex Capitale Europea della Cultura, che rispetto a Budapest resta genuinamente economica e senza folla. Le tre piazze centrali sono collegate da scale e passaggi medievali del tutto percorribili con un cane al guinzaglio, il Museo all'Aperto Astra a 3 km a sud e un parco di 96 ettari che accoglie i cani al guinzaglio, e la scena gastronomica della citta accetta cani sulle terrazze ovunque. I prezzi sono circa il 50% di Budapest per un alloggio equivalente.`,
    ...
    hotelIt: `Hotel Imparatul Romanilor - grand hotel storico 4 stelle sulla piazza principale, cani benvenuti (supplemento modesto).`,
  },
  {
    slug: 'orvieto',
    name: 'Orvieto',
    ...
    whyIt: `Orvieto sorge su un altopiano di tufo vulcanico a 90 minuti di treno diretto da Roma (10 EUR) e la sua cattedrale gotica e considerata una delle piu belle d'Italia. Il borgo sulla rupe e interamente pedonale, riceve una frazione dei 15 milioni di visitatori annui di Roma, e si visita in mezza giornata con un cane al guinzaglio sul centro storico lastricato. Le colline umbre circostanti sono attraversate da sentieri di tenute vinicole aperti ai cani. Una gita di un giorno da Roma e ideale per le razze brachicefale: arriva prima delle 10, riparti prima delle 14 per evitare il caldo di mezzogiorno.`,
    ...
    hotelIt: `Hotel Maitani - 3 stelle di fronte al duomo, cani accettati (supplemento modesto).`,
  },
  {
    slug: 'provins',
    name: 'Provins',
    ...
    whyIt: `Provins e a 1h15 da Parigi Gare de l'Est in treno (14 EUR) ed e una delle citta medievali meglio conservate di Francia (patrimonio UNESCO), con una citta alta fortificata del XII secolo, mura percorribili con un cane al guinzaglio, e il famoso Jardin des Roses (oltre 2000 varieta, aperto giugno-sett, cani al guinzaglio benvenuti sui sentieri). Riceve gitanti giornalieri ma si svuota completamente entro le 17. Nei fine settimana estivi si tengono spettacoli medievali alla Grange aux Dimes, con i cani tollerati fuori dal perimetro dello spettacolo.`,
    ...
    hotelIt: `Hotel de Provins - 3 stelle appena sotto le mura, cani benvenuti, parcheggio privato.`,
  },
  {
    slug: 'bad-ischl',
    name: 'Bad Ischl',
    ...
    whyIt: `Bad Ischl era l'ex residenza estiva imperiale di Francesco Giuseppe I, si trova a 1 ora da Salisburgo in treno regionale (12 EUR) ed e stata nominata Capitale Europea della Cultura 2024. Il parco della Kaiservilla ammette cani al guinzaglio nel perimetro del giardino, la passeggiata lungo il fiume Traun e piatta e completamente accessibile ai cani, e la regione dei laghi del Salzkammergut inizia direttamente dalla citta. L'affluenza e una frazione di quella di Salisburgo anche in piena estate.`,
    ...
    hotelIt: `Hotel Austria Bad Ischl - tradizionale 4 stelle sull'Esplanade, cani benvenuti (supplemento modesto).`,
  },
]
...
const COPY = {
  ...
  de: {
    eyebrow: 'ANTI-OVERTOURISM 2026 · HAUSTIERREISEN',
    title: `Hundefreundliche Alternativen zu Europas überfülltesten Städten: 8 ruhigere Empfehlungen (2026)`,
    intro: `Proteste in Barcelona, Touristentore in Venedig, Besucherobergrenzen in Santorin: Die Anti-Overtourism-Bewegung von 2026 zwingt Reisende, die großen Ikonen zu überdenken. Hundebesitzer haben hier tatsächlich einen versteckten Vorteil: Hunde sind ohnehin an vielen überfüllten ikonischen Orten verboten (Alhambra, Kolosseum, Akropolis), sodass Sie durch deren Auslassung nichts verlieren. Kleinere und weniger besuchte Städte haben dagegen fast immer mehr hundefreundliche Cafes, ruhigere Straßen und niedrigere Haustiergebühren. Dieser Guide wählt 8 ruhigere europäische Alternativen aus, die ihren berühmten Pendants ebenbürtig sind oder sie übertreffen, für jeden Hundebesitzer, der der Menschenmassen müde ist.`,
    pickHeading: '8 ruhigere Alternativen (mit vergleichbarem Charme)',
    whyHere: 'Warum hier',
    hotelLabel: 'Wo übernachten',
    seeDestCta: 'Vollständiger Stadtführer →',
    hotelCta: 'Verfügbarkeit ansehen →',
    summerLabel: 'Sommer Durchschnittshoch',
    insteadOfLabel: 'Statt',
    practicalHeading: 'Praktischer Leitfaden für Anti-Overtourism-Reisen mit Hund',
    practical: [
      { h: 'Warum Überfüllung mit einem Hund tatsächlich schlimmer ist', p: `Die ikonischen Sehenswürdigkeiten, die die größten Menschenmassen anziehen (Sagrada Familia, Kolosseum, Alhambra, Akropolis), verbieten allesamt Hunde auf ihrem Gelände. Das bedeutet, Sie stehen bereits stundenlang an, um dann Ihren Hund bei einem Fremden oder allein in einem heißen Auto zu lassen. Gehwege in touristisch übersättigten Gebieten sind mit Kinderwagen und Gepäckwagen verstopft, sodass kein Platz für einen Hund bleibt. Der Hitzeinsel-Effekt in dichten Touristenzonen treibt die Asphalttemperaturen 5-8C über den Stadtdurchschnitt, was ein reales Risiko für Pfotenballen darstellt. Ruhigere Alternativen beseitigen all diese Reibungspunkte auf einen Schlag.` },
      { h: 'Zugverbindungen zu allen 8 Empfehlungen', p: `Girona: Barcelona Sants nach Girona mit Rodalies oder Regionalzug, 1 Std, 12 EUR. Treviso: Venedig Santa Lucia nach Treviso Centrale, 30 Min, 4,50 EUR. Olomouc: Prag nach Olomouc mit RegioJet oder CD, 2 Std 10, 9-15 EUR. Sifnos: Hafen Piräus in Athen mit Blue Star oder Seajets Fähre, 3 Std Schnellfähre oder 5 Std konventionell. Sibiu: Bukarest nach Sibiu mit CFR, 3 Std 40 direkt. Orvieto: Rom Termini nach Orvieto mit Trenitalia, 1 Std 15, 10 EUR. Provins: Paris Gare de l'Est mit Transilien P, 1 Std 15, 14 EUR hin und zurück. Bad Ischl: Salzburg nach Bad Ischl mit ÖBB Regionalzug, 1 Std 10, 12 EUR.` },
      { h: 'Hundefreundliche Terrassen in weniger touristischen Städten finden', p: `In übertouristischen Städten ist das Terrassenpersonal oft zu gehetzt, um einen Hund richtig willkommen zu heißen, und manche Restaurants haben sie zur Steuerung des Durchsatzes rundweg verboten. In kleineren Städten mit lokaler Kundschaft sind hundetolerante Terrassen eher die Regel als die Ausnahme. Praktische Tipps: Achten Sie in Google-Maps-Bewertungen auf „Hunde willkommen" oder „animaux acceptes", kommen Sie vor dem lokalen Mittagsansturm (12-12:30 Uhr), wählen Sie schattige Terrassen, auf denen sich Ihr Hund unter dem Stuhl niederlassen kann, und meiden Sie Terrassen neben Souvenirmarktständen mit konstantem Fußgängerverkehr.` },
      { h: 'Der Overtourism-Kalender: wann reisen', p: `Die Hochphase der Überfüllung in Barcelona, Venedig, Santorin, Rom, Paris, Budapest und Salzburg reicht von Mitte Juni bis Ende August, wobei der 14. Juli bis 15. August am schlimmsten ist. Alle 8 Alternativen in diesem Guide sind im selben Zeitraum deutlich ruhiger und im Mai-Juni sowie September dramatisch ruhiger, wenn die Temperaturen auch für einen Hund angenehmer sind. Wenn Sie flexibel sind, ist September in Girona, Treviso oder Sibiu wohl die beste Zeit: 22-25C, leere Straßen bei Ihrer Ankunft und lokale Erntefeste, bei denen Hunde auf der Terrasse durchweg dazugehören.` },
    ],
    faqHeading: 'Häufig gestellte Fragen',
    faqs: [
      { q: 'Sind diese Alternativen wirklich mit den berühmten Städten vergleichbar?', a: `Für Hundebesitzer sind mehrere davon speziell besser als ihr berühmtes Pendant, nicht nur vergleichbar. Treviso hat dieselbe Atmosphäre aus Kanälen und mittelalterlichen Fassaden wie Venedig, aber ohne die Brückenstufen, die für große Hunde wirklich schwierig sind, ohne die touristischen Engpass-Menschenmassen, und mit flachen Flussufer-Spaziergängen, die man in Venedigs Insellage nicht findet. Gironas gotisches Viertel und die Ufer des Onyar sind architektonisch dem Barri Gotic von Barcelona ebenbürtig, aber Sie können Ihren Hund tatsächlich in Ruhe ausführen. Die barocken Brunnen von Olomouc sind objektiv beeindruckend, und die Stadt ist unter der Woche so ruhig, dass man das Gefühl hat, sie für sich allein zu haben.` },
      { q: 'Was ist mit Hunden in Venedig? Sind sie erlaubt?', a: `Hunde sind in Venedig technisch an der Leine in den meisten öffentlichen Bereichen erlaubt, aber die praktische Realität ist wirklich schwierig. Die glatten Steinbrücken der Stadt (über 400) bieten keinen Halt und können für große oder ältere Hunde rutschig sein. In der Hochsaison ist die touristische Dichte auf den Hauptrouten so hoch, dass man sich mit einem angeleinten Hund faktisch durch eine Menschenmenge bewegt, was für das Tier stressig ist. Die Vaporetti (Wasserbusse) nehmen kleine Hunde in einer Transportbox zu ermäßigtem Tarif mit, aber große Hunde müssen auf ein Wassertaxi zu deutlich höheren Kosten warten. Treviso bietet dasselbe venezianische ästhetische Erlebnis ohne all diese Reibungspunkte.` },
      { q: 'Ist Sifnos ohne Flugzeug erreichbar?', a: `Ja, vollständig über Land und Meer. Von den meisten Teilen Westeuropas lautet die Route: mit dem Auto oder Zug nach Athen (oder nach Athen fliegen), dann Taxi oder Metro zum Hafen Piräus, dann Blue Star Ferries oder Seajets nach Sifnos. Der schnelle Seajets-Katamaran schafft die Überfahrt in unter 3 Stunden. Es gibt auch eine konventionelle Nachtfähre, die um 23 Uhr in Piräus ablegt und um 5 Uhr ankommt, was für Hunde gut funktioniert, da die Überfahrt während der Schlafstunden stattfindet. Bringen Sie eine Matte und Wasser für die Reise an Deck mit, wenn Ihr Hund über 6 kg wiegt.` },
      { q: 'Welche der 8 ist am meisten unterschätzt?', a: `Olomouc, ohne Frage. Sie ist den meisten Westeuropäern trotz eines UNESCO-Denkmals, sechs barocker Brunnen, einer lebendigen Universitätsstadt-Atmosphäre, einer überdachten Markthalle und Hotelpreisen, die 60% unter Prag liegen, wirklich unbekannt. Die tschechischen Bahnverbindungen machen die Stadt von Wien in 2 Std 40 oder von Prag in 2 Std 10 erreichbar. Ihre Hundekultur ist entspannt: angeleinte Hunde fahren kostenlos mit der Straßenbahn, die meisten Terrassenrestaurants heißen sie willkommen, und der Park Bezrucovy sady ist eine richtige Grünfläche im Stadtzentrum. Wenn Sie schon dreimal in Prag waren und es überfüllt finden, ist Olomouc die naheliegende nächste Wahl.` },
    ],
  ...
  it: {
    eyebrow: 'ANTI-OVERTOURISM 2026 · VIAGGI CON IL CANE',
    title: `Alternative pet-friendly alle citta europee piu affollate: 8 mete piu tranquille (2026)`,
    intro: `Proteste a Barcellona, varchi turistici a Venezia, tetti massimi a Santorini: il movimento anti-overtourism del 2026 sta spingendo i viaggiatori a ripensare le grandi icone. I proprietari di cani hanno in realta un vantaggio nascosto: i cani sono comunque vietati in molti siti iconici affollati (Alhambra, Colosseo, Acropoli), quindi non perdi nulla saltandoli. Nel frattempo, le citta piu piccole e meno visitate hanno quasi sempre piu caffe pet-friendly, strade piu tranquille e supplementi animali piu bassi. Questa guida seleziona 8 alternative europee piu tranquille che eguagliano o superano le loro controparti famose, per ogni proprietario di cane stanco della folla.`,
    pickHeading: '8 alternative piu tranquille (con lo stesso fascino)',
    whyHere: 'Perche qui',
    hotelLabel: 'Dove dormire',
    seeDestCta: 'Guida completa della citta →',
    hotelCta: 'Vedi disponibilita →',
    summerLabel: 'Media massime estive',
    insteadOfLabel: 'Al posto di',
    practicalHeading: 'Guida pratica per viaggiare anti-overtourism con il cane',
    practical: [
      { h: 'Perche il sovraffollamento e in realta peggiore con un cane', p: `I siti iconici che attirano le folle piu grandi (Sagrada Familia, Colosseo, Alhambra, Acropoli) vietano tutti i cani nei loro spazi. Questo significa che fai la fila per ore per poi lasciare il tuo cane con uno sconosciuto o da solo in un'auto calda. I marciapiedi nelle zone sature di turisti sono intasati da passeggini e trolley, senza spazio per un cane. L'effetto isola di calore nelle zone turistiche dense spinge le temperature dell'asfalto 5-8C sopra la media cittadina, un rischio reale per i cuscinetti delle zampe. Le alternative piu tranquille eliminano tutte queste frizioni in un colpo solo.` },
      { h: 'Collegamenti in treno verso tutte e 8 le mete', p: `Girona: Barcellona Sants a Girona con Rodalies o treno regionale, 1h, 12 EUR. Treviso: Venezia Santa Lucia a Treviso Centrale, 30 min, 4,50 EUR. Olomouc: Praga a Olomouc con RegioJet o CD, 2h10, 9-15 EUR. Sifnos: porto del Pireo ad Atene con traghetto Blue Star o Seajets, 3h traghetto veloce o 5h convenzionale. Sibiu: Bucarest a Sibiu con CFR, 3h40 diretto. Orvieto: Roma Termini a Orvieto con Trenitalia, 1h15, 10 EUR. Provins: Parigi Gare de l'Est con Transilien P, 1h15, 14 EUR andata e ritorno. Bad Ischl: Salisburgo a Bad Ischl con OBB regionale, 1h10, 12 EUR.` },
      { h: 'Come trovare terrazze pet-friendly nelle citta meno turistiche', p: `Nelle citta sovraffollate di turisti, il personale delle terrazze spesso ha troppa fretta per accogliere bene un cane e alcuni ristoranti li hanno vietati del tutto per gestire il flusso. Nelle citta piu piccole con clientela locale, le terrazze che tollerano i cani sono la norma piuttosto che l'eccezione. Consigli pratici: cerca "cani benvenuti" o "animaux acceptes" nelle recensioni di Google Maps, arriva prima del rush del pranzo locale (12-12h30), scegli terrazze ombreggiate dove il tuo cane possa sistemarsi sotto la sedia, ed evita le terrazze vicino alle bancarelle dei mercati di souvenir dove il traffico pedonale e costante.` },
      { h: `Il calendario dell'overtourism: quando viaggiare`, p: `Il picco di sovraffollamento a Barcellona, Venezia, Santorini, Roma, Parigi, Budapest e Salisburgo va da meta giugno a fine agosto, con il periodo 14 luglio-15 agosto il peggiore. Tutte e 8 le alternative di questa guida sono notevolmente piu tranquille nello stesso periodo, e drasticamente piu tranquille a maggio-giugno e settembre, quando le temperature sono anche piu gestibili per un cane. Se hai flessibilita, settembre a Girona, Treviso o Sibiu e probabilmente il momento migliore: 22-25C, strade vuote al tuo arrivo, e feste locali del raccolto che sono universalmente occasioni di cane-in-terrazza.` },
    ],
    faqHeading: 'Domande frequenti',
    faqs: [
      { q: 'Queste alternative sono davvero paragonabili alle citta famose?', a: `Per un proprietario di cane in particolare, diverse sono migliori della loro controparte famosa, non solo paragonabili. Treviso ha la stessa atmosfera di canali e facciate medievali di Venezia ma senza i gradini dei ponti che sono davvero difficili per i cani grandi, senza le folle da imbuto turistico, e con passeggiate fluviali piatte che non trovi nella conformazione insulare di Venezia. Il quartiere gotico di Girona e le rive dell'Onyar sono architettonicamente alla pari del Barri Gotic di Barcellona, ma qui puoi davvero portare a spasso il tuo cane in pace. Le fontane barocche di Olomouc sono oggettivamente splendide e la citta e cosi tranquilla infrasettimana che ti sembra di averla tutta per te.` },
      { q: 'Cosa succede ai cani a Venezia? Sono ammessi?', a: `I cani sono tecnicamente ammessi a Venezia al guinzaglio nella maggior parte degli spazi pubblici, ma la realta pratica e davvero complicata. I ponti in pietra liscia della citta (oltre 400) non hanno prese e possono essere scivolosi per i cani grandi o anziani. In piena estate la densita turistica sui percorsi principali e cosi alta che ti muovi in pratica in mezzo a una folla con un cane al guinzaglio, il che e stressante per l'animale. I vaporetti accettano i cani piccoli in un trasportino a tariffa ridotta ma i cani grandi devono aspettare un taxi acqueo a un costo notevolmente piu alto. Treviso ti offre la stessa esperienza estetica veneziana senza tutte queste frizioni.` },
      { q: 'Si puo raggiungere Sifnos senza aereo?', a: `Si, interamente via terra e mare. Dalla maggior parte dell'Europa occidentale il percorso e: auto o treno fino ad Atene (oppure volo fino ad Atene), poi taxi o metro fino al porto del Pireo, poi traghetto Blue Star o Seajets fino a Sifnos. Il catamarano veloce Seajets fa la traversata in meno di 3 ore. C'e anche un'opzione di traghetto convenzionale notturno in partenza dal Pireo alle 23 e in arrivo alle 5, che funziona bene per i cani perche la traversata avviene durante le ore di sonno. Porta un tappetino e acqua per il viaggio in coperta se il tuo cane supera i 6 kg.` },
      { q: 'Quale delle 8 e la piu sottovalutata?', a: `Olomouc, senza dubbio. E davvero sconosciuta alla maggior parte degli europei occidentali nonostante un monumento UNESCO, sei fontane barocche, un'atmosfera vivace da citta universitaria, un mercato coperto e prezzi degli hotel inferiori del 60% rispetto a Praga. I collegamenti delle ferrovie ceche la rendono raggiungibile da Vienna in 2h40 o da Praga in 2h10. La sua cultura canina e rilassata: i cani al guinzaglio viaggiano gratis sui tram, la maggior parte dei ristoranti con terrazza li accoglie, e il parco Bezrucovy sady e un vero spazio verde nel centro citta. Se sei stato a Praga tre volte e la trovi sovraffollata, Olomouc e la scelta successiva ovvia.` },
    ],
