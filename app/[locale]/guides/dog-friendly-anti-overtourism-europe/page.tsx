...
export async function generateMetadata({
  ...
  const titles: Record<string, string> = {
    ...
    it: `Alternative pet-friendly alle città europee più affollate: 8 mete più tranquille (2026)`,
  }
  const descriptions: Record<string, string> = {
    ...
    it: `Proteste a Barcellona, varchi turistici a Venezia, tetti massimi a Santorini: il movimento anti-overtourism del 2026 e reale. I proprietari di cani hanno un vantaggio nascosto: le città più tranquille sono quasi sempre più pet-friendly. Otto alternative verificate con hotel pet-friendly.`,
  }
  return {
...
const PICKS: Pick[] = [
  ...
  },
  {
    ...
    whyIt: `Olomouc e la seconda città storica più grande della Cechia e ha una Colonna della Santissima Trinita patrimonio UNESCO e 6 fontane barocche che rivaleggiano con il centro storico di Praga, ma senza praticamente nessuna folla di turisti. Il parco Bezrucovy sady e uno spazio verde piatto di 10 ettari che accoglie i cani al guinzaglio, i tram accettano i cani al guinzaglio gratis, e la popolazione universitaria della città significa terrazze animate universalmente pet-friendly. Il prezzo medio degli hotel e il 60% di Praga per una qualità equivalente.`,
  ...
  },
  {
    ...
    whyIt: `Sibiu e la più bella città sassone della Transilvania ed ex Capitale Europea della Cultura, che rispetto a Budapest resta genuinamente economica e senza folla. Le tre piazze centrali sono collegate da scale e passaggi medievali del tutto percorribili con un cane al guinzaglio, il Museo all'Aperto Astra a 3 km a sud e un parco di 96 ettari che accoglie i cani al guinzaglio, e la scena gastronomica della città accetta cani sulle terrazze ovunque. I prezzi sono circa il 50% di Budapest per un alloggio equivalente.`,
  ...
  },
  {
    ...
    whyIt: `Provins e a 1h15 da Parigi Gare de l'Est in treno (14 EUR) ed e una delle città medievali meglio conservate di Francia (patrimonio UNESCO), con una città alta fortificata del XII secolo, mura percorribili con un cane al guinzaglio, e il famoso Jardin des Roses (oltre 2000 varieta, aperto giugno-sett, cani al guinzaglio benvenuti sui sentieri). Riceve gitanti giornalieri ma si svuota completamente entro le 17. Nei fine settimana estivi si tengono spettacoli medievali alla Grange aux Dimes, con i cani tollerati fuori dal perimetro dello spettacolo.`,
...
const COPY = {
  ...
  it: {
    ...
    title: `Alternative pet-friendly alle città europee più affollate: 8 mete più tranquille (2026)`,
    intro: `Proteste a Barcellona, varchi turistici a Venezia, tetti massimi a Santorini: il movimento anti-overtourism del 2026 sta spingendo i viaggiatori a ripensare le grandi icone. I proprietari di cani hanno in realta un vantaggio nascosto: i cani sono comunque vietati in molti siti iconici affollati (Alhambra, Colosseo, Acropoli), quindi non perdi nulla saltandoli. Nel frattempo, le città più piccole e meno visitate hanno quasi sempre più caffè pet-friendly, strade più tranquille e supplementi animali più bassi. Questa guida seleziona 8 alternative europee più tranquille che eguagliano o superano le loro controparti famose, per ogni proprietario di cane stanco della folla.`,
    pickHeading: '8 alternative più tranquille (con lo stesso fascino)',
    whyHere: 'Perché qui',
    ...
    practical: [
      { h: 'Perché il sovraffollamento e in realta peggiore con un cane', p: `I siti iconici che attirano le folle più grandi (Sagrada Familia, Colosseo, Alhambra, Acropoli) vietano tutti i cani nei loro spazi. Questo significa che fai la fila per ore per poi lasciare il tuo cane con uno sconosciuto o da solo in un'auto calda. I marciapiedi nelle zone sature di turisti sono intasati da passeggini e trolley, senza spazio per un cane. L'effetto isola di calore nelle zone turistiche dense spinge le temperature dell'asfalto 5-8C sopra la media cittadina, un rischio reale per i cuscinetti delle zampe. Le alternative più tranquille eliminano tutte queste frizioni in un colpo solo.` },
      ...
      { h: 'Come trovare terrazze pet-friendly nelle città meno turistiche', p: `Nelle città sovraffollate di turisti, il personale delle terrazze spesso ha troppa fretta per accogliere bene un cane e alcuni ristoranti li hanno vietati del tutto per gestire il flusso. Nelle città più piccole con clientela locale, le terrazze che tollerano i cani sono la norma piuttosto che l'eccezione. Consigli pratici: cerca "cani benvenuti" o "animaux acceptes" nelle recensioni di Google Maps, arriva prima del rush del pranzo locale (12-12h30), scegli terrazze ombreggiate dove il tuo cane possa sistemarsi sotto la sedia, ed evita le terrazze vicino alle bancarelle dei mercati di souvenir dove il traffico pedonale e costante.` },
      { h: `Il calendario dell'overtourism: quando viaggiare`, p: `Il picco di sovraffollamento a Barcellona, Venezia, Santorini, Roma, Parigi, Budapest e Salisburgo va da meta giugno a fine agosto, con il periodo 14 luglio-15 agosto il peggiore. Tutte e 8 le alternative di questa guida sono notevolmente più tranquille nello stesso periodo, e drasticamente più tranquille a maggio-giugno e settembre, quando le temperature sono anche più gestibili per un cane. Se hai flessibilità, settembre a Girona, Treviso o Sibiu e probabilmente il momento migliore: 22-25C, strade vuote al tuo arrivo, e feste locali del raccolto che sono universalmente occasioni di cane-in-terrazza.` },
    ],
    faqHeading: 'Domande frequenti',
    faqs: [
      { q: 'Queste alternative sono davvero paragonabili alle città famose?', a: `Per un proprietario di cane in particolare, diverse sono migliori della loro controparte famosa, non solo paragonabili. Treviso ha la stessa atmosfera di canali e facciate medievali di Venezia ma senza i gradini dei ponti che sono davvero difficili per i cani grandi, senza le folle da imbuto turistico, e con passeggiate fluviali piatte che non trovi nella conformazione insulare di Venezia. Il quartiere gotico di Girona e le rive dell'Onyar sono architettonicamente alla pari del Barri Gotic di Barcellona, ma qui puoi davvero portare a spasso il tuo cane in pace. Le fontane barocche di Olomouc sono oggettivamente splendide e la città e così tranquilla infrasettimana che ti sembra di averla tutta per te.` },
      { q: 'Cosa succede ai cani a Venezia? Sono ammessi?', a: `I cani sono tecnicamente ammessi a Venezia al guinzaglio nella maggior parte degli spazi pubblici, ma la realta pratica e davvero complicata. I ponti in pietra liscia della città (oltre 400) non hanno prese e possono essere scivolosi per i cani grandi o anziani. In piena estate la densità turistica sui percorsi principali e così alta che ti muovi in pratica in mezzo a una folla con un cane al guinzaglio, il che e stressante per l'animale. I vaporetti accettano i cani piccoli in un trasportino a tariffa ridotta ma i cani grandi devono aspettare un taxi acqueo a un costo notevolmente più alto. Treviso ti offre la stessa esperienza estetica veneziana senza tutte queste frizioni.` },
      { q: 'Si può raggiungere Sifnos senza aereo?', a: `Si, interamente via terra e mare. Dalla maggior parte dell'Europa occidentale il percorso e: auto o treno fino ad Atene (oppure volo fino ad Atene), poi taxi o metro fino al porto del Pireo, poi traghetto Blue Star o Seajets fino a Sifnos. Il catamarano veloce Seajets fa la traversata in meno di 3 ore. C'e anche un'opzione di traghetto convenzionale notturno in partenza dal Pireo alle 23 e in arrivo alle 5, che funziona bene per i cani perché la traversata avviene durante le ore di sonno. Porta un tappetino e acqua per il viaggio in coperta se il tuo cane supera i 6 kg.` },
      { q: 'Quale delle 8 e la più sottovalutata?', a: `Olomouc, senza dubbio. E davvero sconosciuta alla maggior parte degli europei occidentali nonostante un monumento UNESCO, sei fontane barocche, un'atmosfera vivace da città universitaria, un mercato coperto e prezzi degli hotel inferiori del 60% rispetto a Praga. I collegamenti delle ferrovie ceche la rendono raggiungibile da Vienna in 2h40 o da Praga in 2h10. La sua cultura canina e rilassata: i cani al guinzaglio viaggiano gratis sui tram, la maggior parte dei ristoranti con terrazza li accoglie, e il parco Bezrucovy sady e un vero spazio verde nel centro città. Se sei stato a Praga tre volte e la trovi sovraffollata, Olomouc e la scelta successiva ovvia.` },
    ],
