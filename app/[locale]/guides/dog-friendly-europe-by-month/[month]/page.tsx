...
const CURATED: Record<MonthKey, Array<{ slug: string; en: string; fr: string; es: string; de: string; nl: string; it: string }>> = {
  ...
  december: [
    { slug: 'vienna', en: 'Christmas market central, leashed dogs welcomed at most stalls, the Rathausplatz market dog-tolerant, and Habsburg café culture indoors.', fr: 'Capitale du marché de Noël, chiens en laisse bienvenus dans la plupart des stands, marché du Rathausplatz tolérant aux chiens, et culture café habsbourgeoise à l\'intérieur.', es: 'Capital del mercado navideño, perros con correa bienvenidos en la mayoría de los puestos, mercado del Rathausplatz tolerante con perros, y cultura del café habsbúrgica en interiores.', de: `Die Hauptstadt der Weihnachtsmärkte, Hunde an der Leine sind an den meisten Ständen willkommen, der Markt am Rathausplatz ist hundetolerant, und die habsburgische Kaffeehauskultur wärmt drinnen.`, nl: `Hoofdstad van de kerstmarkten, honden aan de lijn zijn welkom bij de meeste kraampjes, de markt op het Rathausplatz is hondentolerant, en de Habsburgse koffiehuiscultuur warmt je binnen op.`, it: `Capitale dei mercatini di Natale, i cani al guinzaglio sono benvenuti alla maggior parte delle bancarelle, il mercato del Rathausplatz e tollerante verso i cani, e la cultura dei caffè asburgici scalda al chiuso.` },
...
const COPY = {
  ...
  it: {
    ...
    faqs: (m: string) => [
      { q: `${m.charAt(0).toUpperCase() + m.slice(1)} e un buon mese per viaggiare in Europa con un cane?`, a: `Si, ogni mese offre buone destinazioni per un viaggio col cane in Europa; la città giusta dipende dalla tolleranza al caldo del tuo cane e dall'accesso alle spiagge per cani. Le nostre 6 scelte sopra superano tutte la soglia di comfort climatico per ${m} nelle loro normali climatiche annuali.` },
      { q: `Quale città europea e la più dog-friendly a ${m}?`, a: `Il primo classificato sopra e la nostra scelta editoriale. Ogni città ha una guida completa con numeri di telefono dei veterinari, aree recintate senza guinzaglio e disponibilità di hotel pet-friendly.` },
