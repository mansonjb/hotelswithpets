...
const CURATED: Record<MonthKey, Array<{ slug: string; en: string; fr: string; es: string; de: string; nl: string; it: string }>> = {
  january: [
    ...
    { slug: 'lisbon', en: 'The mildest big-city option in January Europe (avg high 14 °C, mostly dry), the Tagus riverfront, Belém and the Parque Florestal de Monsanto all dog-friendly.', fr: 'L\'option grande-ville la plus douce d\'Europe en janvier (max moyen 14 °C, plutôt sec), les berges du Tage, Belém et le Parque Florestal de Monsanto tous dog-friendly.', es: 'La opción de gran ciudad más templada de Europa en enero (máxima media 14 °C, mayormente seca), las orillas del Tajo, Belém y el Parque Florestal de Monsanto todos dog-friendly.', de: `Die mildeste Großstadt-Option in Europa im Januar (Höchstwerte im Schnitt 14 °C, meist trocken), das Tejo-Ufer, Belém und der Parque Florestal de Monsanto sind alle hundefreundlich.`, nl: `De mildste grote stad van Europa in januari (gemiddeld 14 °C, meestal droog), de Taag-oever, Belém en het Parque Florestal de Monsanto zijn allemaal hondvriendelijk.`, it: `L'opzione grande citta piu mite d'Europa a gennaio (max media 14 °C, per lo piu asciutto), il lungofiume del Tago, Belém e il Parque Florestal de Monsanto sono tutti dog-friendly.` },
    { slug: 'porto', en: 'Even milder than Lisbon (15 °C avg), Porto in January is quiet and the Foz do Douro dog beaches are dog-accessible year-round.', fr: 'Encore plus douce que Lisbonne (15 °C de moyenne), Porto en janvier est calme et les plages de Foz do Douro sont accessibles aux chiens toute l\'année.', es: 'Aún más templada que Lisboa (15 °C de media), Oporto en enero está tranquila y las playas de Foz do Douro están abiertas a perros todo el año.', de: `Noch milder als Lissabon (im Schnitt 15 °C), Porto ist im Januar ruhig, und die Hundestrände von Foz do Douro sind das ganze Jahr über zugänglich.`, nl: `Nog milder dan Lissabon (gemiddeld 15 °C), Porto is rustig in januari en de hondenstranden van Foz do Douro zijn het hele jaar toegankelijk.`, it: `Ancora piu mite di Lisbona (15 °C di media), Porto a gennaio e tranquilla e le spiagge per cani di Foz do Douro sono accessibili tutto l'anno.` },
  ],
  february: [
    { slug: 'malaga', en: 'Almond blossom season at 16 °C, the Costa del Sol\'s mildest February, with year-round dog beaches at Pedregalejo and Arroyo Totalán still wide open.', fr: 'Saison des amandiers en fleur à 16 °C, le mois de février le plus doux de la Costa del Sol, avec les plages canines toute l\'année de Pedregalejo et Arroyo Totalán encore ouvertes.', es: 'Temporada del almendro en flor a 16 °C, el febrero más suave de la Costa del Sol, con las playas caninas todo el año de Pedregalejo y Arroyo Totalán abiertas.', de: `Mandelblütensaison bei 16 °C, der mildeste Februar der Costa del Sol, mit den ganzjährig geöffneten Hundestränden von Pedregalejo und Arroyo Totalán.`, nl: `Amandelbloesemseizoen bij 16 °C, de mildste februari van de Costa del Sol, met de hele jaar geopende hondenstranden Pedregalejo en Arroyo Totalán nog wagenwijd open.`, it: `Stagione dei mandorli in fiore a 16 °C, il febbraio piu mite della Costa del Sol, con le spiagge per cani aperte tutto l'anno di Pedregalejo e Arroyo Totalán ancora spalancate.` },
  ...
  december: [
    { slug: 'vienna', en: 'Christmas market central, leashed dogs welcomed at most stalls, the Rathausplatz market dog-tolerant, and Habsburg café culture indoors.', fr: 'Capitale du marché de Noël, chiens en laisse bienvenus dans la plupart des stands, marché du Rathausplatz tolérant aux chiens, et culture café habsbourgeoise à l\'intérieur.', es: 'Capital del mercado navideño, perros con correa bienvenidos en la mayoría de los puestos, mercado del Rathausplatz tolerante con perros, y cultura del café habsbúrgica en interiores.', de: `Die Hauptstadt der Weihnachtsmärkte, Hunde an der Leine sind an den meisten Ständen willkommen, der Markt am Rathausplatz ist hundetolerant, und die habsburgische Kaffeehauskultur wärmt drinnen.`, nl: `Hoofdstad van de kerstmarkten, honden aan de lijn zijn welkom bij de meeste kraampjes, de markt op het Rathausplatz is hondentolerant, en de Habsburgse koffiehuiscultuur warmt je binnen op.`, it: `Capitale dei mercatini di Natale, i cani al guinzaglio sono benvenuti alla maggior parte delle bancarelle, il mercato del Rathausplatz e tollerante verso i cani, e la cultura dei caffe asburgici scalda al chiuso.` },
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string; month: string }> }): Promise<Metadata> {
  ...
  const titles: Record<string, string> = {
    ...
    it: `Le migliori citta dog-friendly d'Europa a ${mn} ${year}`,
  }
  const descs: Record<string, string> = {
    ...
    it: `Dove viaggiare in Europa con un cane o un gatto a ${mn}. 6 destinazioni selezionate con meteo attuale, apertura delle spiagge per cani, avvisi sui festival e disponibilita di hotel pet-friendly.`,
  }
...
const COPY = {
  ...
  it: {
    ...
    h1: (m: string) => `Le migliori citta europee per un viaggio col cane a ${m}`,
    lede: (m: string) => `Dove andare davvero con un cane o un gatto a ${m}. Valutiamo ogni citta del nostro dataset di 100 destinazioni in base alla temperatura media del mese, all'apertura delle spiagge per cani, alle regole dei trasporti pubblici e ai rischi legati ai festival stagionali, poi aggiungiamo sopra la selezione della redazione.`,
    ...
    mapHint: 'Disponibilita e prezzi in tempo reale, cani/gatti ammessi. Prenotabile su Booking.com e partner.',
    methodologyTitle: 'Come classifichiamo',
    methodologyParas: [
      `Partiamo dai dati meteo mensili reali di ciascuna delle nostre 100 destinazioni (normali climatiche UE, aggiornate ogni anno). Le citta con una massima media diurna di 14-22 °C ricevono il punteggio di comfort piu alto; oltre 26 °C il punteggio scende bruscamente (rischio di stress da calore per i cani); sotto 10 °C scende in modo moderato.`,
      `Sopra il punteggio climatico aggiungiamo fattori specifici del mese: aperture stagionali delle spiagge per cani (la maggior parte delle spiagge comunali chiude ai cani dal 1 maggio al 30 settembre), i tempi dei mercatini di Natale, la folla dei festival da evitare, e le rare citta che si adattano davvero a un mese particolare.`,
      `Le 6 scelte finali bilanciano clima e accessibilita pratica. Ognuna rimanda alla guida completa della citta con contatti veterinari, disponibilita di hotel e una mappa Booking.com in tempo reale.`,
    ],
    monthsTitle: 'Sfoglia un altro mese',
    faqTitle: 'Domande frequenti',
    faqs: (m: string) => [
      { q: `${m.charAt(0).toUpperCase() + m.slice(1)} e un buon mese per viaggiare in Europa con un cane?`, a: `Si, ogni mese offre buone destinazioni per un viaggio col cane in Europa; la citta giusta dipende dalla tolleranza al caldo del tuo cane e dall'accesso alle spiagge per cani. Le nostre 6 scelte sopra superano tutte la soglia di comfort climatico per ${m} nelle loro normali climatiche annuali.` },
      { q: `Quale citta europea e la piu dog-friendly a ${m}?`, a: `Il primo classificato sopra e la nostra scelta editoriale. Ogni citta ha una guida completa con numeri di telefono dei veterinari, aree recintate senza guinzaglio e disponibilita di hotel pet-friendly.` },
    ...
    ctaDesc: 'Ognuna delle nostre 100 citta europee ha una guida pet-friendly completa con veterinari, parchi, spiagge e una mappa Booking.com in tempo reale.',
