...
const PICKS: Pick[] = [
  ...
  },
  {
    ...
    hotelIt: `L'Imperial Palace e un hotel 4 stelle sul lago immerso nel proprio parco, uno degli indirizzi più iconici di Annecy. Gli animali sono benvenuti con un supplemento modesto, con accesso diretto al giardino dove il cane può camminare libero la mattina prima che arrivino gli altri ospiti. L'hotel e a 10 minuti a piedi dagli argini dei canali della città vecchia e dal parco Paquier.`,
  },
  {
    slug: 'interlaken',
    name: 'Interlaken',
    ...
    whyIt: `Interlaken si trova a 570m tra il lago di Thun e il lago di Brienz, la porta d'accesso all'Oberland bernese. A luglio la valle e intorno ai 22C, ma i sentieri circostanti salgono in fretta verso quote più fresche. Il sentiero delle Grotte di San Beato lungo il lago di Thun accetta cani al guinzaglio sul percorso esterno. I pedalo sul lago di Thun ammettono cani al guinzaglio senza sovrapprezzo, un'attività davvero rilassante nei pomeriggi caldi. Le Ferrovie Federali Svizzere e la maggior parte dei battelli locali accettano cani a meta tariffa, rendendo facili ed economiche le gite giornaliere a Grindelwald o Lauterbrunnen.`,
  ...
  },
  {
    ...
    whyIt: `Il fondovalle di Bolzano tocca i 22C ma la funivia del Renon sale all'altopiano a 2000m dove le temperature restano intorno ai 15C anche ad agosto, a 12 minuti di funivia dal centro città. I cani sono esplicitamente benvenuti sulla funivia del Renon (Rittner Bahn), rendendo questa una delle fughe in montagna dog-friendly più semplici delle Alpi. L'altopiano ha un trenino a scartamento ridotto che collega i paesi, e anche questo accetta cani al guinzaglio. A livello di valle, Bolzano e bilingue italiano e tedesco, i vigneti costeggiano i sentieri fuori città, e il parco lungo il Talvera e una passeggiata larga e ombreggiata per mattina e sera.`,
...
const COPY = {
  ...
  it: {
    ...
    practical: [
      { h: 'Perché la quota rinfresca', p: `La temperatura scende di circa 6,5C ogni 1000m di quota guadagnata (il normale gradiente atmosferico). Una valle a 500m con 28C sara a 21C a 1500m e a soli 14C a 2500m. Ecco perché prendere una funivia col tuo cane non e solo un'attività divertente: nei giorni caldi e il modo più veloce per scendere di 10C senza guidare da nessuna parte. La maggior parte dei paesi alpini ha una funivia o una cabinovia a distanza a piedi dalla via principale.` },
      ...
      { h: 'Protezione delle zampe sui sentieri rocciosi', p: `I sentieri d'alta quota nelle Alpi attraversano spesso pietrisco calcareo, granito e ghiaia grossolana, molto più dura per i cuscinetti rispetto ai sentieri di bosco. Sopra i 1800m considera scarpette leggere per cani (Ruffwear Grip Trex e l'opzione più testata) o almeno una cera protettiva (Musher's Secret) applicata prima della camminata. Controlla le zampe dopo ogni sentiero superiore alle 3 ore per tagli o usura. Gli avvicinamenti rocciosi a ghiacciai e morene sono i tratti a maggior rischio.` },
    ...
    faqs: [
      { q: 'I cani possono salire sulle funivie alpine?', a: `La maggior parte delle funivie alpine accetta cani al guinzaglio, ma la regola varia in base al gestore e al paese. La Svizzera e la più costantemente permissiva: gli impianti della regione della Jungfrau, il Titlis e la maggior parte degli impianti dei Grigioni accettano cani a meta tariffa. In Austria, le regole estive dello Schmittenhöhe (Zell am See), dell'Hahnenkamm (Kitzbühel) e della Nordkette (Innsbruck) accettano tutti i cani. Gli impianti francesi sono più variabili: controlla ogni gestore singolarmente. L'Aiguille du Midi a Chamonix e un'eccezione notevole che non accetta cani. In Italia la funivia del Renon (Bolzano) e quella di Sardagna (Trento) accettano cani. Controlla sempre prima di arrivare.` },
      { q: 'La quota e sicura per i cani?', a: `La maggior parte dei cani sani gestisce senza problemi quote fino a 3000m. I sintomi del mal di montagna nei cani (letargia, perdita di appetito, respiro affannoso) compaiono tipicamente solo sopra i 3000m. Sotto quel livello, le principali preoccupazioni sono la temperatura, le radiazioni UV (il naso dei cani può scottarsi, specialmente sulla neve) e le esigenze fisiche del terreno roccioso. I cani anziani e quelli con problemi cardiaci dovrebbero guadagnare quota gradualmente. Scendi subito se il tuo cane mostra segni di difficolta, respiro insolitamente veloce o disorientamento in quota.` },
