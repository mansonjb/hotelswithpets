...
const PICKS: Pick[] = [
  ...
  },
  {
    ...
    whyIt: `Chamonix a 1035m resta intorno ai 20C a luglio, una vera fuga dal caldo di Lione o Ginevra piu in basso. La funivia dell'Aiguille du Midi non ammette cani, ma questo lascia completamente aperte decine di ottimi sentieri di valle: l'avvicinamento al Mer de Glace da Montenvers (il trenino accetta cani al guinzaglio), il sentiero dell'altopiano del Brévent da Plan de l'Aiguille (raggiungibile con la funivia che accetta cani con un piccolo supplemento), e il percorso lungo l'Arve nel centro citta. Il Plan de l'Aiguille a 2310m resta sotto i 14C e si raggiunge con il tratto basso della funivia del Brévent, che accetta cani al guinzaglio.`,
    ...
    hotelIt: `L'Hotel Morgane e un boutique 4 stelle vicino alla base della funivia del Brévent, con una policy pet-friendly a 20 EUR a notte. La posizione ti mette a 5 minuti dalla funivia del Plan de l'Aiguille e a due passi dal sentiero del fiume Arve. Le camere sono compatte ma la terrazza-giardino e ampia abbastanza perche il tuo cane si sgranchisca.`,
  },
  {
    slug: 'annecy',
    name: 'Annecy',
    ...
    whyIt: `Le spiagge del lago di Annecy vietano i cani da giugno a settembre, ma la mossa intelligente col cane e salire sull'altopiano del Semnoz a 1700m, dove le temperature restano sotto i 18C tutto l'anno, agosto compreso. L'altopiano si raggiunge in auto (strada D41) o con un sentiero segnalato dalla citta, e i sentieri boschivi in cima sono larghi, tranquilli e ombreggiati. A livello cittadino, gli argini dei canali della Vieille Ville sono dog-friendly tutto l'anno, e il parco Paquier in riva al lago ammette cani al guinzaglio fuori dalle zone balneari. Le mattine sul canale Thiou col tuo cane sono davvero splendide prima dell'arrivo della folla turistica.`,
    ...
    hotelIt: `L'Imperial Palace e un hotel 4 stelle sul lago immerso nel proprio parco, uno degli indirizzi piu iconici di Annecy. Gli animali sono benvenuti con un supplemento modesto, con accesso diretto al giardino dove il cane puo camminare libero la mattina prima che arrivino gli altri ospiti. L'hotel e a 10 minuti a piedi dagli argini dei canali della citta vecchia e dal parco Paquier.`,
  },
  {
    slug: 'interlaken',
    name: 'Interlaken',
    ...
    whyIt: `Interlaken si trova a 570m tra il lago di Thun e il lago di Brienz, la porta d'accesso all'Oberland bernese. A luglio la valle e intorno ai 22C, ma i sentieri circostanti salgono in fretta verso quote piu fresche. Il sentiero delle Grotte di San Beato lungo il lago di Thun accetta cani al guinzaglio sul percorso esterno. I pedalo sul lago di Thun ammettono cani al guinzaglio senza sovrapprezzo, un'attivita davvero rilassante nei pomeriggi caldi. Le Ferrovie Federali Svizzere e la maggior parte dei battelli locali accettano cani a meta tariffa, rendendo facili ed economiche le gite giornaliere a Grindelwald o Lauterbrunnen.`,
  ...
  },
  {
    ...
    whyIt: `Il fondovalle di Bolzano tocca i 22C ma la funivia del Renon sale all'altopiano a 2000m dove le temperature restano intorno ai 15C anche ad agosto, a 12 minuti di funivia dal centro citta. I cani sono esplicitamente benvenuti sulla funivia del Renon (Rittner Bahn), rendendo questa una delle fughe in montagna dog-friendly piu semplici delle Alpi. L'altopiano ha un trenino a scartamento ridotto che collega i paesi, e anche questo accetta cani al guinzaglio. A livello di valle, Bolzano e bilingue italiano e tedesco, i vigneti costeggiano i sentieri fuori citta, e il parco lungo il Talvera e una passeggiata larga e ombreggiata per mattina e sera.`,
    ...
    hotelIt: `Il Parkhotel Laurin e un hotel 4 stelle nel cuore di Bolzano con un giardino maturo e una posizione centrale ideale per chi viaggia con un cane. Il giardino pet-friendly e ombreggiato e spazioso, e l'hotel e a 5 minuti a piedi dal punto di partenza della funivia del Renon. I cani sono benvenuti con un supplemento standard e una zona dedicata con ciotole d'acqua all'esterno.`,
  },
  {
    slug: 'trento',
    name: 'Trento',
    ...
    whyIt: `Il fondovalle di Trento raggiunge i 24C a luglio, ma la funivia di Sardagna (a soli 3 minuti da Piazza Dante) porta i cani gratis fino al Monte Bondone a 2100m, dove le temperature di luglio si aggirano sui 12C. Il tragitto in funivia e breve ed economico, il che lo rende una comoda fuga quotidiana per i cani sensibili al caldo. A livello cittadino, la passeggiata serale intorno a Piazza del Duomo e piacevole dalle 19 in poi, quando le temperature scendono. Il compatto centro storico di Trento si esplora benissimo col tuo cane la mattina presto, prima che arrivi il caldo.`,
    ...
    hotelIt: `Il Grand Hotel Trento e un 4 stelle centrale in Piazza Dante, a due passi dalla base della funivia di Sardagna. Gli animali sono accettati su richiesta con un supplemento standard. La posizione centrale dell'hotel permette al tuo cane di girare per le vie del centro storico la mattina prima che si affollino, e la funivia e a 3 minuti a piedi per la fuga quotidiana in quota.`,
  },
  {
    slug: 'zell-am-see',
    name: 'Zell am See',
    ...
    hotelIt: `L'Hotel Seewirt e un hotel sul lago a Zell am See con un giardino dog-friendly che si apre direttamente sulla passeggiata lungolago. I cani sono benvenuti con una tariffa modesta, e il giardino offre uno spazio tranquillo la mattina presto mentre il paese dorme ancora. L'hotel e a 10 minuti a piedi dalla stazione base della funivia dello Schmittenhöhe.`,
  },
  {
    slug: 'kitzbuehel',
    name: 'Kitzbühel',
    ...
    hotelIt: `L'Hotel Zur Tenne e un boutique 4 stelle nel cuore del centro storico di Kitzbühel, a un passo dalla zona pedonale e dalla base della funivia dell'Hahnenkamm. I cani sono benvenuti con un supplemento standard, in un affascinante corridoio piastrellato da sempre tollerante verso i cani. La posizione centrale significa zero auto necessaria per le passeggiate mattutine nel centro storico.`,
  },
]
...
const COPY = {
  ...
  it: {
    ...
    practical: [
      { h: 'Perche la quota rinfresca', p: `La temperatura scende di circa 6,5C ogni 1000m di quota guadagnata (il normale gradiente atmosferico). Una valle a 500m con 28C sara a 21C a 1500m e a soli 14C a 2500m. Ecco perche prendere una funivia col tuo cane non e solo un'attivita divertente: nei giorni caldi e il modo piu veloce per scendere di 10C senza guidare da nessuna parte. La maggior parte dei paesi alpini ha una funivia o una cabinovia a distanza a piedi dalla via principale.` },
      { h: 'Funivie con i cani nelle Alpi', p: `La maggior parte delle funivie svizzere e austriache, e alcune francesi e italiane, accettano cani al guinzaglio, tipicamente al 50-100% del prezzo adulto. Le regole variano: le funivie svizzere sono le piu costantemente dog-friendly, gli impianti austriaci accettano quasi sempre i cani d'estate, quelli francesi sono piu variabili. Controlla sempre il sito del gestore specifico prima di prenotare. In Svizzera i cani viaggiano a meta del prezzo adulto sulla maggior parte degli impianti della regione della Jungfrau.` },
      { h: 'Protezione delle zampe sui sentieri rocciosi', p: `I sentieri d'alta quota nelle Alpi attraversano spesso pietrisco calcareo, granito e ghiaia grossolana, molto piu dura per i cuscinetti rispetto ai sentieri di bosco. Sopra i 1800m considera scarpette leggere per cani (Ruffwear Grip Trex e l'opzione piu testata) o almeno una cera protettiva (Musher's Secret) applicata prima della camminata. Controlla le zampe dopo ogni sentiero superiore alle 3 ore per tagli o usura. Gli avvicinamenti rocciosi a ghiacciai e morene sono i tratti a maggior rischio.` },
      { h: 'Acqua sui sentieri di montagna', p: `I torrenti di montagna sono abbondanti sulle Alpi e generalmente sicuri da bere per i cani, ma porta comunque almeno 500ml in una ciotola pieghevole. I torrenti di acqua di fusione glaciale possono essere molto freddi a luglio (5-8C), cosa che alcuni cani adorano e altri evitano. I cani stressati dal caldo non dovrebbero bere grandi quantita di acqua gelata: puo causare crampi allo stomaco. Lascia che un cane surriscaldato si raffreddi gradualmente prima di lasciarlo bere in abbondanza. In quota, la disidratazione avviene piu rapidamente che a livello del mare.` },
    ],
    faqHeading: 'Domande frequenti',
    faqs: [
      { q: 'I cani possono salire sulle funivie alpine?', a: `La maggior parte delle funivie alpine accetta cani al guinzaglio, ma la regola varia in base al gestore e al paese. La Svizzera e la piu costantemente permissiva: gli impianti della regione della Jungfrau, il Titlis e la maggior parte degli impianti dei Grigioni accettano cani a meta tariffa. In Austria, le regole estive dello Schmittenhöhe (Zell am See), dell'Hahnenkamm (Kitzbühel) e della Nordkette (Innsbruck) accettano tutti i cani. Gli impianti francesi sono piu variabili: controlla ogni gestore singolarmente. L'Aiguille du Midi a Chamonix e un'eccezione notevole che non accetta cani. In Italia la funivia del Renon (Bolzano) e quella di Sardagna (Trento) accettano cani. Controlla sempre prima di arrivare.` },
      { q: 'La quota e sicura per i cani?', a: `La maggior parte dei cani sani gestisce senza problemi quote fino a 3000m. I sintomi del mal di montagna nei cani (letargia, perdita di appetito, respiro affannoso) compaiono tipicamente solo sopra i 3000m. Sotto quel livello, le principali preoccupazioni sono la temperatura, le radiazioni UV (il naso dei cani puo scottarsi, specialmente sulla neve) e le esigenze fisiche del terreno roccioso. I cani anziani e quelli con problemi cardiaci dovrebbero guadagnare quota gradualmente. Scendi subito se il tuo cane mostra segni di difficolta, respiro insolitamente veloce o disorientamento in quota.` },
      { q: 'Ci sono aree per cani senza guinzaglio nelle Alpi?', a: `Le aree senza guinzaglio sono meno formalizzate nelle zone alpine di montagna rispetto alle citta scandinave, ma in pratica molti sentieri di prato d'alta quota sono abbastanza tranquilli da permettere a un cane ben addestrato di camminare senza guinzaglio senza conflitti. Parchi ufficiali senza guinzaglio esistono nella citta di Annecy, a Zell am See e a Kitzbühel. Nei territori dei parchi nazionali (Alti Tauri in Austria, Gran Paradiso in Italia) i cani devono restare sempre al guinzaglio. Anche il parco nazionale svizzero nei Grigioni richiede il guinzaglio. Controlla la segnaletica del parco locale al tuo arrivo.` },
      { q: 'Quanto caldo fanno le valli alpine? L\'effetto Foehn.', a: `Le valli alpine possono diventare sorprendentemente calde a causa dell'effetto Foehn: un vento caldo e secco che scende dai valichi di montagna e si comprime, facendo salire le temperature di valle di 5-10C in poche ore. Innsbruck supera regolarmente i 35C a luglio durante gli episodi di Foehn, e Bolzano e Trento possono arrivare a 37C nelle stesse condizioni. La strategia funivia-e-quota e particolarmente efficace durante gli episodi di Foehn: mentre la valle soffoca, l'altopiano 2000m piu in alto resta a 14C. Controlla le app meteo svizzere e austriache per le previsioni di Foehn prima di pianificare passeggiate in valle.` },
    ],
