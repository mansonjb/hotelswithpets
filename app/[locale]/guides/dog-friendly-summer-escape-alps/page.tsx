...
const STICKY_LABELS: Record<string, { label: string; cta: string }> = {
  ...
  de: { label: 'Haustierfreundliche Hotels für den Alpensommer', cta: 'Hotels ansehen' },
  nl: { label: 'Huisdiervriendelijke hotels voor de Alpenzomer', cta: 'Bekijk hotels' },
  it: { label: 'Hotel pet-friendly per l\'estate alpina', cta: 'Vedi hotel' },
}
...
const PICKS: Pick[] = [
  {
    ...
    whyDe: `Grindelwald liegt auf 1034m direkt unterhalb der Nordwand des Eiger, wodurch die Julihöchstwerte auch an warmen Kontinentaltagen bei rund 18C bleiben. Die Firstbahn nimmt angeleinte Hunde ausdrücklich für 12 CHF pro Hund mit und eröffnet damit den Zugang zum First-Plateau mit seinem Panoramawegenetz. Die Berghütten entlang des Firstbahn-Rundwegs (First Cliff Walk, Wanderweg zum Bachalpsee) sind durchweg hundefreundlich, und das gesamte Gebiet ist für gemächliches Wandern mit Hund wie geschaffen. Der Talweg von Grindelwald in Richtung Grindel ist flach, breit und am Morgen ruhig.`,
    whyNl: `Grindelwald ligt op 1034m direct onder de noordwand van de Eiger, waardoor de julipieken zelfs op warme continentale dagen rond de 18C blijven. De Firstbahn neemt aangelijnde honden expliciet mee voor 12 CHF per hond, en geeft je zo toegang tot het First-plateau met zijn panoramische wandelnetwerk. De berghutten langs de Firstbahn-route (First Cliff Walk, wandelpad naar het Bachalpsee) zijn stuk voor stuk hondvriendelijk, en het hele gebied is gemaakt voor rustig wandelen met je hond. Het dalpad van Grindelwald richting Grindel is vlak, breed en rustig in de ochtend.`,
    whyIt: `Grindelwald si trova a 1034m proprio sotto la parete nord dell'Eiger, il che mantiene le massime di luglio intorno ai 18C anche nelle giornate calde del continente. La funivia del First accetta esplicitamente cani al guinzaglio per 12 CHF a cane, dandoti accesso all'altopiano del First e alla sua rete di sentieri panoramici. I rifugi lungo il circuito della Firstbahn (First Cliff Walk, sentiero del lago Bachalpsee) sono tutti dog-friendly, e l'intera zona è pensata per camminate tranquille col tuo cane. Il sentiero di valle da Grindelwald verso Grindel è piatto, largo e tranquillo la mattina.`,
    ...
    hotelDe: `Das Romantik Hotel Schweizerhof Grindelwald ist ein 4-Sterne-Berghaus mit direktem Blick auf Eiger und Wetterhorn. Hunde sind gegen eine moderate Gebühr willkommen, und das Hotel stellt bei der Ankunft eine Hundedecke und einen Wassernapf bereit. Terrasse und Garten liegen direkt den Bergen zugewandt, ein idealer Ausgangspunkt für einen frühen Start auf dem Wanderweg zur Firstbahn.`,
    hotelNl: `Romantik Hotel Schweizerhof Grindelwald is een 4-sterrenhotel in de bergen met rechtstreeks uitzicht op de Eiger en de Wetterhorn. Honden zijn welkom tegen een bescheiden toeslag, en het hotel geeft je bij aankomst een hondendeken en een waterbak. Terras en tuin kijken direct uit op de bergen, een ideale uitvalsbasis voor een vroege start op het wandelpad naar de Firstbahn.`,
    hotelIt: `Il Romantik Hotel Schweizerhof Grindelwald è un 4 stelle di montagna con vista diretta sull'Eiger e sul Wetterhorn. I cani sono benvenuti con un supplemento modesto, e l'hotel offre una copertina e una ciotola d'acqua all'arrivo. Terrazza e giardino guardano direttamente le montagne, base ideale per partenze mattutine sul sentiero della funivia del First.`,
  },
  {
    slug: 'chamonix',
    ...
    whyDe: `Chamonix liegt auf 1035m und bleibt im Juli bei rund 20C, ein echter Fluchtpunkt vor der Hitze in Lyon oder Genf weiter unten. Die Seilbahn zur Aiguille du Midi nimmt keine Hunde mit, doch dafür stehen Ihnen Dutzende ausgezeichnete Wanderwege im Tal vollständig offen: der Zugang zum Mer de Glace ab Montenvers (die Bahn nimmt angeleinte Hunde mit), der Wanderweg zum Brévent-Plateau ab Plan de l'Aiguille (erreichbar mit der Seilbahn, die Hunde gegen eine geringe Gebühr mitnimmt) und der Uferweg entlang der Arve mitten durchs Stadtzentrum. Das Plan de l'Aiguille auf 2310m bleibt unter 14C und wird über den unteren Abschnitt der Brévent-Seilbahn erreicht, die angeleinte Hunde akzeptiert.`,
    whyNl: `Chamonix ligt op 1035m en blijft in juli rond de 20C, een echte ontsnapping aan de hitte van Lyon of Genève verderop. De kabelbaan naar de Aiguille du Midi laat geen honden toe, maar dat laat tientallen uitstekende dalwandelingen volledig open: de route naar de Mer de Glace vanaf Montenvers (de trein neemt aangelijnde honden mee), het pad naar het Brévent-plateau vanaf Plan de l'Aiguille (bereikbaar met de kabelbaan die honden tegen een kleine toeslag meeneemt), en het pad langs de Arve dwars door het centrum. Het Plan de l'Aiguille op 2310m blijft onder de 14C en is bereikbaar via het onderste stuk van de Brévent-kabelbaan, die aangelijnde honden toelaat.`,
    whyIt: `Chamonix a 1035m resta intorno ai 20C a luglio, una vera fuga dal caldo di Lione o Ginevra più in basso. La funivia dell'Aiguille du Midi non ammette cani, ma questo lascia completamente aperte decine di ottimi sentieri di valle: l'avvicinamento al Mer de Glace da Montenvers (il trenino accetta cani al guinzaglio), il sentiero dell'altopiano del Brévent da Plan de l'Aiguille (raggiungibile con la funivia che accetta cani con un piccolo supplemento), e il percorso lungo l'Arve nel centro città. Il Plan de l'Aiguille a 2310m resta sotto i 14C e si raggiunge con il tratto basso della funivia del Brévent, che accetta cani al guinzaglio.`,
    ...
    hotelDe: `Das Hotel Morgane ist ein 4-Sterne-Boutiquehotel nahe der Talstation der Brévent-Seilbahn mit einer Hunde-Willkommensregel gegen eine Gebühr von 20 EUR pro Nacht. Die Lage bringt Sie in 5 Minuten zur Seilbahn zum Plan de l'Aiguille und in kurzer Gehdistanz zum Uferweg der Arve. Die Zimmer sind kompakt, doch die Gartenterrasse bietet einem Hund reichlich Platz zum Strecken.`,
    hotelNl: `Hotel Morgane is een 4-sterren boutique hotel bij het beginstation van de Brévent-kabelbaan, met een hondenbeleid tegen 20 EUR per nacht. De locatie brengt je in 5 minuten naar de kabelbaan naar Plan de l'Aiguille en op korte loopafstand van het Arve-rivierpad. De kamers zijn compact, maar het tuinterras biedt je hond ruim de ruimte om zich uit te rekken.`,
    hotelIt: `L'Hotel Morgane è un boutique 4 stelle vicino alla base della funivia del Brévent, con una policy pet-friendly a 20 EUR a notte. La posizione ti mette a 5 minuti dalla funivia del Plan de l'Aiguille e a due passi dal sentiero del fiume Arve. Le camere sono compatte ma la terrazza-giardino è ampia abbastanza perché il tuo cane si sgranchisca.`,
  },
  {
    slug: 'annecy',
    name: 'Annecy',
    ...
    whyDe: `An den Seestränden von Annecy sind Hunde von Juni bis September verboten, doch die clevere Lösung mit Hund ist der Aufstieg zum Plateau du Semnoz auf 1700m, wo die Temperaturen das ganze Jahr über, auch im August, unter 18C bleiben. Das Plateau erreichen Sie mit dem Auto (Straße D41) oder über einen markierten Wanderweg ab der Stadt, und die Waldwege oben sind breit, ruhig und schattig. Auf Stadtniveau sind die Kanaluferwege der Vieille Ville das ganze Jahr über hundefreundlich, und der Park Paquier am Seeufer lässt angeleinte Hunde außerhalb der ausgewiesenen Badezonen zu. Morgenspaziergänge mit Hund am Kanal Thiou sind vor der Ankunft der Touristenmassen wirklich wunderschön.`,
    whyNl: `Op de strandjes van het meer van Annecy zijn honden van juni tot september verboden, maar de slimme zet met hond is de klim naar het Plateau du Semnoz op 1700m, waar de temperatuur het hele jaar door, ook in augustus, onder de 18C blijft. Je bereikt het plateau met de auto (weg D41) of via een gemarkeerd wandelpad vanaf de stad, en de bospaden boven zijn breed, rustig en beschaduwd. Op stadsniveau zijn de kadepaden langs de kanalen van de Vieille Ville het hele jaar door hondvriendelijk, en het Paquier-park aan het meer laat aangelijnde honden toe buiten de aangewezen zwemzones. Ochtendwandelingen met je hond langs het kanaal Thiou zijn echt prachtig voor de toeristendrukte begint.`,
    whyIt: `Le spiagge del lago di Annecy vietano i cani da giugno a settembre, ma la mossa intelligente col cane è salire sull'altopiano del Semnoz a 1700m, dove le temperature restano sotto i 18C tutto l'anno, agosto compreso. L'altopiano si raggiunge in auto (strada D41) o con un sentiero segnalato dalla città, e i sentieri boschivi in cima sono larghi, tranquilli e ombreggiati. A livello cittadino, gli argini dei canali della Vieille Ville sono dog-friendly tutto l'anno, e il parco Paquier in riva al lago ammette cani al guinzaglio fuori dalle zone balneari. Le mattine sul canale Thiou col tuo cane sono davvero splendide prima dell'arrivo della folla turistica.`,
    ...
    hotelDe: `Das L'Impérial Palace ist ein 4-Sterne-Hotel am Seeufer in einem eigenen Park, eine der bekanntesten Adressen von Annecy. Haustiere sind gegen einen moderaten Aufpreis willkommen, mit direktem Gartenzugang, wo der Hund sich morgens frei bewegen kann, bevor die übrigen Gäste erscheinen. Das Hotel liegt zu Fuß 10 Minuten von den Kanaluferwegen der Altstadt und dem Park Paquier entfernt.`,
    hotelNl: `L'Impérial Palace is een 4-sterrenhotel aan het meer in een eigen park, een van de meest iconische adressen van Annecy. Huisdieren zijn welkom tegen een bescheiden toeslag, met rechtstreekse tuintoegang waar je hond 's ochtends vrij kan rondlopen voordat de andere gasten verschijnen. Het hotel ligt op 10 minuten lopen van de kadepaden van de oude stad en het Paquier-park.`,
    hotelIt: `L'Imperial Palace è un hotel 4 stelle sul lago immerso nel proprio parco, uno degli indirizzi più iconici di Annecy. Gli animali sono benvenuti con un supplemento modesto, con accesso diretto al giardino dove il cane può camminare libero la mattina prima che arrivino gli altri ospiti. L'hotel è a 10 minuti a piedi dagli argini dei canali della città vecchia e dal parco Paquier.`,
  },
  {
    slug: 'interlaken',
    name: 'Interlaken',
    ...
    whyDe: `Interlaken liegt auf 570m zwischen Thuner- und Brienzersee und ist das Tor zum Berner Oberland. Im Juli liegt die Temperatur im Tal bei rund 22C, doch die umliegenden Wanderwege steigen rasch zu kühleren Höhenlagen an. Der Wanderweg zu den St. Beatus-Höhlen entlang des Thunersees nimmt angeleinte Hunde auf dem Außenweg mit. Tretboote auf dem Thunersee erlauben angeleinte Hunde ohne Aufpreis, eine wirklich entspannende Beschäftigung an heißen Nachmittagen. Die SBB und die meisten lokalen Schiffe nehmen Hunde zum halben Fahrpreis mit, was Tagesausflüge nach Grindelwald oder Lauterbrunnen einfach und günstig macht.`,
    whyNl: `Interlaken ligt op 570m tussen het Thunermeer en het Brienzersee, de poort naar het Berner Oberland. In juli ligt de temperatuur in het dal rond de 22C, maar de omliggende wandelpaden klimmen snel naar koelere hoogtes. Het wandelpad naar de St. Beatusgrotten langs het Thunermeer neemt aangelijnde honden mee op het buitenpad. Waterfietsen op het Thunermeer laten aangelijnde honden gratis toe, een echt ontspannende activiteit op hete middagen. De Zwitserse spoorwegen en de meeste lokale boten nemen honden mee voor het halve tarief, waardoor dagtripjes naar Grindelwald of Lauterbrunnen makkelijk en betaalbaar zijn.`,
    whyIt: `Interlaken si trova a 570m tra il lago di Thun e il lago di Brienz, la porta d'accesso all'Oberland bernese. A luglio la valle è intorno ai 22C, ma i sentieri circostanti salgono in fretta verso quote più fresche. Il sentiero delle Grotte di San Beato lungo il lago di Thun accetta cani al guinzaglio sul percorso esterno. I pedalo sul lago di Thun ammettono cani al guinzaglio senza sovrapprezzo, un'attività davvero rilassante nei pomeriggi caldi. Le Ferrovie Federali Svizzere e la maggior parte dei battelli locali accettano cani a metà tariffa, rendendo facili ed economiche le gite giornaliere a Grindelwald o Lauterbrunnen.`,
    ...
    hotelDe: `Das Victoria-Jungfrau Grand Hotel and Spa ist eine legendäre 5-Sterne-Adresse in Interlaken mit direktem Blick auf das Jungfraumassiv vom Garten aus. Haustiere sind gegen eine moderate Gebühr willkommen, und der hoteleigene Park bietet reichlich Platz für morgendliche Spaziergänge. Die große Lobby und das Restaurant pflegen seit jeher eine tolerante Haltung gegenüber wohlerzogenen Hunden an der Leine.`,
    hotelNl: `Victoria-Jungfrau Grand Hotel and Spa is een legendarisch 5-sterrenadres in Interlaken met rechtstreeks zicht op het Jungfraumassief vanuit de tuin. Huisdieren zijn welkom tegen een bescheiden toeslag, en het eigen park van het hotel biedt volop ruimte voor ochtendwandelingen. De grote lobby en het restaurant staan van oudsher welwillend tegenover goed opgevoede honden aan de lijn.`,
    hotelIt: `Il Victoria-Jungfrau Grand Hotel and Spa è un leggendario indirizzo 5 stelle di Interlaken con vista diretta sul massiccio della Jungfrau dal giardino. Gli animali sono benvenuti con una tariffa moderata, e il parco privato dell'hotel offre ampio spazio per le passeggiate mattutine. La grande hall e il ristorante hanno da sempre un atteggiamento tollerante verso i cani educati al guinzaglio.`,
  },
  {
    slug: 'bolzano',
    name: 'Bolzano',
    ...
    whyDe: `Der Talboden von Bolzano erreicht 22C, doch die Rittner Seilbahn führt zum Plateau auf 2000m, wo die Temperaturen selbst im August bei rund 15C bleiben, eine 12-minütige Fahrt vom Stadtzentrum entfernt. Hunde sind auf der Rittner Seilbahn ausdrücklich willkommen, was dies zu einer der einfachsten hundefreundlichen Bergfluchten in den Alpen macht. Auf dem Plateau verkehrt eine Schmalspurbahn zwischen den Dörfern, die ebenfalls angeleinte Hunde mitnimmt. Auf Talniveau ist Bolzano zweisprachig Italienisch und Deutsch, Weinberge säumen die Wege aus der Stadt hinaus, und der Talvera-Uferpark ist ein breiter, schattiger Spazierweg für Morgen und Abend.`,
    whyNl: `De bodem van het dal van Bolzano bereikt 22C, maar de Rittner kabelbaan brengt je naar het plateau op 2000m, waar de temperatuur zelfs in augustus rond de 15C blijft, een rit van 12 minuten vanaf het centrum. Honden zijn expliciet welkom op de Rittner kabelbaan, wat dit tot een van de makkelijkste hondvriendelijke bergontsnappingen van de Alpen maakt. Op het plateau rijdt een smalspoortreintje tussen de dorpen, dat ook aangelijnde honden meeneemt. Op daalniveau is Bolzano tweetalig Italiaans en Duits, wijngaarden omzomen de paden buiten de stad, en het Talvera-rivierpark is een brede, beschaduwde wandelroute voor ochtend en avond.`,
    whyIt: `Il fondovalle di Bolzano tocca i 22C ma la funivia del Renon sale all'altopiano a 2000m dove le temperature restano intorno ai 15C anche ad agosto, a 12 minuti di funivia dal centro città. I cani sono esplicitamente benvenuti sulla funivia del Renon (Rittner Bahn), rendendo questa una delle fughe in montagna dog-friendly più semplici delle Alpi. L'altopiano ha un trenino a scartamento ridotto che collega i paesi, e anche questo accetta cani al guinzaglio. A livello di valle, Bolzano è bilingue italiano e tedesco, i vigneti costeggiano i sentieri fuori città, e il parco lungo il Talvera è una passeggiata larga e ombreggiata per mattina e sera.`,
    ...
    hotelDe: `Das Parkhotel Laurin ist ein 4-Sterne-Hotel im Herzen von Bolzano mit einem gewachsenen Garten und zentraler Lage, ideal als Basis für Hundehalter. Der haustierfreundliche Garten ist schattig und großzügig, und das Hotel liegt 5 Gehminuten von der Abfahrtsstelle der Rittner Seilbahn entfernt. Hunde sind gegen einen üblichen Aufpreis willkommen, mit einem eigenen Bereich für Wassernäpfe im Freien.`,
    hotelNl: `Parkhotel Laurin is een 4-sterrenhotel in het hart van Bolzano met een oude, volgroeide tuin en een centrale ligging, ideaal als uitvalsbasis voor hondenbezitters. De huisdiervriendelijke tuin is schaduwrijk en ruim, en het hotel ligt op 5 minuten lopen van het vertrekpunt van de Rittner kabelbaan. Honden zijn welkom tegen een gebruikelijke toeslag, met een eigen plek voor waterbakken buiten.`,
    hotelIt: `Il Parkhotel Laurin è un hotel 4 stelle nel cuore di Bolzano con un giardino maturo e una posizione centrale ideale per chi viaggia con un cane. Il giardino pet-friendly è ombreggiato e spazioso, e l'hotel è a 5 minuti a piedi dal punto di partenza della funivia del Renon. I cani sono benvenuti con un supplemento standard e una zona dedicata con ciotole d'acqua all'esterno.`,
  },
  {
    slug: 'trento',
    name: 'Trento',
    ...
    whyDe: `Der Talboden von Trento erreicht im Juli 24C, doch die Sardagna-Seilbahn (nur 3 Minuten von der Piazza Dante entfernt) bringt Hunde kostenlos hinauf zum Monte Bondone auf 2100m, wo die Julitemperaturen bei rund 12C liegen. Die Seilbahnfahrt ist kurz und günstig, was sie zu einer praktischen täglichen Flucht für hitzeempfindliche Hunde macht. Auf Stadtniveau ist der Abendspaziergang rund um die Piazza del Duomo ab 19 Uhr angenehm, wenn die Temperaturen sinken. Die kompakte Altstadt von Trento lässt sich am frühen Morgen mit Hund sehr gut erkunden, bevor die Hitze einsetzt.`,
    whyNl: `De bodem van het dal van Trento bereikt in juli 24C, maar de Sardagna-kabelbaan (slechts 3 minuten van de Piazza Dante) brengt honden gratis omhoog naar de Monte Bondone op 2100m, waar de julitemperatuur rond de 12C ligt. De kabelbaanrit is kort en betaalbaar, wat er een praktische dagelijkse ontsnapping van maakt voor hittegevoelige honden. Op stadsniveau is de avondwandeling rond de Piazza del Duomo prima te doen vanaf 19u, als de temperatuur daalt. Het compacte historische centrum van Trento is heel goed te verkennen met je hond vroeg in de ochtend, voordat de hitte toeslaat.`,
    whyIt: `Il fondovalle di Trento raggiunge i 24C a luglio, ma la funivia di Sardagna (a soli 3 minuti da Piazza Dante) porta i cani gratis fino al Monte Bondone a 2100m, dove le temperature di luglio si aggirano sui 12C. Il tragitto in funivia è breve ed economico, il che lo rende una comoda fuga quotidiana per i cani sensibili al caldo. A livello cittadino, la passeggiata serale intorno a Piazza del Duomo è piacevole dalle 19 in poi, quando le temperature scendono. Il compatto centro storico di Trento si esplora benissimo col tuo cane la mattina presto, prima che arrivi il caldo.`,
    ...
    hotelDe: `Das Grand Hotel Trento ist ein zentrales 4-Sterne-Hotel an der Piazza Dante, nur wenige Schritte von der Talstation der Sardagna-Seilbahn entfernt. Haustiere werden auf Anfrage gegen einen üblichen Aufpreis akzeptiert. Die zentrale Lage des Hotels ermöglicht dem Hund den Zugang zu den morgendlichen Straßen der Altstadt, bevor sie sich füllen, und die Seilbahn ist 3 Gehminuten entfernt für die tägliche Höhenflucht.`,
    hotelNl: `Grand Hotel Trento is een centraal gelegen 4-sterrenhotel aan de Piazza Dante, op een paar stappen van het beginstation van de Sardagna-kabelbaan. Huisdieren worden op aanvraag geaccepteerd tegen een gebruikelijke toeslag. Dankzij de centrale ligging kan je hond 's ochtends de straten van het historische centrum verkennen voordat het er druk wordt, en de kabelbaan ligt op 3 minuten lopen voor de dagelijkse ontsnapping naar hoogte.`,
    hotelIt: `Il Grand Hotel Trento è un 4 stelle centrale in Piazza Dante, a due passi dalla base della funivia di Sardagna. Gli animali sono accettati su richiesta con un supplemento standard. La posizione centrale dell'hotel permette al tuo cane di girare per le vie del centro storico la mattina prima che si affollino, e la funivia è a 3 minuti a piedi per la fuga quotidiana in quota.`,
  },
  {
    slug: 'zell-am-see',
    name: 'Zell am See',
    ...
    whyDe: `Zell am See liegt auf 757m in der Region des Nationalparks Hohe Tauern, mit Julidurchschnittswerten von rund 21C, die an einem windigen Seeabend angenehm kühl wirken. Die Schmittenhöhenbahn nimmt Hunde für 7 EUR pro Fahrt mit und bringt Sie auf 1965m, wo die Temperatur auf 10-12C sinkt und Panorama-Kammwege sich über Stunden erstrecken. Die Uferpromenade ist flach, breit und zu jeder Tageszeit ausdrücklich hundefreundlich. Der Kapruner Gletscher mit seiner Zufahrtsstraße liegt 8km entfernt und bietet eine weitere Option für besonders heiße Tage. Der Ort ist im Sommer als Skigebiet außerhalb der Saison ruhig, ohne die winterliche Besucherdichte.`,
    whyNl: `Zell am See ligt op 757m in de regio van het nationaal park Hohe Tauern, met julitemperaturen die gemiddeld rond de 21C liggen en op een winderige avond aan het meer heerlijk fris aanvoelen. De Schmittenhöhenbahn neemt honden mee voor 7 EUR per rit en brengt je naar 1965m, waar de temperatuur zakt naar 10-12C en panoramische bergkamroutes zich uren lang uitstrekken. De boulevard langs het meer is vlak, breed en op elk moment van de dag uitdrukkelijk hondvriendelijk. De gletsjer van Kaprun met zijn toegangsweg ligt 8km verderop en biedt nog een optie voor extra hete dagen. Het dorp is 's zomers rustig als skigebied buiten het seizoen, zonder de winterse drukte.`,
    whyIt: `Zell am See si trova a 757m nella regione del parco nazionale degli Alti Tauri, con medie di luglio intorno ai 21C che sembrano fresche nelle sere ventose sul lago. La funivia dello Schmittenhöhe accetta cani per 7 EUR a tratta, portandoti a 1965m dove la temperatura scende a 10-12C e i sentieri panoramici di cresta si snodano per ore. La passeggiata lungolago è piatta, larga ed esplicitamente pet-friendly a ogni ora. Il ghiacciaio di Kaprun con la sua strada di accesso è a 8km, un'ulteriore opzione per i giorni più caldi. In estate il paese è tranquillo come stazione sciistica fuori stagione, senza la densità di folla invernale.`,
    ...
    hotelDe: `Das Hotel Seewirt ist ein Hotel am Seeufer in Zell am See mit einem hundefreundlichen Garten, der direkt auf die Seepromenade übergeht. Hunde sind gegen eine moderate Gebühr willkommen, und der Garten bietet am frühen Morgen einen ruhigen Ort, solange der Ort noch schläft. Das Hotel liegt 10 Gehminuten von der Talstation der Schmittenhöhenbahn entfernt.`,
    hotelNl: `Hotel Seewirt is een hotel aan het meer in Zell am See met een hondvriendelijke tuin die rechtstreeks uitkomt op de boulevard langs het meer. Honden zijn welkom tegen een bescheiden toeslag, en de tuin biedt vroeg in de ochtend een rustige plek terwijl het dorp nog slaapt. Het hotel ligt op 10 minuten lopen van het beginstation van de Schmittenhöhenbahn.`,
    hotelIt: `L'Hotel Seewirt è un hotel sul lago a Zell am See con un giardino dog-friendly che si apre direttamente sulla passeggiata lungolago. I cani sono benvenuti con una tariffa modesta, e il giardino offre uno spazio tranquillo la mattina presto mentre il paese dorme ancora. L'hotel è a 10 minuti a piedi dalla stazione base della funivia dello Schmittenhöhe.`,
  },
  {
    slug: 'kitzbuehel',
    name: 'Kitzbühel',
    ...
    whyDe: `Kitzbühel wird im Sommer zu einem ruhigen Wanderdorf, frei von den Menschenmassen der Skisaison und angenehm auf 800m, wo die Julidurchschnittswerte bei rund 22C liegen. Sowohl die Hahnenkammbahn als auch die Kitzbüheler-Horn-Gondel nehmen angeleinte Hunde gegen eine geringe Gebühr mit und eröffnen die hochalpinen Wiesenwege oberhalb von 1600m, wo die Temperaturen auf 12-15C sinken. Die Wiesenwanderungen zwischen den beiden Gipfeln sind breit, grasbewachsen und unter der Woche vollkommen ruhig. Die Altstadt ist mit angeleintem Hund vollständig zu Fuß erkundbar, und der Schwarzsee (2km vom Ort entfernt) hat ein für Hunde zugängliches Ufer, das morgens vor der Öffnung der Badezone offensteht.`,
    whyNl: `Kitzbühel wordt 's zomers een rustig wandeldorp, vrij van de skiseizoendrukte en aangenaam op 800m, waar de julitemperatuur gemiddeld rond de 22C ligt. Zowel de Hahnenkammbahn als de Kitzbüheler-Horngondel neemt aangelijnde honden mee tegen een kleine toeslag, wat de hoogalpiene weilandpaden boven 1600m opent, waar de temperatuur zakt naar 12-15C. De weilandwandelingen tussen de twee toppen zijn breed, grazig en doordeweeks volkomen rustig. De oude dorpskern is volledig te voet te verkennen met je hond aan de lijn, en het Schwarzsee-meer (2km van het dorp) heeft een voor honden toegankelijke oever die 's ochtends open is voordat de zwemzone opengaat.`,
    whyIt: `Kitzbühel diventa in estate un tranquillo villaggio per escursioni, libero dalla folla della stagione sciistica e piacevole a 800m, dove le medie di luglio si aggirano sui 22C. Sia la funivia dell'Hahnenkamm sia la cabinovia del Kitzbüheler Horn accettano cani al guinzaglio con un piccolo supplemento, aprendo i sentieri di prato alpino sopra i 1600m dove le temperature scendono a 12-15C. Le passeggiate tra i due prati in vetta sono ampie, erbose e assolutamente tranquille nei giorni feriali. Il centro storico si visita interamente a piedi con il cane al guinzaglio, e il lago Schwarzsee (2km dal paese) ha una riva accessibile ai cani la mattina prima dell'apertura della zona balneare.`,
    ...
    hotelDe: `Das Hotel Zur Tenne ist ein 4-Sterne-Boutiquehotel im Herzen der Altstadt von Kitzbühel, nur einen Steinwurf von der Fußgängerzone und der Talstation der Hahnenkammbahn entfernt. Hunde sind gegen eine übliche Gebühr willkommen, in einem charmanten gefliesten Eingangsbereich, der seit jeher hundetolerant ist. Die zentrale Lage bedeutet, dass für morgendliche Spaziergänge durch die Altstadt kein Auto nötig ist.`,
    hotelNl: `Hotel Zur Tenne is een 4-sterren boutique hotel in het hart van de oude dorpskern van Kitzbühel, op een steenworp van de voetgangerszone en het beginstation van de Hahnenkammbahn. Honden zijn welkom tegen een gebruikelijke toeslag, in een charmante betegelde hal die van oudsher hondvriendelijk is. Door de centrale ligging heb je geen auto nodig voor ochtendwandelingen door de oude dorpskern.`,
    hotelIt: `L'Hotel Zur Tenne è un boutique 4 stelle nel cuore del centro storico di Kitzbühel, a un passo dalla zona pedonale e dalla base della funivia dell'Hahnenkamm. I cani sono benvenuti con un supplemento standard, in un affascinante corridoio piastrellato da sempre tollerante verso i cani. La posizione centrale significa zero auto necessaria per le passeggiate mattutine nel centro storico.`,
  },
]
...
const COPY = {
  ...
  de: {
    eyebrow: 'PET-FRIENDLY SOMMER · ALPINE KUHLE EUROPAS',
    title: `Hundefreundlicher Alpensommer: 8 Bergorte unter 22C`,
    intro: `Wenn die Mittelmeerhitze die Julitemperaturen uber 30C treibt, liegen die Alpen je nach Hohenlage bereits bei 15-22C. Fur Hunde mit platter Nase (Franzosische Bulldoggen, Mopse, Boxer), altere Hunde oder einfach jeden Hund, der an warmen Tagen stark hechelt, ist ein Alpensommer nicht nur angenehm: er ist wirklich sicher. Diese acht Bergorte bieten gepruefte hundefreundliche Seilbahnen, schattige Wanderwege und haustierfreundliche Hotels in der Schweiz, Frankreich, Italien und Oesterreich.`,
    pickHeading: 'Die acht Alpen-Favoriten (vom kuehlsten zum waermsten sortiert)',
    whyHere: 'Warum hier',
    hotelLabel: 'Wo uebernachten',
    seeDestCta: 'Vollstaendiger Staedteguide →',
    hotelCta: 'Verfuegbarkeit ansehen →',
    julyLabel: 'Durchschnittliches Julihoch',
    practicalHeading: 'Hundeurlaub in den Alpen: praktische Infos',
    practical: [
      { h: 'Warum Hoehe kuehlt', p: `Die Temperatur sinkt pro 1000 Hoehenmeter um etwa 6,5C (die normale atmosphaerische Abnahmerate). Ein Tal auf 500m mit 28C hat auf 1500m nur noch 21C und auf 2500m nur noch 14C. Deshalb ist eine Seilbahnfahrt mit Ihrem Hund nicht nur eine schoene Aktivitaet: An heissen Tagen ist sie der schnellste Weg, um 10C abzukuehlen, ohne irgendwohin zu fahren. Die meisten Alpenorte haben eine Seilbahn oder Gondel in Gehdistanz zur Hauptstrasse.` },
      { h: 'Seilbahnen mit Hund in den Alpen', p: `Die meisten Schweizer und oesterreichischen sowie einige franzoesische und italienische Alpenseilbahnen akzeptieren Hunde an der Leine, typischerweise fuer 50-100% des Erwachsenenpreises. Die Regelungen sind unterschiedlich: Schweizer Seilbahnen sind am durchgaengigsten hundefreundlich, oesterreichische Bahnen akzeptieren Hunde im Sommer fast immer, franzoesische Bahnen sind uneinheitlicher. Pruefen Sie vor der Buchung immer die Website des jeweiligen Bahnbetreibers. In der Schweiz reisen Hunde auf den meisten Bahnen der Jungfrau Region zum halben Erwachsenenpreis.` },
      { h: 'Pfotenschutz auf steinigen Bergwegen', p: `Hochalpine Wege in den Alpen fuehren oft ueber Kalkschutt, Granit und groben Schotter, was fuer Pfotenballen weit belastender ist als Waldwege. Erwaegen Sie auf Wegen ueber 1800m leichte Hundeschuhe (Ruffwear Grip Trex ist die am besten getestete Option) oder mindestens Pfotenwachs (Musher's Secret), das vor der Wanderung aufgetragen wird. Kontrollieren Sie die Pfoten nach jeder Wanderung ueber 3 Stunden auf Schnitte oder Abnutzung. Steinige Zustiege zu Gletschern und Moraenen sind die risikoreichsten Abschnitte.` },
      { h: 'Wasser auf Bergwegen', p: `Bergbaeche gibt es in den Alpen reichlich, und sie sind fuer Hunde in der Regel unbedenklich zu trinken, packen Sie trotzdem mindestens 500ml in einer faltbaren Schuessel ein. Gletscherschmelzwasserbaeche koennen im Juli sehr kalt sein (5-8C), was manche Hunde lieben und andere meiden. Hitzegestresste Hunde sollten kein eiskaltes Wasser in grossen Mengen trinken: Das kann Magenkraempfe verursachen. Lassen Sie einen ueberhitzten Hund erst allmaehlich abkuehlen, bevor Sie ihn viel trinken lassen. In der Hoehe tritt Dehydrierung schneller ein als auf Meereshoehe.` },
    ],
    faqHeading: 'Haeufig gestellte Fragen',
    faqs: [
      { q: 'Duerfen Hunde mit auf Alpenseilbahnen?', a: `Die meisten Alpenseilbahnen akzeptieren Hunde an der Leine, aber die Regelung variiert je nach Bahnbetreiber und Land. Die Schweiz ist am durchgaengigsten grosszuegig: Bahnen der Jungfrau Region, die Titlis-Bahn und die meisten Graubuendner Bahnen nehmen Hunde zum halben Preis mit. In Oesterreich akzeptieren die Sommerregelungen von Schmittenhöhe (Zell am See), Hahnenkamm (Kitzbühel) und Nordkette (Innsbruck) alle Hunde. Franzoesische Bahnen sind uneinheitlicher: pruefen Sie jeden Betreiber einzeln. Die Aiguille du Midi in Chamonix ist eine bemerkenswerte Ausnahme, die keine Hunde akzeptiert. Italiens Rittner Seilbahn (Bozen) und die Bahn von Sardagna (Trient) akzeptieren Hunde. Pruefen Sie vor der Ankunft immer die aktuelle Regelung.` },
      { q: 'Ist die Hoehe fuer Hunde sicher?', a: `Die meisten gesunden Hunde vertragen Hoehen bis 3000m ohne Probleme. Symptome der Hoehenkrankheit bei Hunden (Lethargie, Appetitlosigkeit, erschwerte Atmung) treten typischerweise erst oberhalb von 3000m auf. Unterhalb dieser Grenze sind die Hauptanliegen die Temperatur, die UV-Strahlung (Hundenasen koennen einen Sonnenbrand bekommen, besonders im Schnee) und die koerperlichen Anforderungen von felsigem Gelaende. Aeltere Hunde und Hunde mit Herzerkrankungen sollten Hoehenzuwaechse schrittweise angehen. Steigen Sie sofort ab, wenn Ihr Hund Anzeichen von Stress, ungewoehnlich schnelle Atmung oder Orientierungslosigkeit in der Hoehe zeigt.` },
      { q: 'Gibt es Freilauflaechen in den Alpen?', a: `Freilauflaechen sind in alpinen Berggebieten weniger formalisiert als in skandinavischen Staedten, aber in der Praxis sind viele hochalpine Wiesenwege ruhig genug, um einen zuverlaessig abrufbaren Hund konfliktfrei ohne Leine laufen zu lassen. Offizielle Freilaufparks gibt es in der Stadt Annecy, in Zell am See und in Kitzbühel. Auf Nationalparkgebiet (Hohe Tauern in Oesterreich, Gran Paradiso in Italien) muessen Hunde jederzeit an der Leine sein. Auch der Schweizerische Nationalpark in Graubuenden verlangt Leinenpflicht. Pruefen Sie bei Ankunft die oertlichen Parkschilder.` },
      { q: 'Wie heiss werden die Alpentaeler? Der Foehn-Effekt.', a: `Alpentaeler koennen durch den Foehn-Effekt ueberraschend heiss werden: warmer, trockener Wind, der von Bergpaessen absinkt und sich dabei komprimiert, wodurch die Taltemperaturen innerhalb weniger Stunden um 5-10C steigen. Innsbruck erreicht bei Foehnlagen im Juli regelmaessig ueber 35C, und Bozen und Trient koennen unter denselben Bedingungen auf bis zu 37C ansteigen. Die Strategie aus Seilbahn und Hoehenlage wirkt bei Foehnlagen besonders gut: Waehrend das Tal schwitzt, bleibt das 2000m hoeher gelegene Plateau bei 14C. Pruefen Sie Schweizer und oesterreichische Wetter-Apps auf Foehnvorhersagen, bevor Sie Talwanderungen planen.` },
    ],
    relatedHeading: 'Siehe auch',
  },
  nl: {
    eyebrow: 'PET-FRIENDLY ZOMER · ALPINE KOELTE EUROPA',
    title: `Hondvriendelijke Alpenzomer: 8 bergdorpen onder 22C`,
    intro: `Als de mediterrane hitte de julitemperatuur voorbij 30C duwt, zit het in de Alpen, afhankelijk van de hoogte, al op 15-22C. Voor honden met een platte snuit (Franse bulldogs, mopshonden, boxers), oudere honden, of gewoon elke hond die op warme dagen zwaar hijgt, is een Alpenzomer niet alleen fijn: het is echt veilig. Deze acht bergdorpen bieden geverifieerde hondvriendelijke kabelbanen, beschaduwde wandelpaden en huisdiervriendelijke hotels in Zwitserland, Frankrijk, Italië en Oostenrijk.`,
    pickHeading: 'De acht Alpenkeuzes (van koelst naar warmst)',
    whyHere: 'Waarom hier',
    hotelLabel: 'Waar je kunt overnachten',
    seeDestCta: 'Volledige stadsgids →',
    hotelCta: 'Bekijk beschikbaarheid →',
    julyLabel: 'Gem. julimax',
    practicalHeading: 'Met je hond naar de Alpen: praktische info',
    practical: [
      { h: 'Waarom hoogte verkoelt', p: `De temperatuur daalt ongeveer 6,5C per 1000m stijging (de standaard atmosferische valsnelheid). Een dal op 500m met 28C zit op 1500m nog maar op 21C en op 2500m op slechts 14C. Daarom is een kabelbaanrit met je hond niet zomaar een leuk uitstapje: op hete dagen is het de snelste manier om 10C af te koelen zonder ergens naartoe te rijden. De meeste Alpendorpen hebben een kabelbaan of gondel op loopafstand van de hoofdstraat.` },
      { h: 'Kabelbanen met honden in de Alpen', p: `De meeste Zwitserse en Oostenrijkse en sommige Franse en Italiaanse Alpenkabelbanen laten aangelijnde honden toe, meestal voor 50-100% van de volwassenprijs. Het beleid verschilt: Zwitserse kabelbanen zijn het meest consequent hondvriendelijk, Oostenrijkse liften laten 's zomers vrijwel altijd honden toe, Franse liften zijn wisselvalliger. Check altijd de website van de specifieke liftexploitant voordat je boekt. In Zwitserland reizen honden op de meeste liften in de Jungfrau-regio voor het halve volwassenentarief.` },
      { h: 'Pootbescherming op rotsachtige bergpaden', p: `Hoogalpiene paden in de Alpen kruisen vaak kalksteenpuin, graniet en grof grind, wat veel zwaarder is voor voetzooltjes dan boswegen. Overweeg op paden boven 1800m lichte hondenschoentjes (Ruffwear Grip Trex is de meest geteste optie) of op zijn minst pootwas (Musher's Secret) voor de wandeling. Controleer de pootjes na elke wandeling van meer dan 3 uur op sneetjes of slijtage. Rotsachtige naderingen naar gletsjers en morenes zijn de secties met het hoogste risico.` },
      { h: 'Water op bergpaden', p: `Bergbeekjes zijn er in overvloed in de Alpen en meestal veilig om te drinken voor honden, maar neem hoe dan ook minstens 500ml mee in een opvouwbare bak. Smeltwaterbeekjes van gletsjers kunnen in juli heel koud zijn (5-8C), wat sommige honden geweldig vinden en andere juist mijden. Honden met hittestress mogen geen grote hoeveelheden ijskoud water drinken: dat kan buikkrampen veroorzaken. Laat een oververhitte hond geleidelijk afkoelen voordat je hem veel laat drinken. Op hoogte treedt uitdroging sneller op dan op zeeniveau.` },
    ],
    faqHeading: 'Veelgestelde vragen',
    faqs: [
      { q: 'Mogen honden mee op Alpenkabelbanen?', a: `De meeste Alpenkabelbanen laten aangelijnde honden toe, maar het beleid verschilt per liftexploitant en land. Zwitserland is het meest consequent soepel: liften in de Jungfrau-regio, de Titlis en de meeste Graubünden-liften nemen honden mee voor het halve tarief. In Oostenrijk laten de zomerregelingen van de Schmittenhöhe (Zell am See), de Hahnenkamm (Kitzbühel) en de Nordkette (Innsbruck) allemaal honden toe. Franse liften zijn wisselvalliger: check elke exploitant apart. De Aiguille du Midi in Chamonix is een opvallende uitzondering die geen honden toelaat. De Rittner kabelbaan van Italië (Bolzano) en die van Sardagna (Trento) laten wel honden toe. Check altijd van tevoren.` },
      { q: 'Is hoogte veilig voor honden?', a: `De meeste gezonde honden kunnen hoogtes tot 3000m zonder problemen aan. Symptomen van hoogteziekte bij honden (lusteloosheid, verlies van eetlust, moeizame ademhaling) treden doorgaans pas boven 3000m op. Onder dat niveau zijn de belangrijkste aandachtspunten temperatuur, UV-straling (hondenneuzen kunnen verbranden, vooral op sneeuw) en de fysieke belasting van rotsachtig terrein. Oudere honden en honden met hartproblemen moeten hoogtewinst geleidelijk opbouwen. Daal meteen af als je hond tekenen van nood, ongewoon snelle ademhaling of desoriëntatie op hoogte vertoont.` },
      { q: 'Zijn er losloopgebieden in de Alpen?', a: `Losloopgebieden zijn minder formeel geregeld in alpiene berggebieden dan in Scandinavische steden, maar in de praktijk zijn veel hoogalpiene weilandpaden rustig genoeg om een goed opgevoede hond zonder lijn te laten lopen zonder gedoe. Officiële losloopparken bestaan in de stad Annecy, in Zell am See en in Kitzbühel. Op nationaal-parkgrond (Hohe Tauern in Oostenrijk, Gran Paradiso in Italië) moeten honden altijd aangelijnd zijn. Ook het Zwitserse nationaal park in Graubünden vereist een lijn. Check de lokale bebording bij aankomst.` },
      { q: 'Hoe heet worden Alpendalen? Het foehneffect.', a: `Alpendalen kunnen verrassend heet worden door het foehneffect: warme, droge wind die van bergpassen afdaalt en daarbij samengeperst wordt, waardoor de daltemperatuur binnen enkele uren met 5-10C stijgt. Innsbruck haalt bij foehnperiodes in juli regelmatig meer dan 35C, en Bolzano en Trento kunnen onder dezelfde omstandigheden pieken tot 37C. De strategie van kabelbaan-en-hoogte werkt juist bij foehnperiodes heel goed: terwijl het dal stikt van de hitte, blijft het plateau 2000m hoger op 14C. Check Zwitserse en Oostenrijkse weerapps op foehnvoorspellingen voordat je dalwandelingen plant.` },
    ],
    relatedHeading: 'Zie ook',
  },
  it: {
    eyebrow: 'ESTATE PET-FRIENDLY · FRESCO ALPINO EUROPEO',
    title: `Estate alpina a misura di cane: 8 paesi di montagna sotto i 22C`,
    intro: `Quando il caldo mediterraneo spinge le temperature di luglio oltre i 30C, le Alpi sono già a 15-22C a seconda della quota. Per i cani dal muso schiacciato (bulldog francesi, carlini, boxer), i cani anziani, o semplicemente qualsiasi cane che ansima parecchio nelle giornate calde, un'estate alpina non è solo piacevole: è davvero sicura. Questi otto paesi di montagna offrono funivie dog-friendly verificate, sentieri ombreggiati e hotel che accolgono i tuoi animali in Svizzera, Francia, Italia e Austria.`,
    pickHeading: 'Le otto scelte alpine (dalla più fresca alla più calda)',
    whyHere: 'Perché qui',
    hotelLabel: 'Dove dormire',
    seeDestCta: 'Guida completa della città →',
    hotelCta: 'Vedi disponibilità →',
    julyLabel: 'Media massime luglio',
    practicalHeading: 'Viaggiare in Alpi col cane: info pratiche',
    practical: [
      { h: 'Perché la quota rinfresca', p: `La temperatura scende di circa 6,5C ogni 1000m di quota guadagnata (il normale gradiente atmosferico). Una valle a 500m con 28C sarà a 21C a 1500m e a soli 14C a 2500m. Ecco perché prendere una funivia col tuo cane non è solo un'attività divertente: nei giorni caldi è il modo più veloce per scendere di 10C senza guidare da nessuna parte. La maggior parte dei paesi alpini ha una funivia o una cabinovia a distanza a piedi dalla via principale.` },
      { h: 'Funivie con i cani nelle Alpi', p: `La maggior parte delle funivie svizzere e austriache, e alcune francesi e italiane, accettano cani al guinzaglio, tipicamente al 50-100% del prezzo adulto. Le regole variano: le funivie svizzere sono le più costantemente dog-friendly, gli impianti austriaci accettano quasi sempre i cani d'estate, quelli francesi sono più variabili. Controlla sempre il sito del gestore specifico prima di prenotare. In Svizzera i cani viaggiano a metà del prezzo adulto sulla maggior parte degli impianti della regione della Jungfrau.` },
      { h: 'Protezione delle zampe sui sentieri rocciosi', p: `I sentieri d'alta quota nelle Alpi attraversano spesso pietrisco calcareo, granito e ghiaia grossolana, molto più dura per i cuscinetti rispetto ai sentieri di bosco. Sopra i 1800m considera scarpette leggere per cani (Ruffwear Grip Trex è l'opzione più testata) o almeno una cera protettiva (Musher's Secret) applicata prima della camminata. Controlla le zampe dopo ogni sentiero superiore alle 3 ore per tagli o usura. Gli avvicinamenti rocciosi a ghiacciai e morene sono i tratti a maggior rischio.` },
      { h: 'Acqua sui sentieri di montagna', p: `I torrenti di montagna sono abbondanti sulle Alpi e generalmente sicuri da bere per i cani, ma porta comunque almeno 500ml in una ciotola pieghevole. I torrenti di acqua di fusione glaciale possono essere molto freddi a luglio (5-8C), cosa che alcuni cani adorano e altri evitano. I cani stressati dal caldo non dovrebbero bere grandi quantità di acqua gelata: può causare crampi allo stomaco. Lascia che un cane surriscaldato si raffreddi gradualmente prima di lasciarlo bere in abbondanza. In quota, la disidratazione avviene più rapidamente che a livello del mare.` },
    ],
    faqHeading: 'Domande frequenti',
    faqs: [
      { q: 'I cani possono salire sulle funivie alpine?', a: `La maggior parte delle funivie alpine accetta cani al guinzaglio, ma la regola varia in base al gestore e al paese. La Svizzera è la più costantemente permissiva: gli impianti della regione della Jungfrau, il Titlis e la maggior parte degli impianti dei Grigioni accettano cani a metà tariffa. In Austria, le regole estive dello Schmittenhöhe (Zell am See), dell'Hahnenkamm (Kitzbühel) e della Nordkette (Innsbruck) accettano tutti i cani. Gli impianti francesi sono più variabili: controlla ogni gestore singolarmente. L'Aiguille du Midi a Chamonix è un'eccezione notevole che non accetta cani. In Italia la funivia del Renon (Bolzano) e quella di Sardagna (Trento) accettano cani. Controlla sempre prima di arrivare.` },
      { q: 'La quota è sicura per i cani?', a: `La maggior parte dei cani sani gestisce senza problemi quote fino a 3000m. I sintomi del mal di montagna nei cani (letargia, perdita di appetito, respiro affannoso) compaiono tipicamente solo sopra i 3000m. Sotto quel livello, le principali preoccupazioni sono la temperatura, le radiazioni UV (il naso dei cani può scottarsi, specialmente sulla neve) e le esigenze fisiche del terreno roccioso. I cani anziani e quelli con problemi cardiaci dovrebbero guadagnare quota gradualmente. Scendi subito se il tuo cane mostra segni di difficoltà, respiro insolitamente veloce o disorientamento in quota.` },
      { q: 'Ci sono aree per cani senza guinzaglio nelle Alpi?', a: `Le aree senza guinzaglio sono meno formalizzate nelle zone alpine di montagna rispetto alle città scandinave, ma in pratica molti sentieri di prato d'alta quota sono abbastanza tranquilli da permettere a un cane ben addestrato di camminare senza guinzaglio senza conflitti. Parchi ufficiali senza guinzaglio esistono nella città di Annecy, a Zell am See e a Kitzbühel. Nei territori dei parchi nazionali (Alti Tauri in Austria, Gran Paradiso in Italia) i cani devono restare sempre al guinzaglio. Anche il parco nazionale svizzero nei Grigioni richiede il guinzaglio. Controlla la segnaletica del parco locale al tuo arrivo.` },
      { q: 'Quanto caldo fanno le valli alpine? L\'effetto Foehn.', a: `Le valli alpine possono diventare sorprendentemente calde a causa dell'effetto Foehn: un vento caldo e secco che scende dai valichi di montagna e si comprime, facendo salire le temperature di valle di 5-10C in poche ore. Innsbruck supera regolarmente i 35C a luglio durante gli episodi di Foehn, e Bolzano e Trento possono arrivare a 37C nelle stesse condizioni. La strategia funivia-e-quota è particolarmente efficace durante gli episodi di Foehn: mentre la valle soffoca, l'altopiano 2000m più in alto resta a 14C. Controlla le app meteo svizzere e austriache per le previsioni di Foehn prima di pianificare passeggiate in valle.` },
    ],
