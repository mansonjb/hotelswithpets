...
const COUNTRY_GUIDES = [
  {
    ...
    flag: '🇪🇸',
    label: { en: 'Cool Spain', fr: 'Espagne fraîche', es: 'España fresca', pt: 'Espanha fresca', de: 'Kühles Spanien', nl: 'Koel Spanje' },
    desc: { en: 'Basque Country · Cantabria · Asturias · Galicia · Pyrenees · 8 cities', fr: 'Pays basque · Cantabrie · Asturies · Galice · Pyrénées · 8 villes', es: 'País Vasco · Cantabria · Asturias · Galicia · Pirineo · 8 ciudades', pt: 'País Basco · Cantábria · Astúrias · Galiza · Pirenéus · 8 cidades', de: 'Baskenland · Kantabrien · Asturien · Galicien · Pyrenäen · 8 Städte', nl: 'Baskenland · Cantabrië · Asturië · Galicië · Pyreneeën · 8 steden' },
    maxTemp: 22,
  },
  {
    slug: 'italie-fraiche-chien',
    flag: '🇮🇹',
    label: { en: 'Cool Italy', fr: 'Italie fraîche', es: 'Italia fresca', pt: 'Itália fresca', de: 'Kühles Italien', nl: 'Koel Italië' },
  ...
  },
  {
    ...
    flag: '🇫🇷',
    label: { en: 'Cool France', fr: 'France fraîche', es: 'Francia fresca', pt: 'França fresca', de: 'Kühles Frankreich', nl: 'Koel Frankrijk' },
    desc: { en: 'Brittany · Normandy · Alsace · Alps · Basque coast · 7 cities', fr: 'Bretagne · Normandie · Alsace · Alpes · Côte basque · 7 villes', es: 'Bretaña · Normandía · Alsacia · Alpes · Costa vasca · 7 ciudades', pt: 'Bretanha · Normandia · Alsácia · Alpes · Costa basca · 7 cidades', de: 'Bretagne · Normandie · Elsass · Alpen · Baskenküste · 7 Städte', nl: 'Bretagne · Normandië · Elzas · Alpen · Baskische kust · 7 steden' },
    maxTemp: 20,
  },
  {
    slug: 'portugal-fraiche-chien',
    flag: '🇵🇹',
    label: { en: 'Cool Portugal', fr: 'Portugal frais', es: 'Portugal fresco', pt: 'Portugal fresco', de: 'Kühles Portugal', nl: 'Koel Portugal' },
    desc: { en: 'Porto · Minho coast · Historic Minho · Peneda-Gerês · Costa Vicentina · 6 cities', fr: 'Porto · Minho côtier · Minho historique · Peneda-Gerês · Costa Vicentina · 6 villes', es: 'Oporto · Miño costero · Miño histórico · Peneda-Gerês · Costa Vicentina · 6 ciudades', pt: 'Porto · Minho litoral · Minho histórico · Peneda-Gerês · Costa Vicentina · 6 cidades', de: 'Porto · Minho-Küste · historisches Minho · Peneda-Gerês · Costa Vicentina · 6 Städte', nl: 'Porto · Minho-kust · historisch Minho · Peneda-Gerês · Costa Vicentina · 6 steden' },
    maxTemp: 20,
  },
  {
    slug: 'allemagne-fraiche-chien',
    flag: '🇩🇪',
    label: { en: 'Cool Germany', fr: 'Allemagne fraîche', es: 'Alemania fresca', pt: 'Alemanha fresca', de: 'Kühles Deutschland', nl: 'Koel Duitsland' },
    desc: { en: 'Black Forest · Bavarian Alps · Lake Constance · Baltic · Rhine · 6 cities', fr: 'Forêt-Noire · Alpes bavaroises · Lac de Constance · Baltique · Rhin · 6 villes', es: 'Selva Negra · Alpes bávaros · Lago Constanza · Báltico · Rin · 6 ciudades', pt: 'Floresta Negra · Alpes bávaros · Lago Constança · Báltico · Reno · 6 cidades', de: 'Schwarzwald · Bayerische Alpen · Bodensee · Ostsee · Rhein · 6 Städte', nl: 'Zwarte Woud · Beierse Alpen · Bodenmeer · Oostzee · Rijn · 6 steden' },
    maxTemp: 21,
  },
  {
    slug: 'autriche-fraiche-chien',
    flag: '🇦🇹',
    label: { en: 'Cool Austria', fr: 'Autriche fraîche', es: 'Austria fresca', pt: 'Áustria fresca', de: 'Kühles Österreich', nl: 'Koel Oostenrijk' },
    desc: { en: 'Salzburg · Salzkammergut · Tyrol · Carinthia · Vorarlberg · 6 cities', fr: 'Salzbourg · Salzkammergut · Tyrol · Carinthie · Vorarlberg · 6 villes', es: 'Salzburgo · Salzkammergut · Tirol · Carintia · Vorarlberg · 6 ciudades', pt: 'Salzburgo · Salzkammergut · Tirol · Caríntia · Vorarlberg · 6 cidades', de: 'Salzburg · Salzkammergut · Tirol · Kärnten · Vorarlberg · 6 Städte', nl: 'Salzburg · Salzkammergut · Tirol · Karinthië · Vorarlberg · 6 steden' },
    maxTemp: 21,
  },
]
...
const COUNTRIES: Country[] = [
  {
    id: 'lithuania',
    flag: '🇱🇹',
    name: { en: 'Lithuania', fr: 'Lituanie', es: 'Lituania', pt: 'Lituânia', de: 'Litauen', nl: 'Litouwen' },
    ...
    destinations: [
      {
        ...
        name: 'Neringa',
        julyTemp: 21,
        tag: { en: 'Baltic spit · car-free dunes', fr: 'Flèche baltique · dunes sans voiture', es: 'Lengua báltica · dunas sin coches', pt: 'Língua báltica · dunas sem carros', de: 'Baltische Nehrung · autofreie Dünen', nl: 'Baltische landtong · autovrije duinen' },
        why: {
  ...
  },
  {
    id: 'norway',
    flag: '🇳🇴',
    name: { en: 'Norway', fr: 'Norvège', es: 'Noruega', pt: 'Noruega', de: 'Norwegen', nl: 'Noorwegen' },
    countrySlug: 'norway',
    country: 'Norway',
    revenueNote: '€2.77',
    destinations: [
      {
        ...
        name: 'Bergen',
        julyTemp: 18,
        tag: { en: 'Fjord gateway · 18°C', fr: 'Porte des fjords · 18°C', es: 'Puerta a los fiordos · 18°C', pt: 'Porta dos fiordes · 18°C', de: 'Tor zu den Fjorden · 18°C', nl: 'Poort tot de fjorden · 18°C' },
        why: {
  ...
  },
  {
    id: 'austria',
    flag: '🇦🇹',
    name: { en: 'Austria', fr: 'Autriche', es: 'Austria', pt: 'Áustria', de: 'Österreich', nl: 'Oostenrijk' },
    countrySlug: 'austria',
    country: 'Austria',
    revenueNote: '€2.34',
    destinations: [
      {
        ...
        name: 'Innsbruck',
        julyTemp: 24,
        tag: { en: '574m · Tirol Alps', fr: '574m · Alpes du Tirol', es: '574m · Alpes del Tirol', pt: '574m · Alpes do Tirol', de: '574m · Tiroler Alpen', nl: '574m · Tiroler Alpen' },
        why: {
      ...
      },
      {
        ...
        name: 'Hallstatt',
        julyTemp: 22,
        tag: { en: 'Alpine lake · UNESCO', fr: 'Lac alpin · UNESCO', es: 'Lago alpino · UNESCO', pt: 'Lago alpino · UNESCO', de: 'Alpensee · UNESCO', nl: 'Alpenmeer · UNESCO' },
        why: {
  ...
  },
  {
    id: 'france',
    flag: '🇫🇷',
    name: { en: 'France', fr: 'France', es: 'Francia', pt: 'França', de: 'Frankreich', nl: 'Frankrijk' },
    countrySlug: 'france',
    country: 'France',
    destinations: [
      {
        ...
        name: 'Biarritz',
        julyTemp: 22,
        tag: { en: 'Surf & Basque coast', fr: 'Surf & côte basque', es: 'Surf & costa vasca', pt: 'Surf & costa basca', de: 'Surfen & Baskenküste', nl: 'Surfen & Baskische kust' },
        why: {
      ...
      },
      {
        ...
        name: 'Annecy',
        julyTemp: 25,
        tag: { en: '448m · French Alps', fr: '448m · Alpes françaises', es: '448m · Alpes franceses', pt: '448m · Alpes francesas', de: '448m · Französische Alpen', nl: '448m · Franse Alpen' },
        why: {
  ...
  },
  {
    id: 'ireland',
    flag: '🇮🇪',
    name: { en: 'Ireland', fr: 'Irlande', es: 'Irlanda', pt: 'Irlanda', de: 'Irland', nl: 'Ierland' },
    countrySlug: 'ireland',
    country: 'Ireland',
    destinations: [
      {
        ...
        name: 'Galway',
        julyTemp: 18,
        tag: { en: 'Wild Atlantic Way', fr: 'Wild Atlantic Way', es: 'Wild Atlantic Way', pt: 'Wild Atlantic Way', de: 'Wild Atlantic Way', nl: 'Wild Atlantic Way' },
        why: {
  ...
  },
  {
    id: 'switzerland',
    flag: '🇨🇭',
    name: { en: 'Switzerland', fr: 'Suisse', es: 'Suiza', pt: 'Suíça', de: 'Schweiz', nl: 'Zwitserland' },
    ...
    destinations: [
      {
        ...
        name: 'Grindelwald',
        julyTemp: 19,
        tag: { en: '1,034m · Bernese Alps', fr: '1034m · Alpes bernoises', es: '1034m · Alpes berneses', pt: '1034m · Alpes berneses', de: '1.034m · Berner Alpen', nl: '1.034m · Berner Alpen' },
        why: {
      ...
      },
      {
        ...
        name: 'Locarno',
        julyTemp: 27,
        tag: { en: 'Swiss-Italian lakes · Ticino', fr: 'Lacs suisses-italiens · Tessin', es: 'Lagos suizo-italianos · Tesino', pt: 'Lagos suíço-italianos · Ticino', de: 'Schweizerisch-italienische Seen · Tessin', nl: 'Zwitsers-Italiaanse meren · Ticino' },
        why: {
  ...
  },
  {
    id: 'portugal',
    flag: '🇵🇹',
    name: { en: 'Portugal', fr: 'Portugal', es: 'Portugal', pt: 'Portugal', de: 'Portugal', nl: 'Portugal' },
    ...
    destinations: [
      {
        ...
        name: 'Peniche',
        julyTemp: 23,
        tag: { en: 'Atlantic surf peninsula', fr: 'Péninsule surf atlantique', es: 'Península surf atlántico', pt: 'Península surf atlântico', de: 'Atlantische Surf-Halbinsel', nl: 'Atlantisch surfschiereiland' },
        why: {
  ...
  },
  {
    id: 'germany',
    flag: '🇩🇪',
    name: { en: 'Germany', fr: 'Allemagne', es: 'Alemania', pt: 'Alemanha', de: 'Deutschland', nl: 'Duitsland' },
    countrySlug: 'germany',
    country: 'Germany',
    destinations: [
      {
        ...
        name: 'Freiburg',
        julyTemp: 24,
        tag: { en: 'Black Forest gateway', fr: 'Porte de la Forêt-Noire', es: 'Puerta de la Selva Negra', pt: 'Porta da Floresta Negra', de: 'Tor zum Schwarzwald', nl: 'Poort tot het Zwarte Woud' },
        why: {
  ...
  },
  {
    id: 'slovenia',
    flag: '🇸🇮',
    name: { en: 'Slovenia', fr: 'Slovénie', es: 'Eslovenia', pt: 'Eslovénia', de: 'Slowenien', nl: 'Slovenië' },
    ...
    destinations: [
      {
        ...
        name: 'Bled',
        julyTemp: 23,
        tag: { en: '501m · Julian Alps', fr: '501m · Alpes juliennes', es: '501m · Alpes julianas', pt: '501m · Alpes julianas', de: '501m · Julische Alpen', nl: '501m · Julische Alpen' },
        why: {
  ...
  },
  {
    id: 'italy',
    flag: '🇮🇹',
    name: { en: 'Italy', fr: 'Italie', es: 'Italia', pt: 'Itália', de: 'Italien', nl: 'Italië' },
    countrySlug: 'italy',
    country: 'Italy',
    destinations: [
      {
        ...
        name: 'Lake Como',
        julyTemp: 26,
        tag: { en: 'Alpine lake · Lombardy', fr: 'Lac alpin · Lombardie', es: 'Lago alpino · Lombardía', pt: 'Lago alpino · Lombardia', de: 'Alpensee · Lombardei', nl: 'Alpenmeer · Lombardije' },
        why: {
  ...
  },
  {
    id: 'denmark',
    flag: '🇩🇰',
    name: { en: 'Denmark', fr: 'Danemark', es: 'Dinamarca', pt: 'Dinamarca', de: 'Dänemark', nl: 'Denemarken' },
    countrySlug: 'denmark',
    country: 'Denmark',
    destinations: [
      {
        ...
        name: 'Copenhagen',
        julyTemp: 22,
        tag: { en: 'Scandinavian design capital', fr: 'Capitale du design scandinave', es: 'Capital del diseño escandinavo', pt: 'Capital do design escandinavo', de: 'Skandinavische Designhauptstadt', nl: 'Scandinavische designhoofdstad' },
        why: {
  ...
  },
  {
    id: 'estonia',
    flag: '🇪🇪',
    name: { en: 'Estonia', fr: 'Estonie', es: 'Estonia', pt: 'Estónia', de: 'Estland', nl: 'Estland' },
    countrySlug: 'estonia',
    country: 'Estonia',
    destinations: [
      {
        ...
        name: 'Tallinn',
        julyTemp: 21,
        tag: { en: 'Medieval Baltic capital', fr: 'Capitale baltique médiévale', es: 'Capital báltica medieval', pt: 'Capital báltica medieval', de: 'Mittelalterliche baltische Hauptstadt', nl: 'Middeleeuwse Baltische hoofdstad' },
        why: {
  ...
  },
  {
    id: 'united-kingdom',
    flag: '🇬🇧',
    name: { en: 'United Kingdom', fr: 'Royaume-Uni', es: 'Reino Unido', pt: 'Reino Unido', de: 'Vereinigtes Königreich', nl: 'Verenigd Koninkrijk' },
    ...
    destinations: [
      {
        ...
        name: 'Edinburgh',
        julyTemp: 19,
        tag: { en: "Scottish Highlands gateway", fr: 'Porte des Highlands', es: 'Puerta de las Highlands', pt: 'Porta das Highlands', de: 'Tor zu den schottischen Highlands', nl: 'Poort tot de Schotse Highlands' },
        why: {
...
const T = {
  ...
  seeGuide: { en: 'Dog travel guide', fr: 'Guide voyage chien', es: 'Guía viaje perro', pt: 'Guia viagem cão', de: 'Reiseführer für Hunde', nl: 'Reisgids voor honden' },
  ...
  ourPicks: { en: '3 pet-friendly picks', fr: '3 adresses pet-friendly', es: '3 opciones pet-friendly', pt: '3 opções pet-friendly', de: '3 haustierfreundliche Adressen', nl: '3 huisdiervriendelijke adressen' },
  seeCountry: { en: 'All hotels in', fr: 'Tous les hôtels en', es: 'Todos los hoteles en', pt: 'Todos os hotéis em', de: 'Alle Hotels in', nl: 'Alle hotels in' },
