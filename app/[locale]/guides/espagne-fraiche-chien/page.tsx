...
const REGIONS: Region[] = [
  {
    id: 'pays-basque',
    emoji: '🌊',
    title: { en: 'Basque Country', fr: 'Pays basque', es: 'País Vasco', pt: 'País Basco', de: 'Baskenland', nl: 'Baskenland', it: 'Paesi Baschi' },
    cities: [
      {
        slug: 'san-sebastian',
        name: 'San Sebastián',
        region: { en: 'Basque Country', fr: 'Pays basque', es: 'País Vasco', pt: 'País Basco', de: 'Baskenland', nl: 'Baskenland', it: 'Paesi Baschi' },
        julyTemp: 22,
        tag: { en: 'Atlantic surf coast', fr: 'Côte surf atlantique', es: 'Costa surf atlántica', pt: 'Costa surf atlântica', de: 'Atlantische Surfküste', nl: 'Atlantische surfkust', it: 'Costa surf atlantica' },
        why: {
          ...
          it: `La costa basca resta a 22°C mentre Madrid tocca i 38°C. La spiaggia della Concha ammette i cani prima delle 10 e dopo le 20 in estate, la spiaggia urbana dog-friendly più famosa di Spagna. La spiaggia di Ondarreta è dog-friendly tutto l'anno. I bar di pintxos di Calle 31 de Agosto accettano i cani in terrazza. Il centro storico si gira benissimo con il tuo cane.`,
        },
        dogTip: {
      ...
      },
      {
        ...
        region: { en: 'Basque Country', fr: 'Pays basque', es: 'País Vasco', pt: 'País Basco', de: 'Baskenland', nl: 'Baskenland', it: 'Paesi Baschi' },
        julyTemp: 22,
        tag: { en: 'Guggenheim city · Nervión river', fr: 'Ville Guggenheim · río Nervión', es: 'Ciudad Guggenheim · ría del Nervión', pt: 'Cidade Guggenheim · ria do Nervión', de: 'Guggenheim-Stadt · Fluss Nervión', nl: 'Guggenheimstad · rivier de Nervión', it: 'Città Guggenheim · fiume Nervión' },
        why: {
          ...
          it: 'Bilbao beneficia della stessa aria atlantica che mantiene fresca la costa basca. La passeggiata lungo il Nervión offre 12 km di cammino pianeggiante e ombreggiato per il tuo cane. Il Parque Etxebarria è senza guinzaglio dal parcheggio fino al belvedere. I ristoranti con terrazza del Mercado de la Ribera accettano i cani. Funivia per il monte Artxanda: cani gratis.',
        },
        dogTip: {
          ...
          it: 'Parco Naturale di Urkiola, 45 min in auto: vasta faggeta, senza guinzaglio, fresco anche in agosto.',
        },
        hotels: [
          {
            name: 'Gran Hotel Domine Bilbao',
            stars: 5,
            note: { en: 'Facing the Guggenheim, design hotel, small pets accepted.', fr: 'Face au Guggenheim, hôtel design, petits animaux acceptés.', es: 'Frente al Guggenheim, hotel de diseño, mascotas pequeñas aceptadas.', pt: 'Em frente ao Guggenheim, hotel de design, animais pequenos aceites.', de: 'Gegenüber dem Guggenheim, Designhotel, kleine Haustiere erlaubt.', nl: 'Tegenover het Guggenheim, designhotel, kleine huisdieren toegestaan.', it: 'Di fronte al Guggenheim, hotel di design, animali di piccola taglia accettati.' },
          },
          {
            name: 'Hotel Miró',
            stars: 4,
            note: { en: 'Boutique hotel by the Nervión, 5 min to Guggenheim, dogs under 10 kg welcome.', fr: 'Hôtel boutique au bord du Nervión, 5 min du Guggenheim, chiens de moins de 10 kg bienvenus.', es: 'Hotel boutique junto al Nervión, a 5 min del Guggenheim, perros menores de 10 kg bienvenidos.', pt: 'Hotel boutique junto ao Nervión, 5 min do Guggenheim, cães abaixo de 10 kg bem-vindos.', de: 'Boutique-Hotel am Nervión, 5 Minuten zum Guggenheim, Hunde unter 10 kg willkommen.', nl: 'Boetiekhotel aan de Nervión, 5 min van het Guggenheim, honden onder 10 kg welkom.', it: 'Boutique hotel sul Nervión, a 5 min dal Guggenheim, cani sotto i 10 kg benvenuti.' },
          },
          {
            name: 'Hotel Ercilla',
            stars: 4,
            note: { en: 'Classic Bilbao hotel near the Old Town, dog-friendly rooms available on request.', fr: 'Hôtel classique de Bilbao près du quartier ancien, chambres dog-friendly sur demande.', es: 'Hotel clásico de Bilbao cerca del casco viejo, habitaciones dog-friendly disponibles bajo petición.', pt: 'Hotel clássico de Bilbau perto do bairro antigo, quartos dog-friendly disponíveis mediante pedido.', de: `Klassisches Hotel in Bilbao nahe der Altstadt, hundefreundliche Zimmer auf Anfrage verfügbar.`, nl: 'Klassiek hotel in Bilbao vlak bij de oude stad, hondvriendelijke kamers op aanvraag.', it: 'Hotel classico di Bilbao vicino al centro storico, camere dog-friendly disponibili su richiesta.' },
          },
        ],
      },
    ],
  },
  {
    id: 'cantabrie',
    emoji: '🏖️',
    title: { en: 'Cantabria', fr: 'Cantabrie', es: 'Cantabria', pt: 'Cantábria', de: 'Kantabrien', nl: 'Kantabrië', it: 'Cantabria' },
    cities: [
      {
        slug: 'santander',
        name: 'Santander',
        region: { en: 'Cantabria', fr: 'Cantabrie', es: 'Cantabria', pt: 'Cantábria', de: 'Kantabrien', nl: 'Kantabrië', it: 'Cantabria' },
        julyTemp: 20,
        tag: { en: 'Atlantic bay · royal summer city', fr: "Baie atlantique · ville royale d'été", es: 'Bahía atlántica · ciudad real de verano', pt: 'Baía atlântica · cidade real de verão', de: 'Atlantikbucht · königliche Sommerstadt', nl: 'Atlantische baai · koninklijke zomerstad', it: `Baia atlantica · città reale d'estate` },
        why: {
          ...
          it: 'Santander si trova su una penisola tra due baie, con brezze marine che raramente fanno superare i 20°C a luglio. La spiaggia di El Sardinero ammette i cani prima delle 10 e dopo le 20. Il parco della Penisola della Magdalena (ex tenuta reale estiva) ha 11 ettari di scogliere e giardini, per lo più senza guinzaglio. La Cantabria ha la più alta densità di ristoranti dog-friendly del Nord Spagna.',
        },
        dogTip: {
  ...
  },
  {
    id: 'asturies',
    emoji: '🌿',
    title: { en: 'Asturias', fr: 'Asturies', es: 'Asturias', pt: 'Astúrias', de: 'Asturien', nl: 'Asturië', it: 'Asturie' },
    cities: [
      {
        slug: 'gijon',
        name: 'Gijón',
        region: { en: 'Asturias', fr: 'Asturies', es: 'Asturias', pt: 'Astúrias', de: 'Asturien', nl: 'Asturië', it: 'Asturie' },
        julyTemp: 18,
        tag: { en: 'Cider coast · 18°C', fr: 'Côte du cidre · 18°C', es: 'Costa de la sidra · 18°C', pt: 'Costa da sidra · 18°C', de: 'Cidre-Küste · 18°C', nl: 'Cider-kust · 18°C', it: 'Costa del sidro · 18°C' },
        why: {
          ...
          it: `Gijón è la grande città più fresca della Penisola Iberica con 18°C a luglio, alla stessa latitudine della costa mediterranea spagnola ma affacciata sull'Atlantico. La spiaggia di San Lorenzo (3 km) ammette i cani tutto l'anno al mattino presto. Il quartiere storico di Cimadevilla è dog-friendly ovunque. Le terrazze delle sidrerías sono una consuetudine culturale per i cani.`,
        },
        dogTip: {
      ...
      },
      {
        ...
        region: { en: 'Asturias', fr: 'Asturies', es: 'Asturias', pt: 'Astúrias', de: 'Asturien', nl: 'Asturië', it: 'Asturie' },
        julyTemp: 18,
        tag: { en: 'Pre-Romanesque capital · 18°C', fr: 'Capitale pré-romane · 18°C', es: 'Capital prerrománica · 18°C', pt: 'Capital pré-românica · 18°C', de: 'Vorromanische Hauptstadt · 18°C', nl: 'Pre-Romaanse hoofdstad · 18°C', it: 'Capitale preromanica · 18°C' },
        why: {
          ...
          it: `Il nostro miglior segnale di fatturato per una città asturiana dell'entroterra: un utente portoghese ha prenotato un soggiorno di agosto tramite la nostra campagna dog-friendly. Oviedo si trova a 228m con una brezza atlantica costante, 18°C a luglio quando Madrid soffoca a 36°C. Le chiese preromaniche sul cammino UNESCO del Camino fanno delle strade pedonali la norma. Il Parque San Francisco (7 ha, centro città) è senza guinzaglio e densamente ombreggiato.`,
        },
        dogTip: {
  ...
  },
  {
    id: 'galice',
    emoji: '🌧️',
    title: { en: 'Galicia', fr: 'Galice', es: 'Galicia', pt: 'Galiza', de: 'Galicien', nl: 'Galicië', it: 'Galizia' },
    cities: [
      {
        slug: 'santiago-de-compostela',
        name: 'Santiago de Compostela',
        region: { en: 'Galicia', fr: 'Galice', es: 'Galicia', pt: 'Galiza', de: 'Galicien', nl: 'Galicië', it: 'Galizia' },
        julyTemp: 21,
        tag: { en: 'Camino end · granite city', fr: 'Fin du Camino · ville de granit', es: 'Fin del Camino · ciudad de granito', pt: 'Fim do Caminho · cidade de granito', de: 'Ziel des Camino · Granitstadt', nl: 'Einde van de Camino · granietstad', it: 'Fine del Camino · città di granito' },
        why: {
          ...
          it: `Santiago si trova a 260m con il sistema di piogge atlantiche che mantiene la Galizia verde tutto l'anno, con un picco di 21°C a luglio. La cultura del pellegrinaggio del Camino fa sì che i cani siano profondamente radicati nella vita cittadina: l'ultimo tratto di 100 km (da Sarria a Santiago) è il sentiero a lunga distanza più percorso con i cani al mondo. Il centro storico è lastricato in pietra e fresco. Parco Alameda: 100.000 m² di bosco di querce, pini e camelie, senza guinzaglio.`,
        },
        dogTip: {
      ...
      },
      {
        ...
        region: { en: 'Galicia', fr: 'Galice', es: 'Galicia', pt: 'Galiza', de: 'Galicien', nl: 'Galicië', it: 'Galizia' },
        julyTemp: 18,
        tag: { en: 'Atlantic lighthouse city · 18°C', fr: 'Ville-phare atlantique · 18°C', es: 'Ciudad faro atlántica · 18°C', pt: 'Cidade farol atlântica · 18°C', de: 'Atlantische Leuchtturmstadt · 18°C', nl: 'Atlantische vuurtorenstad · 18°C', it: 'Città faro atlantica · 18°C' },
        why: {
          ...
          it: `Gli edifici con facciate a vetri di A Coruña (le galerías) sono una risposta vernacolare al vento e alla pioggia atlantici. Media di 18°C a luglio. Le spiagge di Riazor e Orzán ammettono i cani prima delle 10 e dopo le 20 in stagione, rivolte a ovest verso l'oceano per catturare una brezza pomeridiana che abbassa la temperatura percepita di 4°C. Il lungomare (8 km intorno alla penisola) è piatto e dog-friendly.`,
        },
        dogTip: {
  ...
  },
  {
    id: 'pyrenees',
    emoji: '🏔️',
    title: { en: 'Aragonese Pyrenees', fr: 'Pyrénées aragonaises', es: 'Pirineo aragonés', pt: 'Pirenéus aragoneses', de: 'Aragonesische Pyrenäen', nl: 'Aragonese Pyreneeën', it: 'Pirenei aragonesi' },
    cities: [
      {
        slug: 'jaca',
        name: 'Jaca',
        region: { en: 'Aragonese Pyrenees', fr: 'Pyrénées aragonaises', es: 'Pirineo aragonés', pt: 'Pirenéus aragoneses', de: 'Aragonesische Pyrenäen', nl: 'Aragonese Pyreneeën', it: 'Pirenei aragonesi' },
        julyTemp: 23,
        tag: { en: '820m · Pyrenean gateway', fr: '820m · Porte des Pyrénées', es: '820m · Puerta del Pirineo', pt: '820m · Porta dos Pirenéus', de: '820m · Tor zu den Pyrenäen', nl: '820m · poort naar de Pyreneeën', it: '820m · porta dei Pirenei' },
        why: {
          ...
          it: 'Jaca si trova a 820m ai piedi dei Pirenei, 15°C in meno rispetto a Saragozza, 120 km più a sud. La Valle de Hecho e la Valle de Ansó iniziano a 30 km dalla città: faggete incontaminate a 1.200m, cascate e rifugi di montagna che accettano i cani. La città ha una cattedrale romanica e la cittadella medievale meglio conservata di Spagna. Il Parco Nazionale di Ordesa è a 1 ora di distanza.',
        },
        dogTip: {
...
const T = {
  title: {
    ...
    it: 'Le migliori città per sfuggire al caldo in Spagna con il tuo cane (2026)',
  },
  metaTitle: {
    ...
    it: 'Spagna fresca con il tuo cane: 8 città sotto i 23°C a luglio (2026)',
  },
  metaDesc: {
    ...
    it: 'Mentre Madrid e Barcellona cuociono a 38°C, il Nord della Spagna resta fresco. San Sebastián, Bilbao, Santander, Gijón, Oviedo, Santiago, A Coruña, Jaca: 8 città dog-friendly sotto i 23°C a luglio con hotel selezionati.',
  },
  intro: {
    ...
    it: `La costa mediterranea spagnola tocca i 36-40°C a luglio. Ma 800 km più a nord, la Spagna verde (Paesi Baschi, Cantabria, Asturie e Galizia) resta sui 18-23°C, rinfrescata dallo stesso sistema atlantico che mantiene miti l'Irlanda e la Bretagna. Queste 8 città ti permettono di goderti una vacanza spagnola senza far surriscaldare il tuo cane.`,
  },
  ...
  seeHotels: { en: 'All pet-friendly hotels', fr: 'Tous les hôtels pet-friendly', es: 'Todos los hoteles pet-friendly', pt: 'Todos os hotéis pet-friendly', de: 'Alle haustierfreundlichen Hotels', nl: 'Alle dierenvriendelijke hotels', it: 'Tutti gli hotel pet-friendly' },
  hotelsLabel: { en: 'Our hotel picks', fr: 'Nos hôtels recommandés', es: 'Nuestros hoteles recomendados', pt: 'Os nossos hotéis recomendados', de: 'Unsere Hotelauswahl', nl: 'Onze hotelselectie', it: 'I nostri hotel consigliati' },
  ...
  faq: {
    ...
    a1: {
      ...
      it: 'Il Nord della Spagna (Paesi Baschi, Cantabria, Asturie, Galizia) resta costantemente 15-20°C più fresco del sud mediterraneo a luglio. Gijón e A Coruña hanno una media di 18°C, come Bergen in Norvegia. I Pirenei in quota (Jaca: 820m) arrivano al massimo a 23°C. La chiave è il sistema meteorologico atlantico: umido, fresco e drasticamente diverso dal sud della Spagna.',
    },
    q2: { en: 'Are there dog-friendly beaches in northern Spain?', fr: "Y a-t-il des plages dog-friendly dans le Nord de l'Espagne ?", es: '¿Hay playas dog-friendly en el norte de España?', pt: 'Há praias dog-friendly no norte de Espanha?', de: 'Gibt es hundefreundliche Strände in Nordspanien?', nl: 'Zijn er hondvriendelijke stranden in Noord-Spanje?', it: 'Ci sono spiagge dog-friendly nel Nord della Spagna?' },
    a2: {
      ...
      it: `Sì, e molto più permissive rispetto al sud. San Sebastián (Ondarreta, La Concha: prima delle 10/dopo le 20 in stagione), Santander (El Sardinero, Puntal), Gijón (San Lorenzo: al mattino) e A Coruña (Riazor, Orzán: al mattino) hanno tutte un accesso chiaro per i cani. Fuori da luglio-agosto, la maggior parte delle spiagge del Nord della Spagna sono dog-friendly tutto l'anno senza limiti orari.`,
    },
    q3: { en: 'How do I get to northern Spain with a dog by train?', fr: "Comment rejoindre le nord de l'Espagne avec un chien en train ?", es: '¿Cómo llegar al norte de España con un perro en tren?', pt: 'Como chegar ao norte de Espanha com um cão de comboio?', de: 'Wie komme ich mit dem Hund per Zug nach Nordspanien?', nl: 'Hoe kom ik met een hond met de trein naar Noord-Spanje?', it: 'Come arrivare nel Nord della Spagna con un cane in treno?' },
    a3: {
      ...
      it: `Renfe accetta cani fino a 10 kg in trasportino (gratis) o di qualsiasi taglia su alcuni treni media-distancia (supplemento di 10€, museruola obbligatoria). Dalla Francia: il valico di Hendaye con TGV più coincidenza Renfe raggiunge San Sebastián in 45 min. Per la Galizia, l'Alvia ad alta velocità raggiunge Santiago in 2h30 da Madrid. La ferrovia costiera a scartamento ridotto FEVE percorre tutta la costa cantabrica e accetta i cani.`,
    },
    q4: { en: 'Is northern Spain dog-friendly in August specifically?', fr: "Le nord de l'Espagne est-il dog-friendly en août spécifiquement ?", es: '¿Es el norte de España dog-friendly en agosto específicamente?', pt: 'O norte de Espanha é dog-friendly especificamente em agosto?', de: 'Ist Nordspanien speziell im August hundefreundlich?', nl: 'Is Noord-Spanje specifiek in augustus hondvriendelijk?', it: 'Il Nord della Spagna è dog-friendly in particolare ad agosto?' },
    a4: {
      ...
      it: `Agosto è l'alta stagione nel Nord della Spagna, il che significa più folla ma anche una regione attrezzata per il turismo estivo. Le restrizioni per i cani sulle spiagge sono più rigide a luglio-agosto (accesso a orari, non divieti). Il clima atlantico resta fresco: Gijón ha una media di 19°C ad agosto, San Sebastián 22°C. Le zone di montagna (Jaca, Pirenei) sono ideali ad agosto, con temperature più fresche e minore umidità rispetto alla costa.`,
    },
    q5: { en: 'Can my dog hike in the Pyrenees in summer?', fr: 'Mon chien peut-il randonner dans les Pyrénées en été ?', es: '¿Puede mi perro hacer senderismo en los Pirineos en verano?', pt: 'O meu cão pode fazer caminhadas nos Pirenéus no verão?', de: 'Kann mein Hund im Sommer in den Pyrenäen wandern?', nl: 'Kan mijn hond in de zomer wandelen in de Pyreneeën?', it: 'Il mio cane può fare escursioni sui Pirenei in estate?' },
    a5: {
      ...
      it: `Sì, i Pirenei aragonesi sono tra le migliori destinazioni per escursioni estive con i cani in Europa. La maggior parte dei sentieri sopra i 1.000m è senza guinzaglio e senza regole specifiche per i cani. I rifugi di montagna (refugios) accettano generalmente i cani, in particolare nelle valli di Hecho e Ansó. Il Parco Nazionale di Ordesa richiede il guinzaglio ma consente i cani su tutti i sentieri segnalati. Le fonti d'acqua sono abbondanti sopra i 1.200m. Le zampe vanno controllate sui sentieri di calcare taglienti, ma i tratti boschivi ombreggiati sono molto più dolci.`,
    },
  },
}
      ...
      <section className="bg-gradient-to-br from-red-900 via-orange-900 to-yellow-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-yellow-200 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-5">
            🇪🇸 {locale === 'fr' ? 'Espagne verte' : locale === 'es' ? 'España verde' : locale === 'pt' ? 'Espanha verde' : locale === 'de' ? 'Grünes Spanien' : locale === 'nl' ? 'Groen Spanje' : locale === 'it' ? 'Spagna verde' : 'Green Spain'}
          </div>
