...
const REGIONS: Region[] = [
  {
    id: 'pays-basque',
    emoji: '🌊',
    title: { en: 'Basque Country', fr: 'Pays basque', es: 'País Vasco', pt: 'País Basco', de: 'Baskenland' },
    cities: [
      {
        slug: 'san-sebastian',
        name: 'San Sebastián',
        region: { en: 'Basque Country', fr: 'Pays basque', es: 'País Vasco', pt: 'País Basco', de: 'Baskenland' },
        julyTemp: 22,
        tag: { en: 'Atlantic surf coast', fr: 'Côte surf atlantique', es: 'Costa surf atlántica', pt: 'Costa surf atlântica', de: 'Atlantische Surfküste' },
        why: {
      ...
      },
      {
        ...
        region: { en: 'Basque Country', fr: 'Pays basque', es: 'País Vasco', pt: 'País Basco', de: 'Baskenland' },
        julyTemp: 22,
        tag: { en: 'Guggenheim city · Nervión river', fr: 'Ville Guggenheim · río Nervión', es: 'Ciudad Guggenheim · ría del Nervión', pt: 'Cidade Guggenheim · ria do Nervión', de: 'Guggenheim-Stadt · Fluss Nervión' },
        why: {
  ...
  },
  {
    id: 'cantabrie',
    emoji: '🏖️',
    title: { en: 'Cantabria', fr: 'Cantabrie', es: 'Cantabria', pt: 'Cantábria', de: 'Kantabrien' },
    cities: [
      {
        slug: 'santander',
        name: 'Santander',
        region: { en: 'Cantabria', fr: 'Cantabrie', es: 'Cantabria', pt: 'Cantábria', de: 'Kantabrien' },
        julyTemp: 20,
        tag: { en: 'Atlantic bay · royal summer city', fr: "Baie atlantique · ville royale d'été", es: 'Bahía atlántica · ciudad real de verano', pt: 'Baía atlântica · cidade real de verão', de: 'Atlantikbucht · königliche Sommerstadt' },
        why: {
        ...
        hotels: [
          {
            name: 'Hotel Chiqui',
            stars: 4,
            note: { en: 'Right on El Sardinero beach, sea-view rooms, pets welcome.', fr: 'Directement sur la plage d\'El Sardinero, chambres vue mer, animaux bienvenus.', es: 'Justo en la playa del Sardinero, habitaciones con vistas al mar, mascotas bienvenidas.', pt: 'Mesmo na praia de El Sardinero, quartos com vista para o mar, animais bem-vindos.', de: 'Direkt am Strand El Sardinero, Zimmer mit Meerblick, Haustiere willkommen.' },
          },
          {
            name: 'Eurostars Real',
            stars: 5,
  ...
  },
  {
    id: 'asturies',
    emoji: '🌿',
    title: { en: 'Asturias', fr: 'Asturies', es: 'Asturias', pt: 'Astúrias', de: 'Asturien' },
    cities: [
      {
        slug: 'gijon',
        name: 'Gijón',
        region: { en: 'Asturias', fr: 'Asturies', es: 'Asturias', pt: 'Astúrias', de: 'Asturien' },
        julyTemp: 18,
        tag: { en: 'Cider coast · 18°C', fr: 'Côte du cidre · 18°C', es: 'Costa de la sidra · 18°C', pt: 'Costa da sidra · 18°C', de: 'Cidre-Küste · 18°C' },
        why: {
      ...
      },
      {
        ...
        region: { en: 'Asturias', fr: 'Asturies', es: 'Asturias', pt: 'Astúrias', de: 'Asturien' },
        julyTemp: 18,
        tag: { en: 'Pre-Romanesque capital · 18°C', fr: 'Capitale pré-romane · 18°C', es: 'Capital prerrománica · 18°C', pt: 'Capital pré-românica · 18°C', de: 'Vorromanische Hauptstadt · 18°C' },
        why: {
  ...
  },
  {
    id: 'galice',
    emoji: '🌧️',
    title: { en: 'Galicia', fr: 'Galice', es: 'Galicia', pt: 'Galiza', de: 'Galicien' },
    cities: [
      {
        slug: 'santiago-de-compostela',
        name: 'Santiago de Compostela',
        region: { en: 'Galicia', fr: 'Galice', es: 'Galicia', pt: 'Galiza', de: 'Galicien' },
        julyTemp: 21,
        tag: { en: 'Camino end · granite city', fr: 'Fin du Camino · ville de granit', es: 'Fin del Camino · ciudad de granito', pt: 'Fim do Caminho · cidade de granito', de: 'Ziel des Camino · Granitstadt' },
        why: {
      ...
      },
      {
        ...
        region: { en: 'Galicia', fr: 'Galice', es: 'Galicia', pt: 'Galiza', de: 'Galicien' },
        julyTemp: 18,
        tag: { en: 'Atlantic lighthouse city · 18°C', fr: 'Ville-phare atlantique · 18°C', es: 'Ciudad faro atlántica · 18°C', pt: 'Cidade farol atlântica · 18°C', de: 'Atlantische Leuchtturmstadt · 18°C' },
        why: {
  ...
  },
  {
    id: 'pyrenees',
    emoji: '🏔️',
    title: { en: 'Aragonese Pyrenees', fr: 'Pyrénées aragonaises', es: 'Pirineo aragonés', pt: 'Pirenéus aragoneses', de: 'Aragonesische Pyrenäen' },
    cities: [
      {
        slug: 'jaca',
        name: 'Jaca',
        region: { en: 'Aragonese Pyrenees', fr: 'Pyrénées aragonaises', es: 'Pirineo aragonés', pt: 'Pirenéus aragoneses', de: 'Aragonesische Pyrenäen' },
        julyTemp: 23,
        tag: { en: '820m · Pyrenean gateway', fr: '820m · Porte des Pyrénées', es: '820m · Puerta del Pirineo', pt: '820m · Porta dos Pirenéus', de: '820m · Tor zu den Pyrenäen' },
        why: {
...
const T = {
  ...
  breadHome: { en: 'Home', fr: 'Accueil', es: 'Inicio', pt: 'Início', de: 'Start' },
  breadGuides: { en: 'Guides', fr: 'Guides', es: 'Guías', pt: 'Guias', de: 'Ratgeber' },
  faq: {
    q1: { en: 'Which Spanish cities stay cool in summer?', fr: 'Quelles villes espagnoles restent fraîches en été ?', es: '¿Qué ciudades españolas permanecen frescas en verano?', pt: 'Que cidades espanholas se mantêm frescas no verão?', de: 'Welche spanischen Städte bleiben im Sommer kühl?' },
    a1: {
    ...
    q2: { en: 'Are there dog-friendly beaches in northern Spain?', fr: "Y a-t-il des plages dog-friendly dans le Nord de l'Espagne ?", es: '¿Hay playas dog-friendly en el norte de España?', pt: 'Há praias dog-friendly no norte de Espanha?', de: 'Gibt es hundefreundliche Strände in Nordspanien?' },
    a2: {
    ...
    q3: { en: 'How do I get to northern Spain with a dog by train?', fr: "Comment rejoindre le nord de l'Espagne avec un chien en train ?", es: '¿Cómo llegar al norte de España con un perro en tren?', pt: 'Como chegar ao norte de Espanha com um cão de comboio?', de: 'Wie komme ich mit dem Hund per Zug nach Nordspanien?' },
    a3: {
    ...
    q5: { en: 'Can my dog hike in the Pyrenees in summer?', fr: 'Mon chien peut-il randonner dans les Pyrénées en été ?', es: '¿Puede mi perro hacer senderismo en los Pirineos en verano?', pt: 'O meu cão pode fazer caminhadas nos Pirenéus no verão?', de: 'Kann mein Hund im Sommer in den Pyrenäen wandern?' },
    a5: {
      ...
      <section className="bg-gradient-to-br from-red-900 via-orange-900 to-yellow-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-yellow-200 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-5">
            🇪🇸 {locale === 'fr' ? 'Espagne verte' : locale === 'es' ? 'España verde' : locale === 'pt' ? 'Espanha verde' : locale === 'de' ? 'Grünes Spanien' : 'Green Spain'}
          </div>
