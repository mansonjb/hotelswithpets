...
const REGIONS: Region[] = [
  {
    id: 'bretagne',
    emoji: '🌊',
    title: { en: 'Brittany', fr: 'Bretagne', es: 'Bretaña', pt: 'Bretanha', de: 'Bretagne', nl: 'Bretagne', it: 'Bretagna' },
    cities: [
      {
        slug: 'brest',
        name: 'Brest',
        region: { en: 'Brittany', fr: 'Bretagne', es: 'Bretaña', pt: 'Bretanha', de: 'Bretagne', nl: 'Bretagne', it: 'Bretagna' },
        julyTemp: 17,
        tag: { en: 'Atlantic tip · coolest city in France', fr: "Pointe atlantique · ville la plus fraîche de France", es: 'Punta atlántica · ciudad más fresca de Francia', pt: 'Ponta atlântica · cidade mais fresca de França', de: 'Atlantikspitze · kühlste Stadt Frankreichs', nl: 'Atlantische punt · koelste stad van Frankrijk', it: 'Punta atlantica · città più fresca di Francia' },
        why: {
      ...
      },
      {
        ...
        region: { en: 'Brittany', fr: 'Bretagne', es: 'Bretaña', pt: 'Bretanha', de: 'Bretagne', nl: 'Bretagne', it: 'Bretagna' },
        julyTemp: 20,
        tag: { en: 'Corsair city · ramparts · tidal beaches', fr: 'Cité corsaire · remparts · plages de marée', es: 'Ciudad corsaria · murallas · playas de marea', pt: 'Cidade corsária · muralhas · praias de maré', de: 'Korsarenstadt · Stadtmauern · Gezeitenstrände', nl: 'Kapersstad · stadsmuren · getijdenstranden', it: 'Città dei corsari · bastioni · spiagge di marea' },
        why: {
  ...
  },
  {
    id: 'normandie',
    emoji: '🏰',
    title: { en: 'Normandy', fr: 'Normandie', es: 'Normandía', pt: 'Normandia', de: 'Normandie', nl: 'Normandië', it: 'Normandia' },
    cities: [
      {
        slug: 'cherbourg',
        name: 'Cherbourg',
        region: { en: 'Normandy', fr: 'Normandie', es: 'Normandía', pt: 'Normandia', de: 'Normandie', nl: 'Normandië', it: 'Normandia' },
        julyTemp: 18,
        tag: { en: 'Cotentin peninsula · ferry port · 18°C', fr: 'Péninsule du Cotentin · port ferry · 18°C', es: 'Península de Cotentin · puerto ferry · 18°C', pt: 'Península de Cotentin · porto de ferry · 18°C', de: 'Halbinsel Cotentin · Fährhafen · 18°C', nl: 'Schiereiland Cotentin · veerhaven · 18°C', it: 'Penisola del Cotentin · porto traghetti · 18°C' },
        why: {
      ...
      },
      {
        ...
        region: { en: 'Normandy', fr: 'Normandie', es: 'Normandía', pt: 'Normandia', de: 'Normandie', nl: 'Normandië', it: 'Normandia' },
        julyTemp: 21,
        tag: { en: 'Impressionist harbour · Seine estuary', fr: 'Port impressionniste · estuaire de la Seine', es: 'Puerto impresionista · estuario del Sena', pt: 'Porto impressionista · estuário do Sena', de: 'Impressionistischer Hafen · Seine-Mündung', nl: 'Impressionistische haven · monding van de Seine', it: 'Porto impressionista · estuario della Senna' },
        why: {
  ...
  },
  {
    id: 'alsace',
    emoji: '🍷',
    title: { en: 'Alsace', fr: 'Alsace', es: 'Alsacia', pt: 'Alsácia', de: 'Elsass', nl: 'de Elzas', it: `l'Alsazia` },
    cities: [
      {
        slug: 'strasbourg',
        name: 'Strasbourg',
        region: { en: 'Alsace', fr: 'Alsace', es: 'Alsacia', pt: 'Alsácia', de: 'Elsass', nl: 'de Elzas', it: `l'Alsazia` },
        julyTemp: 24,
        tag: { en: 'European capital · canals · wine route', fr: 'Capitale européenne · canaux · route des vins', es: 'Capital europea · canales · ruta del vino', pt: 'Capital europeia · canais · rota dos vinhos', de: 'Europäische Hauptstadt · Kanäle · Weinstraße', nl: 'Europese hoofdstad · kanalen · wijnroute', it: 'Capitale europea · canali · strada del vino' },
        why: {
  ...
  },
  {
    id: 'alpes',
    emoji: '🏔️',
    title: { en: 'French Alps', fr: 'Alpes françaises', es: 'Alpes franceses', pt: 'Alpes franceses', de: 'Französische Alpen', nl: 'Franse Alpen', it: 'Alpi francesi' },
    cities: [
      {
        slug: 'annecy',
        name: 'Annecy',
        region: { en: 'French Alps', fr: 'Alpes françaises', es: 'Alpes franceses', pt: 'Alpes franceses', de: 'Französische Alpen', nl: 'Franse Alpen', it: 'Alpi francesi' },
        julyTemp: 25,
        tag: { en: 'Venice of the Alps · clearest lake in Europe', fr: "Venise des Alpes · lac le plus pur d'Europe", es: 'Venecia de los Alpes · lago más limpio de Europa', pt: 'Veneza dos Alpes · lago mais puro da Europa', de: 'Venedig der Alpen · klarster See Europas', nl: 'Venetië van de Alpen · helderste meer van Europa', it: `Venezia delle Alpi · lago più limpido d'Europa` },
        why: {
  ...
  },
  {
    id: 'cote-basque',
    emoji: '🌊',
    title: { en: 'French Basque Coast', fr: 'Côte basque française', es: 'Costa vasca francesa', pt: 'Costa basca francesa', de: 'Französische Baskenküste', nl: 'Franse Baskische kust', it: 'Costa basca francese' },
    cities: [
      {
        slug: 'bayonne',
        name: 'Bayonne',
        region: { en: 'French Basque Country', fr: 'Pays basque français', es: 'País Vasco francés', pt: 'País Basco francês', de: 'Französisches Baskenland', nl: 'Frans Baskenland', it: 'Paesi Baschi francesi' },
        julyTemp: 25,
        tag: { en: 'Basque capital · chocolate · Nive river', fr: 'Capitale basque · chocolat · rivière Nive', es: 'Capital vasca · chocolate · río Nive', pt: 'Capital basca · chocolate · rio Nive', de: 'Baskische Hauptstadt · Schokolade · Fluss Nive', nl: 'Baskische hoofdstad · chocolade · rivier de Nive', it: 'Capitale basca · cioccolato · fiume Nive' },
        why: {
...
const T = {
  title: {
    ...
    de: 'Die besten Städte, um mit Ihrem Hund der Hitze in Frankreich zu entkommen (2026)', nl: 'De beste steden om met je hond de hitte in Frankrijk te ontvluchten (2026)', it: 'Le migliori città per sfuggire al caldo in Francia con il tuo cane (2026)',
  },
  metaTitle: {
    ...
    de: 'Kühles Frankreich mit Hund: 7 Städte unter 25°C im Juli (2026)', nl: 'Koel Frankrijk met je hond: 7 steden onder de 25°C in juli (2026)', it: 'Francia fresca con il tuo cane: 7 città sotto i 25°C a luglio (2026)',
  },
  metaDesc: {
  ...
  dogTipLabel: { en: 'Dog tip', fr: 'Conseil chien', es: 'Consejo para tu perro', pt: 'Dica para o seu cão', de: 'Tipp für Hunde', nl: 'Tip voor je hond', it: 'Consiglio per il tuo cane' },
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-blue-200 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-5">
            🇫🇷 {locale === 'fr' ? 'France atlantique et alpine' : locale === 'es' ? 'Francia atlántica y alpina' : locale === 'pt' ? 'França atlântica e alpina' : locale === 'de' ? 'Atlantik- und Alpenfrankreich' : locale === 'nl' ? 'Atlantisch en Alpien Frankrijk' : locale === 'it' ? 'Francia atlantica e alpina' : 'Atlantic & Alpine France'}
          </div>
