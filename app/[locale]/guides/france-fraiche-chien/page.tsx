...
const REGIONS: Region[] = [
  {
    id: 'bretagne',
    emoji: '🌊',
    title: { en: 'Brittany', fr: 'Bretagne', es: 'Bretaña', pt: 'Bretanha', de: 'Bretagne' },
    cities: [
      {
        slug: 'brest',
        name: 'Brest',
        region: { en: 'Brittany', fr: 'Bretagne', es: 'Bretaña', pt: 'Bretanha', de: 'Bretagne' },
        julyTemp: 17,
        tag: { en: 'Atlantic tip · coolest city in France', fr: "Pointe atlantique · ville la plus fraîche de France", es: 'Punta atlántica · ciudad más fresca de Francia', pt: 'Ponta atlântica · cidade mais fresca de França', de: 'Atlantikspitze · kühlste Stadt Frankreichs' },
        why: {
        ...
        dogTip: {
          ...
          de: 'Halbinsel Crozon, Pointe de Pen-Hir: 5 km Klippenwege über dem Atlantik, vollständig ohne Leine, eine der schönsten Küstenlandschaften Frankreichs, kühl selbst im August.',
        },
        hotels: [
          {
      ...
      },
      {
        ...
        region: { en: 'Brittany', fr: 'Bretagne', es: 'Bretaña', pt: 'Bretanha', de: 'Bretagne' },
        julyTemp: 20,
        tag: { en: 'Corsair city · ramparts · tidal beaches', fr: 'Cité corsaire · remparts · plages de marée', es: 'Ciudad corsaria · murallas · playas de marea', pt: 'Cidade corsária · muralhas · praias de maré', de: 'Korsarenstadt · Stadtmauern · Gezeitenstrände' },
        why: {
  ...
  },
  {
    id: 'normandie',
    emoji: '🏰',
    title: { en: 'Normandy', fr: 'Normandie', es: 'Normandía', pt: 'Normandia', de: 'Normandie' },
    cities: [
      {
        slug: 'cherbourg',
        name: 'Cherbourg',
        region: { en: 'Normandy', fr: 'Normandie', es: 'Normandía', pt: 'Normandia', de: 'Normandie' },
        julyTemp: 18,
        tag: { en: 'Cotentin peninsula · ferry port · 18°C', fr: 'Péninsule du Cotentin · port ferry · 18°C', es: 'Península de Cotentin · puerto ferry · 18°C', pt: 'Península de Cotentin · porto de ferry · 18°C', de: 'Halbinsel Cotentin · Fährhafen · 18°C' },
        why: {
        ...
        dogTip: {
          ...
          de: 'Cap de la Hague, Nez de Jobourg: der westlichste Punkt der Normandie, 128 m hohe Klippen, Schafe und Seevögel, Hunde ohne Leine auf der gesamten 6 km langen Küstenrunde, fast immer menschenleer.',
        },
        hotels: [
          {
      ...
      },
      {
        ...
        region: { en: 'Normandy', fr: 'Normandie', es: 'Normandía', pt: 'Normandia', de: 'Normandie' },
        julyTemp: 21,
        tag: { en: 'Impressionist harbour · Seine estuary', fr: 'Port impressionniste · estuaire de la Seine', es: 'Puerto impresionista · estuario del Sena', pt: 'Porto impressionista · estuário do Sena', de: 'Impressionistischer Hafen · Seine-Mündung' },
        why: {
  ...
  },
  {
    id: 'alsace',
    emoji: '🍷',
    title: { en: 'Alsace', fr: 'Alsace', es: 'Alsacia', pt: 'Alsácia', de: 'Elsass' },
    cities: [
      {
        slug: 'strasbourg',
        name: 'Strasbourg',
        region: { en: 'Alsace', fr: 'Alsace', es: 'Alsacia', pt: 'Alsácia', de: 'Elsass' },
        julyTemp: 24,
        tag: { en: 'European capital · canals · wine route', fr: 'Capitale européenne · canaux · route des vins', es: 'Capital europea · canales · ruta del vino', pt: 'Capital europeia · canais · rota dos vinhos', de: 'Europäische Hauptstadt · Kanäle · Weinstraße' },
        why: {
  ...
  },
  {
    id: 'alpes',
    emoji: '🏔️',
    title: { en: 'French Alps', fr: 'Alpes françaises', es: 'Alpes franceses', pt: 'Alpes franceses', de: 'Französische Alpen' },
    cities: [
      {
        slug: 'annecy',
        name: 'Annecy',
        region: { en: 'French Alps', fr: 'Alpes françaises', es: 'Alpes franceses', pt: 'Alpes franceses', de: 'Französische Alpen' },
        julyTemp: 25,
        tag: { en: 'Venice of the Alps · clearest lake in Europe', fr: "Venise des Alpes · lac le plus pur d'Europe", es: 'Venecia de los Alpes · lago más limpio de Europa', pt: 'Veneza dos Alpes · lago mais puro da Europa', de: 'Venedig der Alpen · klarster See Europas' },
        why: {
  ...
  },
  {
    id: 'cote-basque',
    emoji: '🌊',
    title: { en: 'French Basque Coast', fr: 'Côte basque française', es: 'Costa vasca francesa', pt: 'Costa basca francesa', de: 'Französische Baskenküste' },
    cities: [
      {
        slug: 'bayonne',
        name: 'Bayonne',
        region: { en: 'French Basque Country', fr: 'Pays basque français', es: 'País Vasco francés', pt: 'País Basco francês', de: 'Französisches Baskenland' },
        julyTemp: 25,
        tag: { en: 'Basque capital · chocolate · Nive river', fr: 'Capitale basque · chocolat · rivière Nive', es: 'Capital vasca · chocolate · río Nive', pt: 'Capital basca · chocolate · rio Nive', de: 'Baskische Hauptstadt · Schokolade · Fluss Nive' },
        why: {
        ...
        dogTip: {
          ...
          de: 'Wald der Landes ab Hossegor (30 Min. nördlich): der Fernwanderweg GR8 verläuft 80 km durch flachen Kiefernwald, vollständig ohne Leine, Bäche zum Baden, keine Höhenunterschiede, ideal für große Hunde bei Hitze.',
        },
        hotels: [
          {
...
const T = {
  title: {
    ...
    de: 'Die besten Städte, um mit Ihrem Hund der Hitze in Frankreich zu entkommen (2026)',
  },
  metaTitle: {
    ...
    de: 'Kühles Frankreich mit Hund: 7 Städte unter 25°C im Juli (2026)',
  },
  metaDesc: {
    ...
    de: 'Während Paris und Lyon 32°C erreichen, bleibt das atlantische Frankreich kühl. Brest (17°C), Saint-Malo, Cherbourg, Honfleur, Straßburg, Annecy, Bayonne: 7 hundefreundliche Städte unter 25°C im Juli mit Hotelauswahl.',
  },
  intro: {
    ...
    de: 'Paris erreicht 32°C, Lyon 33°C, Marseille 30°C im Juli. Doch das atlantische Frankreich (Bretagne, Normandie, Baskenküste), das Elsass und das Alpenvorland bleiben deutlich unter 26°C, gekühlt durch Meeresluft, Höhenlage und Rheinbrisen. Diese 7 Städte bieten echte französische Sommer ohne die Hitze.',
  },
  ...
  dogTipLabel: { en: 'Dog tip', fr: 'Conseil chien', es: 'Consejo para tu perro', pt: 'Dica para o seu cão', de: 'Tipp für Hunde' },
  ...
  faq: {
    q1: { en: 'Which French cities stay cool in summer?', fr: 'Quelles villes françaises restent fraîches en été ?', es: '¿Qué ciudades francesas permanecen frescas en verano?', pt: 'Que cidades francesas se mantêm frescas no verão?', de: 'Welche französischen Städte bleiben im Sommer kühl?' },
    a1: {
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-blue-200 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-5">
            🇫🇷 {locale === 'fr' ? 'France atlantique et alpine' : locale === 'es' ? 'Francia atlántica y alpina' : locale === 'pt' ? 'França atlântica e alpina' : locale === 'de' ? 'Atlantik- und Alpenfrankreich' : 'Atlantic & Alpine France'}
          </div>
