...
const SIBLING_GUIDES = [
  { slug: 'alpes-chien', emoji: '🏔️', label: { en: 'Alpine cities: Geneva → Zurich → Munich → Salzburg', fr: 'Villes alpines : Genève → Zurich → Munich → Salzbourg', es: 'Ciudades alpinas: Ginebra → Zúrich → Múnich → Salzburgo', pt: 'Cidades alpinas: Genebra → Zurique → Munique → Salzburgo', de: 'Alpenstädte: Genf → Zürich → München → Salzburg' } },
  { slug: 'fenced-dog-parks-europe', emoji: '🌳', label: { en: 'Fenced dog parks in Europe', fr: 'Parcs canins clôturés en Europe', es: 'Parques caninos vallados en Europa', pt: 'Parques caninos vedados na Europa', de: 'Eingezäunte Hundeparks in Europa' } },
  { slug: 'dog-friendly-europe-by-month', emoji: '📅', label: { en: 'Dog-friendly Europe by month', fr: 'Europe dog-friendly mois par mois', es: 'Europa dog-friendly mes a mes', pt: 'Europa dog-friendly mês a mês', de: 'Hundefreundliches Europa Monat für Monat' } },
]
