...
const COPY = {
  ...
  pt: {
    ...
    subtitle: 'Esta guía te evita as sorpresas desagradables al hacer o check-in. Porque "pet-friendly" pode significar desde uma tolerância a regañadientes até um auténtico kit de bienvenida para tu cão.',
    lastUpdate: 'Atualizado en',

    realityTitle: '"Pet-friendly" pode significar cosas muito diferentes',
    realityText: [
      'Buscas um hotel que acepte animais, filtras, reservas — e llegas a recepción com tu cão para descubrir um suplemento de 50 €/noite, a prohibición de entrar al comedor, e um cartel plastificado que dice "as animais no podem dejarse sem vigilancia em ningún momento". Bem-vindo.',
      'No otro extremo, os hotéis verdaderamente acogedores para animais ofrecen um kit de bienvenida (snacks, um juguete, um tigela), um menú dedicado para cães no restaurante, personal que conoce os MELHORES passeios locales, e uma habitación em planta baja com acceso directo al jardim. Estos hotéis existen em toda Europa a todos os preços.',
      'O problema é que as plataformas de reserva usan a misma etiqueta "pet-friendly" para ambos. Esta guía te enseña a distinguirlos antes de chegar.',
    ],

    redFlagsTitle: 'Señales de alarma: avisos nas descripciones de hotéis',
    redFlagsIntro: 'Detecta estas frases na descripción o política de animais de um hotel — e procede com precaución o com uma chamada previa.',
    redFlags: [
      { flag: '"Animais sob consulta"', meaning: 'Significa que decidirán si tu animal específica é bienvenida. Traducción: no é realmente pet-friendly.' },
      { flag: '"Só animais pequenas" (sem definir o tamanho)', meaning: '¿Qué cuenta como pequeno? ¿5 kg? ¿10 kg? Si no hay peso indicado, tu Beagle de 12 kg podría ser rechazado na puerta.' },
      { flag: '"Animais permitidas só em zonas exteriores"', meaning: 'Tu cão espera fuera mientras duermes, comes e vives. Léase: tu cão espera atado no aparcamiento.' },
      { flag: 'Sem mención de limite de peso, mas limite de 5 kg na letra pequena', meaning: 'Lee sempre a política de animais completa, no só o resultado do filtro. O badge "pet-friendly" de Booking.com no garantiza que tu cão específico esté incluido.' },
      ...
      { flag: '"Habitaciones pet-friendly disponibles"', meaning: 'A menudo significa uma sola habitación — a mais lejos do ascensor, frente a a entrada de serviço, reservada durante os próximos seis meses.' },
    ...
    greenFlagsTitle: 'boas señales: indicadores de um hotel genuinamente pet-friendly',
    greenFlagsIntro: 'Esto é lo que separa aos hotéis que dan a bienvenida a as animais dos que simplemente as permiten.',
    greenFlags: [
      { flag: 'Suplemento por animal indicado claramente (o explícitamente gratuito)', meaning: 'A transparencia nos preços é o indicador mais fiable de um hotel que ha pensado seriamente em acoger animais.' },
      { flag: 'Sem restricciones de raza o peso (o restricciones claramente indicadas)', meaning: 'Si aceitam todas as razas e tamanhos — o indican claramente os limites — han hecho o trabajo de establecer uma política real.' },
      { flag: 'Cama, tigela, alfombra para animais disponibles sob petición', meaning: 'Demuestra inversión em infraestructura. Estos hotéis têm o alojamento de animais integrado em os seus operaciones.' },
      { flag: 'Snacks para cães em recepción o menú dedicado para cães', meaning: 'Este é o estándar de oro. Um hotel com menú para cães ha abrazado genuinamente a hospitalidad para animais.' },
      { flag: 'Personal que conoce os passeios locales para cães', meaning: 'Pregunta quando llames para confirmar: "¿Podem recomendarme um passeio com mi cão cerca?" Uma boa respuesta é uma señal excelente.' },
      { flag: 'Habitaciones em planta baja o acceso garantizado al ascensor', meaning: 'Uma habitación "pet-friendly" no 5.º piso sem ascensor no é realmente pet-friendly para nadie com um cão GRANDE.' },
      { flag: 'Ducha exterior o estação para limpiar as patas', meaning: 'Infraestructura bien pensada. Especialmente útil depois de passeios pela praia o o campo.' },
    ...
    questions: [
      '¿Cuál é o suplemento exacto por animal por noite — e é por animal?',
      '¿Estão disponibles todos os tipos de habitación com uma animal, o só habitaciones específicas?',
      '¿Hay restricciones de peso o raza? (Indica a raza e o peso de tu cão.)',
      '¿É reembolsable o suplemento si a animal no causa daños?',
      ...
      '¿Podemos dejar a nuestra animal sola na habitación? ¿Hay limites de tiempo?',
    ],
    ...
    platforms: [
      {
        name: 'Booking.com',
        icon: '🔵',
        how: 'Os hotéis se auto-declaran "pet-friendly" al configurar o seu anuncio. O filtro muestra todas as propiedades que han marcado a casilla — mas a casilla abarca desde "um gato de menos de 3 kg" até "todas as animais bem-vindas, sem cargo". A política real está enterrada na pestaña de detalles da propiedad. Haz sempre clic para verla.',
        tip: 'Tras filtrar, accede a a página do hotel e busca a sección "Animais" en "Normas da casa". A menudo revela limites de peso, cargos e restricciones no mostradas no anuncio principal.',
      },
      {
        name: 'Airbnb',
        icon: '🔴',
        how: 'Os anfitriones activan um ajuste de "animais permitidas". As tarifas de limpieza podem ser significativas. Algunos anfitriones têm alergias no declaradas o prohibiciones pelas normas do seu edificio. Contacta al anfitrión antes de reservar para confirmar que tu animal específica é aceptada.',
        tip: 'As políticas de cancelación de Airbnb são mais rigorosas que as dos hotéis. Confirma sempre a aceitação de tu animal antes de pagar a tarifa de serviço no reembolsable.',
      },
      {
        name: 'Expedia / Hotels.com',
        icon: '🟡',
        ...
        tip: 'Usa estas plataformas para descubrir opções, luego verifica directamente com o hotel antes de reservar para uma estadia com animal.',
      },
      {
        name: 'Reserva directa',
        icon: '✅',
        how: 'Sempre o estándar de oro para estadias com animais. Puedes hacer preguntas específicas, solicitar a MELHOR habitación apta para animais, e a veces negociar o cargo — especialmente fuera de temporada alta.',
        tip: 'Muitos hotéis independientes ofrecen os seus MELHORES condições para animais quando reservas directamente, porque podem tener uma conversación real sobre as necesidades de tu animal.',
      },
    ],
    platformsConclusion: 'A regla universal: filtra numa plataforma para descubrir opções, luego chama o escribe directamente al hotel para confirmar. Este único paso elimina o 90% das sorpresas desagradables al hacer o check-in.',

    pricesTitle: 'Qué esperar pagar: suplementos por animal em Europa (2025)',
    ...
    priceTiers: [
      ...
      { range: '5–15 €/noite', label: 'Económico', desc: 'Estándar para hotéis de presupuesto e gama media no sur de Europa (España, Portugal, Italia, Grecia). Perfectamente razonable por lo que obtienes.', color: 'blue' },
      { range: '20–35 €/noite', label: 'Gama media estándar', desc: 'Típico em hotéis de 3–4 estrellas em Francia, Bélgica, Suiza e Escandinavia. A menudo incluye comodidades para animais. Aceptable si o hotel realmente cuida a as animais.', color: 'amber' },
      { range: '50 €+/noite', label: 'Nivel lujo', desc: 'Común em hotéis de cinco estrellas e de diseño. Pode incluir serviços premium (menú para animais, pet-sitting, ropa de cama especializada). Algunos cobran tarifas fijas por estadia em lugar de por noite.', color: 'purple' },
      { range: '80–150 €+', label: 'Territorio de alerta roja', desc: 'A este nivel, pregunta qué cubre o suplemento. Si é só um recargo sem serviços — negocia o busca otra opção. Algunos hotéis de cidade em París han cobrado históricamente cantidades exorbitantes sem ningún serviço correspondiente.', color: 'red' },
    ],
    pricesNote: 'Nota: algunos países añaden uma tasa turística para animais por separado. Confirma sempre o importe total incluyendo cualquier depósito de seguridad, que costuma ser reembolsable.',

    categoriesTitle: 'Tipos de alojamento pet-friendly: ¿cuál é o adecuado para ti?',
    categories: [
      {
      ...
      },
      {
        ...
        icon: '🐈',
        desc: 'Menos común e a menudo ignorado. Os gatos têm necesidades diferentes: comodidad interior, sem vecinos caninos, pisos tranquilos. Algunos hotéis se dirigen especificamente aos gatos com zonas designadas.',
        link: '/categories/cat-friendly',
      ...
      },
      {
        type: 'Cães grátis',
        icon: '🆓',
        desc: 'Um segmento em crecimiento em Europa. Muitos hotéis independientes e boutique han eliminado as tarifas por animais como diferenciador competitivo. Vale a pena filtrar especificamente por esto.',
        link: '/categories/dogs-stay-free',
    ...
    faqs: [
      {
        q: '¿Cuánto cuesta de media o suplemento por animal num hotel em Europa?',
        a: 'En 2025, o suplemento medio por animal num hotel europeu oscila entre gratuito e uns 25 €/noite. Os establecimientos de presupuesto no sur de Europa costumam cobrar entre 10 e 15 €/noite. Os hotéis de gama media em Francia, Bélgica e Escandinavia rondan os 20–30 €/noite. Os hotéis de lujo podem cobrar 50 € o mais, a veces como tarifa fija por estadia em lugar de por noite. Alemania e os Países Bajos têm uma GRANDE proporción de hotéis que no cobran nada.',
      },
      {
        q: '¿Puedo dejar a mi cão só na habitación do hotel?',
        a: 'As políticas varían enormemente. Muitos hotéis lo permiten por períodos curtos (2–3 horas) si tu cão está acostumbrado a a jaula e no ladra. Otros lo proíbem completamente. Algunos exigen que as animais estén em jaula mesmo quando estás presente. Pregunta sempre explícitamente antes de reservar — no lo des por supuesto. Si necesitas dejar a tu cão com regularidad, busca hotéis com serviços de pet-sitting o ubicados perto de guarderías caninas.',
      },
      {
        q: '¿Como sé si um hotel é realmente pet-friendly o si simplemente tolera as animais?',
        a: 'Os indicadores mais claros são: (1) transparencia nos preços sem sorpresas ocultas, (2) comodidades específicas mencionadas (cama para animais, cuencos, snacks, menú para cães), (3) personal que pode responder tus preguntas sobre animais com conocimiento, e (4) reseñas em línea de otros propietarios de animais mencionando o seu experiencia. Si a política de animais de um hotel se resume numa línea que dice "animais aceptadas, se aplica suplemento", trátalo como tolerância mais que como bienvenida.',
      },
      {
        q: '¿Hay limites de peso que deba conocer antes de reservar?',
        a: 'Sí — os limites de peso são a fuente mais común de sorpresas desagradables al hacer o check-in. Muitos hotéis nominalmente "pet-friendly" nas plataformas têm um limite de 5 u 8 kg enterrado em o seu política completa. Os cães de mais de 10 kg a menudo se enfrentan a restricciones o estão directamente proibidos. Indica sempre a raza e o peso de tu cão al consultar, e obtén confirmación escrita de que tu cão específico é aceite.',
      },
      {
        q: '¿É fiable o filtro pet-friendly de Booking.com?',
        a: 'Como punto de partida, sí. Como garantía, no. O filtro muestra hotéis que se han auto-declarado pet-friendly, mas as políticas varían enormemente. Haz sempre clic na sección "Normas da casa" da ficha de Booking.com, e lo ideal é ligar o escribir para confirmar antes de reservar. Esto se aplica a todas as plataformas — o filtro reduce o campo mas no hace tu due diligence por ti.',
      },
      {
        q: '¿Cuál é a diferença entre "pet-friendly" e "cães grátis"?',
      ...
      },
      {
        ...
        a: 'Sí, sempre. Reservar sem declarar tu animal e chegar com ella é deshonesto e pode resultar em que te pidan que te vayas, especialmente si o hotel tem habitaciones pet-friendly limitadas. Também anula cualquier protección por daños causados por animais que de otro modo podrías tener. Marca sempre a casilla de declaración de animais, indica o tipo e tamanho de tu animal, e confirma directamente com o hotel.',
      },
    ],
    ...
    internalLinks: [
      ...
      { label: 'Hotéis onde os cães se quedan grátis', href: '/categories/dogs-stay-free' },
    ...
    relatedDestText: 'Encuentra os MELHORES hotéis para tu animal em estos destinos',
  },
}
