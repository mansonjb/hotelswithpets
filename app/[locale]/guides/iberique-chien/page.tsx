...
const COPY: Record<string, RouteCopy> = {
  ...
  pt: {
    hero: { tagline: 'PENÍNSULA IBÉRICA · 12 Dias · Com TU Cão', title: 'Um viaje ibérico de comboio com tu cão', subtitle: 'Lisboa, Porto, Madrid, Barcelona — a costa atlântica portuguesa e as grandes capitales españolas, conectadas por comboios directos. Hotéis que admitem animais, praias caninas e mapas Booking.com em vivo para cada parada.' },
    why: { title: 'Porquê este itinerário ibérico funciona com cão', bullets: [
      'Portugal e España são dos países mais tolerantes com animais de Europa — a maioria de cafés, restaurantes e lojas admitem cães com trela sem objeción.',
      ...
      'As cuatro cidades têm praias caninas oficiales o ano inteiro o zonas sem trela vedadas a menos de 30 minutos do centro.',
      'Sem burocracia nas fronteras Schengen — basta um passaporte europeu com vacunación antirrábica vigente.',
      'O calor é a principal restricción: evita julho-agosto, sobre todo Madrid (40 °C+ habitual). Maio, principios de junho, finais de setembro e outubro são ideales.',
    ] },
    ...
    cities: {
      lisbon: { days: 'Dias 1–3', intro: 'Empieza em Lisboa, uma das cidades mais descontraídas de Europa com cães. Os elétricos (o 28 histórico incluido) admitem cães com trela grátis, as margens do Tajo ofrecen 8 km de passeio peatonal, e a praia canina de Alcântara (Praia do Porto Brandão) está a 15 min em ferri desde o centro. As callejuelas adoquinadas de Bairro Alto e Alfama são pet-friendly de dia; de noite se llenan.', highlight: 'Imprescindible com tu cão: atardecer no Miradouro da Senhora do Monte', highlightDesc: 'O mirador mais alto da cidade, menos concurrido que Santa Catarina. O elétrico 28 te deja a 5 min a pé; cães bem-vindos no bar da esplanada depois.' },
      porto: { days: 'Dias 4–5', intro: 'Tres horas em Alfa Pendular. Porto é aún mais pet-friendly que Lisboa: a margem do Duero na Ribeira admite cães em todas as esplanadas, a costa de Foz do Douro tem praias caninas (Praia do Carneiro, Praia de Lavadores) acessíveis no elétrico, e os jardins do Palácio de Cristal admitem cães sem trela a primera hora.', highlight: 'Imprescindible com tu cão: excursión de comboio al Valle do Duero', highlightDesc: 'A Linha do Douro de Comboios de Portugal desde Porto-São Bento até Régua dura 2h junto al rio. Cães com trela grátis em transportadora, meio preço si no. Muitas quintas (bodegas de Porto) admitem cães em os seus jardins.' },
      madrid: { days: 'Dias 6–9', intro: 'Trenhotel nocturno (8h) o avión com cão (Iberia admite em cabina) para enlazar Porto-Madrid. Madrid tem uma das mayores poblaciones caninas de Europa: 350.000 cães registrados, a enorme Casa de Campo (1.700 ha) e o Parque do Retiro (125 ha) ambos pet-friendly, e o Metro de Madrid admite todos os cães com trela + bozal em horas valle.', highlight: 'Imprescindible com tu cão: circuito matinal pela Casa de Campo', highlightDesc: '1.700 hectáreas de pinar a 15 min de Sol no metro. Varias zonas sem trela e um pequeno lago. Os locales empiezan na entrada do Lago e caminan 6-8 km — tu cão dormirá toda a tarde.' },
      barcelona: { days: 'Dias 10–12', intro: 'AVE desde Madrid en 2h30 (o tramo mais rápido, bilhete canino 15 €). Barcelona é pet-friendly junto al mar: a praia de Llevant é a praia canina oficial o ano inteiro (banho sem trela), Montjuïc tem zonas sem trela, os bairros do Born e Gràcia estão llenos de esplanadas acogedoras. O metro exige trela + bozal para cães medianos/grandes.', highlight: 'Imprescindible com tu cão: praia canina de Llevant + passeio Bogatell', highlightDesc: 'Única praia canina o ano inteiro de Barcelona (sem trela, ducha de água dulce, papeleras). Combínalo com os 4 km do passeio de Bogatell para uma manhã completa. Parada na Bombeta para tapas — cães com trela bem-vindos em esplanada.' },
    },
    ...
    legs: [
      ...
      { from: 'Madrid', to: 'Barcelona', duration: '~2h30', service: 'AVE Renfe (directo, cada 30 min)', petRule: 'Cães pequenos (máx 10 kg) grátis. Renfe Animais Grandes (piloto) admite cães até 40 kg com reserva (15 € / cão). Lleva um bozal flexible.' },
    ],
    practicalTitle: 'Antes de salir: burocracia, vacunas, contactos veterinários',
    practicalBullets: [
      'Passaporte europeu de animal com vacunación antirrábica vigente (21+ dias).',
      'Microchip ISO 11784/11785 — obrigatório.',
      'España tem leis por raza (Lei 50/1999): Pit Bull, Rottweiler, Am. Staff, Bullterrier, Tosa, Dogo Argentino, Fila Brasileiro, Akita Inu, Dóberman são PPP. Se exige licencia, trela + bozal em público, seguro civil.',
      'O calor é o riesgo nº1: asfalto a 50 °C em Madrid em julho, passeios 7-9 h e tras puesta de sol, bol de água plegable, nunca dejar al cão no carro.',
    ...
    faqTitle: 'Preguntas frecuentes',
    faqs: [
      { q: '¿Porquê no hay comboio directo Porto → Madrid?', a: 'A península ibérica históricamente no ha tenido conexión de alta velocidad. O Trenhotel nocturno é a única opção ferroviaria directa (10h). A mayoría vuela (Iberia 1h30, cão admitido) o coge um bus longo. Um AVE Porto-Madrid está previsto mas aún no se ha construido.' },
      { q: '¿É demasiado o calor español para um cão?', a: 'Em julho-agosto, sí — Madrid chega a 40 °C, Barcelona 32 °C com humedad. Pasea 7-9 h e tras o atardecer. Hotéis com A/C esenciales. Evita esos meses para razas braquicéfalas.' },
      { q: '¿São realmente pet-friendly os restaurantes em España?', a: 'A lei española deja a cada establecimiento decidir — mas Madrid e Barcelona têm uma forte tendencia "cão permitido". Busca o adhesivo de huella verde. A maioria de esplanadas admite sem problema; pregunta antes de entrar.' },
      ...
      { q: '¿É pet-friendly o metro de Madrid?', a: 'Sí, todos os tamanhos admitidos com trela + bozal, grátis, mas só em horas valle (antes das 7 h, 10-12 h, 16-19 h, tras as 21 h entre semana; todo o dia os fines de semana). Lleva o bozal no bolso.' },
    ],
  },
}
