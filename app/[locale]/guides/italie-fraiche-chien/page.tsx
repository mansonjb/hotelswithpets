...
const REGIONS: Region[] = [
  {
    id: 'alto-adige',
    emoji: '🏔️',
    title: { en: 'South Tyrol', fr: 'Haut-Adige (Tyrol du Sud)', es: 'Alto Adigio (Tirol del Sur)', pt: 'Alto Ádige (Tirol do Sul)', de: 'Südtirol', nl: 'Zuid-Tirol' },
    cities: [
      {
        slug: 'bolzano',
        name: 'Bolzano',
        region: { en: 'South Tyrol', fr: 'Haut-Adige', es: 'Alto Adigio', pt: 'Alto Ádige', de: 'Südtirol', nl: 'Zuid-Tirol' },
        julyTemp: 24,
        tag: { en: 'Dolomites gateway · bilingual', fr: 'Porte des Dolomites · bilingue', es: 'Puerta de los Dolomitas · bilingüe', pt: 'Porta das Dolomitas · bilingue', de: 'Tor zu den Dolomiten · zweisprachig', nl: 'Poort naar de Dolomieten · tweetalig' },
        why: {
        ...
        dogTip: {
          ...
          nl: 'Kabelbaan naar Kohlern (1.200m): je hond mag mee de gondel in, alpenweiden op de top los van de lijn, 12°C in juli terwijl de stad 24°C haalt.',
        },
        hotels: [
          {
      ...
      },
      {
        ...
        region: { en: 'South Tyrol', fr: 'Haut-Adige', es: 'Alto Adigio', pt: 'Alto Ádige', de: 'Südtirol', nl: 'Zuid-Tirol' },
        julyTemp: 23,
        tag: { en: 'Spa town · Tappeiner promenade', fr: 'Ville thermale · promenade Tappeiner', es: 'Ciudad termal · paseo Tappeiner', pt: 'Cidade termal · passeio Tappeiner', de: 'Kurstadt · Tappeinerpromenade', nl: 'Kuuroord · Tappeinerpromenade' },
        why: {
  ...
  },
  {
    id: 'val-daosta',
    emoji: '🏔️',
    title: { en: "Aosta Valley", fr: "Vallée d'Aoste", es: 'Valle de Aosta', pt: "Vale de Aosta", de: 'Aostatal', nl: 'Aostavallei' },
    cities: [
      {
        slug: 'aoste',
        name: 'Aoste',
        region: { en: "Aosta Valley", fr: "Vallée d'Aoste", es: 'Valle de Aosta', pt: "Vale de Aosta", de: 'Aostatal', nl: 'Aostavallei' },
        julyTemp: 22,
        tag: { en: 'Roman ruins · Mont Blanc gateway', fr: 'Ruines romaines · porte du Mont Blanc', es: 'Ruinas romanas · puerta del Mont Blanc', pt: 'Ruínas romanas · porta do Mont Blanc', de: 'Römische Ruinen · Tor zum Mont Blanc', nl: 'Romeinse ruïnes · poort naar de Mont Blanc' },
        why: {
  ...
  },
  {
    id: 'trentino',
    emoji: '🌿',
    title: { en: 'Trentino', fr: 'Trentin', es: 'Trentino', pt: 'Trentino', de: 'Trentino', nl: 'Trentino' },
    cities: [
      {
        slug: 'trento',
        name: 'Trento',
        region: { en: 'Trentino', fr: 'Trentin', es: 'Trentino', pt: 'Trentino', de: 'Trentino', nl: 'Trentino' },
        julyTemp: 26,
        tag: { en: 'Alpine university city · wine region', fr: 'Ville universitaire alpine · région viticole', es: 'Ciudad universitaria alpina · región vinícola', pt: 'Cidade universitária alpina · região vinícola', de: 'Alpine Universitätsstadt · Weinregion', nl: 'Alpiene universiteitsstad · wijnstreek' },
        why: {
      ...
      },
      {
        ...
        region: { en: 'Trentino', fr: 'Trentin', es: 'Trentino', pt: 'Trentino', de: 'Trentino', nl: 'Trentino' },
        julyTemp: 25,
        tag: { en: "Northern Lake Garda · wind-cooled", fr: 'Nord du lac de Garde · refroidi par le vent', es: 'Norte del lago de Garda · refrigerado por el viento', pt: 'Norte do lago de Garda · arrefecido pelo vento', de: 'Nördlicher Gardasee · windgekühlt', nl: 'Noordelijke Gardameer · windgekoeld' },
        why: {
  ...
  },
  {
    id: 'lacs-alpins',
    emoji: '💧',
    title: { en: 'Alpine Lakes', fr: 'Lacs alpins', es: 'Lagos alpinos', pt: 'Lagos alpinos', de: 'Alpenseen', nl: 'Alpenmeren' },
    cities: [
      {
        slug: 'come',
        name: 'Côme',
        region: { en: 'Lake Como', fr: 'Lac de Côme', es: 'Lago de Como', pt: 'Lago de Como', de: 'Comer See', nl: 'Comomeer' },
        julyTemp: 25,
        tag: { en: 'Lake Como · ferry-hopping · villas', fr: 'Lac de Côme · ferries · villas', es: 'Lago de Como · ferries · villas', pt: 'Lago de Como · ferries · vilas', de: 'Comer See · Fährenhopping · Villen', nl: 'Comomeer · van veer naar veer · villa\'s' },
        why: {
  ...
  },
  {
    id: 'ligurie',
    emoji: '🌊',
    title: { en: 'Liguria', fr: 'Ligurie', es: 'Liguria', pt: 'Ligúria', de: 'Ligurien', nl: 'Ligurië' },
    cities: [
      {
        slug: 'genes',
        name: 'Gênes',
        region: { en: 'Liguria', fr: 'Ligurie', es: 'Liguria', pt: 'Ligúria', de: 'Ligurien', nl: 'Ligurië' },
        julyTemp: 25,
        tag: { en: 'Maritime republic · Caruggi · Ligurian sea', fr: 'République maritime · Caruggi · mer Ligure', es: 'República marítima · Caruggi · mar de Liguria', pt: 'República marítima · Caruggi · mar da Ligúria', de: 'Seefahrerrepublik · Caruggi · Ligurisches Meer', nl: 'Zeevarende republiek · caruggi · Ligurische Zee' },
        why: {
          ...
          nl: 'Genua is Italië\'s best bewaarde hondengeheim: 25°C in juli dankzij constante briesjes vanaf de Ligurische Zee, en waarschijnlijk de meest hondvriendelijke stadscultuur van Europa. De caruggi (middeleeuwse steegjes van de oude stad, UNESCO-werelderfgoed) zijn volledig autovrij en je hond mag er vrij rondlopen. De wijk Nervi (7 km oostelijk) heeft een beroemde klifpromenade boven zee, helemaal los van de lijn. In Ligurische restaurants is het gewoon dat honden zonder te vragen onder de tafel liggen.',
        },
        dogTip: {
...
const T = {
  title: {
    ...
    nl: 'De beste steden om met je hond aan de hitte in Italië te ontsnappen (2026)',
  },
  metaTitle: {
    ...
    nl: 'Koel Italië met je hond: 7 steden onder 26°C in juli (2026)',
  },
  metaDesc: {
    ...
    nl: 'Terwijl Rome 34°C en Napels 33°C halen, blijft Noord-Italië koel. Bolzano, Meran, Aosta, Trento, Riva del Garda, Comomeer, Genua: 7 hondvriendelijke steden onder 26°C in juli met hoteltips.',
  },
  intro: {
    ...
    nl: 'Rome, Napels en Florence halen in juli 33-36°C. Noord-Italië (de Alpen, Voor-Alpen en de Ligurische kust) blijft echter op 22-26°C, gekoeld door hoogte, meerbriesjes en bergwinden. In deze 7 steden breng je een echte Italiaanse vakantie door zonder dat je hond oververhit raakt.',
  },
  ...
  faq: {
    ...
    a3: {
      ...
      nl: 'Trenitalia neemt honden onder 10 kg gratis mee in een transportbox, en honden tot 30 kg aan de lijn met muilkorf voor een vaste prijs van 3,50€ (Intercity) of 5€ (Frecciarossa). De directe trein Milaan-Bolzano duurt 3u30 en rijdt elk uur. Vanuit Frankrijk: Parijs-Milaan met de TGV (3u25 via de Fréjustunnel), daarna aansluiting op het regionale net naar Aosta (2u), Genua (45 min) of het Comomeer (40 min). Italo-treinen (privémaatschappij) nemen alleen honden onder 10 kg in een transportbox mee.',
    },
    q4: { en: 'Can dogs hike in the Dolomites?', fr: 'Les chiens peuvent-ils randonner dans les Dolomites ?', es: '¿Pueden los perros hacer senderismo en los Dolomitas?', pt: 'Os cães podem fazer caminhadas nas Dolomitas?', de: 'Dürfen Hunde in den Dolomiten wandern?', nl: 'Mogen honden wandelen in de Dolomieten?' },
    a4: {
      ...
      nl: 'Ja, de Dolomieten zijn een van de beste wandelgebieden van Europa voor honden. De meeste paden mag je hond los van de lijn en zonder beperkingen belopen. Berghutten (rifugi) in Zuid-Tirol accepteren honden meestal (voor overnachtingen vooraf navragen). Op de Alta Via 1 en de Alta Via 2 (de grote hoogtewegen van de Dolomieten) zijn honden op alle stukken toegestaan. Opvallende uitzonderingen: in sommige kernzones van het nationaal park (Fanes-Sennes-Prags) geldt aanlijnplicht. Kabelbanen in Zuid-Tirol nemen bijna allemaal honden mee; check bij kabelbanen in Veneto steeds de betreffende operator.',
    },
    q5: { en: 'Are dogs allowed on Lake Como and Lake Garda ferries?', fr: 'Les chiens sont-ils acceptés sur les ferries du lac de Côme et du lac de Garde ?', es: '¿Se permiten perros en los ferries del lago de Como y el lago de Garda?', pt: 'São permitidos cães nos ferries do lago de Como e do lago de Garda?', de: 'Sind Hunde auf den Fähren des Comer Sees und des Gardasees erlaubt?', nl: 'Zijn honden toegestaan op de veerboten van het Comomeer en het Gardameer?' },
    a5: {
      ...
      <section className="bg-gradient-to-br from-green-900 via-emerald-900 to-teal-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-green-200 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-5">
            🇮🇹 {locale === 'fr' ? 'Italie alpine et ligure' : locale === 'es' ? 'Italia alpina y ligur' : locale === 'pt' ? 'Itália alpina e ligure' : locale === 'de' ? 'Alpines und ligurisches Italien' : locale === 'nl' ? 'Alpien en Ligurisch Italië' : 'Alpine & Ligurian Italy'}
          </div>
