...
const REGIONS: Region[] = [
  {
    id: 'alto-adige',
    emoji: '🏔️',
    title: { en: 'South Tyrol', fr: 'Haut-Adige (Tyrol du Sud)', es: 'Alto Adigio (Tirol del Sur)', pt: 'Alto Ádige (Tirol do Sul)', de: 'Südtirol' },
    cities: [
      {
        slug: 'bolzano',
        name: 'Bolzano',
        region: { en: 'South Tyrol', fr: 'Haut-Adige', es: 'Alto Adigio', pt: 'Alto Ádige', de: 'Südtirol' },
        julyTemp: 24,
        tag: { en: 'Dolomites gateway · bilingual', fr: 'Porte des Dolomites · bilingue', es: 'Puerta de los Dolomitas · bilingüe', pt: 'Porta das Dolomitas · bilingue', de: 'Tor zu den Dolomiten · zweisprachig' },
        why: {
      ...
      },
      {
        ...
        region: { en: 'South Tyrol', fr: 'Haut-Adige', es: 'Alto Adigio', pt: 'Alto Ádige', de: 'Südtirol' },
        julyTemp: 23,
        tag: { en: 'Spa town · Tappeiner promenade', fr: 'Ville thermale · promenade Tappeiner', es: 'Ciudad termal · paseo Tappeiner', pt: 'Cidade termal · passeio Tappeiner', de: 'Kurstadt · Tappeinerpromenade' },
        why: {
  ...
  },
  {
    id: 'val-daosta',
    emoji: '🏔️',
    title: { en: "Aosta Valley", fr: "Vallée d'Aoste", es: 'Valle de Aosta', pt: "Vale de Aosta", de: 'Aostatal' },
    cities: [
      {
        slug: 'aoste',
        name: 'Aoste',
        region: { en: "Aosta Valley", fr: "Vallée d'Aoste", es: 'Valle de Aosta', pt: "Vale de Aosta", de: 'Aostatal' },
        julyTemp: 22,
        tag: { en: 'Roman ruins · Mont Blanc gateway', fr: 'Ruines romaines · porte du Mont Blanc', es: 'Ruinas romanas · puerta del Mont Blanc', pt: 'Ruínas romanas · porta do Mont Blanc', de: 'Römische Ruinen · Tor zum Mont Blanc' },
        why: {
  ...
  },
  {
    id: 'trentino',
    emoji: '🌿',
    title: { en: 'Trentino', fr: 'Trentin', es: 'Trentino', pt: 'Trentino', de: 'Trentino' },
    cities: [
      {
        slug: 'trento',
        name: 'Trento',
        region: { en: 'Trentino', fr: 'Trentin', es: 'Trentino', pt: 'Trentino', de: 'Trentino' },
        julyTemp: 26,
        tag: { en: 'Alpine university city · wine region', fr: 'Ville universitaire alpine · région viticole', es: 'Ciudad universitaria alpina · región vinícola', pt: 'Cidade universitária alpina · região vinícola', de: 'Alpine Universitätsstadt · Weinregion' },
        why: {
      ...
      },
      {
        ...
        region: { en: 'Trentino', fr: 'Trentin', es: 'Trentino', pt: 'Trentino', de: 'Trentino' },
        julyTemp: 25,
        tag: { en: "Northern Lake Garda · wind-cooled", fr: 'Nord du lac de Garde · refroidi par le vent', es: 'Norte del lago de Garda · refrigerado por el viento', pt: 'Norte do lago de Garda · arrefecido pelo vento', de: 'Nördlicher Gardasee · windgekühlt' },
        why: {
  ...
  },
  {
    id: 'lacs-alpins',
    emoji: '💧',
    title: { en: 'Alpine Lakes', fr: 'Lacs alpins', es: 'Lagos alpinos', pt: 'Lagos alpinos', de: 'Alpenseen' },
    cities: [
      {
        slug: 'come',
        name: 'Côme',
        region: { en: 'Lake Como', fr: 'Lac de Côme', es: 'Lago de Como', pt: 'Lago de Como', de: 'Comer See' },
        julyTemp: 25,
        tag: { en: 'Lake Como · ferry-hopping · villas', fr: 'Lac de Côme · ferries · villas', es: 'Lago de Como · ferries · villas', pt: 'Lago de Como · ferries · vilas', de: 'Comer See · Fährenhopping · Villen' },
        why: {
  ...
  },
  {
    id: 'ligurie',
    emoji: '🌊',
    title: { en: 'Liguria', fr: 'Ligurie', es: 'Liguria', pt: 'Ligúria', de: 'Ligurien' },
    cities: [
      {
        slug: 'genes',
        name: 'Gênes',
        region: { en: 'Liguria', fr: 'Ligurie', es: 'Liguria', pt: 'Ligúria', de: 'Ligurien' },
        julyTemp: 25,
        tag: { en: 'Maritime republic · Caruggi · Ligurian sea', fr: 'République maritime · Caruggi · mer Ligure', es: 'República marítima · Caruggi · mar de Liguria', pt: 'República marítima · Caruggi · mar da Ligúria', de: 'Seefahrerrepublik · Caruggi · Ligurisches Meer' },
        why: {
...
const T = {
  ...
  julyTemp: { en: 'July avg high', fr: 'Max moy. juillet', es: 'Máx. prom. julio', pt: 'Máx. méd. julho', de: 'Julihöchstwert Ø' },
  ...
  faq: {
    q1: { en: 'Which Italian cities stay cool in summer?', fr: 'Quelles villes italiennes restent fraîches en été ?', es: '¿Qué ciudades italianas permanecen frescas en verano?', pt: 'Que cidades italianas se mantêm frescas no verão?', de: 'Welche italienischen Städte bleiben im Sommer kühl?' },
    a1: {
    ...
    q2: { en: 'Are dogs allowed in Italian restaurants and terraces?', fr: 'Les chiens sont-ils acceptés dans les restaurants et terrasses italiens ?', es: '¿Se permiten perros en los restaurantes y terrazas italianos?', pt: 'São permitidos cães nos restaurantes e esplanadas italianos?', de: 'Sind Hunde in italienischen Restaurants und auf Terrassen erlaubt?' },
    a2: {
    ...
    q3: { en: 'How do I get to northern Italy with a dog by train?', fr: "Comment rejoindre le nord de l'Italie avec un chien en train ?", es: '¿Cómo llegar al norte de Italia con un perro en tren?', pt: 'Como chegar ao norte de Itália com um cão de comboio?', de: 'Wie komme ich mit dem Hund per Bahn nach Norditalien?' },
    a3: {
    ...
    q4: { en: 'Can dogs hike in the Dolomites?', fr: 'Les chiens peuvent-ils randonner dans les Dolomites ?', es: '¿Pueden los perros hacer senderismo en los Dolomitas?', pt: 'Os cães podem fazer caminhadas nas Dolomitas?', de: 'Dürfen Hunde in den Dolomiten wandern?' },
    a4: {
    ...
    q5: { en: 'Are dogs allowed on Lake Como and Lake Garda ferries?', fr: 'Les chiens sont-ils acceptés sur les ferries du lac de Côme et du lac de Garde ?', es: '¿Se permiten perros en los ferries del lago de Como y el lago de Garda?', pt: 'São permitidos cães nos ferries do lago de Como e do lago de Garda?', de: 'Sind Hunde auf den Fähren des Comer Sees und des Gardasees erlaubt?' },
    a5: {
      ...
      <section className="bg-gradient-to-br from-green-900 via-emerald-900 to-teal-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-green-200 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-5">
            🇮🇹 {locale === 'fr' ? 'Italie alpine et ligure' : locale === 'es' ? 'Italia alpina y ligur' : locale === 'pt' ? 'Itália alpina e ligure' : locale === 'de' ? 'Alpines und ligurisches Italien' : 'Alpine & Ligurian Italy'}
          </div>
