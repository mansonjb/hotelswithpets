...
const COPY = {
  ...
  pt: {
    ...
    whatIs: '¿Qué é o passaporte europeu para animais?',
    whatIsText: [
      'O passaporte europeu para animais é um documento oficial emitido por um veterinário autorizado. Centraliza a informação esencial sobre tu animal: identificación por microchip, vacunaciones (incluida a rabia) e tratamentos realizados.',
      ...
      'Importante: o microchip debe implantarse ANTES da vacuna antirrábica. Si no é así, a fecha de vacunación no será reconocida e tendrás que vacunar de novo a tu animal.',
    ],
    ...
    checklist: [
      ...
      { icon: '💉', label: 'Vacunación antirrábica válida', note: 'Primera vacunación: esperar 21 dias antes de viajar' },
      ...
      { icon: '🪱', label: 'Tratamento antiparasitario segundo país', note: 'Finlândia, Irlanda, Noruega, Reino Unido, Islandia = obrigatório' },
    ],
    tableTitle: 'Normas país por país',
    levelStandard: 'Estándar UE',
    levelExtra: 'Requisitos adicionales',
    levelStrict: 'Muito rigoroso / Fuera da UE',
    levelNonEu: 'Fuera da UE',
    tipTitle: 'Consejo do experto',
    tipText: 'Planifica tu viaje com tu animal com al menos 4 semanas de antelación para destinos da UE, e 3-6 meses para o Reino Unido o Islandia. Tu veterinário é tu MELHOR aliado para preparar os documentos necesarios.',
    faqTitle: 'Preguntas frecuentes',
    faqs: [
      {
        q: '¿Mi passaporte europeu para animais é válido para sempre?',
        a: 'O passaporte em sí no tem fecha de caducidad, mas as vacunaciones que contiene (incluida a rabia) deben estar al dia. Um passaporte com uma vacuna antirrábica caducada já no é válido para viajar.',
      },
      {
        q: 'Mi cão nació em Francia. ¿Tem automáticamente um passaporte para animais?',
        a: 'No. O passaporte europeu para animais debe ser emitido por um veterinário autorizado depois da implantación do microchip e a vacunación antirrábica. No é automático.',
      },
      {
        q: '¿Necesita um gato um passaporte para viajar por Europa?',
        a: 'Sí, as mismas normas se aplicam aos gatos (e hurones) que aos cães. Se exige microchip ISO, vacunación antirrábica e passaporte europeu.',
      },
      {
        q: '¿Qué pasa si olvido o passaporte de mi animal?',
        a: 'Tu animal pode ser rechazada no país de destino o puesta em cuarentena. Nunca corras ese riesgo: lleva sempre os documentos originales, nunca fotocopias.',
      },
      {
        q: '¿É difícil chegar al Reino Unido com uma animal tras o Brexit?',
        a: 'Sí, o proceso é mais complexo que antes. Necesitas um Certificado Sanitario Animal (AHC) emitido nos 10 dias anteriores a a salida, mais um tratamento contra tenias para os cães. Date muito tiempo e consulta a um veterinário oficial.',
      },
    ],
    seeHotels: 'Ver hotéis',
    seeCountry: 'Página país',
    relatedTitle: 'Destinos pet-friendly em Europa',
    relatedText: 'Encuentra os MELHORES hotéis com animais em estos destinos',
  },
}
