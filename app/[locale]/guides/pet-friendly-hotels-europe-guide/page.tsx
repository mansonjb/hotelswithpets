...
const COPY: Record<string, {
  ...
  pt: {
    hero: {
      ...
      lede: 'Todo lo que necesitas saber para encontrar, avaliar e reservar um hotel que realmente aceita a tu cão o gato em Europa — cadenas que admitem animais, normas país por país, qué preguntar antes de reservar e nuestras selecciones cuidadas en 85 destinos.',
    },
    toc: { title: 'Em esta guía', items: [
      { id: 'what-to-look', label: 'Qué buscar num hotel pet-friendly' },
    ...
    whatToLook: {
      id: 'what-to-look',
      h2: 'Qué hace realmente "pet-friendly" a um hotel',
      paras: [
        'A expresión "pet-friendly" no está regulada. Booking.com, Hotels.com e Airbnb permiten que os establecimientos se etiqueten ellos mismos como pet-friendly sem verificación — lo que significa que um anuncio "pet-friendly" pode ir desde um cinco estrellas com conserjería pet dedicada até um albergue que admite um cão a regañadientes tras um depósito de 40 £. Nuestro papel é filtrar o ruido.',
        'Um hotel realmente pet-friendly — segundo nuestro estándar — cumple al menos cuatro de estos seis critérios: animais admitidas em cualquier habitación estándar (no só numa específica "pet-allowed"), sem discriminación por raza o peso mais allá de normas razonables de seguridad, cargo razonable (0-30 € por estadia o por noite, no 100 £+), boles o camas para animais disponibles a petición, sem obligación de dejar al cão em perrera durante o dia, e proximidad a espaço verde sem trela (a menos de 500 m a pé).',
        'Estos critérios suenan simples mas eliminan o 60-70 % dos anuncios "pet-friendly" em Booking.com. Os hotéis listados em nuestras 85 guías de destino foram todos auditados segundo esta checklist antes de incluirse.',
      ],
      checks: {
    ...
    chains: {
      ...
      paras: [
        ...
        'A continuación uma comparación das 12 cadenas com as políticas de animais mais consistentes em Europa. Excluimos as cadenas onde a aceitação se deja aos gestores individuales (a mayoría, incluido Marriott em algunas regiões).',
      ],
      rows: [
        ...
        { chain: 'Hospes Hotels', policy: 'Toda a cadena', fee: '25 €/estadia', note: 'Cadena boutique 5 estrellas española' },
        ...
        { chain: 'Motel One', policy: 'Pet-friendly toda a cadena desde 2024', fee: '10 €/noite', note: 'Hotéis diseño presupuesto em rápido crecimiento' },
        { chain: '25hours Hotels', policy: 'Kit pet incluido', fee: '20 €/estadia', note: 'Diseño 4 estrellas, boles incluidos' },
        { chain: 'Scandic Hotels', policy: 'Toda a cadena', fee: '20 €/estadia', note: 'Forte red nórdica + alemana' },
        ...
        { chain: 'NH Hotels / NH Collection', policy: 'Pet-friendly toda a cadena', fee: '20-25 €/noite', note: 'Forte presencia España, Italia, Alemania' },
      ],
    },
    byCategory: {
      id: 'by-category',
      h2: 'Por categoría: qué tipo de hotel pet-friendly te conviene',
      paras: [
        'A aceitação de animais é só o bilhete de entrada — a categoría correcta para ti depende de tu viaje. Umas vacaciones de praia com cão exigem critérios diferentes que uma escapada urbana com gato. Hemos organizado nuestros 460+ hotéis pet-friendly em seis categorías que se ajustan a as intenciones comunes de viaje.',
        'Haz clic em cualquier categoría a continuación para explorar nuestra selección cuidada nos 85 destinos.',
      ],
    ...
    byCountry: {
      ...
      paras: [
        'As políticas de animais hoteleras varían significativamente por Europa — tanto o cargo medio como o estilo de aplicación. A continuación, as realidades prácticas país por país, extraídas de nuestra auditoría de 460+ hotéis.',
      ],
    },
    countryNotes: {
      France: 'Francia é um dos os países mais tolerantes com animais — mais do 50 % dos hotéis as admitem, cargo medio 15-25 €/estadia. Os hotéis independientes são típicamente mais baratos que as cadenas. Normas passaporte UE estándar.',
      ...
      Spain: 'A pet-friendliness española ha crecido rápidamente — cargo medio 15-20 €/noite. Madrid e Barcelona lideram em cadenas; Andalucía (Sevilha, Córdoba, Granada) excelente em primavera/outono mas o calor extremo estival é a principal restricción.',
      Italy: 'A lei italiana (Legge 281/1991) da aos cães derechos de acceso fortes mas os hotéis aplicam cargos mais agresivamente que Francia o Alemania — a menudo 25-40 €/estadia. Os comboios (Trenitalia) admitem cães com burocracia.',
      'United Kingdom': 'Post-Brexit: cães UE entrando al UK necesitan um Animal Health Certificate (AHC, 10 dias) mais tratamento obrigatório contra equinococose. Cargo medio 25-50 £/estadia. Os pubs admitiendo cães são a base cultural británica.',
      ...
      Portugal: 'Lisboa e Porto excepcionalmente pet-friendly. Cargos hoteleros a menudo 10-20 €/estadia (mais baratos que España). Elétricos e comboios admitem cães.',
      ...
      Ireland: 'A pet-friendliness de Dublin ha mejorado. Hotéis cobran 15-25 €. Nota: mismas normas que UK para Irlanda do norte.',
    ...
    bookingTips: {
      ...
      h2: 'Consejos de reserva que ahorran dinero',
      paras: [
        'Os cargos por animal são negociables mais a menudo de lo que a gente cree. A reserva directa (no vía Booking.com) te da palanca — alrededor do 30 % dos hotéis independientes anularán o reducirán o cargo para huéspedes directos. Sempre envía um email al hotel antes de reservar para confirmar as condições exactas.',
      ],
      bullets: [
        'Reserva directo (no Booking.com) para MELHOR negociación de cargo por animal — os hotéis independientes a menudo lo anulan ao 10-50 % por reservas directas.',
        'Para estadias multi-noite, pide tarifa plana em vez de cargo por noite. 15 €/noite en 7 noites = 105 €; muitos hotéis cambiarán a 60 € plano si se les pide.',
    ...
    whatToAsk: {
      ...
      questions: [
        ...
        '¿Cuál é a política de cancelación si mi animal está enferma o dia de llegada?',
      ],
    },
    faqTitle: 'Preguntas frecuentes',
    faqs: [
      { q: '¿Cuál é o cargo por animal medio em hotéis europeus?', a: 'O promedio europeu é 15-25 €/estadia para um hotel independiente e 20-30 €/noite para cadenas. Suiza e UK estão no extremo alto (30-50 CHF / 40-60 £). Europa do Este no sob (5-10 €).' },
      { q: '¿Todos os hotéis admitem também gatos?', a: 'A maioria de hotéis "pet-friendly" também admitem gatos — mas no sempre se anuncia. Pregunta sempre explícitamente: aproximadamente o 80 % dos hotéis que admitem cães também admitem gatos com preaviso.' },
      ...
      { q: '¿Como sé si um hotel é genuinamente pet-friendly o só pet-tolerado?', a: 'Tres indicadores: (1) o hotel menciona equipamientos pet específicos (boles, camas, golosinas) em o seu web, (2) o cargo por animal é razonable (10-25 €, no 75 £+), (3) a respuesta do staff a tu email pre-reserva é entusiasta, no vacilante. Pre-filtramos todos os hotéis em nuestras guías de destino.' },
      { q: '¿E os cães de serviço / asistencia?', a: 'Os cães de serviço se admitem grátis em todos os hotéis UE por lei (Reglamento 2016/679 + transposiciones nacionales) e em todos os hotéis UK (Equality Act 2010). O cargo por animal no aplica. Lleva a documentação.' },
      { q: '¿Puedo dejar a mi cão só na habitación do hotel?', a: 'A maioria de hotéis pet-friendly europeus proíbem animais sem vigilancia. Soluciones: um cuidador Pawshake/Tailster pelas horas que necesites, o o serviço de guardería em habitación que ofrecen Kimpton, 25hours e algunos Hilton.' },
    ...
    ctaTitle: '¿Listo para encontrar tu hotel?',
    ctaDesc: 'Explora nuestros hotéis pet-friendly cuidadosamente seleccionados en 85 destinos europeus — todos auditados por políticas pet-welcome genuinas, com avaliações verificadas 8,0+.',
