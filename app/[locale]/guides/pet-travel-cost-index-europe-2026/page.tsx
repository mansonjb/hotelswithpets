...
const COPY: Record<string, {
  ...
  pt: {
    hero: {
      ...
      lede: `O benchmark de costes 2026 para viajar por Europa com cão o gato — tarifas medias por país e cidade, qué porcentaje de hotéis no cobra nada, e a sorprendente brecha de 37 €/noite entre a cidade europeia mais barata e a mais cara.`,
    },
    intro: {
    ...
    keyFindings: {
      ...
      items: [
        ...
        { stat: `${GLOBAL.pctFree} %`, label: 'dos hotéis auditados no cobra ningún cargo' },
    ...
    methodology: {
      ...
      paras: [
        `Extrajimos a tarifa nocturna publicada para cada hotel desde o seu política de animais em Booking.com o web oficial (datos recogidos abril-maio 2026). Os hotéis que só publicam « Animais admitidas sob solicitud » sem preço fueron excluidos da media para no distorsionarla.`,
        `As tarifas em monedas distintas al EUR (GBP, CHF, SEK, NOK, DKK, CZK, HUF, PLN, BGN, RON, ISK) se convirtieron a EUR usando o tipo de cambio medio mensual de maio de 2026. Onde um hotel cobra por estadia em lugar de por noite, anualizamos sobre uma base de 3 noites — a duración media de um viaje doméstico UK.`,
        `As medias por país exigem al menos 5 hotéis com preço para inclusión (publicamos os recuentos de hotéis na tabla). Os ${countryRows.length} países listados a continuación superan ese umbral; otros 7 países com cobertura micro são demasiado escasos para publicarse responsablemente.`,
        ...
        `Nuestro dataset bruto se publica como os archivos destinations.json e hotels.json no repositorio que alimenta este sitio, abiertamente legibles em cada página de destino. Nos comprometemos a um re-audit anual em Q2.`,
      ],
    },
    countryTitle: 'Tarifa para animais por país (da mais barata a a mais cara)',
    countryIntro: `Suecia, República Checa e Bélgica lideram o ranking « barato » — mais do 47 % dos hotéis auditados no cobra nada. Reino Unido e os Balcanes (Serbia, Bulgaria) estão em lo alto do ranking de coste, impulsados por uma cultura de cadenas que trata a a animal como uma línea de ingresos explícita.`,
    cityCheapTitle: 'As 10 cidades europeias mais baratas para uma estadia pet-friendly',
    cityCheapIntro: `Estas são as cidades onde añadir um cão o gato a tu reserva cuesta menos. Dos cidades — Gotemburgo e Lausana — actualmente auditan a 0 € de media: cada hotel com preço de nuestra muestra no cobra nada.`,
    ...
    takeawayTitle: 'Conclusiones prácticas para 2026',
    takeawayParas: [
      `Si tienes flexibilidad de destino, gira hacia o norte de Europa (Suecia, Bélgica, Países Bajos, República Checa) antes de reservar UK o os Balcanes. Misma duración, a menudo 100 €+ ahorrados só em suplemento para animais numa estadia de 5 noites.`,
      ...
      `Nas cidades mediterráneas (Barcelona, Atenas, Lisboa, Valencia, Split), mais do 50 % dos hotéis pet-friendly no cobra nada — o Mediterrâneo europeu é estructuralmente a zona mais barata para viajar com animal na UE. Combínalo com praias caninas o ano inteiro para a MELHOR relación qualidade-preço.`,
    ...
    faqTitle: 'Preguntas frecuentes',
    faqs: [
      { q: '¿Como se recopiló o dataset?', a: `Registramos tarifas e políticas para animais de ${GLOBAL.hotels} hotéis listados em hotelswithpets.com, obteniéndolas das políticas de Booking.com e as webs dos hotéis entre abril e maio de 2026. Cada entrada se cotejó com a política directa do hotel quando estaba disponible.` },
      { q: '¿Porquê o Reino Unido é tan caro?', a: `A hostelería británica trata o cargo por animal como uma línea de ingresos discreta, no como um serviço de hospitalidad. A tarifa media UK (26 €) é mais do doble da media mediterrânea (~10 €). Premier Inn e Travelodge são as excepciones a 10 £/estadia; a maioria dos independientes e cadenas 4-5★ cobran 25-35 £/noite.` },
      { q: `¿Qué é um hotel « grátis » para animais?`, a: `Um hotel cuya política de animais publicada no indica ningún cargo por noite o por estadia. Algunos aún piden um depósito reembolsable por daños o limitan a animal a ciertas categorías de habitación — os contamos como « grátis » si no se cobra nada no check-in o check-out.` },
      { q: '¿Estos preços são definitivos?', a: `São medias indicativas e um indicador de costes típicos. Confirma sempre al reservar, já que os hotéis podem cambiar o seu política estacionalmente e varias cadenas aplicam limites por estadia no visibles na UI de resultados.` },
      { q: '¿Com qué frecuencia se actualizará este índice?', a: `Anualmente, em Q2 (abril-maio). A edição 2027 está planificada para maio de 2027 e trazará o movimiento plurianual nas medias por país clave — esperamos que Suecia e Bélgica permanezcan como suelo e UK como techo salvo cambio estructural de política.` },
    ],
    ctaTitle: 'Explora o dataset completo',
    ctaDesc: 'Cada tarifa para animais e avaliação hotelera de este índice está publicada em o seu página de destino. Elige uma cidade para ver o inventário completo de hotéis, contactos veterinários, parques e mapa Booking.com em vivo.',
