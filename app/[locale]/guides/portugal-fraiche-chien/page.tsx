...
const REGIONS: Region[] = [
  {
    id: 'porto',
    emoji: '🌉',
    title: { en: 'Porto', fr: 'Porto', es: 'Oporto', pt: 'Porto', de: 'Porto', nl: 'Porto', it: 'Porto' },
    cities: [
      {
        slug: 'porto',
        name: 'Porto',
        region: { en: 'Porto', fr: 'Porto', es: 'Oporto', pt: 'Porto', de: 'Porto', nl: 'Porto', it: 'Porto' },
        julyTemp: 23,
        tag: { en: 'Atlantic granite city · Douro river · wine', fr: 'Ville de granit atlantique · Douro · vin', es: 'Ciudad atlántica de granito · Duero · vino', pt: 'Cidade atlântica de granito · Douro · vinho', de: 'Atlantische Granitstadt · Douro · Wein', nl: 'Atlantische granietstad · Douro · wijn', it: 'Città di granito atlantica · Douro · vino' },
        why: {
          ...
          de: 'Porto bleibt im Juli bei 23°C, während Lissabon 29°C und Sevilla 38°C erreicht, gekühlt durch die atlantische Luftströmung aus dem Nordwesten und das Douro-Tal. Die Marginal am Flussufer (Cais da Ribeira bis Freixo, 8 km) ist vollständig für Fußgänger und Hunde bewegen sich dort frei. Der zeitgenössische Kunstpark Serralves (18 ha) erlaubt Hunde auf dem gesamten Gelände. Die Metro von Porto akzeptiert Hunde in Transportboxen. Die Strände von Foz do Douro und Matosinhos (3 km vom Zentrum) erlauben Hunde ganzjährig am Vormittag.',
          nl: 'Porto blijft in juli op 23°C, terwijl Lissabon 29°C en Sevilla 38°C haalt, gekoeld door de Atlantische luchtstroom uit het noordwesten en de Douro-vallei. De Marginal langs de rivier (Cais da Ribeira tot Freixo, 8 km) is volledig voetgangersgebied en honden lopen er vrij rond. Het park voor hedendaagse kunst Serralves (18 ha) staat honden op het hele terrein toe. De metro van Porto accepteert honden in een draagtas. De stranden van Foz do Douro en Matosinhos (3 km van het centrum) staan het hele jaar honden toe in de ochtend.', it: `Porto resta a 23°C a luglio, mentre Lisbona arriva a 29°C e Siviglia a 38°C, rinfrescata dal flusso atlantico da nordovest e dalla valle del Douro. Il lungofiume Marginal (da Cais da Ribeira a Freixo, 8 km) è interamente pedonale e i cani circolano liberi. Il parco d'arte contemporanea Serralves (18 ha) ammette cani su tutta l'area. La metro di Porto accetta cani nel trasportino. Le spiagge di Foz do Douro e Matosinhos (3 km dal centro) ammettono cani tutto l'anno al mattino.`,
        },
        dogTip: {
          ...
          de: 'Parque da Cidade do Porto: der größte Stadtpark Portugals (83 ha), Zonen ohne Leine, direkter Zugang zum Strand von Matosinhos (hundefreundlich am Vormittag), freier Eintritt, 20 Min. zu Fuß vom Museum Serralves.',
          nl: 'Parque da Cidade do Porto: het grootste stadspark van Portugal (83 ha), zones zonder lijn, directe toegang tot het strand van Matosinhos (hondvriendelijk in de ochtend), gratis toegang, 20 min lopen van het Serralves-museum.', it: 'Parque da Cidade do Porto: il più grande parco urbano del Portogallo (83 ha), zone senza guinzaglio, accesso diretto alla spiaggia di Matosinhos (dog-friendly al mattino), ingresso gratuito, 20 min a piedi dal museo Serralves.',
        },
        hotels: [
          {
            name: 'The Yeatman',
            stars: 5,
            note: { en: 'Iconic wine hotel above the Douro in Vila Nova de Gaia, vineyard views, small pets accepted.', fr: 'Hôtel viticole iconique au-dessus du Douro à Vila Nova de Gaia, vue sur les vignobles, petits animaux acceptés.', es: 'Icónico hotel vinícola sobre el Duero en Vila Nova de Gaia, vistas a los viñedos, mascotas pequeñas aceptadas.', pt: 'Icónico hotel vínico acima do Douro em Vila Nova de Gaia, vistas para as vinhas, animais pequenos aceites.', de: 'Ikonisches Weinhotel über dem Douro in Vila Nova de Gaia, Blick auf die Weinberge, kleine Haustiere werden akzeptiert.', nl: 'Iconisch wijnhotel boven de Douro in Vila Nova de Gaia, uitzicht op de wijngaarden, kleine huisdieren toegestaan.', it: 'Hotel iconico dedicato al vino sopra il Douro a Vila Nova de Gaia, vista sui vigneti, animali di piccola taglia accettati.' },
          },
          {
            name: 'Torel Palace Porto',
            stars: 5,
            note: { en: 'Boutique palace hotel with garden terrace overlooking the city, dogs up to 10 kg welcome.', fr: 'Hôtel boutique avec terrasse-jardin dominant la ville, chiens jusqu\'à 10 kg bienvenus.', es: 'Hotel boutique con terraza-jardín con vistas a la ciudad, perros hasta 10 kg bienvenidos.', pt: 'Hotel boutique com terraço-jardim com vista para a cidade, cães até 10 kg bem-vindos.', de: `Boutique-Palasthotel mit Gartenterrasse mit Blick über die Stadt, Hunde bis 10 kg willkommen.`, nl: `Boutique paleishotel met tuinterras en uitzicht over de stad, honden tot 10 kg welkom.`, it: 'Hotel boutique tipo palazzo con terrazza-giardino affacciata sulla città, cani fino a 10 kg benvenuti.' },
          },
          {
            name: 'Hotel Infante de Sagres',
            stars: 4,
            note: { en: 'Historic grand hotel in the heart of the city, 5 min walk to the Ribeira, pets accepted.', fr: 'Grand hôtel historique au coeur de la ville, 5 min à pied de la Ribeira, animaux acceptés.', es: 'Gran hotel histórico en el corazón de la ciudad, a 5 min de la Ribeira, mascotas aceptadas.', pt: 'Grande hotel histórico no coração da cidade, 5 min a pé da Ribeira, animais aceites.', de: 'Historisches Grandhotel im Herzen der Stadt, 5 Min. zu Fuß zur Ribeira, Haustiere akzeptiert.', nl: 'Historisch grandhotel in het hart van de stad, 5 min lopen van de Ribeira, huisdieren toegestaan.', it: 'Grande albergo storico nel cuore della città, 5 min a piedi dalla Ribeira, animali accettati.' },
          },
        ],
      },
    ],
  },
  {
    id: 'costa-verde',
    emoji: '🌊',
    title: { en: 'Costa Verde (Minho coast)', fr: 'Costa Verde (Minho côtier)', es: 'Costa Verde (Miño costero)', pt: 'Costa Verde (Minho litoral)', de: 'Costa Verde (Minho-Küste)', nl: 'Costa Verde (Minho-kust)', it: 'Costa Verde (costa del Minho)' },
    cities: [
      {
        slug: 'viana-do-castelo',
        name: 'Viana do Castelo',
        region: { en: 'Minho coast', fr: 'Minho côtier', es: 'Miño costero', pt: 'Minho litoral', de: 'Minho-Küste', nl: 'Minho-kust', it: 'Costa del Minho' },
        julyTemp: 22,
        tag: { en: 'Lima river mouth · Atlantic · 22°C', fr: 'Embouchure du Lima · Atlantique · 22°C', es: 'Desembocadura del Lima · Atlántico · 22°C', pt: 'Foz do Lima · Atlântico · 22°C', de: 'Lima-Flussmündung · Atlantik · 22°C', nl: 'Monding van de Lima · Atlantische Oceaan · 22°C', it: 'Foce del Lima · Atlantico · 22°C' },
        why: {
          ...
          de: 'Viana do Castelo liegt an der Mündung des Lima in den Atlantik bei 22°C im Juli, 7°C kühler als Lissabon. Die Basilika Santa Luzia (Hügelkuppe, 200m) ist mit der Standseilbahn erreichbar, und das Plateau hat einen 5 km langen Weg ohne Leine durch Pinienwald mit Blick auf den Atlantik. Der Strand Cabedelo (der Stadtstrand, Südufer des Lima) erlaubt Hunde vor 9 Uhr und nach 18 Uhr in der Saison, sowie ganzjährig außerhalb Juli/August. Der Radweg entlang des Lima führt 50 km landeinwärts durch das Minho-Tal, flach und fast durchgehend ohne Leine.',
          nl: 'Viana do Castelo ligt waar de Lima de Atlantische Oceaan ontmoet, op 22°C in juli, 7°C koeler dan Lissabon. De basiliek van Santa Luzia (heuveltop, 200m) is te bereiken met de kabelbaan en het plateau heeft een 5 km lang pad zonder lijn door dennenbos met uitzicht op de Atlantische Oceaan. Het strand van Cabedelo (het stadsstrand, zuidoever van de Lima) staat honden toe voor 9 uur en na 18 uur in het seizoen, en het hele jaar door buiten juli-augustus. Het fietspad langs de Lima loopt 50 km landinwaarts door de Minho-vallei, vlak en bijna overal zonder lijn.', it: `Viana do Castelo si trova dove il Lima incontra l'Atlantico, a 22°C a luglio, 7°C più fresca di Lisbona. La basilica di Santa Luzia (in cima alla collina, 200m) si raggiunge con la funicolare e l'altopiano ha un sentiero senza guinzaglio di 5 km attraverso una pineta con vista sull'Atlantico. La spiaggia di Cabedelo (la spiaggia cittadina, riva sud del Lima) ammette cani prima delle 9 e dopo le 18 in stagione, e tutto l'anno fuori da luglio-agosto. La pista ciclabile lungo il Lima corre per 50 km verso l'interno attraverso la valle del Minho, pianeggiante e quasi ovunque senza guinzaglio.`,
        },
        dogTip: {
          ...
          de: 'Waldwege am Monte de Santa Luzia: ab der Basilika auf 200m, 10 km markierte Wege durch Eukalyptus und Kiefern, durchgehend ohne Leine, kühl selbst im August, Aussicht von Galicien bis Esposende.',
          nl: 'Boswandelpaden op de Monte de Santa Luzia: vanaf de basiliek op 200m, 10 km gemarkeerde paden door eucalyptus en dennen, overal zonder lijn, koel zelfs in augustus, uitzicht van Galicië tot Esposende.', it: 'Sentieri forestali del Monte de Santa Luzia: dalla basilica a 200m, 10 km di percorsi segnalati tra eucalipti e pini, interamente senza guinzaglio, fresco anche in agosto, vista dalla Galizia a Esposende.',
        },
        hotels: [
          {
            name: 'Pousada de Viana do Castelo',
            stars: 4,
            note: { en: 'Historic pousada in a 1920s Art Nouveau building on the Monte de Santa Luzia, panoramic views, dogs accepted.', fr: 'Pousada historique dans un édifice Art Nouveau des années 1920 sur le Monte de Santa Luzia, vues panoramiques, chiens acceptés.', es: 'Histórica pousada en un edificio Art Nouveau de los años 20 en el Monte de Santa Luzia, vistas panorámicas, perros aceptados.', pt: 'Pousada histórica num edifício Art Nouveau dos anos 1920 no Monte de Santa Luzia, vistas panorâmicas, cães aceites.', de: 'Historische Pousada in einem Jugendstilgebäude der 1920er Jahre auf dem Monte de Santa Luzia, Panoramablick, Hunde akzeptiert.', nl: 'Historische pousada in een art-nouveaugebouw uit de jaren 1920 op de Monte de Santa Luzia, panoramisch uitzicht, honden toegestaan.', it: `Pousada storica in un edificio Art Nouveau degli anni '20 sul Monte de Santa Luzia, viste panoramiche, cani accettati.` },
          },
          {
            name: 'Fluviomar Hotel',
            stars: 4,
            note: { en: 'Lima riverside hotel near the marina, modern rooms, pets welcome up to 15 kg.', fr: 'Hôtel en bord du Lima près de la marina, chambres modernes, animaux bienvenus jusqu\'à 15 kg.', es: 'Hotel a orillas del Lima cerca del puerto deportivo, habitaciones modernas, mascotas bienvenidas hasta 15 kg.', pt: 'Hotel à beira do Lima perto da marina, quartos modernos, animais bem-vindos até 15 kg.', de: `Hotel am Lima-Ufer nahe der Marina, moderne Zimmer, Haustiere bis 15 kg willkommen.`, nl: `Hotel aan de Lima-oever bij de jachthaven, moderne kamers, huisdieren tot 15 kg welkom.`, it: 'Hotel sul lungofiume Lima vicino alla marina, camere moderne, animali domestici benvenuti fino a 15 kg.' },
          },
          {
            name: 'Hotel Viana Heritage',
            stars: 4,
            note: { en: 'Central boutique hotel, 5 min walk to the Lima promenade and market, dog-friendly rooms.', fr: 'Hôtel boutique central, 5 min à pied de la promenade du Lima et du marché, chambres dog-friendly.', es: 'Hotel boutique central, a 5 min del paseo del Lima y el mercado, habitaciones dog-friendly.', pt: 'Hotel boutique central, 5 min a pé do passeio do Lima e do mercado, quartos dog-friendly.', de: 'Zentrales Boutique-Hotel, 5 Min. zu Fuß zur Lima-Promenade und zum Markt, hundefreundliche Zimmer.', nl: 'Centraal boutiquehotel, 5 min lopen van de Lima-promenade en de markt, hondvriendelijke kamers.', it: 'Hotel boutique centrale, 5 min a piedi dalla passeggiata del Lima e dal mercato, camere dog-friendly.' },
          },
        ],
      },
    ],
  },
  {
    id: 'minho-historique',
    emoji: '🏰',
    title: { en: 'Historic Minho', fr: 'Minho historique', es: 'Miño histórico', pt: 'Minho histórico', de: 'Historisches Minho', nl: 'Historisch Minho', it: 'Minho storico' },
    cities: [
      {
        slug: 'guimaraes',
        name: 'Guimarães',
        region: { en: 'Historic Minho', fr: 'Minho historique', es: 'Miño histórico', pt: 'Minho histórico', de: 'Historisches Minho', nl: 'Historisch Minho', it: 'Minho storico' },
        julyTemp: 23,
        tag: { en: "Birthplace of Portugal · UNESCO · 23°C", fr: "Berceau du Portugal · UNESCO · 23°C", es: 'Cuna de Portugal · UNESCO · 23°C', pt: 'Berço de Portugal · UNESCO · 23°C', de: 'Wiege Portugals · UNESCO · 23°C', nl: 'Bakermat van Portugal · UNESCO · 23°C', it: 'Culla del Portogallo · UNESCO · 23°C' },
        why: {
          ...
          de: 'Guimarães ist die Wiege Portugals (erste Hauptstadt im 12. Jahrhundert) mit einem mittelalterlichen UNESCO-Zentrum und einem Julidurchschnitt von 23°C dank des Bergmassivs Serra de Penha (600m), das die Hitze aus dem Süden abblockt. Die gesamte Altstadt ist Fußgängerzone. Der Berg Penha (548m, Seilbahn ab der Stadt) bietet ein 15 km langes Wegenetz ohne Leine durch Granitfelsen und Eichenwald. Die keltische Ausgrabungsstätte Citânia de Briteiros (10 km nördlich) hat einen 3 km langen archäologischen Weg ohne Leine.',
          nl: 'Guimarães is de bakermat van Portugal (eerste hoofdstad in de 12e eeuw) met een middeleeuws UNESCO-centrum en een juligemiddelde van 23°C dankzij het bergmassief Serra de Penha (600m) dat de hitte uit het zuiden tegenhoudt. De hele oude binnenstad is autovrij. De berg Penha (548m, kabelbaan vanuit de stad) heeft een netwerk van 15 km paden zonder lijn door granietrotsen en eikenbos. De Keltische nederzetting Citânia de Briteiros (10 km noordelijk) heeft een 3 km lang archeologisch pad zonder lijn.', it: `Guimarães è la culla del Portogallo (prima capitale nel XII secolo) con un centro medievale UNESCO e una media di 23°C a luglio grazie al massiccio della Serra de Penha (600m) che blocca il calore proveniente da sud. L'intero centro storico è pedonale. Il monte Penha (548m, funivia dalla città) offre una rete di 15 km di sentieri senza guinzaglio tra massi di granito e boschi di querce. L'insediamento celtico di Citânia de Briteiros (10 km a nord) ha un sentiero archeologico di 3 km senza guinzaglio.`,
        },
        dogTip: {
          ...
          de: 'Seilbahn der Serra de Penha: 10 Min. Fahrt ab der Stadt, Ankunft auf 548m, 15 km Granitfelsen-Wege ohne Leine, eine Wallfahrtskapelle, kühl den ganzen Sommer über, Hunde fahren kostenlos in der Gondel mit.',
          nl: 'Kabelbaan van de Serra de Penha: 10 min. rit vanuit de stad, aankomst op 548m, 15 km granietrots-paden zonder lijn, een bedevaartskapel, koel de hele zomer, honden reizen gratis mee in de gondel.', it: `Funivia della Serra de Penha: 10 min di viaggio dalla città, arrivo a 548m, 15 km di sentieri tra rocce di granito senza guinzaglio, una cappella-santuario, fresco tutta l'estate, i cani viaggiano gratis in cabina.`,
        },
        hotels: [
          {
            name: 'Pousada de Guimarães',
            stars: 4,
            note: { en: 'National pousada in a converted 12th-century convent adjacent to the castle, dogs accepted.', fr: 'Pousada nationale dans un couvent du XIIe siècle converti adjacent au château, chiens acceptés.', es: 'Pousada nacional en un convento del siglo XII convertido junto al castillo, perros aceptados.', pt: 'Pousada nacional num convento do séc. XII convertido adjacente ao castelo, cães aceites.', de: 'Staatliche Pousada in einem umgebauten Kloster aus dem 12. Jahrhundert direkt neben der Burg, Hunde akzeptiert.', nl: 'Nationale pousada in een verbouwd klooster uit de 12e eeuw naast het kasteel, honden toegestaan.', it: 'Pousada nazionale in un convento del XII secolo convertito, adiacente al castello, cani accettati.' },
          },
          {
            name: 'Hotel de Guimarães',
            stars: 4,
            note: { en: 'Modern hotel near the historic centre, walking distance to the cable car, pets up to 15 kg welcome.', fr: 'Hôtel moderne près du centre historique, à pied du téléphérique, animaux jusqu\'à 15 kg bienvenus.', es: 'Hotel moderno cerca del centro histórico, a pie del teleférico, mascotas hasta 15 kg bienvenidas.', pt: 'Hotel moderno perto do centro histórico, a pé do teleférico, animais até 15 kg bem-vindos.', de: 'Modernes Hotel nahe der Altstadt, fußläufig zur Seilbahn, Haustiere bis 15 kg willkommen.', nl: 'Modern hotel bij het historische centrum, loopafstand van de kabelbaan, huisdieren tot 15 kg welkom.', it: 'Hotel moderno vicino al centro storico, a piedi dalla funivia, animali fino a 15 kg benvenuti.' },
          },
          {
            name: 'Casa de Sezim',
            stars: 4,
            note: { en: 'Manor house estate with vineyard 5 km south of the city, large grounds, dogs welcome.', fr: 'Domaine manorial avec vignoble à 5 km au sud de la ville, grands espaces, chiens bienvenus.', es: 'Casa señorial con viñedo a 5 km al sur de la ciudad, amplios espacios, perros bienvenidos.', pt: 'Solar com vinha a 5 km a sul da cidade, grandes espaços exteriores, cães bem-vindos.', de: 'Herrenhaus mit Weinberg 5 km südlich der Stadt, weitläufiges Gelände, Hunde willkommen.', nl: 'Landgoed met wijngaard 5 km ten zuiden van de stad, groot terrein, honden welkom.', it: 'Tenuta con vigneto a 5 km a sud della città, ampi spazi esterni, cani benvenuti.' },
          },
        ],
      },
      {
        ...
        region: { en: 'Historic Minho', fr: 'Minho historique', es: 'Miño histórico', pt: 'Minho histórico', de: 'Historisches Minho', nl: 'Historisch Minho', it: 'Minho storico' },
        julyTemp: 24,
        tag: { en: 'Rome of Portugal · Bom Jesus · university', fr: 'Rome du Portugal · Bom Jesus · université', es: 'Roma de Portugal · Bom Jesus · universidad', pt: 'Roma de Portugal · Bom Jesus · universidade', de: 'Rom Portugals · Bom Jesus · Universität', nl: 'Rome van Portugal · Bom Jesus · universiteit', it: 'Roma del Portogallo · Bom Jesus · università' },
        why: {
          ...
          de: 'Braga ist Portugals religiöse Hauptstadt und die älteste Stadt des Landes, auf 190m mit einer beständigen atlantischen Brise, die den Juli bei 24°C hält. Das Heiligtum Bom Jesus do Monte (580m, 6 km vom Zentrum) ist eine UNESCO-Pilgerstätte: die barocke Treppe und der umgebende Wald sind ohne Leine. Der Parque do Bom Jesus (12 ha Waldfläche) erlaubt Hunde. Das Universitätsviertel ist voller Caféterrassen. Braga hat die lebendigste Hundekultur aller portugiesischen Städte außerhalb Lissabons und Portos.',
          nl: 'Braga is de religieuze hoofdstad en de oudste stad van Portugal, op 190m met een gestage Atlantische bries die juli op 24°C houdt. Het heiligdom Bom Jesus do Monte (580m, 6 km van het centrum) is een UNESCO-bedevaartsoord: de barokke trap en het omringende bos zijn zonder lijn. Het Parque do Bom Jesus (12 ha bos) staat honden toe. De universiteitswijk zit vol caféterrassen. Braga heeft de levendigste hondencultuur van alle Portugese steden buiten Lissabon en Porto.', it: 'Braga è la capitale religiosa e la città più antica del Portogallo, a 190m con una brezza atlantica costante che mantiene luglio a 24°C. Il santuario del Bom Jesus do Monte (580m, 6 km dal centro) è un sito di pellegrinaggio UNESCO: la scalinata barocca e il bosco circostante sono senza guinzaglio. Il Parque do Bom Jesus (12 ha di bosco) ammette cani. Il quartiere universitario è pieno di terrazze di caffè. Braga ha la cultura canina più vivace di tutte le città portoghesi fuori da Lisbona e Porto.',
        },
        dogTip: {
          ...
          de: 'Parque do Bom Jesus: 12 ha Wald rund um das Heiligtum auf 350m, Hunde auf allen Wegen ohne Leine, ein See, Picknickbereiche und Brunnen, an einem Sommernachmittag 15°C kühler als die Innenstadt von Braga.',
          nl: 'Parque do Bom Jesus: 12 ha bos rond het heiligdom op 350m, honden zonder lijn op alle paden, een meer, picknickplekken en fonteinen, op een zomermiddag 15°C koeler dan het centrum van Braga.', it: `Parque do Bom Jesus: 12 ha di bosco intorno al santuario a 350m, cani senza guinzaglio su tutti i sentieri, un lago, aree picnic e fontane, 15°C più fresco del centro di Braga in un pomeriggio d'estate.`,
        },
        hotels: [
          {
            name: 'Meliá Braga',
            stars: 5,
            note: { en: 'Modern tower hotel next to the Forum Braga, rooftop pool, small pets accepted.', fr: 'Hôtel tour moderne près du Forum Braga, piscine sur le toit, petits animaux acceptés.', es: 'Hotel torre moderno junto al Forum Braga, piscina en la azotea, mascotas pequeñas aceptadas.', pt: 'Hotel torre moderno junto ao Forum Braga, piscina no telhado, animais pequenos aceites.', de: 'Moderner Turmbauhotel neben dem Forum Braga, Pool auf dem Dach, kleine Haustiere akzeptiert.', nl: 'Modern torenhotel naast het Forum Braga, zwembad op het dak, kleine huisdieren toegestaan.', it: 'Moderno hotel a torre accanto al Forum Braga, piscina sul tetto, animali di piccola taglia accettati.' },
          },
          {
            name: 'Hotel do Parque',
            stars: 4,
            note: { en: 'Directly facing the Bom Jesus park and sanctuary, dogs accepted up to 15 kg, ideal for morning hikes.', fr: 'Face au parc et sanctuaire du Bom Jesus, chiens acceptés jusqu\'à 15 kg, idéal pour les randonnées matinales.', es: 'Frente al parque y santuario de Bom Jesus, perros aceptados hasta 15 kg, ideal para excursiones matinales.', pt: 'Em frente ao parque e santuário do Bom Jesus, cães aceites até 15 kg, ideal para caminhadas matinais.', de: 'Direkt gegenüber dem Park und Heiligtum von Bom Jesus, Hunde bis 15 kg akzeptiert, ideal für morgendliche Wanderungen.', nl: 'Direct tegenover het park en heiligdom van Bom Jesus, honden tot 15 kg toegestaan, ideaal voor ochtendwandelingen.', it: 'Proprio di fronte al parco e al santuario del Bom Jesus, cani accettati fino a 15 kg, ideale per passeggiate mattutine.' },
          },
          {
            name: 'Hotel do Templo',
            stars: 4,
            note: { en: 'Boutique hotel steps from the Bom Jesus stairs, peaceful location, dog-friendly policy.', fr: 'Hôtel boutique à deux pas des escaliers du Bom Jesus, emplacement paisible, politique dog-friendly.', es: 'Hotel boutique a dos pasos de las escaleras del Bom Jesus, ubicación tranquila, política dog-friendly.', pt: 'Hotel boutique a dois passos das escadarias do Bom Jesus, localização tranquila, política dog-friendly.', de: 'Boutique-Hotel wenige Schritte von der Treppe von Bom Jesus, ruhige Lage, hundefreundliche Richtlinie.', nl: 'Boutiquehotel op enkele stappen van de trap van Bom Jesus, rustige ligging, hondvriendelijk beleid.', it: 'Hotel boutique a pochi passi dalla scalinata del Bom Jesus, posizione tranquilla, politica dog-friendly.' },
          },
        ],
      },
    ],
  },
  {
    id: 'peneda-geres',
    emoji: '🌿',
    title: { en: 'Peneda-Gerês National Park', fr: 'Parc National Peneda-Gerês', es: 'Parque Nacional Peneda-Gerês', pt: 'Parque Nacional Peneda-Gerês', de: 'Nationalpark Peneda-Gerês', nl: 'Nationaal Park Peneda-Gerês', it: 'Parco Nazionale Peneda-Gerês' },
    cities: [
      {
        slug: 'arcos-de-valdevez',
        name: 'Arcos de Valdevez',
        region: { en: 'Peneda-Gerês', fr: 'Peneda-Gerês', es: 'Peneda-Gerês', pt: 'Peneda-Gerês', de: 'Peneda-Gerês', nl: 'Peneda-Gerês', it: 'Peneda-Gerês' },
        julyTemp: 22,
        tag: { en: 'Park gateway · Vez river · 22°C', fr: 'Porte du parc · río Vez · 22°C', es: 'Puerta del parque · río Vez · 22°C', pt: 'Porta do parque · rio Vez · 22°C', de: 'Parktor · Fluss Vez · 22°C', nl: 'Toegangspoort park · rivier de Vez · 22°C', it: 'Porta del parco · fiume Vez · 22°C' },
        why: {
          ...
          de: 'Arcos de Valdevez ist das ruhigere westliche Tor zum Nationalpark Peneda-Gerês, dem einzigen Nationalpark Portugals und einem der am wenigsten besuchten Westeuropas. Der Fluss Vez fließt durch das Stadtzentrum und hat drei Badestellen (poços), an denen Hunde frei schwimmen. Der Park beginnt 8 km nördlich: Granithochland auf 1.100m, uralte Speicherdörfer (espigueiros) von Soajo, Lebensraum von Wolf und Adler. Fast alle Wege innerhalb des Parks erlauben Hunde an der Leine. Außerhalb der Kernschutzzonen dürfen Hunde ohne Leine laufen.',
          nl: 'Arcos de Valdevez is de rustigere westelijke toegangspoort tot het Nationaal Park Peneda-Gerês, het enige nationale park van Portugal en een van de minst drukke van West-Europa. De rivier de Vez stroomt door het centrum van de stad en heeft drie zwemplekken (poços) waar honden vrij zwemmen. Het park begint 8 km noordelijk: granieten hoogland op 1.100m, eeuwenoude schuurdorpen (espigueiros) van Soajo, leefgebied van wolf en arend. Bijna alle paden binnen het park staan honden aan de lijn toe. Buiten de kernbeschermingszones mogen honden zonder lijn lopen.', it: `Arcos de Valdevez è la porta d'ingresso occidentale più tranquilla al Parco Nazionale Peneda-Gerês, l'unico parco nazionale del Portogallo e uno dei meno affollati dell'Europa occidentale. Il fiume Vez attraversa il centro cittadino e ha tre pozze balneabili (poços) dove i cani nuotano liberi. Il parco inizia 8 km a nord: altopiani granitici a 1.100m, antichi villaggi di granai (espigueiros) di Soajo, habitat di lupi e aquile. Quasi tutti i sentieri all'interno del parco ammettono cani al guinzaglio. Fuori dalle zone protette centrali, i cani possono stare senza guinzaglio.`,
        },
        dogTip: {
          ...
          de: 'Speicherdorf Soajo (10 km nördlich): am Dorfeingang parken, 3 km bis zu den espigueiros laufen (Granitspeicher des 18. Jahrhunderts auf Stelzen), Hunde ohne Leine, außerhalb der Wochenenden fast keine Touristen, das meistfotografierte Dorf Nordportugals.',
          nl: 'Schuurdorp Soajo (10 km noordelijk): parkeer bij de dorpsingang, loop 3 km naar de espigueiros (granieten schuren op poten uit de 18e eeuw), honden zonder lijn, buiten het weekend bijna geen toeristen, het meest gefotografeerde dorp van Noord-Portugal.', it: `Villaggio dei granai di Soajo (10 km a nord): parcheggia all'ingresso del paese, cammina 3 km fino agli espigueiros (granai di granito del XVIII secolo su piloni), cani senza guinzaglio, quasi nessun turista nei giorni feriali, il villaggio più fotografato del nord del Portogallo.`,
        },
        hotels: [
          {
            name: 'Quinta do Burgo',
            stars: 4,
            note: { en: 'Rural tourism estate on the Vez riverbank, large grounds, dogs welcome of any size.', fr: 'Domaine de tourisme rural au bord du Vez, grands espaces, chiens bienvenus de toute taille.', es: 'Finca de turismo rural a orillas del Vez, amplios espacios, perros bienvenidos de cualquier tamaño.', pt: 'Quinta de turismo rural à beira do Vez, grandes espaços exteriores, cães bem-vindos de qualquer tamanho.', de: 'Landtourismus-Anwesen am Ufer des Vez, weitläufiges Gelände, Hunde jeder Größe willkommen.', nl: 'Plattelandstoerisme-landgoed aan de oever van de Vez, groot terrein, honden van elke grootte welkom.', it: 'Tenuta di turismo rurale sulla riva del Vez, ampi spazi esterni, cani benvenuti di qualsiasi taglia.' },
          },
          {
            name: 'Convento dos Capuchos',
            stars: 4,
            note: { en: 'Converted 17th-century convent with garden and pool, 5 km from the park entrance, pets accepted.', fr: 'Couvent du XVIIe siècle converti avec jardin et piscine, 5 km de l\'entrée du parc, animaux acceptés.', es: 'Convento del siglo XVII convertido con jardín y piscina, a 5 km de la entrada del parque, mascotas aceptadas.', pt: 'Convento do séc. XVII convertido com jardim e piscina, 5 km da entrada do parque, animais aceites.', de: 'Umgebautes Kloster aus dem 17. Jahrhundert mit Garten und Pool, 5 km vom Parkeingang, Haustiere akzeptiert.', nl: 'Verbouwd klooster uit de 17e eeuw met tuin en zwembad, 5 km van de parkingang, huisdieren toegestaan.', it: `Convento del XVII secolo convertito con giardino e piscina, 5 km dall'ingresso del parco, animali accettati.` },
          },
          {
            name: 'Hotel do Soajo',
            stars: 3,
            note: { en: 'Simple mountain hotel in the village of Soajo inside the park, dogs accepted, local food.', fr: 'Hôtel de montagne simple dans le village de Soajo à l\'intérieur du parc, chiens acceptés, cuisine locale.', es: 'Sencillo hotel de montaña en el pueblo de Soajo dentro del parque, perros aceptados, cocina local.', pt: 'Hotel de montanha simples na aldeia de Soajo dentro do parque, cães aceites, comida local.', de: 'Einfaches Berghotel im Dorf Soajo innerhalb des Parks, Hunde akzeptiert, lokale Küche.', nl: 'Eenvoudig berghotel in het dorp Soajo binnen het park, honden toegestaan, lokale keuken.', it: 'Semplice hotel di montagna nel villaggio di Soajo dentro il parco, cani accettati, cucina locale.' },
          },
        ],
      },
    ],
  },
  {
    id: 'costa-vicentina',
    emoji: '🌊',
    title: { en: 'Costa Vicentina', fr: 'Costa Vicentina', es: 'Costa Vicentina', pt: 'Costa Vicentina', de: 'Costa Vicentina', nl: 'Costa Vicentina', it: 'Costa Vicentina' },
    cities: [
      {
        slug: 'sagres',
        name: 'Sagres',
        region: { en: 'Costa Vicentina', fr: 'Costa Vicentina', es: 'Costa Vicentina', pt: 'Costa Vicentina', de: 'Costa Vicentina', nl: 'Costa Vicentina', it: 'Costa Vicentina' },
        julyTemp: 20,
        tag: { en: 'Coldest Atlantic coast · wild cliffs · 20°C', fr: 'Côte atlantique la plus froide · falaises sauvages · 20°C', es: 'Costa atlántica más fría · acantilados salvajes · 20°C', pt: 'Costa atlântica mais fria · falésias selvagens · 20°C', de: 'Kühlste Atlantikküste · wilde Klippen · 20°C', nl: 'Koudste Atlantische kust · wilde klippen · 20°C', it: 'Costa atlantica più fredda · scogliere selvagge · 20°C' },
        why: {
          ...
          de: 'Sagres und die Costa Vicentina sind das kühlste Küstengebiet im portugiesischen Festland mit 20°C im Juli, gekühlt durch den Kanarenstrom, denselben kalten atlantischen Auftrieb, der die Kanarischen Inseln mild hält. Die Costa Vicentina ist Europas letzte wilde Atlantikküste: 100 km geschützte Küste mit fast keiner Bebauung, 90% der Strände erlauben Hunde ganzjährig ohne Einschränkung (kein saisonales Verbot), und 75 km Wege entlang der Klippen ohne Leine. Der Naturpark Sudoeste Alentejano hat weniger Hunderegeln als fast jeder andere Ort in Europa.',
          nl: 'Sagres en de Costa Vicentina zijn het koelste kustgebied van het Portugese vasteland met 20°C in juli, gekoeld door de Canarische stroom, dezelfde koude Atlantische opwelling die de Canarische Eilanden mild houdt. De Costa Vicentina is de laatste wilde Atlantische kust van Europa: 100 km beschermde kust met bijna geen bebouwing, 90% van de stranden staan honden het hele jaar toe zonder beperking (geen seizoensverbod), en 75 km paden langs de klippen zonder lijn. Het Natuurpark Sudoeste Alentejano heeft minder hondenregels dan bijna elke andere plek in Europa.', it: `Sagres e la Costa Vicentina sono la zona costiera più fresca del Portogallo continentale, con 20°C a luglio, rinfrescata dalla Corrente delle Canarie, la stessa risalita atlantica fredda che mantiene mite le Canarie. La Costa Vicentina è l'ultima costa atlantica selvaggia d'Europa: 100 km di costa protetta con quasi nessuna costruzione, il 90% delle spiagge ammette cani tutto l'anno senza restrizioni (nessun divieto stagionale), e 75 km di sentieri in cima alle scogliere senza guinzaglio. Il Parco Naturale del Sudoeste Alentejano ha meno regole sui cani di quasi ogni altro posto in Europa.`,
        },
        dogTip: {
          ...
          de: 'Praia do Castelejo (5 km nördlich von Sagres): wilder Strand eingerahmt von 80m hohen Klippen, Hunde ganzjährig ohne Leine, nur über einen 500m langen Weg vom Parkplatz erreichbar, fast immer wenig besucht, selbst im August.',
          nl: 'Praia do Castelejo (5 km noordelijk van Sagres): wild strand ingesloten door 80m hoge klippen, honden het hele jaar zonder lijn, alleen bereikbaar via een 500m lang pad vanaf de parkeerplaats, bijna altijd rustig, zelfs in augustus.', it: `Praia do Castelejo (5 km a nord di Sagres): spiaggia selvaggia racchiusa tra scogliere di 80m, cani senza guinzaglio tutto l'anno, raggiungibile solo con un sentiero di 500m dal parcheggio, quasi sempre poco affollata anche in agosto.`,
        },
        hotels: [
          {
            name: 'Martinhal Sagres Beach Family Resort',
            stars: 5,
            note: { en: 'Award-winning resort with private beach, villas and suites, dogs of all sizes accepted.', fr: 'Resort primé avec plage privée, villas et suites, chiens de toute taille acceptés.', es: 'Resort premiado con playa privada, villas y suites, perros de cualquier tamaño aceptados.', pt: 'Resort premiado com praia privada, vilas e suites, cães de qualquer tamanho aceites.', de: 'Preisgekröntes Resort mit Privatstrand, Villen und Suiten, Hunde jeder Größe akzeptiert.', nl: 'Bekroond resort met privéstrand, villa\'s en suites, honden van elke grootte toegestaan.', it: 'Resort pluripremiato con spiaggia privata, ville e suite, cani di ogni taglia accettati.' },
          },
          {
            name: 'Memmo Baleeira',
            stars: 4,
            note: { en: 'Design hotel above Sagres harbour, sea views from every room, pets welcome.', fr: 'Hôtel design au-dessus du port de Sagres, vue mer depuis chaque chambre, animaux bienvenus.', es: 'Hotel de diseño sobre el puerto de Sagres, vistas al mar desde cada habitación, mascotas bienvenidas.', pt: 'Hotel de design acima do porto de Sagres, vista para o mar de todos os quartos, animais bem-vindos.', de: 'Designhotel oberhalb des Hafens von Sagres, Meerblick aus jedem Zimmer, Haustiere willkommen.', nl: 'Designhotel boven de haven van Sagres, zeezicht vanuit elke kamer, huisdieren welkom.', it: 'Hotel di design sopra il porto di Sagres, vista mare da ogni camera, animali benvenuti.' },
          },
          {
            name: 'Orquidea Aparthotel',
            stars: 3,
            note: { en: 'Affordable self-catering apartments near the village, quiet, dogs accepted of any size.', fr: 'Appartements en location avec cuisine abordables près du village, calme, chiens acceptés de toute taille.', es: 'Apartamentos asequibles con cocina cerca del pueblo, tranquilo, perros aceptados de cualquier tamaño.', pt: 'Apartamentos acessíveis com cozinha perto da aldeia, tranquilo, cães aceites de qualquer tamanho.', de: 'Preisgünstige Apartments mit eigener Küche nahe dem Dorf, ruhig, Hunde jeder Größe akzeptiert.', nl: 'Betaalbare appartementen met eigen keuken bij het dorp, rustig, honden van elke grootte toegestaan.', it: 'Appartamenti convenienti con cucina vicino al villaggio, tranquillo, cani accettati di qualsiasi taglia.' },
          },
        ],
      },
    ],
...
const T = {
  title: {
    ...
    de: 'Die besten Städte, um mit Ihrem Hund der Hitze in Portugal zu entkommen (2026)',
    nl: 'De beste steden om met je hond aan de hitte in Portugal te ontsnappen (2026)', it: 'Le migliori città per sfuggire al caldo in Portogallo con il tuo cane (2026)',
  },
  metaTitle: {
    ...
    de: 'Kühles Portugal mit Ihrem Hund: 6 Städte unter 24°C im Juli (2026)',
    nl: 'Koel Portugal met je hond: 6 steden onder 24°C in juli (2026)', it: 'Portogallo fresco con il tuo cane: 6 città sotto i 24°C a luglio (2026)',
  },
  metaDesc: {
    ...
    de: 'Während Lissabon 29°C und die Algarve 31°C erreicht, bleiben Nordportugal und die Atlantikküste kühl. Porto, Viana do Castelo, Guimarães, Braga, Peneda-Gerês, Sagres: 6 hundefreundliche Städte unter 24°C im Juli.',
    nl: 'Terwijl Lissabon 29°C haalt en de Algarve 31°C, blijven Noord-Portugal en de Atlantische kust koel. Porto, Viana do Castelo, Guimarães, Braga, Peneda-Gerês, Sagres: 6 hondvriendelijke steden onder 24°C in juli.', it: `Mentre Lisbona raggiunge i 29°C e l'Algarve i 31°C, il Portogallo settentrionale e la costa atlantica restano freschi. Porto, Viana do Castelo, Guimarães, Braga, Peneda-Gerês, Sagres: 6 città dog-friendly sotto i 24°C a luglio.`,
  },
  intro: {
    ...
    de: 'Lissabon erreicht im Juli 29°C, die Algarve 31°C. Aber Nordportugal (Minho, Douro) bleibt dank der atlantischen Luftströmung bei 22 bis 24°C, und die Küste der Costa Vicentina sinkt durch den Kanarenstrom auf 20°C. Diese 6 Reiseziele bieten echten portugiesischen Charakter ohne die Sommerhitze.',
    nl: 'Lissabon bereikt 29°C in juli, de Algarve 31°C. Maar Noord-Portugal (Minho, Douro) blijft dankzij de Atlantische luchtstroom op 22-24°C, en de kust van de Costa Vicentina zakt door de Canarische stroom naar 20°C. Deze 6 bestemmingen bieden een echt Portugees karakter zonder de zomerhitte.', it: `Lisbona raggiunge i 29°C a luglio, l'Algarve i 31°C. Ma il Portogallo settentrionale (Minho, Douro) resta sui 22-24°C grazie alla circolazione atlantica, e la costa della Costa Vicentina scende a 20°C per effetto della Corrente delle Canarie. Queste 6 destinazioni offrono un autentico carattere portoghese senza il caldo estivo.`,
  },
  julyTemp: { en: 'July avg high', fr: 'Max moy. juillet', es: 'Máx. prom. julio', pt: 'Máx. méd. julho', de: 'Julihöchstwert', nl: 'Gem. max. juli', it: 'Max. media luglio' },
  ...
  faq: {
    q1: { en: 'Which Portuguese cities stay cool in summer?', fr: 'Quelles villes portugaises restent fraîches en été ?', es: '¿Qué ciudades portuguesas permanecen frescas en verano?', pt: 'Que cidades portuguesas se mantêm frescas no verão?', de: 'Welche portugiesischen Städte bleiben im Sommer kühl?', nl: 'Welke Portugese steden blijven koel in de zomer?', it: 'Quali città portoghesi restano fresche in estate?' },
    a1: {
      ...
      de: 'Die kühlsten Städte im portugiesischen Festland liegen im Minho (Nordwesten): Viana do Castelo (22°C), Arcos de Valdevez (22°C), Guimarães (23°C), Porto (23°C), Braga (24°C). Die Costa Vicentina (Südwestkap) ist mit 20°C das kühlste Küstengebiet dank des Kanarenstroms. Lissabon (29°C), die Küste des Alentejo (28°C) und die Algarve (30-32°C) sind deutlich wärmer. Die Azoren (Ponta Delgada, 24°C) und Madeira (Funchal, 26°C) sind warm, aber stets ozeanisch geprägt.',
      nl: 'De koelste steden op het Portugese vasteland liggen in de Minho (noordwesten): Viana do Castelo (22°C), Arcos de Valdevez (22°C), Guimarães (23°C), Porto (23°C), Braga (24°C). De Costa Vicentina (zuidwestelijke kaap) is met 20°C het koelste kustgebied dankzij de Canarische stroom. Lissabon (29°C), de Alentejo-kust (28°C) en de Algarve (30-32°C) zijn aanzienlijk warmer. De Azoren (Ponta Delgada, 24°C) en Madeira (Funchal, 26°C) zijn warm maar altijd oceanisch.', it: `Le città più fresche del Portogallo continentale si trovano nel Minho (nordovest): Viana do Castelo (22°C), Arcos de Valdevez (22°C), Guimarães (23°C), Porto (23°C), Braga (24°C). La Costa Vicentina (capo sudoccidentale) è la zona costiera più fresca con 20°C grazie alla Corrente delle Canarie. Lisbona (29°C), la costa dell'Alentejo (28°C) e l'Algarve (30-32°C) sono decisamente più calde. Le Azzorre (Ponta Delgada, 24°C) e Madeira (Funchal, 26°C) sono calde ma sempre di clima oceanico.`,
    },
    q2: { en: 'Are dogs allowed on Portuguese beaches?', fr: 'Les chiens sont-ils autorisés sur les plages portugaises ?', es: '¿Se permiten perros en las playas portuguesas?', pt: 'São permitidos cães nas praias portuguesas?', de: 'Sind Hunde an portugiesischen Stränden erlaubt?', nl: 'Zijn honden toegestaan op Portugese stranden?', it: 'I cani sono ammessi sulle spiagge portoghesi?' },
    a2: {
      ...
      de: 'Die Strandregeln in Portugal variieren je nach Gemeinde. Im Allgemeinen: Strände in der Algarve und im Raum Lissabon verbieten Hunde an Badestränden von Juni bis September. Nordportugal (Minho-Küste, Raum Porto) ist großzügiger: die meisten Strände erlauben Hunde an der Leine, und viele haben außerhalb der Hochsaison Juli/August gar keine Einschränkungen. Costa Vicentina: 90% der Strände haben zu keiner Jahreszeit ein saisonales Hundeverbot. Das Gesetz (DL 309/93) erlaubt Hunde an Stränden außerhalb der Badesaison, aber die kommunalen Strandregeln (regulamento de praia) legen die Badesaison-Daten und etwaige ganzjährige Einschränkungen fest. Prüfen Sie vor dem Besuch stets die Regeln des jeweiligen Strandes.',
      nl: 'De strandregels in Portugal verschillen per gemeente. Over het algemeen: stranden in de Algarve en de regio Lissabon verbieden honden op badstranden van juni tot september. Noord-Portugal (Minho-kust, regio Porto) is soepeler: de meeste stranden staan honden aan de lijn toe, en veel hebben buiten het hoogseizoen juli-augustus helemaal geen beperkingen. Costa Vicentina: 90% van de stranden heeft geen enkel seizoensverbod voor honden. De wet (DL 309/93) staat honden toe op stranden buiten het badseizoen, maar de gemeentelijke strandregels (regulamento de praia) bepalen de data van het badseizoen en eventuele jaarrondbeperkingen. Controleer altijd de regels van het specifieke strand voordat je gaat.', it: `Le regole delle spiagge portoghesi variano da comune a comune. In generale: le spiagge dell'Algarve e della zona di Lisbona vietano i cani sulle spiagge balneari da giugno a settembre. Il Portogallo settentrionale (costa del Minho, zona di Porto) è più permissivo: la maggior parte delle spiagge ammette cani al guinzaglio, e molte non hanno alcuna restrizione fuori dall'alta stagione di luglio-agosto. Costa Vicentina: il 90% delle spiagge non ha alcun divieto stagionale per i cani. La legge (DL 309/93) permette i cani sulle spiagge fuori dalla stagione balneare, ma i regolamenti comunali delle spiagge (regulamento de praia) stabiliscono le date della stagione balneare ed eventuali restrizioni valide tutto l'anno. Controlla sempre le regole della spiaggia specifica prima di andarci.`,
    },
    q3: { en: 'How do I travel by train in Portugal with a dog?', fr: 'Comment voyager en train au Portugal avec un chien ?', es: '¿Cómo viajar en tren en Portugal con un perro?', pt: 'Como viajar de comboio em Portugal com um cão?', de: 'Wie reise ich mit dem Zug in Portugal mit einem Hund?', nl: 'Hoe reis ik met de trein door Portugal met een hond?', it: 'Come si viaggia in treno in Portogallo con un cane?' },
    a3: {
      ...
      de: 'Regeln der CP (Comboios de Portugal): Hunde unter 8 kg in einer Transportbox reisen kostenlos. Hunde ab 8 kg: akzeptiert in Regional- und Intercidades-Zügen zu 50% des Erwachsenentarifs, an der Leine mit Maulkorb. Alfa Pendular (Hochgeschwindigkeit): nur Hunde in Transportboxen unter 8 kg. Porto nach Viana do Castelo: 1 Std. 10 Min. mit dem Regionalzug (stündlich, Hunde akzeptiert). Porto nach Braga: 1 Std. mit dem Regionalzug (Hunde akzeptiert). Porto nach Guimarães: 1 Std. mit Metro-Sul do Tejo, dann Vorortbahn (Hunde in Transportboxen). Lissabon nach Porto: 3 Std. mit dem Alfa Pendular (nur kleine Hunde in Transportbox) oder 3 Std. 30 Min. mit dem Intercidades (größere Hunde akzeptiert mit Leine und Maulkorb).',
      nl: 'Regels van CP (Comboios de Portugal): honden onder 8 kg in een draagtas reizen gratis. Honden vanaf 8 kg: toegestaan in Regional- en Intercidades-treinen tegen 50% van het volwassen tarief, aan de lijn met muilkorf. Alfa Pendular (hogesnelheid): alleen honden in draagtassen onder 8 kg. Porto naar Viana do Castelo: 1u10 met de Regional-trein (elk uur, honden toegestaan). Porto naar Braga: 1u met de Regional-trein (honden toegestaan). Porto naar Guimarães: 1u met Metro-Sul do Tejo, dan voorstadstrein (honden in draagtas). Lissabon naar Porto: 3u met de Alfa Pendular (alleen kleine honden in draagtas) of 3u30 met de Intercidades (grotere honden toegestaan met lijn en muilkorf).', it: `Regole di CP (Comboios de Portugal): i cani sotto gli 8 kg in trasportino viaggiano gratis. Cani dagli 8 kg in su: accettati sui treni Regional e Intercidades al 50% della tariffa adulti, al guinzaglio con museruola. Alfa Pendular (alta velocità): solo cani in trasportino sotto gli 8 kg. Porto-Viana do Castelo: 1h10 in treno Regional (ogni ora, cani accettati). Porto-Braga: 1h in Regional (cani accettati). Porto-Guimarães: 1h con la Metro-Sul do Tejo, poi treno suburbano (cani in trasportino). Lisbona-Porto: 3h con l'Alfa Pendular (solo cani piccoli in trasportino) o 3h30 con l'Intercidades (cani più grandi accettati con guinzaglio e museruola).`,
    },
    q4: { en: 'Are dogs welcome in Portuguese restaurants and cafés?', fr: 'Les chiens sont-ils bienvenus dans les restaurants et cafés portugais ?', es: '¿Son bienvenidos los perros en los restaurantes y cafés portugueses?', pt: 'Os cães são bem-vindos nos restaurantes e cafés portugueses?', de: 'Sind Hunde in portugiesischen Restaurants und Cafés willkommen?', nl: 'Zijn honden welkom in Portugese restaurants en cafés?', it: 'I cani sono benvenuti nei ristoranti e nei caffè portoghesi?' },
    a4: {
      ...
      de: 'Portugal hat eine der entspanntesten Hundekulturen Europas. Auf der Terrasse (esplanada): Hunde werden fast überall akzeptiert. Im Innenbereich: das Gesetz erlaubt es nach Ermessen des Inhabers, und in der Praxis sind Hunde in der Mehrheit der tascas, cervejarias und traditionellen Restaurants drinnen willkommen, besonders außerhalb der Stadtzentren von Lissabon und Porto. Nordportugal (Minho, Trás-os-Montes) ist besonders aufgeschlossen. Cafés (pastelarias) heißen Hunde fast immer willkommen. Die Frage "posso entrar com o meu cão?" (darf ich mit meinem Hund hinein?) wird selten abgelehnt.',
      nl: 'Portugal heeft een van de meest ontspannen hondenculturen van Europa. Op het terras (esplanada): honden worden bijna overal geaccepteerd. Binnen: de wet staat het toe naar goeddunken van de eigenaar, en in de praktijk zijn honden binnen welkom bij de meerderheid van de tascas, cervejarias en traditionele restaurants, vooral buiten de centra van Lissabon en Porto. Noord-Portugal (Minho, Trás-os-Montes) is bijzonder open. Cafés (pastelarias) heten honden bijna altijd welkom. De vraag "posso entrar com o meu cão?" (mag ik naar binnen met mijn hond?) wordt zelden geweigerd.', it: `Il Portogallo ha una delle culture canine più rilassate d'Europa. In terrazza (esplanada): i cani sono accettati quasi ovunque. All'interno: la legge lo permette a discrezione del titolare, e in pratica i cani sono i benvenuti all'interno nella maggior parte delle tascas, cervejarias e ristoranti tradizionali, soprattutto fuori dai centri di Lisbona e Porto. Il Portogallo settentrionale (Minho, Trás-os-Montes) è particolarmente aperto. I caffè (pastelarias) accolgono quasi sempre i cani. La domanda "posso entrar com o meu cão?" (posso entrare con il mio cane?) viene raramente rifiutata.`,
    },
    q5: { en: 'Can dogs hike in Peneda-Gerês National Park?', fr: 'Les chiens peuvent-ils randonner dans le Parc National Peneda-Gerês ?', es: '¿Pueden los perros hacer senderismo en el Parque Nacional Peneda-Gerês?', pt: 'Os cães podem fazer trilhos no Parque Nacional Peneda-Gerês?', de: 'Können Hunde im Nationalpark Peneda-Gerês wandern?', nl: 'Kunnen honden wandelen in Nationaal Park Peneda-Gerês?', it: 'I cani possono fare escursioni nel Parco Nazionale Peneda-Gerês?' },
    a5: {
      ...
      de: 'Ja, mit wichtigen Nuancen. Peneda-Gerês ist Portugals einziger Nationalpark und Hunde sind auf den meisten Wegen erlaubt, aber innerhalb der Parkgrenzen ist eine Leine vorgeschrieben. Außerhalb der Kernschutzzonen (die meisten Zugänge des Minho-Tals, das Vez-Tal) dürfen Hunde ohne Leine laufen. Wichtige Wege mit Hund an der Leine: Trilho das Pedras Boroas (Soajo, 6 km), Trilho do Rio Homem (Caldas do Gerês, 8 km), Trilho do Albergaria (alte Straße, 5 km). Der Park hat Wölfe. Halten Sie Hunde bei Dämmerung und Anbruch der Nacht an kurzer Leine. Badestellen (poços) innerhalb des Parks erlauben Hunde. Ranger erteilen bei gut kontrollierten Hunden an der Leine selten Verwarnungen.',
      nl: 'Ja, met belangrijke nuances. Peneda-Gerês is Portugals enige nationale park en honden zijn toegestaan op de meeste paden, maar binnen de parkgrenzen is een lijn verplicht. Buiten de kernbeschermingszones (de meeste toegangen van de Minho-vallei, de Vez-vallei) mogen honden zonder lijn lopen. Belangrijke paden met hond aan de lijn: Trilho das Pedras Boroas (Soajo, 6 km), Trilho do Rio Homem (Caldas do Gerês, 8 km), Trilho do Albergaria (oude weg, 5 km). Het park heeft wolven. Houd je hond bij zonsopgang en -ondergang kort aan de lijn. Zwemplekken (poços) binnen het park staan honden toe. Boswachters geven zelden een waarschuwing bij goed gecontroleerde honden aan de lijn.', it: `Sì, con alcune sfumature importanti. Peneda-Gerês è l'unico parco nazionale del Portogallo e i cani sono ammessi sulla maggior parte dei sentieri, ma dentro i confini del parco il guinzaglio è obbligatorio. Fuori dalle zone di protezione centrale (la maggior parte degli accessi della valle del Minho, la valle del Vez), i cani possono stare senza guinzaglio. Sentieri principali che ammettono cani al guinzaglio: Trilho das Pedras Boroas (Soajo, 6 km), Trilho do Rio Homem (Caldas do Gerês, 8 km), Trilho do Albergaria (vecchia strada, 5 km). Il parco ha lupi. Tieni il cane vicino e al guinzaglio all'alba e al tramonto. Le pozze balneabili (poços) dentro il parco ammettono cani. I guardiaparco raramente fanno avvisi per cani ben controllati al guinzaglio.`,
    },
  },
}
      ...
      <section className="bg-gradient-to-br from-emerald-900 via-teal-900 to-cyan-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-emerald-200 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-5">
            🇵🇹 {locale === 'fr' ? 'Minho · Douro · Costa Vicentina' : locale === 'es' ? 'Miño · Duero · Costa Vicentina' : locale === 'pt' ? 'Minho · Douro · Costa Vicentina' : locale === 'de' ? 'Minho · Douro · Costa Vicentina' : locale === 'nl' ? 'Minho · Douro · Costa Vicentina' : locale === 'it' ? 'Minho · Douro · Costa Vicentina' : 'Minho · Douro · Costa Vicentina'}
          </div>
