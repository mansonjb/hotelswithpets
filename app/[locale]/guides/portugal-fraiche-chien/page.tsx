...
const REGIONS: Region[] = [
  {
    id: 'porto',
    emoji: '🌉',
    title: { en: 'Porto', fr: 'Porto', es: 'Oporto', pt: 'Porto', de: 'Porto', nl: 'Porto' },
    cities: [
      {
        slug: 'porto',
        name: 'Porto',
        region: { en: 'Porto', fr: 'Porto', es: 'Oporto', pt: 'Porto', de: 'Porto', nl: 'Porto' },
        julyTemp: 23,
        tag: { en: 'Atlantic granite city · Douro river · wine', fr: 'Ville de granit atlantique · Douro · vin', es: 'Ciudad atlántica de granito · Duero · vino', pt: 'Cidade atlântica de granito · Douro · vinho', de: 'Atlantische Granitstadt · Douro · Wein', nl: 'Atlantische granietstad · Douro · wijn' },
        why: {
  ...
  },
  {
    id: 'costa-verde',
    emoji: '🌊',
    title: { en: 'Costa Verde (Minho coast)', fr: 'Costa Verde (Minho côtier)', es: 'Costa Verde (Miño costero)', pt: 'Costa Verde (Minho litoral)', de: 'Costa Verde (Minho-Küste)', nl: 'Costa Verde (Minho-kust)' },
    cities: [
      {
        slug: 'viana-do-castelo',
        name: 'Viana do Castelo',
        region: { en: 'Minho coast', fr: 'Minho côtier', es: 'Miño costero', pt: 'Minho litoral', de: 'Minho-Küste', nl: 'Minho-kust' },
        julyTemp: 22,
        tag: { en: 'Lima river mouth · Atlantic · 22°C', fr: 'Embouchure du Lima · Atlantique · 22°C', es: 'Desembocadura del Lima · Atlántico · 22°C', pt: 'Foz do Lima · Atlântico · 22°C', de: 'Lima-Flussmündung · Atlantik · 22°C', nl: 'Monding van de Lima · Atlantische Oceaan · 22°C' },
        why: {
  ...
  },
  {
    id: 'minho-historique',
    emoji: '🏰',
    title: { en: 'Historic Minho', fr: 'Minho historique', es: 'Miño histórico', pt: 'Minho histórico', de: 'Historisches Minho', nl: 'Historisch Minho' },
    cities: [
      {
        slug: 'guimaraes',
        name: 'Guimarães',
        region: { en: 'Historic Minho', fr: 'Minho historique', es: 'Miño histórico', pt: 'Minho histórico', de: 'Historisches Minho', nl: 'Historisch Minho' },
        julyTemp: 23,
        tag: { en: "Birthplace of Portugal · UNESCO · 23°C", fr: "Berceau du Portugal · UNESCO · 23°C", es: 'Cuna de Portugal · UNESCO · 23°C', pt: 'Berço de Portugal · UNESCO · 23°C', de: 'Wiege Portugals · UNESCO · 23°C', nl: 'Bakermat van Portugal · UNESCO · 23°C' },
        why: {
        ...
        dogTip: {
          ...
          nl: 'Kabelbaan van de Serra de Penha: 10 min. rit vanuit de stad, aankomst op 548m, 15 km granietrots-paden zonder lijn, een bedevaartskapel, koel de hele zomer, honden reizen gratis mee in de gondel.',
        },
        hotels: [
          {
      ...
      },
      {
        ...
        region: { en: 'Historic Minho', fr: 'Minho historique', es: 'Miño histórico', pt: 'Minho histórico', de: 'Historisches Minho', nl: 'Historisch Minho' },
        julyTemp: 24,
        tag: { en: 'Rome of Portugal · Bom Jesus · university', fr: 'Rome du Portugal · Bom Jesus · université', es: 'Roma de Portugal · Bom Jesus · universidad', pt: 'Roma de Portugal · Bom Jesus · universidade', de: 'Rom Portugals · Bom Jesus · Universität', nl: 'Rome van Portugal · Bom Jesus · universiteit' },
        why: {
        ...
        dogTip: {
          ...
          nl: 'Parque do Bom Jesus: 12 ha bos rond het heiligdom op 350m, honden zonder lijn op alle paden, een meer, picknickplekken en fonteinen, op een zomermiddag 15°C koeler dan het centrum van Braga.',
        },
        hotels: [
          {
            name: 'Meliá Braga',
            stars: 5,
            note: { en: 'Modern tower hotel next to the Forum Braga, rooftop pool, small pets accepted.', fr: 'Hôtel tour moderne près du Forum Braga, piscine sur le toit, petits animaux acceptés.', es: 'Hotel torre moderno junto al Forum Braga, piscina en la azotea, mascotas pequeñas aceptadas.', pt: 'Hotel torre moderno junto ao Forum Braga, piscina no telhado, animais pequenos aceites.', de: 'Moderner Turmbauhotel neben dem Forum Braga, Pool auf dem Dach, kleine Haustiere akzeptiert.', nl: 'Modern torenhotel naast het Forum Braga, zwembad op het dak, kleine huisdieren toegestaan.' },
          },
          {
            name: 'Hotel do Parque',
            stars: 4,
            note: { en: 'Directly facing the Bom Jesus park and sanctuary, dogs accepted up to 15 kg, ideal for morning hikes.', fr: 'Face au parc et sanctuaire du Bom Jesus, chiens acceptés jusqu\'à 15 kg, idéal pour les randonnées matinales.', es: 'Frente al parque y santuario de Bom Jesus, perros aceptados hasta 15 kg, ideal para excursiones matinales.', pt: 'Em frente ao parque e santuário do Bom Jesus, cães aceites até 15 kg, ideal para caminhadas matinais.', de: 'Direkt gegenüber dem Park und Heiligtum von Bom Jesus, Hunde bis 15 kg akzeptiert, ideal für morgendliche Wanderungen.', nl: 'Direct tegenover het park en heiligdom van Bom Jesus, honden tot 15 kg toegestaan, ideaal voor ochtendwandelingen.' },
          },
          {
  ...
  },
  {
    id: 'peneda-geres',
    emoji: '🌿',
    title: { en: 'Peneda-Gerês National Park', fr: 'Parc National Peneda-Gerês', es: 'Parque Nacional Peneda-Gerês', pt: 'Parque Nacional Peneda-Gerês', de: 'Nationalpark Peneda-Gerês', nl: 'Nationaal Park Peneda-Gerês' },
    cities: [
      {
        slug: 'arcos-de-valdevez',
        name: 'Arcos de Valdevez',
        region: { en: 'Peneda-Gerês', fr: 'Peneda-Gerês', es: 'Peneda-Gerês', pt: 'Peneda-Gerês', de: 'Peneda-Gerês', nl: 'Peneda-Gerês' },
        julyTemp: 22,
        tag: { en: 'Park gateway · Vez river · 22°C', fr: 'Porte du parc · río Vez · 22°C', es: 'Puerta del parque · río Vez · 22°C', pt: 'Porta do parque · rio Vez · 22°C', de: 'Parktor · Fluss Vez · 22°C', nl: 'Toegangspoort park · rivier de Vez · 22°C' },
        why: {
          ...
          nl: 'Arcos de Valdevez is de rustigere westelijke toegangspoort tot het Nationaal Park Peneda-Gerês, het enige nationale park van Portugal en een van de minst drukke van West-Europa. De rivier de Vez stroomt door het centrum van de stad en heeft drie zwemplekken (poços) waar honden vrij zwemmen. Het park begint 8 km noordelijk: granieten hoogland op 1.100m, eeuwenoude schuurdorpen (espigueiros) van Soajo, leefgebied van wolf en arend. Bijna alle paden binnen het park staan honden aan de lijn toe. Buiten de kernbeschermingszones mogen honden zonder lijn lopen.',
        },
        dogTip: {
  ...
  },
  {
    id: 'costa-vicentina',
    emoji: '🌊',
    title: { en: 'Costa Vicentina', fr: 'Costa Vicentina', es: 'Costa Vicentina', pt: 'Costa Vicentina', de: 'Costa Vicentina', nl: 'Costa Vicentina' },
    cities: [
      {
        slug: 'sagres',
        name: 'Sagres',
        region: { en: 'Costa Vicentina', fr: 'Costa Vicentina', es: 'Costa Vicentina', pt: 'Costa Vicentina', de: 'Costa Vicentina', nl: 'Costa Vicentina' },
        julyTemp: 20,
        tag: { en: 'Coldest Atlantic coast · wild cliffs · 20°C', fr: 'Côte atlantique la plus froide · falaises sauvages · 20°C', es: 'Costa atlántica más fría · acantilados salvajes · 20°C', pt: 'Costa atlântica mais fria · falésias selvagens · 20°C', de: 'Kühlste Atlantikküste · wilde Klippen · 20°C', nl: 'Koudste Atlantische kust · wilde klippen · 20°C' },
        why: {
        ...
        dogTip: {
          ...
          nl: 'Praia do Castelejo (5 km noordelijk van Sagres): wild strand ingesloten door 80m hoge klippen, honden het hele jaar zonder lijn, alleen bereikbaar via een 500m lang pad vanaf de parkeerplaats, bijna altijd rustig, zelfs in augustus.',
        },
        hotels: [
          {
            name: 'Martinhal Sagres Beach Family Resort',
            stars: 5,
            note: { en: 'Award-winning resort with private beach, villas and suites, dogs of all sizes accepted.', fr: 'Resort primé avec plage privée, villas et suites, chiens de toute taille acceptés.', es: 'Resort premiado con playa privada, villas y suites, perros de cualquier tamaño aceptados.', pt: 'Resort premiado com praia privada, vilas e suites, cães de qualquer tamanho aceites.', de: 'Preisgekröntes Resort mit Privatstrand, Villen und Suiten, Hunde jeder Größe akzeptiert.', nl: 'Bekroond resort met privéstrand, villa\'s en suites, honden van elke grootte toegestaan.' },
          },
          {
            name: 'Memmo Baleeira',
            stars: 4,
...
const T = {
  title: {
    ...
    nl: 'De beste steden om met je hond aan de hitte in Portugal te ontsnappen (2026)',
  },
  metaTitle: {
    ...
    nl: 'Koel Portugal met je hond: 6 steden onder 24°C in juli (2026)',
  },
  metaDesc: {
    ...
    nl: 'Terwijl Lissabon 29°C haalt en de Algarve 31°C, blijven Noord-Portugal en de Atlantische kust koel. Porto, Viana do Castelo, Guimarães, Braga, Peneda-Gerês, Sagres: 6 hondvriendelijke steden onder 24°C in juli.',
  },
  intro: {
    ...
    nl: 'Lissabon bereikt 29°C in juli, de Algarve 31°C. Maar Noord-Portugal (Minho, Douro) blijft dankzij de Atlantische luchtstroom op 22-24°C, en de kust van de Costa Vicentina zakt door de Canarische stroom naar 20°C. Deze 6 bestemmingen bieden een echt Portugees karakter zonder de zomerhitte.',
  },
  julyTemp: { en: 'July avg high', fr: 'Max moy. juillet', es: 'Máx. prom. julio', pt: 'Máx. méd. julho', de: 'Julihöchstwert', nl: 'Gem. max. juli' },
  ...
  faq: {
    ...
    q2: { en: 'Are dogs allowed on Portuguese beaches?', fr: 'Les chiens sont-ils autorisés sur les plages portugaises ?', es: '¿Se permiten perros en las playas portuguesas?', pt: 'São permitidos cães nas praias portuguesas?', de: 'Sind Hunde an portugiesischen Stränden erlaubt?', nl: 'Zijn honden toegestaan op Portugese stranden?' },
    a2: {
      ...
      <section className="bg-gradient-to-br from-emerald-900 via-teal-900 to-cyan-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-emerald-200 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-5">
            🇵🇹 {locale === 'fr' ? 'Minho · Douro · Costa Vicentina' : locale === 'es' ? 'Miño · Duero · Costa Vicentina' : locale === 'pt' ? 'Minho · Douro · Costa Vicentina' : locale === 'de' ? 'Minho · Douro · Costa Vicentina' : locale === 'nl' ? 'Minho · Douro · Costa Vicentina' : 'Minho · Douro · Costa Vicentina'}
          </div>
