...
const REGIONS: Region[] = [
  {
    id: 'porto',
    emoji: '🌉',
    title: { en: 'Porto', fr: 'Porto', es: 'Oporto', pt: 'Porto', de: 'Porto' },
    cities: [
      {
        slug: 'porto',
        name: 'Porto',
        region: { en: 'Porto', fr: 'Porto', es: 'Oporto', pt: 'Porto', de: 'Porto' },
        julyTemp: 23,
        tag: { en: 'Atlantic granite city · Douro river · wine', fr: 'Ville de granit atlantique · Douro · vin', es: 'Ciudad atlántica de granito · Duero · vino', pt: 'Cidade atlântica de granito · Douro · vinho', de: 'Atlantische Granitstadt · Douro · Wein' },
        why: {
  ...
  },
  {
    id: 'costa-verde',
    emoji: '🌊',
    title: { en: 'Costa Verde (Minho coast)', fr: 'Costa Verde (Minho côtier)', es: 'Costa Verde (Miño costero)', pt: 'Costa Verde (Minho litoral)', de: 'Costa Verde (Minho-Küste)' },
    cities: [
      {
        slug: 'viana-do-castelo',
        name: 'Viana do Castelo',
        region: { en: 'Minho coast', fr: 'Minho côtier', es: 'Miño costero', pt: 'Minho litoral', de: 'Minho-Küste' },
        julyTemp: 22,
        tag: { en: 'Lima river mouth · Atlantic · 22°C', fr: 'Embouchure du Lima · Atlantique · 22°C', es: 'Desembocadura del Lima · Atlántico · 22°C', pt: 'Foz do Lima · Atlântico · 22°C', de: 'Lima-Flussmündung · Atlantik · 22°C' },
        why: {
  ...
  },
  {
    id: 'minho-historique',
    emoji: '🏰',
    title: { en: 'Historic Minho', fr: 'Minho historique', es: 'Miño histórico', pt: 'Minho histórico', de: 'Historisches Minho' },
    cities: [
      {
        slug: 'guimaraes',
        name: 'Guimarães',
        region: { en: 'Historic Minho', fr: 'Minho historique', es: 'Miño histórico', pt: 'Minho histórico', de: 'Historisches Minho' },
        julyTemp: 23,
        tag: { en: "Birthplace of Portugal · UNESCO · 23°C", fr: "Berceau du Portugal · UNESCO · 23°C", es: 'Cuna de Portugal · UNESCO · 23°C', pt: 'Berço de Portugal · UNESCO · 23°C', de: 'Wiege Portugals · UNESCO · 23°C' },
        why: {
      ...
      },
      {
        ...
        region: { en: 'Historic Minho', fr: 'Minho historique', es: 'Miño histórico', pt: 'Minho histórico', de: 'Historisches Minho' },
        julyTemp: 24,
        tag: { en: 'Rome of Portugal · Bom Jesus · university', fr: 'Rome du Portugal · Bom Jesus · université', es: 'Roma de Portugal · Bom Jesus · universidad', pt: 'Roma de Portugal · Bom Jesus · universidade', de: 'Rom Portugals · Bom Jesus · Universität' },
        why: {
  ...
  },
  {
    id: 'peneda-geres',
    emoji: '🌿',
    title: { en: 'Peneda-Gerês National Park', fr: 'Parc National Peneda-Gerês', es: 'Parque Nacional Peneda-Gerês', pt: 'Parque Nacional Peneda-Gerês', de: 'Nationalpark Peneda-Gerês' },
    cities: [
      {
        slug: 'arcos-de-valdevez',
        name: 'Arcos de Valdevez',
        region: { en: 'Peneda-Gerês', fr: 'Peneda-Gerês', es: 'Peneda-Gerês', pt: 'Peneda-Gerês', de: 'Peneda-Gerês' },
        julyTemp: 22,
        tag: { en: 'Park gateway · Vez river · 22°C', fr: 'Porte du parc · río Vez · 22°C', es: 'Puerta del parque · río Vez · 22°C', pt: 'Porta do parque · rio Vez · 22°C', de: 'Parktor · Fluss Vez · 22°C' },
        why: {
  ...
  },
  {
    id: 'costa-vicentina',
    emoji: '🌊',
    title: { en: 'Costa Vicentina', fr: 'Costa Vicentina', es: 'Costa Vicentina', pt: 'Costa Vicentina', de: 'Costa Vicentina' },
    cities: [
      {
        slug: 'sagres',
        name: 'Sagres',
        region: { en: 'Costa Vicentina', fr: 'Costa Vicentina', es: 'Costa Vicentina', pt: 'Costa Vicentina', de: 'Costa Vicentina' },
        julyTemp: 20,
        tag: { en: 'Coldest Atlantic coast · wild cliffs · 20°C', fr: 'Côte atlantique la plus froide · falaises sauvages · 20°C', es: 'Costa atlántica más fría · acantilados salvajes · 20°C', pt: 'Costa atlântica mais fria · falésias selvagens · 20°C', de: 'Kühlste Atlantikküste · wilde Klippen · 20°C' },
        why: {
...
const T = {
  ...
  julyTemp: { en: 'July avg high', fr: 'Max moy. juillet', es: 'Máx. prom. julio', pt: 'Máx. méd. julho', de: 'Julihöchstwert' },
  seeHotels: { en: 'All pet-friendly hotels', fr: 'Tous les hôtels pet-friendly', es: 'Todos los hoteles pet-friendly', pt: 'Todos os hotéis pet-friendly', de: 'Alle haustierfreundlichen Hotels' },
  hotelsLabel: { en: 'Our hotel picks', fr: 'Nos hôtels recommandés', es: 'Nuestros hoteles recomendados', pt: 'Os nossos hotéis recomendados', de: 'Unsere Hotelempfehlungen' },
  dogTipLabel: { en: 'Dog tip', fr: 'Conseil chien', es: 'Consejo para tu perro', pt: 'Dica para o seu cão', de: 'Hundetipp' },
  ...
  faq: {
    q1: { en: 'Which Portuguese cities stay cool in summer?', fr: 'Quelles villes portugaises restent fraîches en été ?', es: '¿Qué ciudades portuguesas permanecen frescas en verano?', pt: 'Que cidades portuguesas se mantêm frescas no verão?', de: 'Welche portugiesischen Städte bleiben im Sommer kühl?' },
    a1: {
    ...
    q2: { en: 'Are dogs allowed on Portuguese beaches?', fr: 'Les chiens sont-ils autorisés sur les plages portugaises ?', es: '¿Se permiten perros en las playas portuguesas?', pt: 'São permitidos cães nas praias portuguesas?', de: 'Sind Hunde an portugiesischen Stränden erlaubt?' },
    a2: {
    ...
    q3: { en: 'How do I travel by train in Portugal with a dog?', fr: 'Comment voyager en train au Portugal avec un chien ?', es: '¿Cómo viajar en tren en Portugal con un perro?', pt: 'Como viajar de comboio em Portugal com um cão?', de: 'Wie reise ich mit dem Zug in Portugal mit einem Hund?' },
    a3: {
      ...
      <section className="bg-gradient-to-br from-emerald-900 via-teal-900 to-cyan-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-emerald-200 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-5">
            🇵🇹 {locale === 'fr' ? 'Minho · Douro · Costa Vicentina' : locale === 'es' ? 'Miño · Duero · Costa Vicentina' : locale === 'pt' ? 'Minho · Douro · Costa Vicentina' : locale === 'de' ? 'Minho · Douro · Costa Vicentina' : 'Minho · Douro · Costa Vicentina'}
          </div>
