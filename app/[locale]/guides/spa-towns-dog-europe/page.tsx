...
const STICKY_LABELS: Record<string, { label: string; cta: string }> = {
  ...
  it: { label: 'Hotel pet-friendly in citta termale', cta: 'Vedi gli hotel' },
}
...
export async function generateMetadata({
  ...
  const titles: Record<string, string> = {
    ...
    it: `Citta termali dog-friendly in Europa: 8 ritiri wellness con hotel pet-friendly (2026)`,
  }
  const descriptions: Record<string, string> = {
    ...
    it: `Otto citta termali europee dove i cani sono benvenuti in parchi, passeggiate e hotel wellness. Spa (Belgio), Bad Gastein, Karlovy Vary, Aix-les-Bains, Saturnia, Heviz, Vichy e Bad Ischl, con hotel pet-friendly verificati in ogni citta.`,
  }
  return {
...
const PICKS: Pick[] = [
  {
    ...
    whyIt: `Spa (Belgio) e la citta che ha dato il nome alla parola inglese "spa". Le terme (Les Thermes de Spa, riaperte nel 2004 sulla collina sopra la citta) non ammettono cani all'interno, ma l'altopiano boscoso delle Fagnes intorno alla citta e una delle migliori aree d'Europa per l'escursionismo con il cane: la riserva delle Hautes Fagnes ha 700 km di sentieri segnalati, cani al guinzaglio benvenuti. La citta stessa e tranquilla, benestante e poco turistica.`,
  ...
  },
  {
    ...
    whyIt: `Bad Gastein e una spettacolare citta termale Belle Epoque costruita verticalmente su una rupe a 1000 m di altitudine nell'Hohe Tauern. Immagina un set di Wes Anderson sulle Alpi, con una cascata che attraversa il centro. La sola altitudine mantiene le temperature estive sotto i 22C. Il sentiero della valle Gasteinertal e un percorso pianeggiante di 4 km lungo il fiume, adatto ai cani. L'estate e bassa stagione per questa stazione sciistica, quindi i prezzi calano del 40% e la folla scompare. I cani sono benvenuti sulla funivia dello Stubnerkogel (6 EUR a cane).`,
  ...
  },
  {
    ...
    whyIt: `Aix-les-Bains e il luogo dove e nato il turismo termale francese: i Romani vi costruirono le terme nel I secolo d.C., e le Thermes Nationaux funzionano ancora oggi. La citta si affaccia sul Lac du Bourget, il piu grande lago naturale di Francia, dove la Plage du Tresserve ha una zona apposita per cani (confermata per l'estate 2026). La passeggiata lungolago dalla citta a Viviers-du-Lac e pianeggiante per 3 km ed e accessibile ai cani. L'altopiano del Revard a 1500 m si raggiunge in 30 minuti d'auto e abbassa la temperatura di 8C nei giorni piu caldi.`,
  ...
  },
  {
    ...
    whyIt: `Heviz ospita il piu grande lago termale biologicamente attivo del mondo: 4,4 ettari d'acqua naturalmente a 33-36C alimentata da una sorgente vulcanica. I cani non sono ammessi nel lago stesso, ma il parco Gyogyfurdo che lo circonda e un grande spazio verde pianeggiante e ombreggiato, aperto ai cani al guinzaglio. La citta e piccola e tranquilla, a 5 km dalla punta occidentale del lago Balaton. Heviz e genuinamente orientata al benessere piuttosto che al turismo di massa, e la maggior parte degli hotel in citta sono pensati per soggiorni tranquilli e prolungati.`,
...
const COPY = {
  ...
  it: {
    ...
    title: `Citta termali dog-friendly in Europa: 8 ritiri wellness con hotel pet-friendly (2026)`,
    intro: `Il turismo termale e wellness e in piena crescita in tutta Europa, e le citta termali si rivelano perfette per chi viaggia con il cane: niente divieti da gestire in spiaggia, ampi parchi e passeggiate pensate per camminare con calma, folle piu tranquille rispetto alle localita costiere, e microclimi piu freschi grazie all'altitudine o alla posizione nell'entroterra. Soprattutto, gli hotel wellness delle citta termali accolgono cani accanto ai loro ospiti in cura da generazioni. Queste 8 citta uniscono un autentico patrimonio termale al tipo di ambiente calmo e percorribile a piedi che si adatta a qualsiasi cane.`,
    pickHeading: '8 citta termali dove i cani sono benvenuti',
    whyHere: 'Perche qui',
    hotelLabel: 'Dove alloggiare',
    seeDestCta: 'Guida completa alla citta →',
    hotelCta: 'Vedi disponibilita →',
    summerLabel: 'Media massima estiva',
    practicalHeading: 'Info pratiche per viaggiare con il cane in citta termale',
    practical: [
      {
        h: 'I cani possono entrare nelle piscine termali?',
        p: `Quasi mai. Le piscine stesse (compresi il famoso lago di Heviz e il complesso Terme di Saturnia) hanno regole igieniche che escludono gli animali. Tuttavia, non e questo cio che conta per chi viaggia con un cane: cio che conta e se i parchi, le terrazze esterne, le passeggiate sotto i colonnati e i giardini degli hotel intorno agli stabilimenti termali sono accessibili ai cani. In ogni citta di questa lista, lo sono. L'esperienza di una citta termale sta nell'atmosfera, nell'architettura e nel ritmo lento, di cui i cani godono pienamente senza mai entrare in acqua.`,
      },
      {
        h: 'Ritmo delle citta termali e cani sensibili al caldo',
        p: `Le citta termali funzionano a un ritmo piu lento rispetto alle localita balneari: pranzi lunghi, ore di quiete pomeridiana, passeggiate serali. Questo ritmo si adatta molto meglio ai cani sensibili al caldo (razze brachicefale, cani anziani, cani dal pelo folto) rispetto a una vivace citta di mare. La maggior parte degli hotel delle citta termali ha giardini dove i cani possono riposare durante le ore piu calde del mezzogiorno. L'altitudine delle citta termali di montagna (Bad Gastein a 1000 m, Bad Ischl nel Salzkammergut) abbassa le temperature di 4-8C rispetto alle vicine citta di pianura.`,
      },
      {
        h: 'La rete UNESCO Great Spas of Europe',
        p: `Nel 2021, undici citta termali europee hanno ottenuto lo status di Patrimonio Mondiale UNESCO come Great Spas of Europe: Baden-Baden, Spa (Belgio), Bath, Vichy, Montecatini Terme, Franzensbad, Marienbad, Karlsbad (Karlovy Vary), Bad Ems, Bad Kissingen e Bad Wildbad. Tutte condividono le stesse caratteristiche: passeggiate sotto colonnati, architettura termale, parchi pensati per le cure di cammino, e una cultura del benessere che risale a secoli fa. Per chi viaggia con il cane, questa rete e una guida affidabile verso citta tranquille, ricche di parchi e di grande valore architettonico.`,
      },
      {
        h: 'Combinare le visite termali con l\'escursionismo con il cane',
        p: `Le migliori citta termali di questa lista fungono anche da basi per l'escursionismo. Bad Gastein ha il Parco Nazionale dell'Hohe Tauern alle porte (e il percorso della valle Gasteinertal senza dislivello). Spa (Belgio) e circondata dalla riserva delle Hautes Fagnes con 700 km di sentieri segnalati. Bad Ischl si trova nel Salzkammergut, con 25 laghi e diversi sentieri di montagna raggiungibili in 30 minuti. Karlovy Vary confina con il parco naturale della foresta di Slavkov. In ogni caso, la citta termale e la base comoda e il paesaggio circostante e l'attivita per il cane.`,
      },
    ],
    faqHeading: 'Domande frequenti',
    faqs: [
      {
        q: 'Perche le citta termali fanno bene ai cani?',
        a: `Le citta termali sono progettate intorno a un movimento lento e contemplativo: lunghe passeggiate, gallerie con colonnati, percorsi nei parchi. Questi ambienti sono esattamente adatti a un cane in vacanza wellness. Niente divieti in spiaggia, niente rumore di moto d'acqua, niente folle estive da spiaggia. La cultura degli hotel wellness significa che lo staff e abituato a gestire ospiti con esigenze particolari (dieta, mobilita, orari), quindi un ospite con cane non e una novita. Molti hotel termali hanno cani residenti da decenni. Il microclima piu fresco (altitudine, posizione interna, copertura arborea) riduce lo stress da caldo. E il ritmo turistico piu lento significa ristoranti con terrazze, caffe con posti a sedere all'aperto, e parchi con panchine.`,
      },
      {
        q: 'Il mio cane puo venire alle terme?',
      ...
      {
        q: 'Quale di queste citta e la piu calda in estate?',
        a: `Saturnia (Toscana) ha la media estiva piu alta a 30C, ed e meglio visitarla all'alba o dopo le 19 in luglio-agosto. Vichy e Heviz raggiungono entrambe i 27-28C in piena estate. Le opzioni piu fresche sono Bad Gastein (media 19C, rinfrescata dall'altitudine) e Spa Belgio (21C, boscosa). Per cani sensibili al caldo o razze brachicefale, Bad Gastein, Spa (Belgio) o Bad Ischl (23C) sono le scelte piu sicure. Karlovy Vary a 23C e Aix-les-Bains a 26C si collocano nella fascia intermedia.`,
      },
      {
        q: 'Vale la pena seguire la rete Great Spas of Europe per i viaggi con il cane?',
        a: `Si. Tutte le 11 citta membro della rete UNESCO Great Spas of Europe condividono lo stesso profilo: tranquille, ricche di architettura, ricche di parchi, e significativamente meno turistiche rispetto alle vicine localita balneari o montane. Per chi viaggia con il cane, queste qualita si traducono direttamente in passeggiate accessibili, terrazze di ristoranti tolleranti verso i cani, hotel wellness con giardini, e una popolazione locale abituata a turisti in cura di piu giorni (che tendono a camminare, non a correre). La rete copre attualmente Germania, Belgio, Regno Unito, Francia, Italia, Repubblica Ceca e Austria, quindi c'e una citta membro raggiungibile in auto in un tempo ragionevole da gran parte dell'Europa continentale.`,
      },
    ],
