...
const STICKY_LABELS: Record<string, { label: string; cta: string }> = {
  ...
  it: { label: 'Hotel pet-friendly in città termale', cta: 'Vedi gli hotel' },
}
...
export async function generateMetadata({
  ...
  const titles: Record<string, string> = {
    ...
    it: `Città termali dog-friendly in Europa: 8 ritiri wellness con hotel pet-friendly (2026)`,
  }
  const descriptions: Record<string, string> = {
    ...
    it: `Otto città termali europee dove i cani sono benvenuti in parchi, passeggiate e hotel wellness. Spa (Belgio), Bad Gastein, Karlovy Vary, Aix-les-Bains, Saturnia, Heviz, Vichy e Bad Ischl, con hotel pet-friendly verificati in ogni città.`,
  }
  return {
...
const PICKS: Pick[] = [
  {
    ...
    whyIt: `Spa (Belgio) e la città che ha dato il nome alla parola inglese "spa". Le terme (Les Thermes de Spa, riaperte nel 2004 sulla collina sopra la città) non ammettono cani all'interno, ma l'altopiano boscoso delle Fagnes intorno alla città e una delle migliori aree d'Europa per l'escursionismo con il cane: la riserva delle Hautes Fagnes ha 700 km di sentieri segnalati, cani al guinzaglio benvenuti. La città stessa e tranquilla, benestante e poco turistica.`,
    ...
    hotelIt: `Radisson Blu Balmoral Hotel Spa - 4 stelle con accesso al benessere termale, vista sul bosco, animali benvenuti con un supplemento modesto. L'hotel sorge direttamente sulla collina sopra il quartiere termale, con sentieri boschivi che partono dal giardino sul retro.`,
  },
  {
    slug: 'bad-gastein',
    name: 'Bad Gastein',
    ...
    whyIt: `Bad Gastein e una spettacolare città termale Belle Epoque costruita verticalmente su una rupe a 1000 m di altitudine nell'Hohe Tauern. Immagina un set di Wes Anderson sulle Alpi, con una cascata che attraversa il centro. La sola altitudine mantiene le temperature estive sotto i 22C. Il sentiero della valle Gasteinertal e un percorso pianeggiante di 4 km lungo il fiume, adatto ai cani. L'estate e bassa stagione per questa stazione sciistica, quindi i prezzi calano del 40% e la folla scompare. I cani sono benvenuti sulla funivia dello Stubnerkogel (6 EUR a cane).`,
    ...
    hotelIt: `Hotel Weismayr - storico hotel 4 stelle Art Deco, cani accettati con supplemento moderato, terrazza panoramica sulla valle. L'edificio risale alla grande epoca termale Belle Epoque e conserva la sua facciata ornamentale originale sopra la cascata centrale.`,
  },
  {
    slug: 'karlovy-vary',
    name: 'Karlovy Vary',
    ...
    whyIt: `Karlovy Vary (Carlsbad) ha 12 sorgenti minerali e un quartiere termale con colonnati da candidatura UNESCO che rivaleggia con Vienna per architettura Belle Epoque. Le passeggiate sotto i colonnati lungo il fiume Tepla sono interamente accessibili ai cani al guinzaglio, i sentieri della foresta di Slavkov iniziano direttamente in città, e il festival del cinema estivo (inizio luglio) attira un pubblico raffinato piuttosto che zainisti. La cultura ceca dell'acqua minerale fa si che le terrazze dei ristoranti siano abituate a soste lunghe e tranquille, e i cani vi si integrano perfettamente.`,
    ...
    hotelIt: `Hotel Savoy Westend - 5 stelle nel quartiere termale, animali benvenuti con supplemento moderato, accesso alla zona termale. L'hotel si trova sulla passeggiata dei colonnati e gli ospiti con cane possono usare la terrazza del giardino mentre i loro compagni di viaggio visitano le sorgenti.`,
  },
  {
    slug: 'aix-les-bains',
    name: 'Aix-les-Bains',
    ...
    whyIt: `Aix-les-Bains e il luogo dove e nato il turismo termale francese: i Romani vi costruirono le terme nel I secolo d.C., e le Thermes Nationaux funzionano ancora oggi. La città si affaccia sul Lac du Bourget, il più grande lago naturale di Francia, dove la Plage du Tresserve ha una zona apposita per cani (confermata per l'estate 2026). La passeggiata lungolago dalla città a Viviers-du-Lac e pianeggiante per 3 km ed e accessibile ai cani. L'altopiano del Revard a 1500 m si raggiunge in 30 minuti d'auto e abbassa la temperatura di 8C nei giorni più caldi.`,
    ...
    hotelIt: `Hotel Ariana - hotel spa 4 stelle con vista sul lago, cani benvenuti con supplemento moderato. La terrazza dell'hotel si affaccia direttamente sul Lac du Bourget, e la passeggiata pianeggiante inizia a 100 metri dall'ingresso.`,
  },
  {
    slug: 'saturnia',
    name: 'Saturnia',
    ...
    whyIt: `Saturnia (Toscana) e famosa per le sue cascate del mulino: una serie di piscine termali naturali gratuite all'aperto a 37,5C che traboccano dalle terrazze calcaree nella campagna maremmana. I cani sono tollerati alle cascate (nessun divieto ufficiale, anche se il complesso termale organizzato Terme di Saturnia li esclude). Le colline circostanti della Maremma offrono infinite strade di campagna e sentieri poderali senza obbligo di guinzaglio. Agosto può essere caldo, con 30C, quindi organizza la visita all'alba o al tramonto per le condizioni migliori per il tuo cane.`,
    ...
    hotelIt: `Il Colletto Agriturismo - agriturismo vicino a Saturnia, cani liberamente benvenuti senza supplemento, piscina privata. Il casale sorge su una collina con vista panoramica sulla Maremma, a 10 minuti d'auto dalle cascate. Pollaio e orto sono separati dalle aree per cani.`,
  },
  {
    slug: 'heviz',
    name: 'Heviz',
    ...
    whyIt: `Heviz ospita il più grande lago termale biologicamente attivo del mondo: 4,4 ettari d'acqua naturalmente a 33-36C alimentata da una sorgente vulcanica. I cani non sono ammessi nel lago stesso, ma il parco Gyogyfurdo che lo circonda e un grande spazio verde pianeggiante e ombreggiato, aperto ai cani al guinzaglio. La città e piccola e tranquilla, a 5 km dalla punta occidentale del lago Balaton. Heviz e genuinamente orientata al benessere piuttosto che al turismo di massa, e la maggior parte degli hotel in città sono pensati per soggiorni tranquilli e prolungati.`,
    ...
    hotelIt: `Danubius Hotel Heviz - hotel spa 4 stelle a 200 m dal lago termale, animali benvenuti con supplemento modesto. L'hotel ha accesso diretto a un complesso spa e a un giardino dove i cani al guinzaglio possono riposare tra una passeggiata e l'altra intorno al parco termale.`,
  },
  {
    slug: 'vichy',
    name: 'Vichy',
    ...
    whyIt: `Vichy era la capitale estiva di Napoleone III, e l'intero quartiere termale e iscritto nella rete UNESCO Great Spas of Europe (2021): padiglioni Art Nouveau, il Parc des Sources con le sue 6 fontane sorgive, il Grand Casino. I cani sono benvenuti nel Parc des Sources (8 ha, pianeggiante, centrale), le rive dell'Allier offrono 6 km di passeggiate dog-friendly, e la cultura termale di Vichy fa si che gli hotel abbiano sempre accolto cani accanto ai loro ospiti in cura.`,
    ...
    hotelIt: `Vichy Spa Hotel Les Celestins - spa 5 stelle di riferimento, cani benvenuti con supplemento moderato, piscina interna, direttamente sulla riva dell'Allier. Questo e l'hotel wellness di riferimento di Vichy, con giardini che scendono fino al fiume e un programma spa pensato per soggiorni di più giorni.`,
  },
  {
    slug: 'bad-ischl',
    name: 'Bad Ischl',
    ...
    whyIt: `Bad Ischl e l'ex residenza estiva dell'imperatore Francesco Giuseppe I e dell'imperatrice Sissi, a un'ora da Salisburgo nel cuore del Salzkammergut. E stata nominata Capitale Europea della Cultura 2024. Il parco della Kaiservilla ammette i cani sui sentieri perimetrali (cartelli ufficiali lo confermano), la passeggiata lungo il fiume Traun e la camminata mattutina pianeggiante ideale, e il giardino del museo Leharvilla tollera un cane tranquillo al guinzaglio. Le temperature estive restano sotto i 24C grazie all'altitudine della regione dei laghi.`,
    ...
    hotelIt: `Hotel Austria Bad Ischl - tradizionale hotel 4 stelle sull'Esplanade, cani benvenuti con supplemento modesto. L'hotel si affaccia direttamente sul fiume Traun, e la passeggiata mattutina lungo l'esplanade fino alla Kaiservilla parte dai gradini d'ingresso.`,
  },
]
...
const COPY = {
  ...
  it: {
    eyebrow: 'VIAGGI WELLNESS CON CANE 2026 · TERMALISMO EUROPA',
    title: `Città termali dog-friendly in Europa: 8 ritiri wellness con hotel pet-friendly (2026)`,
    intro: `Il turismo termale e wellness e in piena crescita in tutta Europa, e le città termali si rivelano perfette per chi viaggia con il cane: niente divieti da gestire in spiaggia, ampi parchi e passeggiate pensate per camminare con calma, folle più tranquille rispetto alle località costiere, e microclimi più freschi grazie all'altitudine o alla posizione nell'entroterra. Soprattutto, gli hotel wellness delle città termali accolgono cani accanto ai loro ospiti in cura da generazioni. Queste 8 città uniscono un autentico patrimonio termale al tipo di ambiente calmo e percorribile a piedi che si adatta a qualsiasi cane.`,
    pickHeading: '8 città termali dove i cani sono benvenuti',
    whyHere: 'Perché qui',
    hotelLabel: 'Dove alloggiare',
    seeDestCta: 'Guida completa alla città →',
    hotelCta: 'Vedi disponibilità →',
    summerLabel: 'Media massima estiva',
    practicalHeading: 'Info pratiche per viaggiare con il cane in città termale',
    practical: [
      {
        h: 'I cani possono entrare nelle piscine termali?',
        p: `Quasi mai. Le piscine stesse (compresi il famoso lago di Heviz e il complesso Terme di Saturnia) hanno regole igieniche che escludono gli animali. Tuttavia, non e questo cio che conta per chi viaggia con un cane: cio che conta e se i parchi, le terrazze esterne, le passeggiate sotto i colonnati e i giardini degli hotel intorno agli stabilimenti termali sono accessibili ai cani. In ogni città di questa lista, lo sono. L'esperienza di una città termale sta nell'atmosfera, nell'architettura e nel ritmo lento, di cui i cani godono pienamente senza mai entrare in acqua.`,
      },
      {
        h: 'Ritmo delle città termali e cani sensibili al caldo',
        p: `Le città termali funzionano a un ritmo più lento rispetto alle località balneari: pranzi lunghi, ore di quiete pomeridiana, passeggiate serali. Questo ritmo si adatta molto meglio ai cani sensibili al caldo (razze brachicefale, cani anziani, cani dal pelo folto) rispetto a una vivace città di mare. La maggior parte degli hotel delle città termali ha giardini dove i cani possono riposare durante le ore più calde del mezzogiorno. L'altitudine delle città termali di montagna (Bad Gastein a 1000 m, Bad Ischl nel Salzkammergut) abbassa le temperature di 4-8C rispetto alle vicine città di pianura.`,
      },
      {
        h: 'La rete UNESCO Great Spas of Europe',
        p: `Nel 2021, undici città termali europee hanno ottenuto lo status di Patrimonio Mondiale UNESCO come Great Spas of Europe: Baden-Baden, Spa (Belgio), Bath, Vichy, Montecatini Terme, Franzensbad, Marienbad, Karlsbad (Karlovy Vary), Bad Ems, Bad Kissingen e Bad Wildbad. Tutte condividono le stesse caratteristiche: passeggiate sotto colonnati, architettura termale, parchi pensati per le cure di cammino, e una cultura del benessere che risale a secoli fa. Per chi viaggia con il cane, questa rete e una guida affidabile verso città tranquille, ricche di parchi e di grande valore architettonico.`,
      },
      {
        h: 'Combinare le visite termali con l\'escursionismo con il cane',
        p: `Le migliori città termali di questa lista fungono anche da basi per l'escursionismo. Bad Gastein ha il Parco Nazionale dell'Hohe Tauern alle porte (e il percorso della valle Gasteinertal senza dislivello). Spa (Belgio) e circondata dalla riserva delle Hautes Fagnes con 700 km di sentieri segnalati. Bad Ischl si trova nel Salzkammergut, con 25 laghi e diversi sentieri di montagna raggiungibili in 30 minuti. Karlovy Vary confina con il parco naturale della foresta di Slavkov. In ogni caso, la città termale e la base comoda e il paesaggio circostante e l'attività per il cane.`,
      },
    ],
    faqHeading: 'Domande frequenti',
    faqs: [
      {
        q: 'Perché le città termali fanno bene ai cani?',
        a: `Le città termali sono progettate intorno a un movimento lento e contemplativo: lunghe passeggiate, gallerie con colonnati, percorsi nei parchi. Questi ambienti sono esattamente adatti a un cane in vacanza wellness. Niente divieti in spiaggia, niente rumore di moto d'acqua, niente folle estive da spiaggia. La cultura degli hotel wellness significa che lo staff e abituato a gestire ospiti con esigenze particolari (dieta, mobilita, orari), quindi un ospite con cane non e una novità. Molti hotel termali hanno cani residenti da decenni. Il microclima più fresco (altitudine, posizione interna, copertura arborea) riduce lo stress da caldo. E il ritmo turistico più lento significa ristoranti con terrazze, caffè con posti a sedere all'aperto, e parchi con panchine.`,
      },
      {
        q: 'Il mio cane può venire alle terme?',
        a: `Non in acqua, praticamente in ogni caso. Le piscine stesse sono ambienti medici a igiene controllata. Tuttavia, i parchi che le circondano, i giardini spa degli hotel e le terrazze esterne sono generalmente accessibili ai cani. A Saturnia, le cascate del mulino naturali (un traboccamento gratuito e non gestito di sorgente calda) tollerano i cani sulla riva dell'acqua. A Heviz, il parco intorno al lago termale e aperto ai cani al guinzaglio. A Spa (Belgio), l'altopiano delle Hautes Fagnes direttamente sopra le terme offre 700 km di sentieri per cani. Lo schema e costante: nessun accesso all'acqua, accesso completo a tutto cio che la circonda.`,
      },
      {
        q: 'Quale di queste città e la più calda in estate?',
        a: `Saturnia (Toscana) ha la media estiva più alta a 30C, ed e meglio visitarla all'alba o dopo le 19 in luglio-agosto. Vichy e Heviz raggiungono entrambe i 27-28C in piena estate. Le opzioni più fresche sono Bad Gastein (media 19C, rinfrescata dall'altitudine) e Spa Belgio (21C, boscosa). Per cani sensibili al caldo o razze brachicefale, Bad Gastein, Spa (Belgio) o Bad Ischl (23C) sono le scelte più sicure. Karlovy Vary a 23C e Aix-les-Bains a 26C si collocano nella fascia intermedia.`,
      },
      {
        q: 'Vale la pena seguire la rete Great Spas of Europe per i viaggi con il cane?',
        a: `Si. Tutte le 11 città membro della rete UNESCO Great Spas of Europe condividono lo stesso profilo: tranquille, ricche di architettura, ricche di parchi, e significativamente meno turistiche rispetto alle vicine località balneari o montane. Per chi viaggia con il cane, queste qualità si traducono direttamente in passeggiate accessibili, terrazze di ristoranti tolleranti verso i cani, hotel wellness con giardini, e una popolazione locale abituata a turisti in cura di più giorni (che tendono a camminare, non a correre). La rete copre attualmente Germania, Belgio, Regno Unito, Francia, Italia, Repubblica Ceca e Austria, quindi c'e una città membro raggiungibile in auto in un tempo ragionevole da gran parte dell'Europa continentale.`,
      },
    ],
