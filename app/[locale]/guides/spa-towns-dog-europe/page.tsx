...
const PICKS: Pick[] = [
  {
    ...
    whyIt: `Spa (Belgio) è la città che ha dato il nome alla parola inglese "spa". Le terme (Les Thermes de Spa, riaperte nel 2004 sulla collina sopra la città) non ammettono cani all'interno, ma l'altopiano boscoso delle Fagnes intorno alla città è una delle migliori aree d'Europa per l'escursionismo con il cane: la riserva delle Hautes Fagnes ha 700 km di sentieri segnalati, cani al guinzaglio benvenuti. La città stessa è tranquilla, benestante e poco turistica.`,
  ...
  },
  {
    ...
    whyIt: `Bad Gastein è una spettacolare città termale Belle Epoque costruita verticalmente su una rupe a 1000 m di altitudine nell'Hohe Tauern. Immagina un set di Wes Anderson sulle Alpi, con una cascata che attraversa il centro. La sola altitudine mantiene le temperature estive sotto i 22C. Il sentiero della valle Gasteinertal è un percorso pianeggiante di 4 km lungo il fiume, adatto ai cani. L'estate è bassa stagione per questa stazione sciistica, quindi i prezzi calano del 40% e la folla scompare. I cani sono benvenuti sulla funivia dello Stubnerkogel (6 EUR a cane).`,
  ...
  },
  {
    ...
    whyIt: `Aix-les-Bains è il luogo dove è nato il turismo termale francese: i Romani vi costruirono le terme nel I secolo d.C., e le Thermes Nationaux funzionano ancora oggi. La città si affaccia sul Lac du Bourget, il più grande lago naturale di Francia, dove la Plage du Tresserve ha una zona apposita per cani (confermata per l'estate 2026). La passeggiata lungolago dalla città a Viviers-du-Lac è pianeggiante per 3 km ed è accessibile ai cani. L'altopiano del Revard a 1500 m si raggiunge in 30 minuti d'auto e abbassa la temperatura di 8C nei giorni più caldi.`,
  ...
  },
  {
    ...
    whyIt: `Heviz ospita il più grande lago termale biologicamente attivo del mondo: 4,4 ettari d'acqua naturalmente a 33-36C alimentata da una sorgente vulcanica. I cani non sono ammessi nel lago stesso, ma il parco Gyogyfurdo che lo circonda è un grande spazio verde pianeggiante e ombreggiato, aperto ai cani al guinzaglio. La città è piccola e tranquilla, a 5 km dalla punta occidentale del lago Balaton. Heviz è genuinamente orientata al benessere piuttosto che al turismo di massa, e la maggior parte degli hotel in città sono pensati per soggiorni tranquilli e prolungati.`,
  ...
  },
  {
    ...
    whyIt: `Vichy era la capitale estiva di Napoleone III, e l'intero quartiere termale è iscritto nella rete UNESCO Great Spas of Europe (2021): padiglioni Art Nouveau, il Parc des Sources con le sue 6 fontane sorgive, il Grand Casino. I cani sono benvenuti nel Parc des Sources (8 ha, pianeggiante, centrale), le rive dell'Allier offrono 6 km di passeggiate dog-friendly, e la cultura termale di Vichy fa sì che gli hotel abbiano sempre accolto cani accanto ai loro ospiti in cura.`,
    ...
    hotelIt: `Vichy Spa Hotel Les Celestins - spa 5 stelle di riferimento, cani benvenuti con supplemento moderato, piscina interna, direttamente sulla riva dell'Allier. Questo è l'hotel wellness di riferimento di Vichy, con giardini che scendono fino al fiume e un programma spa pensato per soggiorni di più giorni.`,
  },
  {
    slug: 'bad-ischl',
    name: 'Bad Ischl',
    ...
    whyIt: `Bad Ischl è l'ex residenza estiva dell'imperatore Francesco Giuseppe I e dell'imperatrice Sissi, a un'ora da Salisburgo nel cuore del Salzkammergut. È stata nominata Capitale Europea della Cultura 2024. Il parco della Kaiservilla ammette i cani sui sentieri perimetrali (cartelli ufficiali lo confermano), la passeggiata lungo il fiume Traun è la camminata mattutina pianeggiante ideale, e il giardino del museo Leharvilla tollera un cane tranquillo al guinzaglio. Le temperature estive restano sotto i 24C grazie all'altitudine della regione dei laghi.`,
...
const COPY = {
  ...
  it: {
    ...
    intro: `Il turismo termale e wellness è in piena crescita in tutta Europa, e le città termali si rivelano perfette per chi viaggia con il cane: niente divieti da gestire in spiaggia, ampi parchi e passeggiate pensate per camminare con calma, folle più tranquille rispetto alle località costiere, e microclimi più freschi grazie all'altitudine o alla posizione nell'entroterra. Soprattutto, gli hotel wellness delle città termali accolgono cani accanto ai loro ospiti in cura da generazioni. Queste 8 città uniscono un autentico patrimonio termale al tipo di ambiente calmo e percorribile a piedi che si adatta a qualsiasi cane.`,
    ...
    practical: [
      {
        ...
        p: `Quasi mai. Le piscine stesse (compresi il famoso lago di Heviz e il complesso Terme di Saturnia) hanno regole igieniche che escludono gli animali. Tuttavia, non è questo ciò che conta per chi viaggia con un cane: ciò che conta è se i parchi, le terrazze esterne, le passeggiate sotto i colonnati e i giardini degli hotel intorno agli stabilimenti termali sono accessibili ai cani. In ogni città di questa lista, lo sono. L'esperienza di una città termale sta nell'atmosfera, nell'architettura e nel ritmo lento, di cui i cani godono pienamente senza mai entrare in acqua.`,
      },
      {
