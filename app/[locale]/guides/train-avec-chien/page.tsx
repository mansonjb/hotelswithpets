...
const OPERATORS: Operator[] = [
  {
    ...
    flag: '🇫🇷',
    name: 'SNCF / TGV INOUI',
    country: { fr: 'France', en: 'France', es: 'Francia', pt: 'Francia' , de: 'Frankreich', nl: 'Frankrijk' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui', en: 'Yes', es: 'Sí', pt: 'Sí' , de: 'Ja', nl: 'Ja' },
    price: { fr: '10 € (panier) · 20 € (en laisse)', en: '€10 (carrier) · €20 (on lead)', es: '10 € (transportín) · 20 € (con correa)', pt: '10 € (transportadora) · 20 € (com trela)' , de: '10 € (Transportbox) · 20 € (an der Leine)', nl: '10 € (transportmand) · 20 € (aan de lijn)' },
    ...
    muzzle: { fr: 'Obligatoire > 6 kg', en: 'Mandatory > 6 kg', es: 'Obligatorio > 6 kg', pt: 'Obrigatório > 6 kg' , de: 'Pflicht > 6 kg', nl: 'Verplicht > 6 kg' },
    carrier: { fr: 'Obligatoire < 6 kg', en: 'Mandatory < 6 kg', es: 'Obligatorio < 6 kg', pt: 'Obrigatório < 6 kg' , de: 'Pflicht < 6 kg', nl: 'Verplicht < 6 kg' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' , de: '1 pro Fahrgast', nl: '1 per reiziger' },
    notes: { fr: 'Chiens de cat. 1 interdits. Chiens guides gratuits.', en: 'Category 1 dogs banned. Guide dogs free.', es: 'Perros de cat. 1 prohibidos. Perros guía gratis.', pt: 'Cães de cat. 1 prohibidos. Cães guía grátis.' , de: 'Hunde der Kategorie 1 verboten. Blindenführhunde kostenlos.', nl: 'Honden van categorie 1 verboden. Blindengeleidehonden gratis.' },
  },
  {
    slug: 'ouigo',
    flag: '🇫🇷',
    ...
    allowed: 'yes',
    ticketRequired: { fr: 'Oui', en: 'Yes', es: 'Sí', pt: 'Sí' , de: 'Ja', nl: 'Ja' },
    price: { fr: '10 € (tous poids)', en: '€10 (all sizes)', es: '10 € (todos los tamaños)', pt: '10 € (todos os tamanhos)' , de: '10 € (alle Größen)', nl: '10 € (alle formaten)' },
    sizeLimit: { fr: 'Aucune limite de poids', en: 'No weight limit', es: 'Sin límite de peso', pt: 'Sem limite de peso' , de: 'Kein Gewichtslimit', nl: 'Geen gewichtslimiet' },
    muzzle: { fr: 'Obligatoire', en: 'Mandatory', es: 'Obligatorio', pt: 'Obrigatório' , de: 'Pflicht', nl: 'Verplicht' },
    carrier: { fr: 'Non requis (laisse suffisante)', en: 'Not required (lead sufficient)', es: 'No requerido (correa suficiente)', pt: 'No requerido (trela suficiente)' , de: 'Nicht erforderlich (Leine ausreichend)', nl: 'Niet verplicht (lijn is voldoende)' },
    maxDogs: { fr: '1 par passager adulte', en: '1 per adult passenger', es: '1 por pasajero adulto', pt: '1 por pasajero adulto' , de: '1 pro erwachsenem Fahrgast', nl: '1 per volwassen reiziger' },
    notes: { fr: 'Carnet de vaccination obligatoire. Cat. 1 interdits.', en: 'Vaccination booklet mandatory. Cat. 1 banned.', es: 'Cartilla de vacunación obligatoria. Cat. 1 prohibidos.', pt: 'Cartilla de vacinação obrigatória. Cat. 1 prohibidos.' , de: 'Impfausweis Pflicht. Kategorie 1 verboten.', nl: 'Vaccinatieboekje verplicht. Categorie 1 verboden.' },
  },
  {
    slug: 'eurostar',
    flag: '🇬🇧',
    name: 'Eurostar',
    country: { fr: 'UK–France–Belgique', en: 'UK–France–Belgium', es: 'RU–Francia–Bélgica', pt: 'RU–Francia–Bélgica' , de: 'UK–Frankreich–Belgien', nl: 'VK–Frankrijk–België' },
    allowed: 'partial',
    ticketRequired: { fr: 'Oui (routes continentales)', en: 'Yes (continental routes)', es: 'Sí (rutas continentales)', pt: 'Sí (rutas continentales)' , de: 'Ja (Festlandstrecken)', nl: 'Ja (routes op het vasteland)' },
    ...
    carrier: { fr: 'Obligatoire < 6 kg', en: 'Mandatory < 6 kg', es: 'Obligatorio < 6 kg', pt: 'Obrigatório < 6 kg' , de: 'Pflicht < 6 kg', nl: 'Verplicht < 6 kg' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' , de: '1 pro Fahrgast', nl: '1 per reiziger' },
    notes: { fr: '⚠️ Animaux INTERDITS sur les trains vers/depuis Londres (tunnel sous la Manche). Autorisés sur routes Belgique–France–Allemagne–Pays-Bas.', en: '⚠️ Pets BANNED on trains to/from London (Channel Tunnel). Allowed on Belgium–France–Germany–Netherlands routes.', es: '⚠️ Animales PROHIBIDOS en trenes hacia/desde Londres (Eurotúnel). Permitidos en rutas Bélgica–Francia–Alemania–Países Bajos.', pt: '⚠️ Animales PROHIBIDOS en comboios hacia/a partir de Londres (Eurotúnel). Permitidos en rutas Bélgica–Francia–Alemania–Países Bajos.' , de: '⚠️ Tiere auf Zügen von/nach London VERBOTEN (Ärmelkanaltunnel). Erlaubt auf den Strecken Belgien–Frankreich–Deutschland–Niederlande.', nl: '⚠️ Huisdieren VERBODEN op treinen van/naar Londen (Kanaaltunnel). Toegestaan op de routes België–Frankrijk–Duitsland–Nederland.' },
  },
  {
    slug: 'deutsche-bahn',
    flag: '🇩🇪',
    name: 'Deutsche Bahn (DB)',
    country: { fr: 'Allemagne', en: 'Germany', es: 'Alemania', pt: 'Alemania' , de: 'Deutschland', nl: 'Duitsland' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui (grands chiens)', en: 'Yes (large dogs)', es: 'Sí (perros grandes)', pt: 'Sí (cães grandes)' , de: 'Ja (große Hunde)', nl: 'Ja (grote honden)' },
    price: { fr: 'Gratuit en panier (taille chat). Demi-tarif adulte (grande distance) · plein tarif (régional)', en: 'Free in carrier (cat-sized). Half adult fare (long-distance) · full fare (regional)', es: 'Gratis en transportín (talla gato). Mitad tarifa adulto (larga distancia) · tarifa completa (regional)', pt: 'Grátis en transportadora (talla gato). Mitad tarifa adulto (larga distancia) · tarifa completa (regional)' , de: 'Kostenlos in Transportbox (Katzengröße). Halber Erwachsenenpreis (Fernverkehr) · voller Preis (Nahverkehr)', nl: 'Gratis in transportmand (kattenformaat). Halve volwassenenprijs (langeafstandstreinen) · volle prijs (regionaal)' },
    sizeLimit: { fr: 'Petit animal en panier gratuit. Grand chien : billet obligatoire.', en: 'Small pet in carrier free. Large dog: ticket required.', es: 'Animal pequeño en transportín gratis. Perro grande: billete obligatorio.', pt: 'Animal pequenho en transportadora grátis. Cão grande: bilhete obrigatório.' , de: 'Kleines Tier in Transportbox kostenlos. Großer Hund: Fahrkarte erforderlich.', nl: 'Klein huisdier in transportmand gratis. Grote hond: kaartje verplicht.' },
    muzzle: { fr: 'Obligatoire (grands chiens)', en: 'Mandatory (large dogs)', es: 'Obligatorio (perros grandes)', pt: 'Obrigatório (cães grandes)' , de: 'Pflicht (große Hunde)', nl: 'Verplicht (grote honden)' },
    carrier: { fr: 'Obligatoire (petits animaux)', en: 'Mandatory (small pets)', es: 'Obligatorio (animales pequeños)', pt: 'Obrigatório (animales pequenhos)' , de: 'Pflicht (kleine Tiere)', nl: 'Verplicht (kleine huisdieren)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' , de: '1 pro Fahrgast', nl: '1 per reiziger' },
    notes: { fr: 'Billet chien réservable en ligne (app DB Next Navigator) ou en gare.', en: 'Dog ticket bookable online (DB Next Navigator app) or at station.', es: 'Billete perro reservable online (app DB Next Navigator) o en estación.', pt: 'Bilhete cão reservable online (app DB Next Navigator) o en estação.' , de: 'Hundefahrkarte online buchbar (App DB Next Navigator) oder am Bahnhof.', nl: 'Hondenkaartje online boekbaar (app DB Next Navigator) of op het station.' },
  },
  {
    slug: 'renfe',
    flag: '🇪🇸',
    name: 'Renfe',
    country: { fr: 'Espagne', en: 'Spain', es: 'España', pt: 'Espanha' , de: 'Spanien', nl: 'Spanje' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui', en: 'Yes', es: 'Sí', pt: 'Sí' , de: 'Ja', nl: 'Ja' },
    price: { fr: '10 € (Avlo) · 35 € sans cage (trains AVE avec sièges chiens) · Gratuit (Media Distancia)', en: '€10 (Avlo) · €35 without crate (AVE with dog seats) · Free (Media Distancia)', es: '10 € (Avlo) · 35 € sin jaula (AVE con asientos perros) · Gratis (Media Distancia)', pt: '10 € (Avlo) · 35 € sem jaula (AVE com asientos cães) · Grátis (Media Distancia)' , de: '10 € (Avlo) · 35 € ohne Box (AVE mit Hundeplätzen) · Kostenlos (Media Distancia)', nl: '10 € (Avlo) · 35 € zonder bench (AVE met hondenplaatsen) · Gratis (Media Distancia)' },
    sizeLimit: { fr: 'En cage : 60×35×35 cm max. Sans cage jusqu\'à 40 kg sur trains équipés.', en: 'In crate: max 60×35×35 cm. No crate up to 40 kg on fitted trains.', es: 'En jaula: máx 60×35×35 cm. Sin jaula hasta 40 kg en trenes equipados.', pt: 'En jaula: máx 60×35×35 cm. Sem jaula até 40 kg en comboios equipados.' , de: 'In Box: max. 60×35×35 cm. Ohne Box bis 40 kg in ausgestatteten Zügen.', nl: 'In bench: max. 60×35×35 cm. Zonder bench tot 40 kg in uitgeruste treinen.' },
    muzzle: { fr: 'Obligatoire (Media Distancia)', en: 'Mandatory (Media Distancia)', es: 'Obligatorio (Media Distancia)', pt: 'Obrigatório (Media Distancia)' , de: 'Pflicht (Media Distancia)', nl: 'Verplicht (Media Distancia)' },
    carrier: { fr: 'Obligatoire (AVE, sauf sièges chiens)', en: 'Mandatory (AVE, except dog seats)', es: 'Obligatorio (AVE, salvo asientos perros)', pt: 'Obrigatório (AVE, salvo asientos cães)' , de: 'Pflicht (AVE, außer Hundeplätze)', nl: 'Verplicht (AVE, behalve hondenplaatsen)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' , de: '1 pro Fahrgast', nl: '1 per reiziger' },
  ...
  },
  {
    ...
    sizeLimit: { fr: 'Panier gratuit. Grand chien : supplément requis.', en: 'Carrier free. Large dog: supplement required.', es: 'Transportín gratis. Perro grande: suplemento requerido.', pt: 'Transportadora grátis. Cão grande: suplemento requerido.' , de: 'Box kostenlos. Großer Hund: Zuschlag erforderlich.', nl: 'Bench gratis. Grote hond: toeslag verplicht.' },
    muzzle: { fr: 'Non obligatoire (recommandée)', en: 'Not mandatory (recommended)', es: 'No obligatorio (recomendado)', pt: 'No obrigatório (recomendado)' , de: 'Nicht Pflicht (empfohlen)', nl: 'Niet verplicht (aanbevolen)' },
    carrier: { fr: 'Obligatoire (petits animaux)', en: 'Mandatory (small pets)', es: 'Obligatorio (animales pequeños)', pt: 'Obrigatório (animales pequenhos)' , de: 'Pflicht (kleine Tiere)', nl: 'Verplicht (kleine huisdieren)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' , de: '1 pro Fahrgast', nl: '1 per reiziger' },
    notes: { fr: 'Chiens guides gratuits et sans muselière obligatoire.', en: 'Guide dogs free and no muzzle required.', es: 'Perros guía gratis y sin bozal obligatorio.', pt: 'Cães guía grátis e sem bozal obrigatório.' , de: 'Blindenführhunde kostenlos und ohne Maulkorbpflicht.', nl: 'Blindengeleidehonden gratis en zonder muilkorfplicht.' },
  },
  {
    slug: 'ns',
    flag: '🇳🇱',
    name: 'NS (Nederlandse Spoorwegen)',
    country: { fr: 'Pays-Bas', en: 'Netherlands', es: 'Países Bajos', pt: 'Países Bajos' , de: 'Niederlande', nl: 'Nederland' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui (grand chien)', en: 'Yes (large dog)', es: 'Sí (perro grande)', pt: 'Sí (cão grande)' , de: 'Ja (großer Hund)', nl: 'Ja (grote hond)' },
    price: { fr: 'Gratuit (panier 55×30×30 cm). Dagkaart Hond : 3,50 € (e-ticket) / 5 € (papier).', en: 'Free (carrier 55×30×30 cm). Dagkaart Hond: €3.50 (e-ticket) / €5 (paper).', es: 'Gratis (transportín 55×30×30 cm). Dagkaart Hond: 3,50 € (e-ticket) / 5 € (papel).', pt: 'Grátis (transportadora 55×30×30 cm). Dagkaart Hond: 3,50 € (e-ticket) / 5 € (papel).' , de: 'Kostenlos (Box 55×30×30 cm). Dagkaart Hond: 3,50 € (E-Ticket) / 5 € (Papier).', nl: 'Gratis (bench 55×30×30 cm). Dagkaart Hond: € 3,50 (e-ticket) / € 5 (papier).' },
    sizeLimit: { fr: 'Panier < 55×30×30 cm gratuit. Grand chien : laisse + muselière.', en: 'Carrier < 55×30×30 cm free. Large dog: lead + muzzle.', es: 'Transportín < 55×30×30 cm gratis. Perro grande: correa + bozal.', pt: 'Transportadora < 55×30×30 cm grátis. Cão grande: trela + bozal.' , de: 'Box < 55×30×30 cm kostenlos. Großer Hund: Leine + Maulkorb.', nl: 'Bench < 55×30×30 cm gratis. Grote hond: lijn + muilkorf.' },
    muzzle: { fr: 'Obligatoire (grands chiens)', en: 'Mandatory (large dogs)', es: 'Obligatorio (perros grandes)', pt: 'Obrigatório (cães grandes)' , de: 'Pflicht (große Hunde)', nl: 'Verplicht (grote honden)' },
    carrier: { fr: 'Obligatoire (petits animaux)', en: 'Mandatory (small pets)', es: 'Obligatorio (animales pequeños)', pt: 'Obrigatório (animales pequenhos)' , de: 'Pflicht (kleine Tiere)', nl: 'Verplicht (kleine huisdieren)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' , de: '1 pro Fahrgast', nl: '1 per reiziger' },
    notes: { fr: 'Dagkaart Hond valable toute la journée sur tout le réseau domestique NS.', en: 'Dagkaart Hond valid all day on all domestic NS routes.', es: 'Dagkaart Hond válido todo el día en toda la red doméstica NS.', pt: 'Dagkaart Hond válido todo o dia en toda a rede doméstica NS.' , de: 'Dagkaart Hond den ganzen Tag gültig im gesamten NS-Inlandsnetz.', nl: 'Dagkaart Hond de hele dag geldig op het volledige binnenlandse NS-netwerk.' },
  },
  {
    slug: 'sbb',
    flag: '🇨🇭',
    name: 'SBB / CFF / FFS',
    country: { fr: 'Suisse', en: 'Switzerland', es: 'Suiza', pt: 'Suiza' , de: 'Schweiz', nl: 'Zwitserland' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui (grand chien)', en: 'Yes (large dog)', es: 'Sí (perro grande)', pt: 'Sí (cão grande)' , de: 'Ja (großer Hund)', nl: 'Ja (grote hond)' },
    ...
    sizeLimit: { fr: 'Petit en sac/panier gratuit. Grand chien : abonnement jour.', en: 'Small in bag/carrier free. Large dog: day pass.', es: 'Pequeño en bolsa/transportín gratis. Perro grande: abono día.', pt: 'Pequenho en bolsa/transportadora grátis. Cão grande: abono dia.' , de: 'Kleiner Hund in Tasche/Box kostenlos. Großer Hund: Tageskarte.', nl: 'Kleine hond in tas/bench gratis. Grote hond: dagkaart.' },
    muzzle: { fr: 'Recommandée', en: 'Recommended', es: 'Recomendado', pt: 'Recomendado' , de: 'Empfohlen', nl: 'Aanbevolen' },
    carrier: { fr: 'Obligatoire (petits animaux)', en: 'Mandatory (small pets)', es: 'Obligatorio (animales pequeños)', pt: 'Obrigatório (animales pequenhos)' , de: 'Pflicht (kleine Tiere)', nl: 'Verplicht (kleine huisdieren)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' , de: '1 pro Fahrgast', nl: '1 per reiziger' },
    notes: { fr: 'Le TGV Lyria (France–Suisse) suit les tarifs SNCF : 10 € (panier) ou 20 € (laisse).', en: 'TGV Lyria (France–Switzerland) follows SNCF rates: €10 (carrier) or €20 (lead).', es: 'TGV Lyria (Francia–Suiza) sigue tarifas SNCF: 10 € (transportín) o 20 € (correa).', pt: 'TGV Lyria (Francia–Suiza) sigue tarifas SNCF: 10 € (transportadora) o 20 € (trela).' , de: 'Der TGV Lyria (Frankreich–Schweiz) folgt den SNCF-Tarifen: 10 € (Box) oder 20 € (Leine).', nl: 'De TGV Lyria (Frankrijk–Zwitserland) volgt de SNCF-tarieven: 10 € (bench) of 20 € (lijn).' },
  },
  {
    slug: 'obb',
    flag: '🇦🇹',
    name: 'ÖBB',
    country: { fr: 'Autriche', en: 'Austria', es: 'Austria', pt: 'Austria' , de: 'Österreich', nl: 'Oostenrijk' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui (grand chien)', en: 'Yes (large dog)', es: 'Sí (perro grande)', pt: 'Sí (cão grande)' , de: 'Ja (großer Hund)', nl: 'Ja (grote hond)' },
    price: { fr: 'Gratuit (panier 70×30×50 cm). Grand chien : billet séparé + compartiment privatif.', en: 'Free (carrier 70×30×50 cm). Large dog: separate ticket + private compartment.', es: 'Gratis (transportín 70×30×50 cm). Perro grande: billete separado + compartimento privado.', pt: 'Grátis (transportadora 70×30×50 cm). Cão grande: bilhete separado + compartimento privado.' , de: 'Kostenlos (Box 70×30×50 cm). Großer Hund: separate Fahrkarte + eigenes Abteil.', nl: 'Gratis (bench 70×30×50 cm). Grote hond: apart kaartje + eigen coupé.' },
    ...
    carrier: { fr: 'Obligatoire (petits animaux)', en: 'Mandatory (small pets)', es: 'Obligatorio (animales pequeños)', pt: 'Obrigatório (animales pequenhos)' , de: 'Pflicht (kleine Tiere)', nl: 'Verplicht (kleine huisdieren)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' , de: '1 pro Fahrgast', nl: '1 per reiziger' },
    notes: { fr: 'Laisse et muselière obligatoires pour grands chiens.', en: 'Lead and muzzle mandatory for large dogs.', es: 'Correa y bozal obligatorios para perros grandes.', pt: 'Trela e bozal obrigatórios para cães grandes.' , de: 'Leine und Maulkorb für große Hunde Pflicht.', nl: 'Lijn en muilkorf verplicht voor grote honden.' },
  },
  {
    slug: 'pkp',
    flag: '🇵🇱',
    name: 'PKP Intercity',
    country: { fr: 'Pologne', en: 'Poland', es: 'Polonia', pt: 'Polonia' , de: 'Polen', nl: 'Polen' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui', en: 'Yes', es: 'Sí', pt: 'Sí' , de: 'Ja', nl: 'Ja' },
    price: { fr: 'Billet animal requis (tarif variable)', en: 'Pet ticket required (variable fare)', es: 'Billete mascota requerido (tarifa variable)', pt: 'Bilhete animal requerido (tarifa variable)' , de: 'Tierfahrkarte erforderlich (variabler Preis)', nl: 'Dierenkaartje verplicht (variabele prijs)' },
    sizeLimit: { fr: 'Petit en panier accepté. Grand chien en laisse.', en: 'Small in carrier accepted. Large dog on lead.', es: 'Pequeño en transportín aceptado. Perro grande con correa.', pt: 'Pequenho en transportadora aceite. Cão grande com trela.' , de: 'Kleiner Hund in Box akzeptiert. Großer Hund an der Leine.', nl: 'Kleine hond in bench toegestaan. Grote hond aan de lijn.' },
    muzzle: { fr: 'Obligatoire', en: 'Mandatory', es: 'Obligatorio', pt: 'Obrigatório' , de: 'Pflicht', nl: 'Verplicht' },
    carrier: { fr: 'Obligatoire (petits animaux)', en: 'Mandatory (small pets)', es: 'Obligatorio (animales pequeños)', pt: 'Obrigatório (animales pequenhos)' , de: 'Pflicht (kleine Tiere)', nl: 'Verplicht (kleine huisdieren)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' , de: '1 pro Fahrgast', nl: '1 per reiziger' },
    notes: { fr: 'Chiens interdits dans les voitures-lits et couchettes EuroNight PKP.', en: 'Dogs banned in EuroNight PKP couchette and sleeping cars.', es: 'Perros prohibidos en coches cama y literas EuroNight PKP.', pt: 'Cães prohibidos en carros cama e literas EuroNight PKP.' , de: 'Hunde in EuroNight-PKP-Liege- und Schlafwagen verboten.', nl: 'Honden verboden in EuroNight PKP-lig- en slaapwagens.' },
  },
]
