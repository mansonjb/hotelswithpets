  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        pt: `${SITE_URL}/é/guides/train-avec-chien`,
...
const OPERATORS: Operator[] = [
  {
    ...
    flag: '🇫🇷',
    name: 'SNCF / TGV INOUI',
    country: { fr: 'France', en: 'France', es: 'Francia', pt: 'Francia' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui', en: 'Yes', es: 'Sí', pt: 'Sí' },
    price: { fr: '10 € (panier) · 20 € (en laisse)', en: '€10 (carrier) · €20 (on lead)', es: '10 € (transportín) · 20 € (con correa)', pt: '10 € (transportadora) · 20 € (com trela)' },
    sizeLimit: { fr: 'Panier < 6 kg : 45×30×25 cm. Grand chien en laisse.', en: 'Carrier < 6 kg: 45×30×25 cm. Large dog on lead.', es: 'Transportín < 6 kg: 45×30×25 cm. Perro grande con correa.', pt: 'Transportadora < 6 kg: 45×30×25 cm. Cão grande com trela.' },
    muzzle: { fr: 'Obligatoire > 6 kg', en: 'Mandatory > 6 kg', es: 'Obligatorio > 6 kg', pt: 'Obrigatório > 6 kg' },
    carrier: { fr: 'Obligatoire < 6 kg', en: 'Mandatory < 6 kg', es: 'Obligatorio < 6 kg', pt: 'Obrigatório < 6 kg' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' },
    notes: { fr: 'Chiens de cat. 1 interdits. Chiens guides gratuits.', en: 'Category 1 dogs banned. Guide dogs free.', es: 'Perros de cat. 1 prohibidos. Perros guía gratis.', pt: 'Cães de cat. 1 prohibidos. Cães guía grátis.' },
  },
  {
    slug: 'ouigo',
    flag: '🇫🇷',
    ...
    allowed: 'yes',
    ticketRequired: { fr: 'Oui', en: 'Yes', es: 'Sí', pt: 'Sí' },
    price: { fr: '10 € (tous poids)', en: '€10 (all sizes)', es: '10 € (todos los tamaños)', pt: '10 € (todos os tamanhos)' },
    sizeLimit: { fr: 'Aucune limite de poids', en: 'No weight limit', es: 'Sin límite de peso', pt: 'Sem limite de peso' },
    muzzle: { fr: 'Obligatoire', en: 'Mandatory', es: 'Obligatorio', pt: 'Obrigatório' },
    carrier: { fr: 'Non requis (laisse suffisante)', en: 'Not required (lead sufficient)', es: 'No requerido (correa suficiente)', pt: 'No requerido (trela suficiente)' },
    maxDogs: { fr: '1 par passager adulte', en: '1 per adult passenger', es: '1 por pasajero adulto', pt: '1 por pasajero adulto' },
    notes: { fr: 'Carnet de vaccination obligatoire. Cat. 1 interdits.', en: 'Vaccination booklet mandatory. Cat. 1 banned.', es: 'Cartilla de vacunación obligatoria. Cat. 1 prohibidos.', pt: 'Cartilla de vacinação obrigatória. Cat. 1 prohibidos.' },
  },
  {
    slug: 'eurostar',
    flag: '🇬🇧',
    name: 'Eurostar',
    country: { fr: 'UK–France–Belgique', en: 'UK–France–Belgium', es: 'RU–Francia–Bélgica', pt: 'RU–Francia–Bélgica' },
    allowed: 'partial',
    ticketRequired: { fr: 'Oui (routes continentales)', en: 'Yes (continental routes)', es: 'Sí (rutas continentales)', pt: 'Sí (rutas continentales)' },
    price: { fr: 'Gratuit < 6 kg · 30 € > 6 kg (routes continentales)', en: 'Free < 6 kg · €30 > 6 kg (continental routes)', es: 'Gratis < 6 kg · 30 € > 6 kg (rutas continentales)', pt: 'Grátis < 6 kg · 30 € > 6 kg (rutas continentales)' },
    sizeLimit: { fr: '< 6 kg en panier 45×30×25 cm. Grand chien en laisse.', en: '< 6 kg in 45×30×25 cm carrier. Large dog on lead.', es: '< 6 kg en transportín 45×30×25 cm. Perro grande con correa.', pt: '< 6 kg en transportadora 45×30×25 cm. Cão grande com trela.' },
    muzzle: { fr: 'Obligatoire > 6 kg', en: 'Mandatory > 6 kg', es: 'Obligatorio > 6 kg', pt: 'Obrigatório > 6 kg' },
    carrier: { fr: 'Obligatoire < 6 kg', en: 'Mandatory < 6 kg', es: 'Obligatorio < 6 kg', pt: 'Obrigatório < 6 kg' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' },
    notes: { fr: '⚠️ Animaux INTERDITS sur les trains vers/depuis Londres (tunnel sous la Manche). Autorisés sur routes Belgique–France–Allemagne–Pays-Bas.', en: '⚠️ Pets BANNED on trains to/from London (Channel Tunnel). Allowed on Belgium–France–Germany–Netherlands routes.', es: '⚠️ Animales PROHIBIDOS en trenes hacia/desde Londres (Eurotúnel). Permitidos en rutas Bélgica–Francia–Alemania–Países Bajos.', pt: '⚠️ Animales PROHIBIDOS en comboios hacia/a partir de Londres (Eurotúnel). Permitidos en rutas Bélgica–Francia–Alemania–Países Bajos.' },
  },
  {
    slug: 'deutsche-bahn',
    flag: '🇩🇪',
    name: 'Deutsche Bahn (DB)',
    country: { fr: 'Allemagne', en: 'Germany', es: 'Alemania', pt: 'Alemania' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui (grands chiens)', en: 'Yes (large dogs)', es: 'Sí (perros grandes)', pt: 'Sí (cães grandes)' },
    price: { fr: 'Gratuit en panier (taille chat). Demi-tarif adulte (grande distance) · plein tarif (régional)', en: 'Free in carrier (cat-sized). Half adult fare (long-distance) · full fare (regional)', es: 'Gratis en transportín (talla gato). Mitad tarifa adulto (larga distancia) · tarifa completa (regional)', pt: 'Grátis en transportadora (talla gato). Mitad tarifa adulto (larga distancia) · tarifa completa (regional)' },
    sizeLimit: { fr: 'Petit animal en panier gratuit. Grand chien : billet obligatoire.', en: 'Small pet in carrier free. Large dog: ticket required.', es: 'Animal pequeño en transportín gratis. Perro grande: billete obligatorio.', pt: 'Animal pequenho en transportadora grátis. Cão grande: bilhete obrigatório.' },
    muzzle: { fr: 'Obligatoire (grands chiens)', en: 'Mandatory (large dogs)', es: 'Obligatorio (perros grandes)', pt: 'Obrigatório (cães grandes)' },
    carrier: { fr: 'Obligatoire (petits animaux)', en: 'Mandatory (small pets)', es: 'Obligatorio (animales pequeños)', pt: 'Obrigatório (animales pequenhos)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' },
    notes: { fr: 'Billet chien réservable en ligne (app DB Next Navigator) ou en gare.', en: 'Dog ticket bookable online (DB Next Navigator app) or at station.', es: 'Billete perro reservable online (app DB Next Navigator) o en estación.', pt: 'Bilhete cão reservable online (app DB Next Navigator) o en estação.' },
  },
  {
    slug: 'renfe',
    flag: '🇪🇸',
    name: 'Renfe',
    country: { fr: 'Espagne', en: 'Spain', es: 'España', pt: 'Espanha' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui', en: 'Yes', es: 'Sí', pt: 'Sí' },
    price: { fr: '10 € (Avlo) · 35 € sans cage (trains AVE avec sièges chiens) · Gratuit (Media Distancia)', en: '€10 (Avlo) · €35 without crate (AVE with dog seats) · Free (Media Distancia)', es: '10 € (Avlo) · 35 € sin jaula (AVE con asientos perros) · Gratis (Media Distancia)', pt: '10 € (Avlo) · 35 € sem jaula (AVE com asientos cães) · Grátis (Media Distancia)' },
    sizeLimit: { fr: 'En cage : 60×35×35 cm max. Sans cage jusqu\'à 40 kg sur trains équipés.', en: 'In crate: max 60×35×35 cm. No crate up to 40 kg on fitted trains.', es: 'En jaula: máx 60×35×35 cm. Sin jaula hasta 40 kg en trenes equipados.', pt: 'En jaula: máx 60×35×35 cm. Sem jaula até 40 kg en comboios equipados.' },
    muzzle: { fr: 'Obligatoire (Media Distancia)', en: 'Mandatory (Media Distancia)', es: 'Obligatorio (Media Distancia)', pt: 'Obrigatório (Media Distancia)' },
    carrier: { fr: 'Obligatoire (AVE, sauf sièges chiens)', en: 'Mandatory (AVE, except dog seats)', es: 'Obligatorio (AVE, salvo asientos perros)', pt: 'Obrigatório (AVE, salvo asientos cães)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' },
    notes: { fr: 'Présenter carnet de vaccination + assurance RC à l\'enregistrement (40 min avant départ).', en: 'Show vaccination booklet + liability insurance at check-in (40 min before departure).', es: 'Presentar cartilla de vacunación + seguro RC en facturación (40 min antes de salida).', pt: 'Presentar cartilla de vacinação + seguro RC en facturación (40 min antes de salida).' },
  },
  {
    slug: 'trenitalia',
    flag: '🇮🇹',
    name: 'Trenitalia',
    country: { fr: 'Italie', en: 'Italy', es: 'Italia', pt: 'Italia' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui (grand chien)', en: 'Yes (large dog)', es: 'Sí (perro grande)', pt: 'Sí (cão grande)' },
    price: { fr: 'Gratuit (panier < 70×30×50 cm). 50 % du tarif 2e classe (grand chien).', en: 'Free (carrier < 70×30×50 cm). 50% of 2nd class fare (large dog).', es: 'Gratis (transportín < 70×30×50 cm). 50% tarifa 2ª clase (perro grande).', pt: 'Grátis (transportadora < 70×30×50 cm). 50% tarifa 2ª clase (cão grande).' },
    sizeLimit: { fr: 'Petit en panier gratuit. Grand chien en laisse sur Frecce, Intercity.', en: 'Small in carrier free. Large dog on lead on Frecce, Intercity.', es: 'Pequeño en transportín gratis. Perro grande con correa en Frecce, Intercity.', pt: 'Pequenho en transportadora grátis. Cão grande com trela en Frecce, Intercity.' },
    muzzle: { fr: 'Obligatoire (grands chiens)', en: 'Mandatory (large dogs)', es: 'Obligatorio (perros grandes)', pt: 'Obrigatório (cães grandes)' },
    carrier: { fr: 'Obligatoire (petits)', en: 'Mandatory (small)', es: 'Obligatorio (pequeños)', pt: 'Obrigatório (pequenhos)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' },
    notes: { fr: 'Carnet canin + livret sanitaire obligatoires. Promo été 2025 : grands chiens gratuits sur Frecce et Intercity.', en: 'Dog registration + health booklet mandatory. Summer 2025 promo: large dogs free on Frecce and Intercity.', es: 'Registro canino + libreta sanitaria obligatorios. Promo verano 2025: perros grandes gratis en Frecce e Intercity.', pt: 'Registro canino + libreta sanitaria obrigatórios. Promo verão 2025: cães grandes grátis en Frecce e Intercity.' },
  },
  {
    slug: 'sncb',
    flag: '🇧🇪',
    name: 'SNCB / NMBS',
    country: { fr: 'Belgique', en: 'Belgium', es: 'Bélgica', pt: 'Bélgica' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui (en laisse)', en: 'Yes (on lead)', es: 'Sí (con correa)', pt: 'Sí (com trela)' },
    price: { fr: 'Gratuit (panier 30×55×30 cm max). Supplément animal en laisse.', en: 'Free (carrier max 30×55×30 cm). Pet supplement on lead.', es: 'Gratis (transportín máx 30×55×30 cm). Suplemento mascota con correa.', pt: 'Grátis (transportadora máx 30×55×30 cm). Suplemento animal com trela.' },
    sizeLimit: { fr: 'Panier gratuit. Grand chien : supplément requis.', en: 'Carrier free. Large dog: supplement required.', es: 'Transportín gratis. Perro grande: suplemento requerido.', pt: 'Transportadora grátis. Cão grande: suplemento requerido.' },
    muzzle: { fr: 'Non obligatoire (recommandée)', en: 'Not mandatory (recommended)', es: 'No obligatorio (recomendado)', pt: 'No obrigatório (recomendado)' },
    carrier: { fr: 'Obligatoire (petits animaux)', en: 'Mandatory (small pets)', es: 'Obligatorio (animales pequeños)', pt: 'Obrigatório (animales pequenhos)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' },
    notes: { fr: 'Chiens guides gratuits et sans muselière obligatoire.', en: 'Guide dogs free and no muzzle required.', es: 'Perros guía gratis y sin bozal obligatorio.', pt: 'Cães guía grátis e sem bozal obrigatório.' },
  },
  {
    slug: 'ns',
    flag: '🇳🇱',
    name: 'NS (Nederlandse Spoorwegen)',
    country: { fr: 'Pays-Bas', en: 'Netherlands', es: 'Países Bajos', pt: 'Países Bajos' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui (grand chien)', en: 'Yes (large dog)', es: 'Sí (perro grande)', pt: 'Sí (cão grande)' },
    price: { fr: 'Gratuit (panier 55×30×30 cm). Dagkaart Hond : 3,50 € (e-ticket) / 5 € (papier).', en: 'Free (carrier 55×30×30 cm). Dagkaart Hond: €3.50 (e-ticket) / €5 (paper).', es: 'Gratis (transportín 55×30×30 cm). Dagkaart Hond: 3,50 € (e-ticket) / 5 € (papel).', pt: 'Grátis (transportadora 55×30×30 cm). Dagkaart Hond: 3,50 € (e-ticket) / 5 € (papel).' },
    sizeLimit: { fr: 'Panier < 55×30×30 cm gratuit. Grand chien : laisse + muselière.', en: 'Carrier < 55×30×30 cm free. Large dog: lead + muzzle.', es: 'Transportín < 55×30×30 cm gratis. Perro grande: correa + bozal.', pt: 'Transportadora < 55×30×30 cm grátis. Cão grande: trela + bozal.' },
    muzzle: { fr: 'Obligatoire (grands chiens)', en: 'Mandatory (large dogs)', es: 'Obligatorio (perros grandes)', pt: 'Obrigatório (cães grandes)' },
    carrier: { fr: 'Obligatoire (petits animaux)', en: 'Mandatory (small pets)', es: 'Obligatorio (animales pequeños)', pt: 'Obrigatório (animales pequenhos)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' },
    notes: { fr: 'Dagkaart Hond valable toute la journée sur tout le réseau domestique NS.', en: 'Dagkaart Hond valid all day on all domestic NS routes.', es: 'Dagkaart Hond válido todo el día en toda la red doméstica NS.', pt: 'Dagkaart Hond válido todo o dia en toda a rede doméstica NS.' },
  },
  {
    slug: 'sbb',
    flag: '🇨🇭',
    name: 'SBB / CFF / FFS',
    country: { fr: 'Suisse', en: 'Switzerland', es: 'Suiza', pt: 'Suiza' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui (grand chien)', en: 'Yes (large dog)', es: 'Sí (perro grande)', pt: 'Sí (cão grande)' },
    price: { fr: 'Gratuit (en sac/panier). Abonnement journalier chien : CHF 25.', en: 'Free (in bag/carrier). Dog day pass: CHF 25.', es: 'Gratis (en bolsa/transportín). Abono diario perro: CHF 25.', pt: 'Grátis (en bolsa/transportadora). Abono diario cão: CHF 25.' },
    sizeLimit: { fr: 'Petit en sac/panier gratuit. Grand chien : abonnement jour.', en: 'Small in bag/carrier free. Large dog: day pass.', es: 'Pequeño en bolsa/transportín gratis. Perro grande: abono día.', pt: 'Pequenho en bolsa/transportadora grátis. Cão grande: abono dia.' },
    muzzle: { fr: 'Recommandée', en: 'Recommended', es: 'Recomendado', pt: 'Recomendado' },
    carrier: { fr: 'Obligatoire (petits animaux)', en: 'Mandatory (small pets)', es: 'Obligatorio (animales pequeños)', pt: 'Obrigatório (animales pequenhos)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' },
    notes: { fr: 'Le TGV Lyria (France–Suisse) suit les tarifs SNCF : 10 € (panier) ou 20 € (laisse).', en: 'TGV Lyria (France–Switzerland) follows SNCF rates: €10 (carrier) or €20 (lead).', es: 'TGV Lyria (Francia–Suiza) sigue tarifas SNCF: 10 € (transportín) o 20 € (correa).', pt: 'TGV Lyria (Francia–Suiza) sigue tarifas SNCF: 10 € (transportadora) o 20 € (trela).' },
  },
  {
    slug: 'obb',
    flag: '🇦🇹',
    name: 'ÖBB',
    country: { fr: 'Autriche', en: 'Austria', es: 'Austria', pt: 'Austria' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui (grand chien)', en: 'Yes (large dog)', es: 'Sí (perro grande)', pt: 'Sí (cão grande)' },
    price: { fr: 'Gratuit (panier 70×30×50 cm). Grand chien : billet séparé + compartiment privatif.', en: 'Free (carrier 70×30×50 cm). Large dog: separate ticket + private compartment.', es: 'Gratis (transportín 70×30×50 cm). Perro grande: billete separado + compartimento privado.', pt: 'Grátis (transportadora 70×30×50 cm). Cão grande: bilhete separado + compartimento privado.' },
    ...
    carrier: { fr: 'Obligatoire (petits animaux)', en: 'Mandatory (small pets)', es: 'Obligatorio (animales pequeños)', pt: 'Obrigatório (animales pequenhos)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' },
    notes: { fr: 'Laisse et muselière obligatoires pour grands chiens.', en: 'Lead and muzzle mandatory for large dogs.', es: 'Correa y bozal obligatorios para perros grandes.', pt: 'Trela e bozal obrigatórios para cães grandes.' },
  },
  {
    slug: 'pkp',
    flag: '🇵🇱',
    name: 'PKP Intercity',
    country: { fr: 'Pologne', en: 'Poland', es: 'Polonia', pt: 'Polonia' },
    allowed: 'yes',
    ticketRequired: { fr: 'Oui', en: 'Yes', es: 'Sí', pt: 'Sí' },
    price: { fr: 'Billet animal requis (tarif variable)', en: 'Pet ticket required (variable fare)', es: 'Billete mascota requerido (tarifa variable)', pt: 'Bilhete animal requerido (tarifa variable)' },
    sizeLimit: { fr: 'Petit en panier accepté. Grand chien en laisse.', en: 'Small in carrier accepted. Large dog on lead.', es: 'Pequeño en transportín aceptado. Perro grande con correa.', pt: 'Pequenho en transportadora aceite. Cão grande com trela.' },
    muzzle: { fr: 'Obligatoire', en: 'Mandatory', es: 'Obligatorio', pt: 'Obrigatório' },
    carrier: { fr: 'Obligatoire (petits animaux)', en: 'Mandatory (small pets)', es: 'Obligatorio (animales pequeños)', pt: 'Obrigatório (animales pequenhos)' },
    maxDogs: { fr: '1 par passager', en: '1 per passenger', es: '1 por pasajero', pt: '1 por pasajero' },
    notes: { fr: 'Chiens interdits dans les voitures-lits et couchettes EuroNight PKP.', en: 'Dogs banned in EuroNight PKP couchette and sleeping cars.', es: 'Perros prohibidos en coches cama y literas EuroNight PKP.', pt: 'Cães prohibidos en carros cama e literas EuroNight PKP.' },
  },
]
