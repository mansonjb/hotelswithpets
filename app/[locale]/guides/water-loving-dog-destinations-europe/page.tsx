...
const SIBLING_GUIDES = [
  { slug: 'high-energy-dog-destinations-europe', emoji: '🥾', label: { en: 'Best destinations for a high-energy dog', fr: 'Meilleures destinations pour un chien très actif', es: 'Mejores destinos para un perro muy activo', pt: 'Melhores destinos para um cão muito ativo', de: 'Beste Reiseziele für einen sehr aktiven Hund' } },
  { slug: 'dog-beaches-france', emoji: '🏖️', label: { en: 'Dog-friendly beaches in France', fr: 'Plages pour chiens en France', es: 'Playas para perros en Francia', pt: 'Praias para cães em França', de: 'Hundefreundliche Strände in Frankreich' } },
  { slug: 'best-dog-beaches-europe-2026', emoji: '🌊', label: { en: 'Best dog beaches in Europe 2026', fr: 'Meilleures plages pour chiens en Europe 2026', es: 'Mejores playas para perros en Europa 2026', pt: 'Melhores praias para cães na Europa 2026', de: 'Beste Hundestrände in Europa 2026' } },
]
...
const T = {
  ...
  kicker: { en: 'By dog profile', fr: 'Par profil de chien', es: 'Por perfil de perro', pt: 'Por perfil de cão', de: 'Nach Hundeprofil' },
  closingTitle: {
  ...
  siblingTitle: { en: 'Plan the rest of the trip', fr: `Planifier le reste du voyage`, es: 'Planifica el resto del viaje', pt: 'Planeie o resto da viagem', de: 'Den Rest der Reise planen' },
  faq: {
    q1: {
