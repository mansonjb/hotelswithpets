    ...
    destinations: [
      {
        ...
        country: 'Spain',
        janTemp: 21,
        tag: { en: 'Biggest island · Teide + coast', fr: 'La plus grande île · Teide + côte', es: 'La isla mayor · Teide + costa', pt: 'A maior ilha · Teide + costa' },
        why: {
      ...
      },
      {
        ...
        country: 'Spain',
        janTemp: 21,
        tag: { en: 'Dunes, ravines and dog beaches', fr: 'Dunes, ravins et plages canines', es: 'Dunas, barrancos y playas caninas', pt: 'Dunas, ravinas e praias caninas' },
        why: {
      ...
      },
      {
        ...
        country: 'Spain',
        janTemp: 19,
        tag: { en: 'Gran Canaria dunes · sheltered south', fr: 'Dunes de Gran Canaria · sud abrité', es: 'Dunas de Gran Canaria · sur resguardado', pt: 'Dunas da Gran Canaria · sul abrigado' },
        why: {
      ...
      },
      {
        ...
        country: 'Spain',
        janTemp: 21,
        tag: { en: 'Volcanic island · warm and dry', fr: 'Île volcanique · chaude et sèche', es: 'Isla volcánica · cálida y seca', pt: 'Ilha vulcânica · quente e seca' },
        why: {
      ...
      },
      {
        ...
        country: 'Portugal',
        janTemp: 16,
        tag: { en: 'Madeira · levada trails', fr: 'Madère · sentiers des levadas', es: 'Madeira · senderos de levadas', pt: 'Madeira · veredas das levadas' },
        why: {
    ...
    destinations: [
      {
        ...
        country: 'Spain',
        janTemp: 13,
        tag: { en: 'Andalusian city · museums + sea', fr: 'Ville andalouse · musées + mer', es: 'Ciudad andaluza · museos + mar', pt: 'Cidade andaluza · museus + mar' },
        why: {
      ...
      },
      {
        ...
        country: 'Spain',
        janTemp: 17,
        tag: { en: 'Cliff coves · slower pace', fr: 'Criques de falaise · rythme lent', es: 'Calas de acantilado · ritmo lento', pt: 'Enseadas de falésia · ritmo lento' },
        why: {
      ...
      },
      {
        ...
        country: 'Portugal',
        janTemp: 13,
        tag: { en: 'Algarve · empty cliff trails', fr: 'Algarve · sentiers de falaise déserts', es: 'Algarve · senderos de acantilado vacíos', pt: 'Algarve · trilhos de falésia vazios' },
        why: {
    ...
    destinations: [
      {
        ...
        country: 'Austria',
        janTemp: -2,
        tag: { en: 'Alpine thermal town · Belle Époque', fr: 'Ville thermale alpine · Belle Époque', es: 'Pueblo termal alpino · Belle Époque', pt: 'Vila termal alpina · Belle Époque' },
        why: {
...
const SIBLING_GUIDES = [
  { slug: 'autumn-destinations-with-dog-2026', emoji: '🍂', label: { en: 'Autumn destinations with your dog', fr: 'Destinations d\'automne avec son chien', es: 'Destinos de otoño con tu perro', pt: 'Destinos de outono com o seu cão' } },
