      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href={`/${locale}/dog-parks`} className="hover:text-white transition-colors">{locale === 'fr' ? 'Parcs canins' : locale === 'es' ? 'Parques para perros' : locale === 'pt' ? 'Parques para cães' : locale === 'de' ? 'Hundeparks' : 'Dog parks'}</Link></li>
              <li><Link href={`/${locale}/countries`} className="hover:text-white transition-colors">{locale === 'fr' ? 'Par pays' : locale === 'es' ? 'Por país' : locale === 'pt' ? 'Por país' : locale === 'de' ? 'Nach Land' : 'By country'}</Link></li>
            </ul>
          </div>
          ...
          <div>
            <h3 className="text-white font-semibold mb-4">
              {locale === 'fr' ? 'Populaires' : locale === 'es' ? 'Populares' : locale === 'pt' ? 'Populares' : locale === 'de' ? 'Beliebt' : 'Popular'}
            </h3>
            <ul className="space-y-2 text-sm">
              {[
        ...
        <div className="border-t border-gray-800 mt-10 pt-8">
          <p className="text-xs text-gray-500 uppercase tracking-wide mb-3">
            {locale === 'fr' ? 'Par pays' : locale === 'es' ? 'Por país' : locale === 'pt' ? 'Por país' : locale === 'de' ? 'Nach Land' : 'By country'}
          </p>
        ...
        <div className="border-t border-gray-800 mt-6 pt-6">
          <p className="text-xs text-gray-500 uppercase tracking-wide mb-3">
            {locale === 'fr' ? 'Guides populaires' : locale === 'es' ? 'Guías populares' : locale === 'pt' ? 'Guias populares' : locale === 'de' ? 'Beliebte Reiseführer' : 'Popular guides'}
          </p>
