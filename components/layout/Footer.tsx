        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href={`/${locale}/dog-parks`} className="hover:text-white transition-colors">{locale === 'fr' ? 'Parcs canins' : locale === 'es' ? 'Parques para perros' : locale === 'pt' ? 'Parques para cães' : 'Dog parks'}</Link></li>
