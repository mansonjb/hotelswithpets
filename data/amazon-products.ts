...
export const PRODUCTS: AmazonProduct[] = [
  ...
  {
    asin: 'B007N7DQ2C',
    name: `Doggyhut Medium - Remorque vélo + jogger`,
    desc: `Remorque vélo 2-en-1 (jogger inclus), chiens jusqu'à 23 kg, plancher renforcé. Pour qui veut partir à vélo avec son chien sans le faire courir 30 km.`,
    category: 'transport',
    petType: 'dog',
    priceHint: '130–180 €',
    emoji: '🚲',
    imageUrl: 'https://m.media-amazon.com/images/I/71yf0MZoJnS._AC_SL1500_.jpg',
  },
  {
    asin: 'B07G495HGR',
