...
const cityContent: Record<string, CityContent> = {
  ...
  bratislava: {
    ...
    petTips: {
      ...
      en: [
        `A muzzle is mandatory for medium and large dogs on all DPB and ZSSK transport — pack one even if your dog never wears one at home.`,
        `Buy the dog ticket along with your own on trams; the unannounced fine for an undeclared dog is €5.`,
        `Most central 24/7 emergency vet: VETLINE, Staromestská 6/D, +421 911 122 122 — minutes on foot from the castle.`,
        `Bratislava Castle and most museums are closed to non-assistance pets; plan a sitter via Pawshake.sk for indoor visits.`,
    ...
    practicalInfo: {
      ...
      en: [
        ...
        `Dog-friendly hotel rates: from €60 per night for 3*, average pet supplement €15–25 per stay.`,
        `Continental climate: cold snowy winters (-3 °C in January), warm summers (23 °C in July); icy cobbles in winter, pack a coat for small dogs.`,
        `Pawshake.sk is the dominant pet-care platform; budget €10–12 per drop-in visit, €18–25 for full-day care, €20–30 per night.`,
  ...
  brighton: {
    ...
    petTips: {
      fr: [
        `Interdiction estivale (1er mai-30 septembre) sur la majeure partie du front de mer central — repliez-vous sur Hove Lawns, Saltdean ou Rottingdean, ouvertes toute l'année.`,
      ...
      en: [
        ...
        `Up to 2 dogs ride free per passenger on the entire Brighton & Hove bus network; pets must sit on the floor or on a lap, never on a seat.`,
        `24/7 emergency vet: Coastway Veterinary Group, Freshfield Way, BN2 0DF, +44 1273 692 257 — covers most of the city's smaller clinics overnight.`,
        `Post-Brexit: since 2021 EU pet passports are no longer valid for entry into the UK — an Animal Health Certificate is required.`,
    ...
    practicalInfo: {
      ...
      en: [
        `Eurostar: not possible with non-assistance pets; the best route is Eurotunnel Le Shuttle (Calais-Folkestone) plus car, or a ferry-and-train route via Newhaven-Dieppe.`,
        `Trains from London Victoria/St Pancras (Southern, Thameslink): 1 hour, up to 2 dogs free per adult ticket.`,
        `Mild oceanic climate: gentle summers (20 °C in July), wet winters; Channel winds can be strong, so pack a coat for small dogs October-March.`,
        `Tailster.com and BorrowMyDoggy.com are the two reference platforms for sitting and walking; budget £12-15 per walk, £30-40 per full day.`,
        `£100 fixed penalty for not picking up dog mess in public spaces, enforced by council officers.`,
      ],
      es: [
  ...
  manchester: {
    ...
    sights: [
      ...
      },
      {
        ...
        desc: {
          ...
          es: `Histórico canal desde el que la Revolución Industrial embarcó su primer algodón, hoy un barrio frondoso de bares junto al canal, el escenario Castlefield Bowl y restos del fuerte romano. La senda del Bridgewater Canal lleva hasta Sale (9 km) con correa.`,
        },
      },
      {
      ...
      },
      {
        ...
        desc: {
          ...
          es: `Parque de 109 hectáreas al sur con zona sin correa señalizada, senderos dog-friendly y café-terraza de Wythenshawe Hall que admite perros fuera. Bus 41 desde Piccadilly Gardens.`,
        },
      },
      {
        name: 'Formby Beach',
    ...
    petTips: {
      ...
      en: [
        ...
        `Pets free on the entire Bee Network (Metrolink, buses) — up to 2 leashed dogs per passenger; permanent policy since 2023.`,
        `Northern Rail trains: up to 2 dogs free per adult ticket; small pets in carriers travel free with no carrier-size limit.`,
        `24/7 emergency vet: Vets Now Manchester, 98 Bury Old Road, Whitefield, +44 161 222 6004 — about 20 minutes by Bolt from the centre.`,
    ...
    practicalInfo: {
      ...
      en: [
        ...
        `Dog-friendly hotel rates: from £90 per night for 4*, average pet supplement £20-50 per stay or per night.`,
        `Oceanic climate: cool summers (17 °C in July), mild but wet winters (5 °C in January); wind and humidity make the cold feel sharper than the numbers suggest.`,
        `Tailster.com and BorrowMyDoggy.com are the two reference platforms for sitting and walking; budget £12-18 per walk, £30-45 per full day.`,
  ...
  riga: {
    ...
    sights: [
      ...
      {
        name: 'Vecrīga & House of the Black Heads',
        emoji: '⛪',
        petFriendly: true,
        desc: {
  ...
  'the-hague': {
    ...
    sights: [
      ...
      {
        name: 'Westduinpark & Bosjes van Poot',
        emoji: '🌾',
        petFriendly: true,
        desc: {
      ...
      {
        name: 'Scheveningen Pier & Boulevard',
        emoji: '🌊',
        petFriendly: true,
        desc: {
    ...
    petTips: {
      ...
      en: [
        ...
        `On the central Scheveningen beach in summer, dogs are off-leash only between 21:00 and 07:00 — a small but lively local social ritual.`,
        `HTM (trams and buses): small dogs in a carrier travel free, large dogs on a leash are accepted at no extra fare provided they sit in the aisle.`,
        `24/7 emergency vet: AniCura Haaglanden Rijswijk, Frijdastraat 20a (+31 85 483 13 00), 10 minutes by car from the centre.`,
    ...
    practicalInfo: {
      ...
      en: [
        `The main airport for The Hague is Amsterdam Schiphol (AMS), 45 minutes by direct train; Rotterdam-The Hague (RTM) is closer but serves fewer destinations.`,
        `On NS trains, large dogs need a Dog Day Ticket at around €3.50, valid all day across the domestic network. Small dogs in a bag travel free.`,
        `24/7 regional emergency vet line: 0900-2226333, which routes to the on-call clinic (in practice AniCura Rijswijk).`,
        `Oceanic climate: mild summers (19 °C in July), grey and windy winters; the North Sea wind makes a coat sensible for small dogs from October to March.`,
