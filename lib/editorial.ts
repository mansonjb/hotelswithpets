...
export const destContextByLocale: Record<string, Record<string, DestCtx>> = {
  en: {
    ...
    palamos: {
      personality: `a 17,000-resident Costa Brava centre fishing-port municipality in the Baix Empordà comarca of Girona, defined by its active Port de Palamós fleet (3rd by volume in Catalonia), the Llotja de Palamós afternoon fish auction, the Castell de Sant Esteve de Mar medieval clifftop ruins, and a four-port coastline from Platja Gran (town centre) to La Fosca, the postcard fishermen-hut cove of Cala S'Alguer, the Platja del Castell with its year-round dog-beach zone on the northern section, and southern Cala Margarida, all linked north by the 6 km Camí de Ronda GR-92 clifftop path to Calella de Palafrugell, and crowned by the Gamba de Palamós PDO red prawn and Cuina del Peix de Palamós Slow-Food kitchen`,
      highlight: `the working Port de Palamós quay around the Llotja fish auction (5 pm), the free open-air Castell de Sant Esteve de Mar clifftop ruins with a panoramic viewpoint over La Fosca, the postcard fishermen-hut cove of Cala S'Alguer (foot-access only via the GR-92), and the year-round dog-beach zone on the northern section of Platja del Castell`,
      area: `the Passeig del Mar seafront along Platja Gran, the harbour quay around the Plaça Sant Pere opposite the Llotja, the Sant Joan de Palamós casc antic hilltop, and the north-coast cala corridor (La Fosca, Cala S'Alguer, Platja del Castell, Cap de Planes)`,
    },
    palermo: {
    ...
    'sant-josep': {
      personality: `the largest municipality on Ibiza by area, 28,000 residents spread across the entire south of the island, home to Es Vedrà (the 382 m vertical limestone monolith offshore from Cala d'Hort), Sa Talaia (the island's 475 m highest peak), the 18th-century Església de Sant Josep in the village plaza, the Parque Natural de Ses Salines d'Eivissa i Formentera UNESCO Biosphere, the Sa Pedrera (Atlantis) quarry-cove, and the 2.7 km Platja d'en Bossa strip, with Ibiza Airport (IBZ) physically inside its boundaries`,
      highlight: `the Es Vedrà clifftop sunset above Cala d'Hort, the Sa Talaia summit trail from the village (475 m, highest peak on Ibiza), the Ses Salines salt-pan dyke walks with winter flamingos, off-season Cala Vadella and Cala Carbó cove walks, and Es Vedrà boat excursions from Cala d'Hort`,
      area: `Sant Josep village plaza and casco antiguo, Sant Jordi de ses Salines next to the airport, Es Cubells and Cala d'Hort on the south-west clifftop, the south-west coves of Cala Vadella, Cala Tarida, Cala Molí and Cala Carbó, and Cala Jondal, Sa Caleta and Platja d'en Bossa on the south coast`,
    },
    'santa-eulalia': {
    ...
    'cinque-terre': {
      personality: `five UNESCO-listed Ligurian fishing villages (Monterosso, Vernazza, Corniglia, Manarola, Riomaggiore) strung along terraced cliffs in La Spezia province, genuinely dog-friendly where it counts: leashed dogs ride the Cinque Terre Express regional train and the Golfo dei Poeti ferry, and walk the coastal CAI trails and the reopened Via dell'Amore, though the villages are steep and their beaches restricted`,
      highlight: `the reopened Via dell'Amore seaside promenade between Riomaggiore and Manarola, the coastal Sentiero Azzurro (Blue Path) walked with the Cinque Terre Trekking Card, the panoramic Punta Bonfiglio headland garden above Manarola, Vernazza harbour with its Doria Castle viewpoint, and the dog-friendly ferry deck along the whole coast`,
      area: `the five villages of Monterosso, Vernazza, Corniglia, Manarola and Riomaggiore, the flat northern gateway town of Levanto, and La Spezia to the south with the nearest 24-hour vet`,
    },
    portofino: {
      personality: `the iconic fishing village of the Italian Riviera, a cluster of pastel houses around a tiny, exclusive harbour on a steep wooded promontory in the province of Genoa, glamorous but honest work with a dog: there is essentially no dog beach and the coast is rocky and pricey, yet leashed dogs stroll the flat harbour piazzetta, climb to Castello Brown and the lighthouse, and hike the Parco di Portofino trails to San Fruttuoso`,
    ...
    positano: {
      ...
      area: `the beach-level Spiaggia Grande and quieter Fornillo, the upper town along Viale Pasitea served by the internal orange shuttle, the hillside hamlet of Nocelle above the centre, and the gateway towns of Sorrento over the pass and Amalfi along the coast`,
    },
    sorrento: {
    ...
    taormina: {
      personality: `the Sicilian clifftop balcony 200 m above the Ionian Sea facing Mount Etna and the HBO White Lotus Season 2 location, a pedestrianised Corso Umberto threading the medieval centre between Porta Catania and Porta Messina, with the 3rd-century BC Greco-Roman Teatro Antico open-air theatre overlooking Etna and the bay, the Funivia cable car down to Mazzarò pebble cove, the tidal-causeway Isola Bella islet nature reserve and a long sandy designated dog beach at Letojanni 5 km north`,
      highlight: `the panoramic Teatro Antico over Etna and the Ionian, the Corso Umberto walk from Porta Catania to Piazza IX Aprile and the Villa Comunale gardens, the Funivia cable car down to Mazzarò and the Isola Bella causeway, the Sea Cup Beach designated dog stretch at Letojanni 5 km north, and an Etna foothills excursion to Rifugio Sapienza 1923 m`,
      area: `the pedestrianised Corso Umberto between Porta Catania and Porta Messina, Piazza IX Aprile with the Sant'Agostino terrace and Madonna della Rocca hike above, the Villa Comunale Trevelyan gardens on the seaward edge, and the Mazzarò + Isola Bella waterfront 200 m below reached by the Funivia`,
    },
    tarifa: {
  ...
  fr: {
    ...
    palamos: {
      personality: `une commune portuaire de pêche du centre de la Costa Brava de 17 000 habitants dans la comarca du Baix Empordà à Gérone, définie par sa flotte active du Port de Palamós (3e de Catalogne en volume), la criée Llotja de Palamós de l'après-midi, les ruines clifftop médiévales du Castell de Sant Esteve de Mar, et un littoral à quatre ports de la Platja Gran (centre-ville) à La Fosca, la crique carte postale aux cabanes de pêcheurs de Cala S'Alguer, la Platja del Castell avec sa zone plage canine à l'année sur la section nord, et la Cala Margarida au sud, toutes reliées au nord par le Camí de Ronda GR-92 de 6 km en bord de falaise jusqu'à Calella de Palafrugell, et couronnée par la gambe rouge Gamba de Palamós PDO et la cuisine Slow Food Cuina del Peix de Palamós`,
      highlight: `le quai en activité du Port de Palamós autour de la criée Llotja (17h), les ruines libres en plein air du Castell de Sant Esteve de Mar en bord de falaise avec un belvédère panoramique sur La Fosca, la crique carte postale aux cabanes de pêcheurs de Cala S'Alguer (accès pied uniquement par le GR-92), et la zone plage canine à l'année sur la section nord de la Platja del Castell`,
      area: `le Passeig del Mar en front de mer le long de la Platja Gran, le quai du port autour de la Plaça Sant Pere face à la Llotja, le casc antic perché de Sant Joan de Palamós, et le corridor des criques de la côte nord (La Fosca, Cala S'Alguer, Platja del Castell, Cap de Planes)`,
    },
    palermo: {
    ...
    'sant-josep': {
      personality: `la plus grande commune d'Ibiza en surface, 28 000 habitants étalés sur tout le sud de l'île, qui abrite Es Vedrà (le monolithe calcaire vertical de 382 m au large de Cala d'Hort), le Sa Talaia (475 m, point culminant de l'île), l'Església de Sant Josep du XVIIIe siècle sur la place du village, le Parc Natural de Ses Salines d'Eivissa i Formentera classé réserve de biosphère UNESCO, la carrière-crique de Sa Pedrera (Atlantis) et le strip de 2,7 km de Platja d'en Bossa, avec l'aéroport d'Ibiza (IBZ) physiquement dans ses limites`,
      highlight: `le coucher de soleil sur Es Vedrà depuis la falaise au-dessus de Cala d'Hort, le sentier du sommet de Sa Talaia depuis le village (475 m, point culminant d'Ibiza), les digues des salinas de Ses Salines avec les flamants en hiver, les balades hors saison à Cala Vadella et Cala Carbó, et les excursions en bateau à Es Vedrà depuis Cala d'Hort`,
      area: `la place et le casco antiguo du village de Sant Josep, Sant Jordi de ses Salines à côté de l'aéroport, Es Cubells et Cala d'Hort sur la falaise sud-ouest, les criques sud-ouest Cala Vadella, Cala Tarida, Cala Molí et Cala Carbó, et Cala Jondal, Sa Caleta et Platja d'en Bossa sur la côte sud`,
    },
    'santa-eulalia': {
    ...
    'cinque-terre': {
      personality: `cinq villages de pêcheurs liguriens classés à l'UNESCO (Monterosso, Vernazza, Corniglia, Manarola, Riomaggiore) accrochés à des falaises en terrasses dans la province de La Spezia, réellement dog-friendly là où ça compte : les chiens en laisse prennent le train régional Cinque Terre Express et le ferry du Golfo dei Poeti, et parcourent les sentiers côtiers CAI et la Via dell'Amore rouverte, même si les villages sont pentus et leurs plages réglementées`,
      highlight: `la promenade de bord de mer Via dell'Amore rouverte entre Riomaggiore et Manarola, le sentier côtier Sentiero Azzurro (sentier bleu) parcouru avec la Cinque Terre Trekking Card, le jardin panoramique de Punta Bonfiglio au-dessus de Manarola, le port de Vernazza et le point de vue de son château Doria, et le pont du ferry dog-friendly le long de toute la côte`,
      area: `les cinq villages de Monterosso, Vernazza, Corniglia, Manarola et Riomaggiore, la ville-porte nord de Levanto et son front de mer plat, et La Spezia au sud avec le vétérinaire 24h le plus proche`,
    },
    portofino: {
    ...
    positano: {
      ...
      highlight: `le Sentiero degli Dei (Sentier des Dieux) de Bomerano à Nocelle avec des chiens en laisse, la promenade plate Via Positanesi d'America entre la Spiaggia Grande et Fornillo, l'église Santa Maria Assunta à la coupole de majolique et sa place, le hameau plus vert de Nocelle, et le plateau plus frais d'Agerola où débute le sentier`,
      area: `la Spiaggia Grande au niveau de la plage et Fornillo plus calme, la ville haute le long de la Viale Pasitea desservie par la navette orange interne, le hameau de Nocelle au-dessus du centre, et les villes-portes de Sorrente par le col et d'Amalfi le long de la côte`,
    },
    sorrento: {
    ...
    taormina: {
      personality: `le balcon sicilien perché à 200 m au-dessus de la mer Ionienne face à l'Etna et lieu de tournage de The White Lotus saison 2 (HBO), avec un Corso Umberto piétonnier qui traverse le centre médiéval entre Porta Catania et Porta Messina, le Teatro Antico gréco-romain du IIIe siècle av. J.-C. ouvert sur l'Etna et la baie, la Funivia descendant à la crique de galets de Mazzarò, l'îlot Isola Bella accessible par tombolo et une longue plage de sable canine désignée à Letojanni à 5 km au nord`,
      highlight: `le panorama du Teatro Antico sur l'Etna et la mer Ionienne, le Corso Umberto de Porta Catania à la Piazza IX Aprile et aux jardins de la Villa Comunale, la Funivia jusqu'à Mazzarò et le tombolo d'Isola Bella, la zone canine de Sea Cup Beach à Letojanni à 5 km au nord, et une excursion sur les pentes de l'Etna jusqu'au Rifugio Sapienza à 1 923 m`,
      area: `le Corso Umberto piétonnier entre Porta Catania et Porta Messina, la Piazza IX Aprile avec la terrasse de Sant'Agostino et la montée vers Madonna della Rocca, les jardins Trevelyan de la Villa Comunale côté mer, et le front de mer Mazzarò + Isola Bella 200 m en contrebas accessible par la Funivia`,
    },
    tarifa: {
  ...
  es: {
    ...
    palamos: {
      personality: `un municipio portuario pesquero del centro de la Costa Brava de 17.000 habitantes en la comarca del Baix Empordà en Girona, definido por su flota activa del Port de Palamós (3ª de Cataluña por volumen), la subasta Llotja de Palamós de la tarde, las ruinas clifftop medievales del Castell de Sant Esteve de Mar, y un litoral de cuatro puertos desde la Platja Gran (centro del pueblo) hasta La Fosca, la cala postal con barracas de pescadores de Cala S'Alguer, la Platja del Castell con su zona playa canina anual en la sección norte, y la Cala Margarida al sur, todas conectadas al norte por el Camí de Ronda GR-92 de 6 km en borde de acantilado hasta Calella de Palafrugell, y coronada por la gamba roja Gamba de Palamós PDO y la cocina Slow Food Cuina del Peix de Palamós`,
      highlight: `el muelle en activo del Port de Palamós alrededor de la subasta Llotja (17:00), las ruinas libres al aire libre del Castell de Sant Esteve de Mar en borde de acantilado con un mirador panorámico sobre La Fosca, la cala postal con barracas de pescadores de Cala S'Alguer (acceso a pie solo por el GR-92), y la zona playa canina anual en la sección norte de la Platja del Castell`,
      area: `el Passeig del Mar frente al mar a lo largo de la Platja Gran, el muelle del puerto en torno a la Plaça Sant Pere frente a la Llotja, el casc antic encaramado de Sant Joan de Palamós, y el corredor de calas de la costa norte (La Fosca, Cala S'Alguer, Platja del Castell, Cap de Planes)`,
    },
    palermo: {
    ...
    'sant-josep': {
      personality: `el municipio más extenso de Ibiza, 28.000 habitantes desplegados por todo el sur de la isla, que alberga Es Vedrà (el monolito calizo vertical de 382 m frente a Cala d'Hort), el Sa Talaia (475 m, la cima más alta de la isla), la Església de Sant Josep del siglo XVIII en la plaza del pueblo, el Parc Natural de Ses Salines d'Eivissa i Formentera reserva de la biosfera UNESCO, la cantera-cala de Sa Pedrera (Atlantis) y el strip de 2,7 km de Platja d'en Bossa, con el aeropuerto de Ibiza (IBZ) físicamente dentro de sus límites`,
      highlight: `el ocaso sobre Es Vedrà desde el acantilado sobre Cala d'Hort, el sendero a la cima de Sa Talaia desde el pueblo (475 m, cima de Ibiza), los diques de las salinas de Ses Salines con los flamencos en invierno, los paseos fuera de temporada en Cala Vadella y Cala Carbó, y las excursiones en barco a Es Vedrà desde Cala d'Hort`,
      area: `la plaza y el casco antiguo del pueblo de Sant Josep, Sant Jordi de ses Salines junto al aeropuerto, Es Cubells y Cala d'Hort en el acantilado suroeste, las calas del suroeste Cala Vadella, Cala Tarida, Cala Molí y Cala Carbó, y Cala Jondal, Sa Caleta y Platja d'en Bossa en la costa sur`,
    },
    'santa-eulalia': {
    ...
    'cinque-terre': {
      personality: `cinco pueblos pesqueros ligures declarados Patrimonio de la UNESCO (Monterosso, Vernazza, Corniglia, Manarola, Riomaggiore) colgados de acantilados en terrazas en la provincia de La Spezia, realmente pet-friendly donde importa: los perros con correa viajan en el tren regional Cinque Terre Express y en el ferry del Golfo dei Poeti, y recorren los senderos costeros CAI y la reabierta Via dell'Amore, aunque los pueblos son empinados y sus playas restringidas`,
      highlight: `el paseo marítimo reabierto Via dell'Amore entre Riomaggiore y Manarola, el sendero costero Sentiero Azzurro (sendero azul) recorrido con la Cinque Terre Trekking Card, el jardín panorámico de Punta Bonfiglio sobre Manarola, el puerto de Vernazza y el mirador de su castillo Doria, y la cubierta del ferry pet-friendly a lo largo de toda la costa`,
      area: `los cinco pueblos de Monterosso, Vernazza, Corniglia, Manarola y Riomaggiore, la localidad de acceso norte de Levanto con su paseo marítimo llano, y La Spezia al sur con el veterinario 24 horas más cercano`,
    },
    portofino: {
      personality: `el icónico pueblo pesquero de la Riviera italiana, un conjunto de casas pastel en torno a un puerto minúsculo y exclusivo sobre un promontorio empinado y boscoso de la provincia de Génova, glamuroso pero exigente con un perro: prácticamente no hay playa para perros y la costa es rocosa y cara, pero los perros con correa recorren la piazzetta llana del puerto, suben al Castello Brown y al faro, y hacen los senderos del Parco di Portofino hacia San Fruttuoso`,
    ...
    positano: {
      ...
      area: `la Spiaggia Grande a nivel de playa y la más tranquila Fornillo, el pueblo alto a lo largo de la Viale Pasitea servido por la lanzadera naranja interna, la aldea de Nocelle sobre el centro, y las localidades de acceso de Sorrento por el paso y Amalfi a lo largo de la costa`,
    },
    sorrento: {
    ...
    taormina: {
      personality: `el balcón siciliano encaramado a 200 m sobre el mar Jónico frente al Etna y localización de The White Lotus temporada 2 (HBO), con un Corso Umberto peatonal que atraviesa el centro medieval entre Porta Catania y Porta Messina, el Teatro Antico grecorromano del siglo III a.C. abierto al Etna y la bahía, la Funivia que baja a la cala de cantos de Mazzarò, el islote Isola Bella accesible por tómbolo y una larga playa de arena canina señalizada en Letojanni a 5 km al norte`,
      highlight: `el panorama del Teatro Antico sobre el Etna y el mar Jónico, el Corso Umberto desde Porta Catania hasta la Piazza IX Aprile y los jardines de la Villa Comunale, la Funivia hasta Mazzarò y el tómbolo de Isola Bella, la zona canina de Sea Cup Beach en Letojanni a 5 km al norte, y una excursión por las laderas del Etna hasta el Rifugio Sapienza a 1923 m`,
      area: `el Corso Umberto peatonal entre Porta Catania y Porta Messina, la Piazza IX Aprile con la terraza de Sant'Agostino y la subida a Madonna della Rocca, los jardines Trevelyan de la Villa Comunale junto al mar, y el frente marítimo Mazzarò + Isola Bella 200 m abajo accesible por la Funivia`,
    },
    tarifa: {
  ...
  pt: {
    ...
    palamos: {
      personality: `um município portuário piscatório do centro da Costa Brava de 17.000 habitantes na comarca do Baix Empordà em Girona, definido pela sua frota ativa do Port de Palamós (3ª da Catalunha em volume), a lota Llotja de Palamós da tarde, as ruínas clifftop medievais do Castell de Sant Esteve de Mar, e um litoral de quatro portos desde a Platja Gran (centro da vila) até La Fosca, a cala postal com barracas de pescadores de Cala S'Alguer, a Platja del Castell com a sua zona praia canina anual na secção norte, e a Cala Margarida a sul, todas ligadas a norte pelo Camí de Ronda GR-92 de 6 km à beira da falésia até Calella de Palafrugell, e coroada pela gamba vermelha Gamba de Palamós PDO e a cozinha Slow Food Cuina del Peix de Palamós`,
      highlight: `o cais em atividade do Port de Palamós à volta da lota Llotja (17:00), as ruínas livres ao ar livre do Castell de Sant Esteve de Mar à beira da falésia com um miradouro panorâmico sobre La Fosca, a cala postal com barracas de pescadores de Cala S'Alguer (acesso a pé só pelo GR-92), e a zona praia canina anual na secção norte da Platja del Castell`,
      area: `o Passeig del Mar frente ao mar ao longo da Platja Gran, o cais do porto em torno da Plaça Sant Pere em frente à Llotja, o casc antic empoleirado de Sant Joan de Palamós, e o corredor de calas da costa norte (La Fosca, Cala S'Alguer, Platja del Castell, Cap de Planes)`,
    },
    palermo: {
    ...
    'sant-josep': {
      personality: `o município mais extenso de Ibiza, 28.000 habitantes espalhados por todo o sul da ilha, que abriga Es Vedrà (o monólito calcário vertical de 382 m em frente a Cala d'Hort), o Sa Talaia (475 m, o ponto mais alto da ilha), a Església de Sant Josep do século XVIII na praça da aldeia, o Parc Natural de Ses Salines d'Eivissa i Formentera reserva da biosfera UNESCO, a pedreira-enseada de Sa Pedrera (Atlantis) e a faixa de 2,7 km de Platja d'en Bossa, com o aeroporto de Ibiza (IBZ) fisicamente dentro dos seus limites`,
      highlight: `o pôr do sol sobre Es Vedrà desde a falésia sobre Cala d'Hort, o trilho do cume de Sa Talaia desde a aldeia (475 m, ponto mais alto de Ibiza), os diques das salinas de Ses Salines com os flamingos no inverno, os passeios fora de época em Cala Vadella e Cala Carbó, e as excursões de barco a Es Vedrà desde Cala d'Hort`,
      area: `a praça e o casco antigo da aldeia de Sant Josep, Sant Jordi de ses Salines junto ao aeroporto, Es Cubells e Cala d'Hort na falésia sudoeste, as enseadas do sudoeste Cala Vadella, Cala Tarida, Cala Molí e Cala Carbó, e Cala Jondal, Sa Caleta e Platja d'en Bossa na costa sul`,
    },
    'santa-eulalia': {
    ...
    'cinque-terre': {
      personality: `cinco aldeias piscatórias lígures classificadas pela UNESCO (Monterosso, Vernazza, Corniglia, Manarola, Riomaggiore) penduradas em falésias em socalcos na província de La Spezia, verdadeiramente pet-friendly onde importa: os cães com trela viajam no comboio regional Cinque Terre Express e no ferry do Golfo dei Poeti, e percorrem os trilhos costeiros CAI e a Via dell'Amore reaberta, embora as aldeias sejam íngremes e as suas praias restritas`,
      highlight: `o passeio marítimo reaberto Via dell'Amore entre Riomaggiore e Manarola, o trilho costeiro Sentiero Azzurro (trilho azul) percorrido com o Cinque Terre Trekking Card, o jardim panorâmico de Punta Bonfiglio sobre Manarola, o porto de Vernazza e o miradouro do seu castelo Doria, e o convés do ferry pet-friendly ao longo de toda a costa`,
      area: `as cinco aldeias de Monterosso, Vernazza, Corniglia, Manarola e Riomaggiore, a vila de acesso a norte, Levanto, com a sua marginal plana, e La Spezia a sul com o veterinário 24 horas mais próximo`,
    },
    portofino: {
    ...
    positano: {
      ...
      highlight: `o Sentiero degli Dei (Caminho dos Deuses) de Bomerano a Nocelle com cães com trela, o passeio plano Via Positanesi d'America entre a Spiaggia Grande e Fornillo, a Igreja de Santa Maria Assunta com a sua cúpula de majólica e a sua praça, a mais verde aldeia de Nocelle, e o mais fresco planalto de Agerola onde começa o trilho`,
      area: `a Spiaggia Grande ao nível da praia e a mais calma Fornillo, a vila alta ao longo da Viale Pasitea servida pela lançadeira laranja interna, a aldeia de Nocelle acima do centro, e as vilas de acesso de Sorrento pelo passo e Amalfi ao longo da costa`,
    },
    sorrento: {
    ...
    taormina: {
      personality: `o balcão siciliano empoleirado a 200 m sobre o mar Jónico em frente ao Etna e localização de The White Lotus temporada 2 (HBO), com um Corso Umberto pedonal que atravessa o centro medieval entre Porta Catania e Porta Messina, o Teatro Antico greco-romano do século III a.C. aberto ao Etna e à baía, a Funivia que desce à enseada de calhau de Mazzarò, o ilhéu Isola Bella acessível por tômbolo e uma longa praia de areia canina designada em Letojanni a 5 km a norte`,
      highlight: `o panorama do Teatro Antico sobre o Etna e o mar Jónico, o Corso Umberto desde Porta Catania até à Piazza IX Aprile e aos jardins da Villa Comunale, a Funivia até Mazzarò e o tômbolo de Isola Bella, a zona canina de Sea Cup Beach em Letojanni a 5 km a norte, e uma excursão pelas encostas do Etna até ao Rifugio Sapienza a 1923 m`,
      area: `o Corso Umberto pedonal entre Porta Catania e Porta Messina, a Piazza IX Aprile com o terraço de Sant'Agostino e a subida a Madonna della Rocca, os jardins Trevelyan da Villa Comunale junto ao mar, e a frente marítima Mazzarò + Isola Bella 200 m abaixo acessível pela Funivia`,
    },
    tarifa: {
