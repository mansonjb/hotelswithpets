...
const TARGETS = [
  ...
  { slug: 'oviedo',        query: 'Oviedo Asturias Spain green Spain pre-Romanesque UNESCO Santa Maria del Naranco San Miguel de Lillo Monte Naranco panorama Catedral de San Salvador Gothic Camara Santa casco antiguo Plaza del Fontan Mercado del Fontan Calle Gascona Bulevar de la Sidra cider sidreria Campo de San Francisco park Teatro Campoamor mild green hills panorama sunset' },
  ...
  { slug: 'leuven',        query: 'Leuven Louvain Belgium Vlaams-Brabant KU Leuven oldest Catholic university 1425 Stadhuis flamboyant Brabantine Gothic Late 15th century 236 niche statues facade Grote Markt Sint-Pieterskerk Late Gothic Dirk Bouts Last Supper altarpiece 1464 Oude Markt longest bar Europe 40 cafe terraces Groot Begijnhof UNESCO largest preserved beguinage Belgium 1232 cobbled neighborhood Universiteitsbibliotheek Bibliotheektoren carillon Naamsestraat student strip Stella Artois brewery Den Hoorn 1366 Vaartkom canal Heverleebos Meerdaalwoud forests panorama sunset' },
  ...
  { slug: 'taormina',      query: 'Taormina Sicily Italy Greek Theatre Teatro Antico Greco Romano panoramic terrace columns over Etna volcano Ionian Sea Isola Bella islet pearl Mediterranean Mazzaro cove turquoise water Corso Umberto Piazza IX Aprile clifftop terrace Sant Agostino White Lotus HBO sunset' },
  ...
  { slug: 'roses', query: 'Roses Spain Catalan Costa Brava nord Bahia de Roses crescent bay Ciutadella de Roses Renaissance 16th century fortress Carlos V pentagonal walls Greek Rhode Roman ruins Platja de Roses Passeig Maritim Castell de la Trinitat Punta Falconera Cap de Creus Natural Park southern gateway Dolmen Creu d en Cobertella El Bulli legacy panorama sunset' },
  { slug: 'begur', query: 'Begur Spain Catalan Costa Brava centre medieval clifftop town Baix Emporda Girona Castell de Begur 11th century castle ruins panoramic hilltop casc antic cobbled alleys Esglesia de Sant Pere four medieval watchtowers cases indianas 19th century painted facades returnees Cuba Sa Tuna fishing port cove Aiguablava turquoise sand bay Parador Aiguafreda intimate cove Sa Riera largest sand beach Fornells port Tamariu Cami de Ronda GR-92 clifftop coastal path Cap de Begur lighthouse panorama sunset' },
  { slug: 'palamos', query: 'Palamos Spain Catalan Costa Brava centre fishing port municipality Baix Emporda Girona working Port de Palamos 3rd Catalonia volume Llotja fish auction afternoon Museu de la Pesca harbour quay Sant Joan de Palamos medieval hilltop casc antic Castell de Sant Esteve de Mar clifftop ruins La Fosca fjord sand cove Cala S Alguer postcard fishermen huts Platja del Castell year-round dog beach northern section Cala Margarida Cap Gros lighthouse breakwater Cami de Ronda GR-92 clifftop coastal path Cap de Planes Gamba de Palamos PDO red prawn Cuina del Peix Slow Food panorama sunset' },
